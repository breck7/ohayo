...
TileCommander.prototype.changeTileContentAndRenderCommand=function(a){var b=this.getTarget();b.setContent(a);b._clearTileStruct();b.getApp().renderApp();return b.autosaveTile()};TileCommander.prototype.copyTileCommand=function(){var a=this,b;return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){b=a.getTarget();b.getApp().getWillowProgram().copyTextToClipboard(b.getFirstAncestor().toString());c.jumpToEnd()})};
TileCommander.prototype.inspectTileCommand=function(){var a=this,b,c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){b=a.getTarget();c=b.getInspection();b.getTab().logMessageBray(c);b.getApp().renderApp();d.jumpToEnd()})};TileCommander.prototype.toggleToolbarCommand=function(){var a=this,b;return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){b=a.getTarget();b.toggleToolbar();c.jumpToEnd()})};
TileCommander.prototype.createCardsFromTNCommand=function(a){return this.getTarget().createCards((new CardParser).parse(a,"tree"))};TileCommander.prototype.copyDataCommand=function(a){var b=this,c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){c=b.getTarget();c.getApp().getWillowProgram().copyTextToClipboard(c.getOutputBinder().toDelimited(a));d.jumpToEnd()})};
TileCommander.prototype.copyDataAsTreeCommand=function(){var a=this,b,c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){b=a.getTarget();c=b.getOutputBinder().toTree().toString();b.getApp().getWillowProgram().copyTextToClipboard(c);d.jumpToEnd()})};
TileCommander.prototype.exportTileDataCommand=function(){var a=this,b;return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){b=a.getTarget();b.getApp().getWillowProgram().downloadFile(b.getOutputBinder().toDelimited(","),b.getKeyword()+".csv","text/csv");c.jumpToEnd()})};window.TileCommander=TileCommander;var HakonPropertyNode=function(a){return jtree.TreeNode.apply(this,arguments)||this};$jscomp.inherits(HakonPropertyNode,jtree.TreeNode);
HakonPropertyNode.prototype.toCss=function(a){return""+a+this.getKeyword()+": "+this.getContent()+";"};var HakonSelectorNode=function(a){return jtree.TreeNode.apply(this,arguments)||this};$jscomp.inherits(HakonSelectorNode,jtree.TreeNode);HakonSelectorNode.prototype.parseNodeType=function(a){return a.includes(" ")?HakonPropertyNode:HakonSelectorNode};
...
$jscomp.inherits(AppCommander,AbstractCommander);AppCommander.prototype.playFirstVisitCommand=function(){var a=this;return $jscomp.asyncExecutePromiseGeneratorProgram(function(b){return b.yield(a.openOhayoProgramCommand("ohayo.flow"),0)})};AppCommander.prototype.moveTilesFromShadowsCommand=function(){return this.getTarget().getAppWall().getCommander().moveTilesFromShadowsCommand()};
...
AppCommander.prototype.createProgramFromFileCommand=function(a,b){var c=this.getTarget(),d=Util.getFileExtension(a);if(c.getGrammars()[d])return c._createAndOpen(b,a);b=(d=FlowTemplates[d])?d(a,b):">h1 No visualization templates for "+a;return c._createAndOpen(b,a+".flow")};AppCommander.prototype.toggleShadowByIdCommand=function(a){var b=this,c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){c=b.getTarget();c.getWillowProgram().findStumpByChild("id "+a).getShadow().toggleShadow();d.jumpToEnd()})};
...
BrayTile.prototype.getTileBodyBray=function(){var a=this.getSettingsStruct(),b=this.getPipishInput()||this.getHtmlContent(),c=a.element||this.getKeyword().substr(1),d="true"===a.editable.toString();return"@"+c+"\n style "+a.style+jtree.TreeNode.nest(a.src?"src "+a.src:"",1)+"\n data-onBlurCommand chisel updateContentFromHtmlCommand\n contenteditable "+(d?"true":"false")+"\n bern"+jtree.TreeNode.nest(b,2)};window.BrayTile=BrayTile;
...
AbstractUrlProvider.prototype._getFormat=function(a){a=Util.getFileExtension(a);if((new CardParser).getEncodingNames()[a])return a};AbstractUrlProvider.prototype._tempParseCards=function(a){return a};
AbstractUrlProvider.prototype.fetchCards=function(){var a=this,b,c,d,e,f,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){if(1==h.nextAddress){b=a.getUrl();if(!b)return h.return([]);b=encodeURI(b);b.match(/\.json/);c=a.getSettingsStruct();d=c.format||a._getFormat(b);h.setCatchFinallyBlocks(2);return h.yield(a.getApp().getWillowProgram().get(b),4)}if(2!=h.nextAddress)return e=h.yieldResult,f=new CardParser,g="string"===typeof e?f.parse(e,d):f.parseFromObject(e,d),h.return(a._tempParseCards(g));
h.enterCatchBlock();a.logMessageBray("@div Error getting url: "+b);return h.return([])})};window.AbstractUrlProvider=AbstractUrlProvider;var DataTileCard=function(a){ObjectBackedCard.apply(this,arguments)};$jscomp.inherits(DataTileCard,ObjectBackedCard);DataTileCard._uniqueId=ObjectBackedCard._uniqueId;var DataTile=function(a){return AbstractProviderTile.apply(this,arguments)||this};$jscomp.inherits(DataTile,AbstractProviderTile);DataTile._mountedChisels=AbstractProviderTile._mountedChisels;
DataTile.loadCode=AbstractProviderTile.loadCode;DataTile.prototype.getDataSlang=function(){var a=this.getNode("slang");return a?a.childrenToString():""};DataTile.prototype.getTileBodyBray=function(){var a=lodash.escape(this.getDataSlang());return"@textarea\n data-onChangeCommand chisel updateSlangCommand\n class TileTextArea savable\n bern"+jtree.TreeNode.nest(a,2)};DataTile.prototype.isVisible=function(){return"false"!==this.get("visible")};DataTile.prototype.getCardClass=function(){return DataTileCard};
DataTile.prototype.fetchCards=function(){var a=this;return $jscomp.asyncExecutePromiseGeneratorProgram(function(b){return b.return((new CardParser).parse(a.getDataSlang(),a.getSettingsStruct().format))})};DataTile.prototype._getFormatted=function(a,b){switch(b){case "tree":return(new jtree.TreeNode(a)).toString();case "json":return(new jtree.TreeNode(a)).toJson();default:return(new jtree.TreeNode(a)).toCsv()}};
...
ProgramsTile.prototype.fetchCards=function(){var a=this,b;return $jscomp.asyncExecutePromiseGeneratorProgram(function(c){if(1==c.nextAddress)return c.yield(a.getApp().getFolder().readFiles(),2);b=c.yieldResult;return c.return(b.map(function(a){return a.toFileObject()}))})};window.ProgramsTile=ProgramsTile;var QueryTile=function(a){return AbstractUrlProvider.apply(this,arguments)||this};$jscomp.inherits(QueryTile,AbstractUrlProvider);QueryTile._mountedChisels=AbstractUrlProvider._mountedChisels;
QueryTile.loadCode=AbstractUrlProvider.loadCode;QueryTile.prototype.getUrl=function(){return"/sql?q="+this.getQuery()};QueryTile.prototype.getQuery=function(){return this.getContent()};QueryTile.prototype.getTileBodyBray=function(){return"@textarea\n data-onChangeCommand chisel changeTileSettingAndRenderCommand\n name query\n class TileTextArea\n bern"+jtree.TreeNode.nest(Format.stripHtml(this.getQuery()))};window.QueryTile=QueryTile;
var RedditTile=function(a){return AbstractUrlProvider.apply(this,arguments)||this};$jscomp.inherits(RedditTile,AbstractUrlProvider);RedditTile._mountedChisels=AbstractUrlProvider._mountedChisels;RedditTile.loadCode=AbstractUrlProvider.loadCode;RedditTile.prototype.getUrl=function(){var a=this.getSettingsStruct();return">subreddit"!==this.getKeyword()?a.url:"https://www.reddit.com/r/"+this.getContent()+"/top/.json?sort=top&t=all"};
RedditTile.prototype._tempParseCards=function(a){return a.length?a[1].children.map(function(a){return a.data}):[]};window.RedditTile=RedditTile;var TopTile=function(a){return AbstractUrlProvider.apply(this,arguments)||this};$jscomp.inherits(TopTile,AbstractUrlProvider);TopTile._mountedChisels=AbstractUrlProvider._mountedChisels;TopTile.loadCode=AbstractUrlProvider.loadCode;TopTile.prototype.getUrl=function(){return"/static/samples/presidents.csv"};window.TopTile=TopTile;
var AbstractExtendTile=function(a){return AbstractTransformerTile.apply(this,arguments)||this};$jscomp.inherits(AbstractExtendTile,AbstractTransformerTile);AbstractExtendTile._mountedChisels=AbstractTransformerTile._mountedChisels;AbstractExtendTile.loadCode=AbstractTransformerTile.loadCode;AbstractExtendTile.prototype.getTileClassColumns=function(){return this.getSettingsStructColumns().filter(function(a){return!!a.source})};
...
MorphTile.prototype.getHakon=function(){var a=this.getTheme();return".MorphTile\n .TileBody\n  display flex\n  flex-flow row wrap\n  overflow scroll\n  a\n   padding 10px\n   margin 5px\n   height 30px\n   background-color "+a.backgroundColor+"\n   border 1px solid "+a.borderColor+"\n   overflow hidden\n   text-align center\n   text-overflow ellipsis\n   font-size 14px\n   width 70px\n   span\n    font-size 90%"};
MorphTile.prototype.getTileBodyBray=function(){var a=this.getTileProcess().getProcessGrammarProgram(),b=a.getTopNodeTypes().slice(0,20);this.getApp();return b.map(function(b){return a.getDefinitionByName(b)}).map(function(a){var b=a.getConstantsObject();return"@a "+lodash.upperFirst(a.getId().substr(1))+" <br> <span>"+b.category+"</span>\n title "+a.getDescription()+"\n tabindex -1\n value "+a.getId()+"\n data-onClickCommand chisel changeTileTypeCommand"}).join("\n")};
MorphTile.prototype.getTileHeaderBern=function(){return"Add a Tile"};window.MorphTile=MorphTile;var TileProcess=function(a){return jtree.TreeNode.apply(this,arguments)||this};$jscomp.inherits(TileProcess,jtree.TreeNode);TileProcess.prototype.parseNodeType=function(a){var b=a.split(" ")[0],c=this.getProcessGrammarProgram();return c.getRunTimeKeywordMap()[b]?TileGrammar.getDefinitionTileClass(c.getDefinitionByName(b)):this.getCatchAllNodeClass(a)};TileProcess.prototype.getCatchAllNodeClass=function(){return DidYouMeanTile};
