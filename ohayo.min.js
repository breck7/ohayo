var $jscomp$templatelit$26=["Ok"];$jscomp$templatelit$26.raw=["Ok"];var $jscomp$templatelit$25=["Cancel"];$jscomp$templatelit$25.raw=["Cancel"];var $jscomp$templatelit$24=["Delete card"];$jscomp$templatelit$24.raw=["Delete card"];var $jscomp$templatelit$23=["Adding..."];$jscomp$templatelit$23.raw=["Adding..."];var $jscomp$templatelit$22=["Keyboard Shortcuts"];$jscomp$templatelit$22.raw=["Keyboard Shortcuts"];var $jscomp$templatelit$21=["ohayo"];$jscomp$templatelit$21.raw=["ohayo"];
...
var $jscomp$templatelit$8=["Drop to create a new program. Hold shift key to insert cards into current program."];$jscomp$templatelit$8.raw=["Drop to create a new program. Hold shift key to insert cards into current program."];var $jscomp$templatelit$7=["Are you sure you want to delete "," programs?"];$jscomp$templatelit$7.raw=["Are you sure you want to delete "," programs?"];var $jscomp$templatelit$6=["Are you sure you want to delete ","?"];
$jscomp$templatelit$6.raw=["Are you sure you want to delete ","?"];var $jscomp$templatelit$5=["Switched to "," theme"];$jscomp$templatelit$5.raw=["Switched to "," theme"];var $jscomp$templatelit$4=["Autosave is ",""];$jscomp$templatelit$4.raw=["Autosave is ",""];var $jscomp$templatelit$3=["Enter a regex to open multiple matching files"];$jscomp$templatelit$3.raw=["Enter a regex to open multiple matching files"];var $jscomp$templatelit$2=["Enter a url to open"];$jscomp$templatelit$2.raw=["Enter a url to open"];
var $jscomp$templatelit$1=["Created '","'"];$jscomp$templatelit$1.raw=["Created '","'"];var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(a,b,c){a!=Array.prototype&&a!=Object.prototype&&(a[b]=c.value)};
...
this.onSettledCallbacks_,b=0;b<a.length;++b)a[b].call(),a[b]=null;this.onSettledCallbacks_=null}};var f=new b;e.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};e.prototype.settleSameAsThenable_=function(a,b){var c=this.createResolveAndReject_();try{a.call(b,c.resolve,c.reject)}catch(k){c.reject(k)}};e.prototype.then=function(a,b){function c(a,b){return"function"==typeof a?function(b){try{d(a(b))}catch(x){f(x)}}:b}var d,f,g=new e(function(a,
...
$jscomp.owns=function(a,b){return Object.prototype.hasOwnProperty.call(a,b)};$jscomp.polyfill("Object.values",function(a){return a?a:function(a){var b=[],d;for(d in a)$jscomp.owns(a,d)&&b.push(a[d]);return b}},"es8","es3");$jscomp.checkStringArgs=function(a,b,c){if(null==a)throw new TypeError("The 'this' value for String.prototype."+c+" must not be null or undefined");if(b instanceof RegExp)throw new TypeError("First argument to String.prototype."+c+" must not be a regular expression");return a+""};
...
AC.prototype._mount=function(a,b){if(!this.shouldComponentMount())return this;this._setRTime(this._getNow());this.componentWillMount();var c=this._getInnerHtml(),d=this.getApp().getWillowDom();this._cssStump=d.makeStumpFromString("<style>"+c.css+"</style>");this._htmlStump=d.makeStumpFromString("<div "+this.getAttributes()+' class="'+this.getClasses()+'">'+c.html+"</div>");a.append(this._cssStump);void 0===b?a.append(this._htmlStump):0===b?a.prepend(this._htmlStump):this._htmlStump.insertAfter(a.children().get(b));
this._htmlStump.data("container",this);this._lastTimeToRender=this._getNow()-this.getRTime();return this};AC.prototype.unmountAndDestroy=function(){this.unmount();return this.destroy()};AC.prototype.toggle=function(a,b){var c=this.getNode(a);if(!b)return c?c.unmountAndDestroy():this.append(a);c=void 0===c?void 0:c.getTail();c=b.indexOf(c);b=-1===c||c+1===b.length?b[0]:b[c+1];this.delete(a);b&&this.touchNode(a).setTail(b);return b};AC.prototype.isMounted=function(){return!!this._htmlStump};
...
AC.prototype.render=function(a,b){var c=this.isMounted();c?this._update():this._mount(a,b);this.isMounted()&&this._renderChildren();c?this.componentDidUpdate():this.componentDidMount();return this};window.AC=AC;var AbstractCard=function(a,b){a=void 0===a?{}:a;this._puid=this._getUniqueId();this._sourceObject=a;this._binder=b};AbstractCard.prototype._getUniqueId=function(){void 0===AbstractCard._uniqueId&&(AbstractCard._uniqueId=0);AbstractCard._uniqueId++;return AbstractCard._uniqueId};
AbstractCard.prototype.destroy=function(){};AbstractCard.prototype._getCardBinder=function(){return this._binder};AbstractCard.prototype.getCardApp=function(){return this.getCardBlock().getApp()};AbstractCard.prototype.getCardBlock=function(){return this._getCardBinder().getBinderOwner()};AbstractCard.prototype.destroyCardCommand=function(){return Promise.resolve()};AbstractCard.prototype.getCardSourceAsObject=function(){return this.getCardSource()};
AbstractCard.prototype.getAsArray=function(a){var b=this.getCardNumeric();return a.map(function(a){return b[a]})};AbstractCard.prototype.getCardSource=function(){return this._sourceObject};AbstractCard.prototype._parseNumeric=function(){var a=this,b=this._getCardBinder().getColumnsMap(),c={};Object.keys(b).forEach(function(d){var e=b[d],f=a.getCardValue(d);void 0===f&&(f="");c[d]=""===f?"":e.getType().fromStringToNumeric(f)});return c};
AbstractCard.prototype.getCardNumeric=function(){this._numeric||(this._numeric=this._parseNumeric());return this._numeric};AbstractCard.prototype.getCardKeys=function(){return Object.keys(this.getCardSource())};AbstractCard.prototype.getFirstCell=function(){return this.getCardValue(this.getCardKeys()[0])};AbstractCard.prototype.getCardValue=function(a){a=this.getCardSource()[a];return null===a?"":a};AbstractCard.prototype.setCardValue=function(a,b){this.getCardSource()[a]=b;return this};
AbstractCard.prototype.reloadFromStr=function(a){var b=this.getCardSource();Object.keys(b).forEach(function(a){return delete b[a]});var c=JSON.parse(a);Object.keys(c).forEach(function(a){return b[a]=c[a]})};AbstractCard.prototype.deleteFromCard=function(a){delete this.getCardSource()[a];return this};AbstractCard.prototype.getPuid=function(){return this._puid};AbstractCard.prototype.renameCard=function(a,b){var c=this.getCardSource();c[b]=c[a];delete c[a];return this};
...
var HtmlParser=function(a){AbstractTreeCardParser.apply(this,arguments)};$jscomp.inherits(HtmlParser,AbstractTreeCardParser);HtmlParser.prototype.is=function(a){return a.trimmedStr.match(/^(\<\!doctype html\>|\<html|\<div)/i)?1:0};HtmlParser.prototype._getFormatName=function(){return"html"};HtmlParser.prototype.parseTrees=function(a){return TreeNotation.fromXml(a)};var RssParser=function(a){AbstractCardParser.apply(this,arguments)};$jscomp.inherits(RssParser,AbstractCardParser);
RssParser.prototype._getFormatName=function(){return"rss"};RssParser.prototype.is=function(a){return"<rss "===a.trimmedStr.substr(0,5)||"<?xml "===a.trimmedStr.substr(0,6)?1:0};
RssParser.prototype.parse=function(a){if("undefined"===typeof $)return TreeNotation.fromXml(a).getChildren().map(function(a){return a.toObject()});var b=[],c=0;$(a).find("item").each(function(){var a={};$(this).children().each(function(){var b=$(this),c=b[0].tagName.toLowerCase();(b=b.text())&&(a[c]=b)});c++;a.index=c;b.push(a)});return b};var SpacedParser=function(a){AbstractCardParser.apply(this,arguments)};$jscomp.inherits(SpacedParser,AbstractCardParser);SpacedParser.prototype.getExample=function(){return"name john\nage 12\n\nname mary\nage 20"};
SpacedParser.prototype._getFormatName=function(){return"spaced"};SpacedParser.prototype.is=function(a){return 10<a.blankLineCount?.95:.05};
...
var CardParser=function(){var a=this;this._parsers=[new CsvParser,new TsvParser,new SsvParser,new PsvParser,new TextParser,new TreeParser,new XmlParser,new RssParser,new HtmlParser,new SectionsParser,new SpacedParser,new ListParser,new JsonParser,new JsonArrayParser,new JsonVectorParser,new JsonMapParser,new JsonCountMapParser];this._parserMap={};this._parsers.forEach(function(b){var c=b._getFormatName();c&&(a._parserMap[c]=b)})};CardParser.prototype.getEncodingNames=function(){return Object.keys(this._getParserMap())};
...
window.CardStringSpecimen=CardStringSpecimen;var Column=function(a,b){this._obj=a;this._rawVector=b;this._sampleSet=_.sampleSize(b,30)};Column.prototype.getColumnName=function(){return this._obj.name};Column.prototype.isInvalidValue=function(a){return this.getType().isInvalidValue(a)};Column.prototype._getSample=function(){if(void 0===this._sample){var a=this._getSampleSet();this._sample=a.length?a[0]:""}return this._sample};Column.prototype._getObject=function(){return this._obj};
...
Column.prototype._getReductionResult=function(a,b){var c=a.values,d=c.length,e={};e.incompleteCount=a.incompleteCount;e.uniqueValues=a.uniqueValues;if(!d)return e;a=function(a,b){return a>b?1:a<b?-1:0};var f=c.slice();b.isString()?f.sort():f.sort(a);c=f[0];a=f[0];for(var g=0,h=void 0,n=0,k=void 0,p=0,m=0;m<d;m++){var q=f[m],g=g+q;q>a&&(a=q);q<c&&(c=q);q===k?p++:(k=q,p=1);p>n&&(n=p,h=k)}k=Math.floor(d/2);e.count=d;e.sum=g;e.median=f[k];e.average=g/d;e.min=c;e.max=a;e.range=a-c;e.mode=h;e.modeSize=
n;b.isString()?(e.sum=void 0,e.average=void 0):b.isTemporal()&&(e.sum=void 0);e.deciles={};[10,20,30,40,50,60,70,80,90,99,100].forEach(function(a){var b=Math.floor(a/100*d),b=b===d?b-1:b;e.deciles[a]=f[b]});return e};
...
ColumnProp.prototype.parseValue=function(a,b){var c=b.getInputBinder(),d=c.getColumnsMap(),e=this.getNode("auto");if(d[a])return a;if(e){if(e.getTail())return this._getAutoColumn(b,e.getTail());a=c.getColumnsByImportance();if(a=a.length&&a[0].getColumnName())return a}};
...
ParserBlock.prototype.getPattern=function(){return this._getExtended().findTail("pattern")};ParserBlock.prototype.getDescription=function(){return this.findTail("description")||""};ParserBlock.prototype.getSvg=function(){return this._getExtended().findTail("svg")||"table"};ParserBlock.prototype._getExtended=function(){this._extended||(this._extended=this._makeExtended());return this._extended};
ParserBlock.prototype._makeExtended=function(){var a=this.getGraph(),b=new ParserBlock;a.forEach(function(a){b.extend(a)});return b};ParserBlock.prototype._loadCss=function(a){var b=this._getExtended().findTail("css");if(b){var c=a.getServerPath();a.getWillowDom().getBodyStump().append(b.split(" ").map(function(a){return'<link rel="stylesheet" media="screen" href="'+(c+a)+'">'}).join("\n"))}};
ParserBlock.prototype.executeLoadBlockOrGetLoadingPromise=function(a){this._loadCss(a);var b=this.getJSClass(a),c=this._getExtended().findTail("script"),d=a.getServerPath(),c=c?c.match(/^https\:/)?c:d+c:void 0;return a.appendScript(c).then(function(){return b.loadCode()})};ParserBlock.prototype.getSuggestedSize=function(){var a=(this._getExtended().findTail("size")||"280 220").split(" ").map(function(a){return parseInt(a)});return{width:a[0],height:a[1]}};
ParserBlock.prototype.getPropertyNodes=function(){var a=[];this.getGraph().forEach(function(b){b.getChildrenByNodeType(BlockPropertyNode).forEach(function(b){a.push(b)})});return a};ParserBlock.prototype.getPropertiesMap=function(){var a={};this.getPropertyNodes().forEach(function(b){a[b.getPropertyName()]=b});return a};ParserBlock.prototype.computeStruct=function(a){var b={};this.getPropertyNodes().forEach(function(c){c.addValue(b,a)});return b};
ParserBlock.prototype.getJSClass=function(a){if(this._class)return this._class;a=a.getWillowDom().getWindowNamespace();var b=this._getExtended().findTail("require").split(" "),c=b[0],b=b[1];"undefined"===typeof require||a[c]||(b=require(b),a[b.name]=b);this._class=a[c];if(!this._class)debugger;return this._class};var ParserETN=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(ParserETN,TreeNotation);ParserETN.prototype.parseNodeType=function(a){return ParserBlock};
ParserETN.prototype.dynamicGetJsClass=function(a,b,c){var d=b.split(" ")[0];return(d=(d=this.getParserBlockMap()[d])&&d.getJSClass(c))?d:a.getProgram().getCatchAllBlockClass(this,a,b,c)};ParserETN.prototype.getCatchAllBlockClass=function(a,b,c,d){return TreeNotation};ParserETN.prototype.getDocs=function(){return this.toString()};
...
window.TableSpecimen=TableSpecimen;var TreeBackedCard=function(a){AbstractCard.apply(this,arguments)};$jscomp.inherits(TreeBackedCard,AbstractCard);TreeBackedCard._uniqueId=AbstractCard._uniqueId;TreeBackedCard.prototype.getCardId=function(){return this.getCardSource().getHead()};TreeBackedCard.prototype.destroy=function(){this.getCardSource().destroy();return AbstractCard.prototype.destroy.call(this)};TreeBackedCard.prototype.getCardSourceAsObject=function(){return this.getCardSource().toObject()};
TreeBackedCard.prototype.renameCard=function(a,b){return this.getCardSource().rename(a,b)};TreeBackedCard.prototype.reloadFromStr=function(a){return this.getCardSource().setChildren(a)};TreeBackedCard.prototype.setCardValue=function(a,b){this.getCardSource().touchNode(a).setTail(b);return this};TreeBackedCard.prototype.getCardKeys=function(){return this.getCardSource().getHeads()};TreeBackedCard.prototype.deleteFromCard=function(a){return this.getCardSource().delete(a)};
TreeBackedCard.prototype.cardToString=function(){return this.getCardSource().childrenToString()};TreeBackedCard.prototype.getCardValue=function(a){return this.getCardSource().findTail(a)||""};window.TreeBackedCard=TreeBackedCard;
var Util={getFileExtension:function(a){return(a=(void 0===a?"":a).match(/\.([^\.]+)$/))&&a[1]||""},removeFileExtension:function(a){a=void 0===a?"":a;if(!a.includes("."))return a;a=a.split(".");a.pop();return a.join(".")},getAvailablePermalink:function(a,b){var c=Util.getFileExtension(a);a=Util.removeFileExtension(a);for(var d=2,e="",f=""+a+e+"."+c;b(f);)f=""+a+e+"."+c,e="-"+d,d++;return f},parseCookie:function(a){var b={};(void 0===a?"":a).split(/[;,] */).forEach(function(a){var c=a.indexOf("="),
e=a.substr(0,c).trim();a=a.substr(++c,a.length).trim();'"'===a[0]&&(a=a.slice(1,-1));if(void 0===b[e])try{b[e]=decodeURIComponent(a)}catch(f){b[e]=a}});return b},pLimit:function(a){var b=[],c=0;return function(d){return new Promise(function(e,f){var g=function(){c++;d().then(function(a){e(a);c--;b.length&&b.shift()()},function(a){f(a);c--;b.length&&b.shift()()})};c<a?g():b.push(g)})}},moveArray:function(a,b,c){return a.splice(c,0,a.splice(b,1)[0])},dynamicSort:function(a){var b=1;"-"===a[0]&&(b=-1,
a=a.substr(1));return function(c,d){c=c[a];d=d[a];var e=c<d?-1:c>d?1:0;void 0===c&&void 0!==d?e=-1:void 0===d&&void 0!==c&&(e=1);return e*b}},sortByAccessor:function(a){return function(b,c){b=a(b);c=a(c);var d=b<c?-1:b>c?1:0;void 0===b&&void 0!==c?d=-1:void 0===c&&void 0!==b&&(d=1);return d}},isExternalLink:function(a,b){if(a&&"/"===a.substr(0,1)||!a.includes(":"))return!1;a=new miuri(a);return a.hostname()&&b!==a.hostname()},toggle:function(a,b){a=b.indexOf(a);return-1===a||a+1===b.length?b[0]:b[a+
...
a?b[a]:e++;d[c]||(d[c]={});var g=d[c];f.forEach(function(a){return g[a]=b[a]})})});return Object.values(d)}};window.Util=Util;var Version="1.2.2";"undefined"!==typeof exports&&(module.exports=Version);var UnitTestSection=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(UnitTestSection,TreeNotation);var Wall=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(Wall,TreeNotation);Wall.prototype.parseNodeType=function(a){return UnitTestSection};
Wall.prototype.getSectionsToRun=function(){var a=this.getChildren().filter(function(a){return a.getLine().startsWith("+")});return a.length?a:this.getChildren().filter(function(a){return!a.getLine().startsWith("!")})};Wall.prototype.execute=function(a){this.getSectionsToRun().map(function(b){Tape(b.getHead(),function(c){var d=a(b);c.equal(d.actual,d.expected,d.message);c.end()})})};window.Wall=Wall;var WillowElement=function(a){return TreeNotation.apply(this,arguments)||this};
$jscomp.inherits(WillowElement,TreeNotation);WillowElement.prototype.setAttribute=function(){};WillowElement.prototype.click=function(){};WillowElement.prototype.addEventListener=function(){};WillowElement.prototype.open=function(){};var WillowDocumentElement=function(){var a=WillowElement.call(this)||this;a.location={};return a};$jscomp.inherits(WillowDocumentElement,WillowElement);var WillowIpc=function(){};WillowIpc.prototype.on=function(){};WillowIpc.prototype.send=function(){};
var WillowHistory=function(){};WillowHistory.prototype.replaceState=function(){};var WillowStore=function(){this._values={}};WillowStore.prototype.get=function(a){return this._values[a]};WillowStore.prototype.set=function(a,b){this._values[a]=b;return this};WillowStore.prototype.remove=function(a){delete this._values[a]};WillowStore.prototype.each=function(a){var b=this;Object.keys(this._values).forEach(function(c){a(b._values[c],c)})};WillowStore.prototype.clearAll=function(){this._values={}};
var WillowMousetrap=function(){this.prototype={}};WillowMousetrap.prototype.bind=function(){};var WillowStump=function(){};WillowStump.prototype.closest=function(){return this};WillowStump.prototype.remove=function(){return this};WillowStump.prototype.data=function(){return this};WillowStump.prototype.addClass=function(){return this};WillowStump.prototype.removeClass=function(){return this};WillowStump.prototype.append=function(){return this};WillowStump.prototype.children=function(){return new WillowStump};
WillowStump.prototype.get=function(){return new WillowStump};WillowStump.prototype.insertAfter=function(){return this};WillowStump.prototype.each=function(){return this};WillowStump.prototype.hide=function(){return this};WillowStump.prototype.selectable=function(){return this};WillowStump.prototype.css=function(){return this};WillowStump.prototype.width=function(){return 100};WillowStump.prototype.height=function(){return 100};WillowStump.prototype.val=function(){return""};
WillowStump.prototype.parent=function(){return new WillowStump};WillowStump.prototype.focus=function(){return this};WillowStump.prototype.find=function(){return new WillowStump};WillowStump.prototype.typeahead=function(){return this};WillowStump.prototype.bind=function(){return this};WillowStump.prototype.prepend=function(){return this};WillowStump.prototype.html=function(){return this};WillowStump.prototype.on=function(){return this};var AbstractDom=function(a){this._baseUrl=a||""};
AbstractDom.prototype.toggleFullScreen=function(){};AbstractDom.prototype.getMousetrap=function(){return new WillowMousetrap};AbstractDom.prototype.getStore=function(){this._store||(this._store=new WillowStore);return this._store};AbstractDom.prototype.getBodyStump=function(){return new WillowStump};AbstractDom.prototype.someInputHasFocus=function(){return!1};AbstractDom.prototype.isNode=function(){return"undefined"!==typeof exports};AbstractDom.prototype.copyTextToClipboard=function(){};
AbstractDom.prototype.getFocusedStump=function(){return new WillowStump};AbstractDom.prototype.setHeaders=function(a){this._headers=a;return this};AbstractDom.prototype.getWindowNamespace=function(){return{}};AbstractDom.prototype.getBaseUrlNoSlash=function(){return this.getBaseUrl().replace(/\/$/,"")};AbstractDom.prototype.setCopyData=function(a,b){};AbstractDom.prototype.getBaseUrl=function(){return this._baseUrl};
AbstractDom.prototype._normalizeUrl=function(a){return a.startsWith("http://")||a.startsWith("https://")?a:this.getBaseUrlNoSlash()+a};AbstractDom.prototype.get=function(a,b){a=this._normalizeUrl(a);return superagent.get(a).query(b).set(this._headers||{}).then(function(a){return a.body||a.text})};AbstractDom.prototype.post=function(a,b){a=this._normalizeUrl(a);return superagent.post(a).set(this._headers||{}).send(b).then(function(a){return a.body||a.text})};AbstractDom.prototype.createElement=function(){return new WillowElement};
AbstractDom.prototype.encodeURIComponent=function(a){return encodeURIComponent(a)};AbstractDom.prototype.getWindowElement=function(){this._windowElement||(this._windowElement=new WillowElement);return this._windowElement};AbstractDom.prototype.getWindowStump=function(){return this.getStumpFromElement(this.getWindowElement())};AbstractDom.prototype.getDocumentStump=function(){return this.getStumpFromElement(this.getDocumentElement())};AbstractDom.prototype.getHtmlStump=function(){return this.getStumpFromElement(new WillowElement)};
AbstractDom.prototype.getHistory=function(){return new WillowHistory};AbstractDom.prototype.getDocumentElement=function(){return new WillowDocumentElement};AbstractDom.prototype.setWindowTitle=function(a){this.getDocumentElement().title=a};AbstractDom.prototype.getElementsByTagName=function(){return[]};AbstractDom.prototype._getDocumentLocation=function(){return this.getDocumentElement().location};AbstractDom.prototype.setDocumentLocation=function(a){this.getDocumentElement().location=a;return this};
AbstractDom.prototype.getDocumentPathName=function(){return this._getDocumentLocation().pathname||""};AbstractDom.prototype.getDocumentHostname=function(){return this._getDocumentLocation().hostname||""};AbstractDom.prototype.getIpc=function(){return new WillowIpc};AbstractDom.prototype.makeStumpFromString=function(a){return new WillowStump};AbstractDom.prototype.getStumpById=function(a){return new WillowStump};AbstractDom.prototype.getStumpByClass=function(a){return new WillowStump};
AbstractDom.prototype.getStumps=function(a){return new WillowStump};AbstractDom.prototype.getStumpFromElement=function(a){return new WillowStump(a)};AbstractDom.startApp=function(a){document.addEventListener("DOMContentLoaded",function(){window.app||(window.app=new a,window.app.renderApp())},!1)};var JQueryDom=function(a){AbstractDom.apply(this,arguments)};$jscomp.inherits(JQueryDom,AbstractDom);JQueryDom.startApp=AbstractDom.startApp;JQueryDom.prototype.getStumpFromElement=function(a){return $(a)};
JQueryDom.prototype.getIpc=function(){return require("electron").ipcRenderer};
...
JQueryDom.prototype.getElementsByTagName=function(a){return document.getElementsByTagName(a)};JQueryDom.prototype.createElement=function(a){return document.createElement(a)};JQueryDom.prototype.getWindowNamespace=function(){return window};JQueryDom.prototype.getHistory=function(){return history};JQueryDom.prototype.getDocumentStump=function(){return $(document)};JQueryDom.prototype.getDocumentElement=function(){return document};JQueryDom.prototype.getFocusedStump=function(){return $("input:focus,div:focus,textarea:focus,[contenteditable=true]:focus")};
JQueryDom.prototype.someInputHasFocus=function(){return 0<this.getFocusedStump().length};var WillowDom=function(a){AbstractDom.apply(this,arguments)};$jscomp.inherits(WillowDom,AbstractDom);WillowDom.startApp=AbstractDom.startApp;WillowDom.JQueryDom=JQueryDom;window.WillowDom=WillowDom;var AbstractProgramNode=function(a){return AC.apply(this,arguments)||this};$jscomp.inherits(AbstractProgramNode,AC);AbstractProgramNode._mountedComponents=AC._mountedComponents;
AbstractProgramNode.prototype.parseNodeType=function(a){return this.getParser().dynamicGetJsClass(this,a,this.getApp())};AbstractProgramNode.prototype.toJavascript=function(){return""};AbstractProgramNode.prototype.getProgram=function(){return this.isProgram()?this:this.getParent().getProgram()};AbstractProgramNode.prototype.getCardClass=function(){return ObjectBackedCard};AbstractProgramNode.prototype.getStructColumns=function(){return[]};AbstractProgramNode.prototype.getBlockClassColumns=function(){return[]};
AbstractProgramNode.prototype.getChildBlocks=function(){return this.getChildrenByNodeType(AbstractProgramNode)};AbstractProgramNode.prototype.getChildNonBlocks=function(){return this.getChildren().filter(function(a){return!(a instanceof AbstractProgramNode)})};AbstractProgramNode.prototype.getDescendantBlocks=function(){var a=[];this.getChildBlocks().forEach(function(b){return b._getDescendantBlocks(a)});return a};AbstractProgramNode.prototype._getDescendantBlocks=function(a){a.push(this);this.getChildBlocks().forEach(function(b){return b._getDescendantBlocks(a)})};
AbstractProgramNode.prototype.getHierarchyWithNonTerminals=function(){return{children:this.getChildBlocks().map(function(a){return a._getHierarchyWithNonTerminals()})}};AbstractProgramNode.prototype._getHierarchyWithNonTerminals=function(){var a=this.getChildBlocks().map(function(a){return a._getHierarchyWithNonTerminals()});a.unshift({block:this});return{children:a}};AbstractProgramNode.prototype.getTTL=function(){return this._ttl||0};
AbstractProgramNode.prototype.getHierarchy=function(){return{block:this,children:this.getChildBlocks().map(function(a){return a.getHierarchy()})}};AbstractProgramNode.prototype.getInputBinder=function(){var a=this.getParent();return a.isProvider()?a.getOutputBinder():a.getInputBinder()};AbstractProgramNode.prototype.getOutputBinder=function(){if(!this.isProvider())return this.getInputBinder();this._outputBinder||(this._outputBinder=new Binder(this));return this._outputBinder};
window.AbstractProgramNode=AbstractProgramNode;var AbstractBlock=function(a){return AbstractProgramNode.apply(this,arguments)||this};$jscomp.inherits(AbstractBlock,AbstractProgramNode);AbstractBlock._mountedComponents=AbstractProgramNode._mountedComponents;AbstractBlock.prototype.getStruct=function(){this._blockStruct||(this._blockStruct=this.getBlock().computeStruct(this));return this._blockStruct};AbstractBlock.prototype.getParser=function(){return this.getProgram().getParser()};
AbstractBlock.prototype._getInnerHtml=function(){return{html:'<div class="BlockPage" data-contextmenucommand="ac _openBlockContextMenuCommand">\n        '+this.getBlockHtmlPage()+"\n      </div>",css:this._getCssContent()}};AbstractBlock.prototype.isNode=function(){return"undefined"!==typeof exports};AbstractBlock.prototype.isVisible=function(){return this.getStruct().visible};AbstractBlock.prototype.selectBlock=function(){this._selected=!0;this.isMounted()&&this.getStump().addClass("ui-selected")};
AbstractBlock.prototype.unselect=function(){delete this._selected;this.isMounted()&&this.getStump().removeClass("ui-selected")};AbstractBlock.prototype.isSelected=function(){return this._selected};AbstractBlock.prototype.getBlockHtmlPage=function(){return'<div class="BlockGrabber"></div>\n    <div class="BlockHeader">'+this.getBlockHtmlHeader()+'</div>\n  <div class="BlockBody">'+this.getBlockHtmlBody()+'</div>\n  <div class="BlockFooter">'+this.getBlockHtmlFooter()+'</div>\n  <div class="BlockGrabber"></div>'};
AbstractBlock.prototype.getBlockHtmlHeader=function(){return""+this.getHead()};AbstractBlock.prototype.openCardEditorByIndexCommand=function(a){return this._openCardEditor(this.getInputBinder().getCards()[a])};AbstractBlock.prototype.makeBlockDimension=function(a){a=void 0===a?this.getPin():a;a=a.split(" ").map(function(a){return 20*parseInt(a)});var b={left:a[0],top:a[1]};2<a.length&&(b.width=a[2]);3<a.length&&(b.height=a[3]);return new BlockDimension(this,b)};
AbstractBlock.prototype.openCardEditorByPuidCommand=function(a){return this._openCardEditor(this._getCardByPuid(a))};AbstractBlock.prototype._openCardEditor=function(a){var b=this.getApp();b.setTargetNode(a);return b.toggleAndRender("cardEditorModal")};AbstractBlock.prototype._getCardByPuid=function(a){a=parseInt(a);return this.getInputBinder().getCards().find(function(b){return b.getPuid()===a})};AbstractBlock.prototype.getBlockHtmlBody=function(){return""};
AbstractBlock.prototype.openSingleInsertModalCommand=function(){var a=this.getApp();a.setTargetNode(this);return a.toggleAndRender("singleInsertModal")};AbstractBlock.prototype.openBulkInsertModalCommand=function(){return this.getApp().setTargetNode(this).toggleAndRender("bulkInsertModal")};AbstractBlock.prototype.getPanel=function(){return this.getProgram().getPanel()};
AbstractBlock.prototype._getCssContent=function(){var a="#"+this.getId(),b=this.getStyles(),c=this.getTheme(),d=this.isVisible()?"":"display: none",e=this.getBlockDimension(),e=e?e.toCss():"",f=Object.keys(b).map(function(d){return a+" "+d+" {"+c.objToCss(b[d])+"}"}).join("");return a+" { "+d+" "+e+" }\n      "+f+"\n      "+c.hakonToCss(this.getHakon())};AbstractBlock.prototype.isProvider=function(){return!1};AbstractBlock.prototype.getBlock=function(){return this.getParser().getParserBlockByName(this.getHead())};
AbstractBlock.prototype.mapPropertiesToColumnNames=function(a){var b=this.getStruct();return a.map(function(a){return b[a]})};AbstractBlock.prototype.getRequiredTable=function(a){a=this.mapPropertiesToColumnNames(a);var b=this.getOutputBinder();return a.map(function(a){return b.getBinderColumnByName(a)}).some(function(a){return!a})?[]:this.getCardsAsCsvArray(a)};
AbstractBlock.prototype.getCardsWithStructQuery=function(){if(this.isProgram())return this.getCards();var a=this.getLimit(),b=this.getStruct().orderBy;return this.getOutputBinder().getSortedCardsWithLimit(b,a)};AbstractBlock.prototype.getCardsAsCsvArray=function(a){var b=this.getCardsWithStructQuery().map(function(b){return b.getAsArray(a)});b.unshift(a);return b};AbstractBlock.prototype.getContextMenuHtml=function(){return""};
...
AbstractBlock.prototype.createCardsFromTNCommand=function(a){return this.createCards((new CardParser).parse(a,"tree"))};AbstractBlock.prototype.createCards=function(a){return Promise.resolve()};AbstractBlock.prototype.fetchCards=function(){return Promise.resolve([])};AbstractBlock.prototype.getStructColumns=function(){var a=this.getNode("columns"),b=a?a.toObject():{};return Object.keys(b).map(function(a){var c=b[a]||{};"object"!==typeof c&&(c={});c.name||(c.name=a);return c})};
AbstractBlock.prototype.getBlockClassColumns=function(){return[]};AbstractBlock.prototype.executeLoadNewBinder=function(){var a=this,b=this._getNow();this._timeLastLoadStarted=b;var c=this.fetchCards();if(!(c instanceof Promise))debugger;return c.then(function(c){if(a._timeLastLoadStarted!==b)return Promise.resolve();var d=_.flatten(a.getStructColumns(),a.getBlockClassColumns()),f=a.getCardClass();a._outputBinder=new Binder(a,c,d,f);a._ttl=a._getNow()-b;return Promise.all(a.getChildBlocks().map(function(a){return a.executeLoadNewBinder()})).then(function(b){return a})}).catch(function(b){a.handleBlockError(b)})};
...
AbstractBlock.prototype.getNewDataCommand=function(){};AbstractBlock.prototype.changePropertyCommand=function(a,b){this.touchNode(b).setTail(a);this.render();return this.autosaveBlock()};AbstractBlock.prototype.changeWordCommand=function(a,b){this.setWord(b,a);this.render();return this.autosaveBlock()};AbstractBlock.prototype.insertSuggestionCommand=function(a){var b=this;this.append(a);this.autosaveBlock();return this.getProgram().executeLoadProgramCode().then(function(){return b.render()})};
AbstractBlock.prototype.copyBlockCommand=function(){this.getApp().getWillowDom().copyTextToClipboard(this.getFirstAncestor().toString());return Promise.resolve()};AbstractBlock.prototype.copyDataCommand=function(a){this.getApp().getWillowDom().copyTextToClipboard(this.getOutputBinder().toDelimited(a));return Promise.resolve()};AbstractBlock.prototype._exportDataCommand=function(){this.getApp().downloadFile(this.getOutputBinder().toDelimited(","),this.getHead()+".csv","text/csv")};
...
AbstractFireBlock._mountedComponents=AbstractBlock._mountedComponents;AbstractFireBlock.loadCode=AbstractBlock.loadCode;AbstractFireBlock.prototype.getHakon=function(){return".AbstractFireBlock\n input\n  border 0\n  font-size 16px"};
AbstractFireBlock.prototype.getBlockHtmlBody=function(){var a=this,b=this.getBlock(),c=MakeSVG(b.getSvg(),14),d=this.getPatternWords(),e=d.length-1,d=d.map(function(b,c){var d=c+1;c=(e===c?a.getWords(d).join(" "):a.getWord(d))||"";return'<input placeholder="'+b+'" value="'+c+'" name="'+d+'" data-command="ac changeWordCommand" / >'}).join("");return c+" "+b.getDescription()+"<br>\n\t\t"+d};
AbstractFireBlock.prototype.getPatternWords=function(){var a=this.getBlock().getPattern();return a?a.split(" "):[]};
AbstractFireBlock.prototype.toJavascript=function(a){a=void 0===a?0:a;var b=this.getBlock()._getExtended(),c=b.findTail("toJS")||"",d=this.getPatternWords(),e=this.getWords(1),f={},g=d.length-1,h=b.findTail("joinLastBy")||" ";d.forEach(function(a,b){f[a]=b===g?e.slice(b).join(h):e[b]});var c=(new TreeNotation(f)).format(c),b=b.getNode("hasBlock"),n=" ".repeat(a);return b?n+c+" {\n"+this.getChildrenByNodeType(AbstractBlock).map(function(b){return n+b.toJavascript(a+2)}).join("\n")+"\n"+n+"}\n":n+c};
window.AbstractFireBlock=AbstractFireBlock;var AbstractApp=function(a){return AC.apply(this,arguments)||this};$jscomp.inherits(AbstractApp,AC);AbstractApp._mountedComponents=AC._mountedComponents;
AbstractApp.prototype.componentWillMount=function(){var a=this;this._startVisitCounter();var b=this.getFromStore(StorageKeys.openPrograms),b=(b=b?b.replace("!",""):"")?b.split(" "):[],b=_.uniq(b),c=this.getProgramToOpen();c&&-1===b.indexOf(c)&&b.push(c);b=b.map(function(a){return a===c?"!"+a:a});b=b.slice(0,30);this.concat("theme\nmenu\npanel\n programs "+b+"\n search");b.forEach(function(b){return b.startsWith("!")?a.openUrlInNewSpaceAndFocus(b.substr(1)):a.openUrlInNewSpace(b)});this._setContainerHandlers();
this._makeProgramLinksOpenImmediately();this._makeWindowDroppable(this);this._makeWindowPastable(this);this._makeDocumentCopyableAndCuttable();this._bindKeyboardShortcuts();this._setErrorHandlers()};AbstractApp.prototype.getSessionId=function(){this._sessionId||(this._sessionId=Format.randomString(16));return this._sessionId};AbstractApp.prototype.getTargetNode=function(){return this._targetNode};AbstractApp.prototype.setTargetNode=function(a){this._targetNode=a;return this};
AbstractApp.prototype.getWillowDom=function(){this._willowDom||(this._willowDom="undefined"===typeof $?new WillowDom("http://localhost:8000/"):new WillowDom.JQueryDom(""));return this._willowDom};AbstractApp.prototype.emptyFolderCommand=function(){};
AbstractApp.prototype.getFlowBlocks=function(){var a=this.constructor.name.toLowerCase(),b=new TreeNotation(FlowBlocks);b.getChildren().filter(function(b){b=b.findTail("platform");return!b||b.includes(a)?!0:!1}).map(function(a){return a.toString()}).join("");return b.toString()};AbstractApp.prototype.getServerPath=function(){return""};AbstractApp.prototype.getVersion=function(){return Version};AbstractApp.prototype._startVisitCounter=function(){var a=this._getVisitCount();a++;this.setVisitCount(a)};
AbstractApp.prototype.setVisitCount=function(a){this.storeValue(StorageKeys.visitCount,a)};AbstractApp.prototype._getVisitCount=function(){var a=this.getFromStore(StorageKeys.visitCount);return a?parseInt(a):0};AbstractApp.prototype.getProgramToOpen=function(){var a=this.getWillowDom().getDocumentPathName();return 1<a.length&&!a.match(/\.html$/)?a:void 0};
AbstractApp.prototype.getNodeTypes=function(){return{theme:ThemeContainer,menu:MenuContainer,panel:PanelContainer,nodePickerModal:NodePickerModal,buildProgramModal:BuildProgramModal,sourceEditorModal:SourceEditorModal,programContextMenu:ProgramContextMenu,blockContextMenu:BlockContextMenu,blockInspectorModal:BlockInspectorModal,cardEditorModal:CardEditorModal,singleInsertModal:SingleInsertModal,bulkInsertModal:BulkInsertModal,promptModal:CustomPromptModal,confirmModal:CustomConfirmModal,nodeEditorModal:NodeEditorModal,
helpModal:HelpModal}};AbstractApp.prototype.parseNodeType=function(a){return this.getNodeTypes()[a.split(" ")[0]]};AbstractApp.prototype.getClasses=function(){return"AC AbstractApp "+this.constructor.name};AbstractApp.prototype.getHakon=function(){return".AbstractApp\n height 100%\n width 100%"};AbstractApp.prototype.getCommandsBuffer=function(){this._commandsBuffer||(this._commandsBuffer=[]);return this._commandsBuffer};
AbstractApp.prototype.logCommand=function(a){this.getCommandsBuffer().push({command:a,time:Date.now()})};AbstractApp.prototype.goRed=function(a){var b=this.getMountedProgram(),c=this.getWillowDom();console.log("error on page: "+c.getDocumentPathName());console.log(a);console.log("going red on page: "+(b?b.getUrl():""))};AbstractApp.prototype.reportUncaughtError=function(a){return Promise.resolve()};
AbstractApp.prototype._setErrorHandlers=function(){var a=this,b=this;this.getWillowDom().getWindowElement().addEventListener("error",function(c,d,e){a.reportUncaughtError(c);b.goRed();console.error(c)})};AbstractApp.prototype.openNodeEditorModalCommand=function(a){a=this.getMountedProgram().nodeAt(a);this.setTargetNode(a);return this.toggleAndRender("nodeEditorModal")};AbstractApp.prototype.closeModal=function(){this.getOpenModals().forEach(function(a){return a.unmountAndDestroy()})};
AbstractApp.prototype.getOpenModals=function(){return this.getChildren().filter(function(a){return a instanceof AbstractModal})};AbstractApp.prototype.closeContextMenu=function(){this.getChildren().filter(function(a){return a instanceof AbstractContextMenu}).forEach(function(a){return a.unmountAndDestroy()})};AbstractApp.prototype.getHtml=function(){return""};AbstractApp.prototype.renderApp=function(){this.render(this.getWillowDom().getBodyStump());return this};
AbstractApp.prototype.downloadFile=function(a,b,c){var d=this.getWillowDom(),e=d.createElement("a");e.setAttribute("href","data:"+c+","+d.encodeURIComponent(a));e.setAttribute("download",b);e.click()};AbstractApp.prototype.appendBlockCommand=function(a,b){this._appendBlocks(a,b);return this.getMountedProgram().autosaveAndRender()};AbstractApp.prototype._getAvailablePermalink=function(a){var b=this;return Util.getAvailablePermalink(a,function(a){return b.doesFileExistSync(a)})};
AbstractApp.prototype._appendBlocks=function(a,b){return this.getNodeCursors().map(function(c){c=c.append(a,b);c.executeLoadNewBinder();return c})};AbstractApp.prototype.isPaid=function(){return!!Util.parseCookie(this.getAppCookie()).paidToken};AbstractApp.prototype.appendBlockAndSelectCommand=function(a,b){var c=this._appendBlocks(a,b);a=this.getMountedProgram();a.clearSelection();return a.autosaveAndRender().then(function(){c.forEach(function(a){return a.selectBlock()})})};
AbstractApp.prototype.insertMorphBlockCommand=function(){var a=this.getMountedProgram(),b=this.getDblClickEvent();this.getNodeCursors().forEach(function(c){c.append(">morph","pin "+a.makePin(b))});return a.autosaveAndRender()};AbstractApp.prototype.getNodeCursors=function(){var a=this.getMountedProgram().getSelectedBlocks();return a.length?a:[this.getMountedProgram()]};AbstractApp.prototype.deleteAllCardsInTargetBlockCommand=function(){var a=this,b=this.getTargetNode().getInputBinder();return Promise.all(b.getCards().map(function(a){return a.destroyCardCommand()})).then(function(){a.renderApp()})};
AbstractApp.prototype.appendScript=function(a){if(!a)return Promise.resolve();this._loadingPromises||(this._loadingPromises={});if(this._loadingPromises[a])return this._loadingPromises[a];var b=this.getWillowDom();if(b.isNode())return Promise.resolve();var c=new Promise(function(c,e){var d=!1,g=b.getElementsByTagName("script")[0],h=b.createElement("script");h.type="text/javascript";h.src=a;h.async=!0;h.onload=h.onreadystatechange=function(){d||this.readyState&&"complete"!=this.readyState||(d=!0,c(this))};
h.onerror=h.onabort=e;g.parentNode.insertBefore(h,g)});return this._loadingPromises[a]=c};AbstractApp.prototype.getAppCookie=function(){return this.getWillowDom().getDocumentElement().cookie};AbstractApp.prototype.openOhayoProgramCommand=function(a){var b=this;return Promise.all(a.split(" ").map(function(a){return b._openOhayoProgramCommand(a)}))};
AbstractApp.prototype._openOhayoProgramCommand=function(a){var b=(new TreeNotation(DemoPrograms)).getNode(a).getTailWithChildren(),c=this.getFocusedPanel(),d=c.getOpenTabByUrl(a);return d?c.setMountedProgram(d):this.createAndOpen(b,a)};AbstractApp.prototype.makeDataBlock=function(a){var b=(new CardParser).inferEncoding(a),b=new TreeNotation(">data\n format "+b+"\n content");b.getNode(">data content").setTailWithChildren(a);return b.toString()};AbstractApp.prototype.onProgramsChange=function(){};
AbstractApp.prototype.getFocusedPanel=function(){return this.getNode("panel")};AbstractApp.prototype.getMountedProgram=function(){return this.getFocusedPanel().getMountedProgram()};AbstractApp.prototype.getMenuContainer=function(){return this.getNode("menu")};AbstractApp.prototype.emitGlobalMessage=function(a){console.log(a)};AbstractApp.prototype.emitGlobalMessageAndFade=function(a){console.log(a)};AbstractApp.prototype.handleGlobalError=function(a){console.error(a)};
AbstractApp.prototype.createNewBlankProgramCommand=function(a){var b=this;return this.createAndOpen("",void 0===a?"untitled.flow":a).then(function(a){return b.emitGlobalMessageAndFade(Say($jscomp$templatelit$1,a.getUrl()))})};AbstractApp.prototype.canMakePrograms=function(){return!0};AbstractApp.prototype.openUrlPromptCommand=function(){var a=this;this.prompt(Say($jscomp$templatelit$2),"").then(function(b){b&&a.openUrlInNewSpaceAndFocus(b)})};
AbstractApp.prototype.openManyPrompt=function(){var a=this;return this.prompt(Say($jscomp$templatelit$3),"").then(function(b){if(b)return a.openManyCommand(b)})};AbstractApp.prototype.openManyCommand=function(a){var b=this,c=new RegExp(a,"i");return Promise.all(this.getLinks().map(function(a){a.link.match(c)&&b.openUrlInNewSpace(a.link)}))};AbstractApp.prototype.openUrlInNewSpace=function(a){var b=this.getFocusedPanel().getOpenTabByUrl(a);return b?Promise.resolve(b):this.getFocusedPanel().openUrlInNewSpace(a)};
AbstractApp.prototype.openUrlInNewSpaceAndFocus=function(a){var b=this;return this.openUrlInNewSpace(a).then(function(a){return b.getFocusedPanel().setMountedProgram(a)})};AbstractApp.prototype.mountTabByIndexCommand=function(a){return this.getFocusedPanel().mountTabByIndex(a)};AbstractApp.prototype.closeTabByIndexCommand=function(a){return this.getFocusedPanel().closeTabByIndex(a)};AbstractApp.prototype.getFolder=function(){return""};AbstractApp.prototype.tabDidOpen=function(){};
AbstractApp.prototype.isAutoSaveEnabled=function(){return"false"!==this.getFromStore(StorageKeys.autoSave)};AbstractApp.prototype.toggleAutoSaveCommand=function(){var a=!this.isAutoSaveEnabled();a?this.removeValue(StorageKeys.autoSave):this.storeValue(StorageKeys.autoSave,"false");this.emitGlobalMessageAndFade(Say($jscomp$templatelit$4,a));return Promise.resolve()};
AbstractApp.prototype.saveCompiledCommand=function(){var a=this.getMountedProgram(),b=a.compilesTo(),c=Format.permalink(Format.removeFileExtension(a.getFileName()))+"."+b,a=a.buildProgram();this.downloadFile(a,c,"text/"+b);return Promise.resolve()};AbstractApp.prototype.toggleThemeCommand=function(){return this._toggleTheme()};AbstractApp.prototype._getThemeName=function(){return this.getFromStore(StorageKeys.theme)};AbstractApp.prototype.getTheme=function(){return Themes[this._getThemeName()]||Themes.glass};
AbstractApp.prototype._toggleTheme=function(){var a=Util.toggle(this._getThemeName(),Object.keys(Themes));this.emitGlobalMessageAndFade(Say($jscomp$templatelit$5,a));this.storeValue(StorageKeys.theme,a);this.getApp().makeAllDirty();this.renderApp();return Promise.resolve()};AbstractApp.prototype.confirmAndDeleteFile=function(a){var b=this;return this.confirm(Say($jscomp$templatelit$6,a)).then(function(c){return c?b.deleteFileCommand(a):Promise.resolve(!1)})};
AbstractApp.prototype.promptToRenameFile=function(a,b){var c=this;return this.prompt("Enter new name for file",a).then(function(d){return d&&d!==a?(d=Format.permalink(d))?c.renameFileCommand(a,d,b).then(function(a){c.emitGlobalMessageAndFade("Renamed");return a}):Promise.resolve():Promise.resolve()})};
AbstractApp.prototype.deleteAllProgramsPrompt=function(){var a=this,b=this.getFocusedPanel().getPrograms();return this.confirm(Say($jscomp$templatelit$7,b.length)).then(function(c){return c?Promise.all(b.map(function(b){return a.deleteFileCommand(b.getDiskPath())})):Promise.resolve(!1)})};AbstractApp.prototype.getFolderPath=function(){return""};AbstractApp.prototype.insertStringCommand=function(a){this.getWillowDom().getFocusedStump().val(a);return Promise.resolve()};
AbstractApp.prototype.showTabRenamePromptCommand=function(){var a=this,b=this.getMountedProgram();this.promptToRenameFile(b.getFileName()).then(function(c){if(!c)return!1;a.openUrlInNewSpaceAndFocus(""+a.getFolderPath()+c).then(function(c){a.getFocusedPanel().closeProgram(b)});a.fetchLinks()});return Promise.resolve()};AbstractApp.prototype.fetchLinks=function(){return Promise.resolve(this.getLinks())};AbstractApp.prototype.fetchLinksCommand=function(){return this.fetchLinks()};
AbstractApp.prototype.toggleHelpCommand=function(){return this.toggleAndRender("helpModal")};AbstractApp.prototype.toggleSourceEditorCommand=function(){return this.toggleAndRender("sourceEditorModal")};AbstractApp.prototype.toggleLayoutCommand=function(){return this.getMountedProgram().toggleLayout()};AbstractApp.prototype.setRefreshUrl=function(a){this.getWillowDom().getHistory().replaceState({},"",a);return this};AbstractApp.prototype.closeMountedProgramCommand=function(){return this.getFocusedPanel().closeProgram(this.getMountedProgram())};
AbstractApp.prototype.fetchAndReloadFocusedProgramCommand=function(){return this.getFocusedPanel().fetchAndReloadProgram(this.getMountedProgram())};AbstractApp.prototype.selectAllCommand=function(){this.getMountedProgram().selectAll();return Promise.resolve()};AbstractApp.prototype.selectBlocksBySelectorCommand=function(a){this.logCommand("app selectBlocksBySelectorCommand");this.getMountedProgram().selectBlocksBySelector(a);return Promise.resolve()};
AbstractApp.prototype.clearSelectionCommand=function(){this.logCommand("app clearSelectionCommand");this.getMountedProgram().clearSelection();return Promise.resolve()};AbstractApp.prototype.deleteSelectionCommand=function(){return this.getMountedProgram().deleteSelection()};AbstractApp.prototype.duplicateSelectionCommand=function(){return this.getMountedProgram().duplicateSelection()};AbstractApp.prototype.cancelConfirmCommand=function(){return this._confirmModal._resolveCommand("0")};
AbstractApp.prototype.acceptConfirmCommand=function(){return this._confirmModal._resolveCommand("1")};AbstractApp.prototype.submitPromptCommand=function(){return this._promptModal._resolveCommand()};AbstractApp.prototype.clickElementCommand=function(a){this.getWillowDom().getStumps(a).click();return Promise.resolve()};
AbstractApp.prototype.showDeleteFileConfirmDialogCommand=function(){var a=this,b=this.getMountedProgram();return this.confirmAndDeleteFile(b.getFileName()).then(function(c){!1!==c&&a.getFocusedPanel().closeProgram(b)})};AbstractApp.prototype.mountPreviousProgramCommand=function(){return this.getFocusedPanel().mountPreviousProgram()};AbstractApp.prototype.mountNextProgramCommand=function(){return this.getFocusedPanel().mountNextProgram()};AbstractApp.prototype.closeAllProgramsCommand=function(){return this.getFocusedPanel().closeAllPrograms()};
AbstractApp.prototype.openFocusedPanelSearchCommand=function(){return this.getFocusedPanel().openSearchCommand()};AbstractApp.prototype.universalSearchCommand=function(a){return Promise.resolve()};AbstractApp.prototype.toggleFullScreenCommand=function(){this.getWillowDom().toggleFullScreen();return Promise.resolve()};AbstractApp.prototype.toggleFocusedModeCommand=function(){this.toggle("menu");var a=this.getFocusedPanel();a.toggle("programs");a.toggle("search");return this.toggleFullScreenCommand()};
AbstractApp.prototype.toggleSourceGutterCommand=function(){this.makeAllDirty();return this.getFocusedPanel().toggleAndRender("sourceGutter")};AbstractApp.prototype.getKeyboardShortcuts=function(){this._shortcuts||(this._shortcuts=new KeyboardShortcutNotation(this._getKeyboardShortcuts()));return this._shortcuts};AbstractApp.prototype.selectNextCommand=function(){return this.getMountedProgram().selectNext()};AbstractApp.prototype.selectPreviousCommand=function(){return this.getMountedProgram().selectPrevious()};
AbstractApp.prototype._getKeyboardShortcuts=function(){return"mounted showDeleteFileConfirmDialogCommand shift+backspace Delete Program\npanel createNewBlankProgramCommand ctrl+n New Flow Program\npanel toggleHelpCommand ? Help\nmounted closeMountedProgramCommand ctrl+w Close focused program\npanel closeAllProgramsCommand ctrl+shift+w Close all programs\npanel toggleThemeCommand shift+t Toggle Theme\nmounted selectAllCommand command+a Select All\npanel openFocusedPanelSearchCommand command+p\nmounted toggleLayoutCommand shift+l Toggle layout\nmounted mountPreviousProgramCommand shift+left Previous program\nmounted mountNextProgramCommand shift+right Next program\nmounted selectNextCommand shift+down Select next\nmounted selectPreviousCommand shift+up Select previous\npanel toggleSourceGutterCommand shift+u Edit Source\npanel toggleFullScreenCommand shift+f Toggle Full Screen\npanel toggleFocusedModeCommand command+shift+f Toggle Focused Mode\npanel toggleSourceEditorCommand ctrl+u Edit Source\nmounted deleteSelectionCommand backspace Delete Selection\nmounted saveProgramAndNotifyCommand command+s Save Program\nmounted showTabRenamePromptCommand ctrl+shift+r Rename File\npanel toggleAutoSaveCommand shift+s Toggle autosave\nmounted fetchAndReloadFocusedProgramCommand shift+r Re-download and refresh program\nmounted duplicateSelectionCommand command+d Duplicate Selection\nmounted toggleNodePickerCommand shift+p Edit node\nmounted buildProgramCommand shift+b Build program\nmounted saveCompiledCommand command+shift+b\nmounted undoFocusedProgramCommand command+z Undo\nmounted redoFocusedProgramCommand command+shift+z Redo\npanel openManyPrompt command+shift+o Open multiple programs from regex\npanel deleteAllProgramsPrompt command+shift+d Delete all open programs\npanel _runSpeedTestCommand ctrl+shift+m\npanel openUrlPromptCommand shift+o Open program from url\npanel closeModalCommand escape Close any open modal\nmounted cloneProgramCommand ctrl+shift+n Clone program"};
AbstractApp.prototype.buildProgramCommand=function(){return this.toggleAndRender("buildProgramModal")};AbstractApp.prototype.toggleNodePickerCommand=function(){return this.toggleAndRender("nodePickerModal")};AbstractApp.prototype.undoFocusedProgramCommand=function(){return this.getMountedProgram().undoCommand()};AbstractApp.prototype.redoFocusedProgramCommand=function(){return this.getMountedProgram().redoCommand()};AbstractApp.prototype._getMousetrap=function(){return this.getWillowDom().getMousetrap()};
AbstractApp.prototype.closeModalCommand=function(){this.closeModal();return Promise.resolve()};
AbstractApp.prototype._bindKeyboardShortcuts=function(){var a=this._getMousetrap(),b=this.getWillowDom();a._originalStopCallback=a.prototype.stopCallback;a.prototype.stopCallback=function(c,e,f){var d=b.getStumpFromElement(e);return"command+s"===f&&d.hasClass("savable")?(d.trigger(BrowserEvents.change),c.preventDefault(),!0):a._pause?!0:a._originalStopCallback.call(this,c,e)};var c=this;this.getKeyboardShortcuts().getChildren().forEach(function(b){a.bind(b.getKeyCombo(),function(a){b.execute(c);a.preventDefault&&
a.preventDefault();return!1})})};AbstractApp.prototype.executeCommandLine=function(a){this.logCommand(a.join(" "));return this[a[0]](a[1],a[2],a[3])};AbstractApp.prototype.pauseShortcutListener=function(){this._getMousetrap()._pause=!0};AbstractApp.prototype.resumeShortcutListener=function(){this._getMousetrap()._pause=!1};AbstractApp.prototype.getStore=function(){return this.getWillowDom().getStore()};
AbstractApp.prototype.getStoreKeys=function(){var a=this.constructor.name,b=a.length,c=[];this.getStore().each(function(d,e){e.startsWith(a)&&c.push(e.substr(b))});return c};AbstractApp.prototype.getFromStore=function(a){return this.getStore().get(this.constructor.name+a)};AbstractApp.prototype.storeValue=function(a,b){return this.getStore().set(this.constructor.name+a,b)};AbstractApp.prototype.removeValue=function(a){return this.getStore().remove(this.constructor.name+a)};
AbstractApp.prototype.clearStore=function(){this.getStore().disabled||this.getStore().clearAll()};AbstractApp.prototype._makeDocumentCopyableAndCuttable=function(){var a=this;a.getWillowDom().getDocumentStump().on(BrowserEvents.copy,function(b){return a.copySelectionCommand(b)}).on(BrowserEvents.cut,function(b){return a.cutSelectionCommand(b)})};AbstractApp.prototype.copySelectionCommand=function(a){return this.getMountedProgram().copySelection(a)};AbstractApp.prototype.cutSelectionCommand=function(a){return this.getMountedProgram().cutSelection(a)};
AbstractApp.prototype._handleLinkClick=function(a,b){var c=a.attr("href");if(c&&!a.attr("target")){b.preventDefault();if(Util.isExternalLink(c,this.getWillowDom().getDocumentHostname()))return this.openExternalLink(c),!1;"true"===a.attr("data-focus")?this.openUrlInNewSpaceAndFocus(c):this.openUrlInNewSpace(c)}};
AbstractApp.prototype._makeProgramLinksOpenImmediately=function(){var a=this,b=this.getWillowDom();b.getBodyStump().on(BrowserEvents.click,"a",function(c){a._handleLinkClick(b.getStumpFromElement(this),c)})};AbstractApp.prototype.saveProgramAndNotifyCommand=function(){var a=this,b=this.getMountedProgram();b.forceSaveToDisk().then(function(){a.renderApp()}).catch(function(a){b.handleProgramError(a)})};AbstractApp.prototype.prompt=function(a,b){return Promise.resolve(prompt(a,b))};
AbstractApp.prototype.confirm=function(a){return Promise.resolve(confirm(a))};AbstractApp.prototype.openExternalLink=function(a){this.getWillowDom().getWindowElement().open(a)};AbstractApp.prototype.cloneProgramCommand=function(){var a=this.getMountedProgram(),b=a.getParentId()||a.getHostedProgramId();return this.createAndOpen(a.childrenToString(),a.getFileName(),b)};
AbstractApp.prototype._makeWindowDroppable=function(){var a=this,b=a.getWillowDom(),c=function(b,c){c=_.upperFirst(Format.toTitleCase(Format.removeFileExtension(c)));c=Format.permalink(c);b=(new TreeNotation(b)).toString();return a.createAndOpen(">data\n content "+b+"\n >table\n >scatter",c)},d=function(a,b,c){b=b||"";a.isFile?a.file(function(a){console.log("File:",b+a.name);e(b,a,c)}):a.isDirectory&&a.createReader().readEntries(function(c){for(var e=0;e<c.length;e++)d(c[e],b+a.name+"/")})},e=function(a,
...
c&&(c.concat(a.makeDataBlock(b)),c.autosaveProgram(),a.renderApp())}):g&&d(g,null,c)}};(function(){var a=b.getBodyStump(),c=function(a){a=a.originalEvent;var b=a.dataTransfer.effectAllowed;a.dataTransfer.dropEffect="move"===b||"linkMove"===b?"move":"copy"},d=function(c){c.preventDefault();c.stopPropagation();a.removeClass("dragOver");b.getStumpById("dragOverHelp").remove();a.off(BrowserEvents.dragleave,d)};a.on(BrowserEvents.dragover,function(b){c(b);b.preventDefault();b.stopPropagation();a.hasClass("dragOver")||
(a.append('<div id="dragOverHelp">'+Say($jscomp$templatelit$8)+"</div>"),a.addClass("dragOver"),setTimeout(function(){a.on(BrowserEvents.dragleave,d)},50))});a.on(BrowserEvents.drop,function(c){c.preventDefault();c.stopPropagation();a.removeClass("dragOver");b.getStumpById("dragOverHelp").remove();f(c.originalEvent.dataTransfer.items,c.shiftKey)});a.on(BrowserEvents.dragenter,function(a){a.preventDefault();a.stopPropagation()})})()};AbstractApp.prototype.getRenderedBlocks=function(){return this.getMountedProgram().getDescendantBlocks().filter(function(a){return a.isMounted()})};
AbstractApp.prototype._createProgramFromPaste=function(a){return this.createAndOpen(a,"untitled.flow")};AbstractApp.prototype.pasteCommand=function(a){var b=this.getMountedProgram();return!b||b.isReadOnly()?this._createProgramFromPaste(a):b.appendFromPaste(a)};
AbstractApp.prototype._makeWindowPastable=function(){var a=this;a.getWillowDom().getWindowElement().addEventListener(BrowserEvents.paste,function(b){if(a.getWillowDom().someInputHasFocus())return!0;b.clipboardData&&b.clipboardData.getData&&a.pasteCommand(b.clipboardData.getData("text/plain"))},!1)};AbstractApp.prototype.setContextMenuEvent=function(a){this._contextMenuEvent=a;return this};AbstractApp.prototype.setDblClickEvent=function(a){this._dblClickEvent=a;return this};
AbstractApp.prototype.getDblClickEvent=function(){return this._dblClickEvent};AbstractApp.prototype.getContextMenuEvent=function(){return this._contextMenuEvent};
AbstractApp.prototype._runSpeedTestCommand=function(){var a=this,b=this.getLinks().map(function(a){return a.link}),c=Date.now(),d=Util.pLimit(7),e=this.getFocusedPanel(),b=b.map(function(b){return d(function(){return a.openUrlInNewSpace(b).then(function(a){var b=e.getMountedProgram();e.setMountedProgram(a);b&&e.closeProgram(b);return a.getProgramStats()})})});return Promise.all(b).then(function(b){e.closeProgram(e.getMountedProgram());b=new TreeNotation(b);var d=Date.now()-c,d="Program Load Times "+
moment().format("MM/DD/YYYY")+" version "+a.getVersion()+". Run time: "+d;return a.createAndOpen(SpeedTestTemplate(d,b.toCsv()),"program-load-times")})};AbstractApp.prototype.executeCommandOnFirstSelectedBlock=function(a,b,c){return this.getMountedProgram().getFirstSelectedBlock()[a](b,c)};
AbstractApp.prototype._executeCommand=function(a,b,c,d){var e=this.getWillowDom();a=e.getStumpFromElement(a);b=a.attr(b);if(!b||d&&c.target!==c.currentTarget)return!0;c.preventDefault();c=a.closest(".AC").data("container");d=a.is(":checkbox")?a.is(":checked")?!0:!1:a.attr("contenteditable")?a.html():a.val()?a.val():a.attr("value");var f=a.attr("name");this.logCommand([b,d,f].filter(function(a){return a}).join(" "));if(b.startsWith("block "))c.getChildBlock()[b.substr(6)](d,f);else if(b.startsWith("context "))this.getTargetNode()[b.substr(8)](d,
f);else if(b.startsWith("app "))this[b.substr(4)](d,f);else if(b.startsWith("ac "))c[b.substr(3)](d,f);else throw new ErrorKinds.ThisShouldNeverHappenError("Bad command "+b);0<a.closest(".AbstractContextMenu,.dropdownMenu").length&&e.getBodyStump().trigger("click");return!1};
AbstractApp.prototype._setContainerHandlers=function(){var a=this,b=this.getWillowDom().getBodyStump();b.on(BrowserEvents.contextmenu,"*",function(b){if(b.ctrlKey)return!0;a.setContextMenuEvent(b);return a._executeCommand(this,"data-contextmenucommand",b)});b.on(BrowserEvents.change,"input,select,textarea",function(b){return a._executeCommand(this,"data-command",b)});b.on(BrowserEvents.blur,"[contenteditable='true']",function(b){return a._executeCommand(this,"data-command",b)});b.on(BrowserEvents.click,
"a,button,svg,section,span",function(b){return a._executeCommand(this,"data-command",b)});b.on(BrowserEvents.dblclick,"div",function(b){a.setDblClickEvent(b);return a._executeCommand(this,"data-dblclickcommand",b,!0)})};window.AbstractApp=AbstractApp;var AbstractModal=function(a){return AC.apply(this,arguments)||this};$jscomp.inherits(AbstractModal,AC);AbstractModal._mountedComponents=AC._mountedComponents;
...
AbstractProgram.prototype.copySelection=function(a){a=this._copySelection(a);if(!a)return Promise.resolve();this.getApp().emitGlobalMessageAndFade(Say($jscomp$templatelit$9));return Promise.resolve(a)};AbstractProgram.prototype._copySelection=function(a){var b=this.getApp().getWillowDom();if(b.someInputHasFocus())return"";var c=this.selectionToString();if(!c)return"";b.setCopyData(a,c);return c};AbstractProgram.prototype.selectionToString=function(){return this.getSelectedBlocks().map(function(a){return a.toString()}).join("\n")};
AbstractProgram.prototype.selectBlocksBySelector=function(a){a=void 0===a?".ui-selected":a;var b=this.getApp().getWillowDom();b.getStumps(a).each(function(){b.getStumpFromElement(this).data("container").selectBlock()})};AbstractProgram.prototype._getPinChangeInPixels=function(a,b){return{left:a.offset.left-b.left,top:a.offset.top-b.top}};
AbstractProgram.prototype.cutSelection=function(a){a=this._copySelection(a);if(!a)return Promise.resolve();this.deleteSelection();this.getApp().emitGlobalMessageAndFade(Say($jscomp$templatelit$10));return Promise.resolve(a)};AbstractProgram.prototype.deleteSelection=function(){var a=this.getSelectedBlocks();if(!a.length)return Promise.resolve();a.forEach(function(a){return a.unmountAndDestroy()});return this.autosaveAndRender()};
AbstractProgram.prototype.duplicateSelection=function(){var a=this,b=this.getSelectedBlocks().map(function(b){return a.cloneBlock(b)}),c=this.autosaveAndRender();this.clearSelection();b.forEach(function(a){return a.selectBlock()});return c};AbstractProgram.prototype.selectPrevious=function(){for(var a=this.getFirstSelectedBlock().getPrevious();!a.getHead().startsWith(">");)a=this.getFirstSelectedBlock().getPrevious();this.clearSelection();a.selectBlock();return Promise.resolve()};
AbstractProgram.prototype.appendFromPaste=function(a){var b=this,c=this.concat(a).filter(function(a){return a instanceof AbstractBlock});a=this.autosaveAndRender();this.clearSelection();return a.then(function(){return b.executeLoadProgramCodeAndData().then(function(){c.forEach(function(a){return a.selectBlock()})}).catch(function(a){console.error(a);debugger})})};
...
AbstractProgram.prototype._updateCustomLayout=function(a){a=void 0===a?!1:a;var b=this.getApp(),c=b.getWillowDom(),d=this;c.getStumpByClass("BlockContainer").each(function(){d._updateBlockLayout(c.getStumpFromElement(this),a)});this.setLayout("custom");this.autosaveProgram();b.renderApp()};
...
AbstractProgram.prototype.makePin=function(a){var b=this.getGridSize();return[Math.floor((a.offsetX-0)/b),Math.floor(a.offsetY/b)].join(" ")};AbstractProgram.prototype.componentDidUpdate=function(){this._fixBigBug()};
AbstractProgram.prototype._fixBigBug=function(){var a={"min-height":"","min-width":""},b=this.getApp(),c=this.getStump(),d=c.parent(),e=b.getWillowDom(),f=e.getDocumentStump(),e=e.getHtmlStump(),b=(b=b.getMenuContainer())&&b.getStump();c.css(a);d.css(a);f.width();b&&b.css("width","");e.css({width:"",height:"","min-height":"","min-width":""});a=f.width();f=f.height();b&&b.css("width",a);e.css({"min-height":"100%","min-width":"100%",width:a,height:f});f={"min-height":f-60+"px","min-width":a+"px"};d.css(f);
c.css(f)};AbstractProgram.prototype.componentDidMount=function(){this._makeSelectable();this._makeBlocksMoveableAndResizableAndEditable();this.componentDidUpdate()};
AbstractProgram.prototype._makeSelectable=function(){var a=this.getApp(),b=this.getStump(),c=a.getWillowDom();b.on(BrowserEvents.click,function(b){b.target===this&&a.getWillowDom().someInputHasFocus()&&c.getStumps(":focus").first().trigger("blur")});b.selectable({cancel:".BlockContainer",distance:10,filter:".BlockContainer",start:function(b){b.shiftKey?c.getStumpByClass("ui-selected").addClass("StaySelected"):a.clearSelectionCommand()},stop:function(){c.getStumpByClass("StaySelected").addClass("ui-selected").removeClass("StaySelected");
a.selectBlocksBySelectorCommand();return!0}})};AbstractProgram.prototype.getAllCards=function(){return _.flatten(this.getDescendantBlocks().map(function(a){return a.isProvider()?a.getOutputBinder().getCards():[]}))};AbstractProgram.prototype.getProgramCardCount=function(){return this.getAllCards().reduce(function(a,b){return a+b.length},0)};
...
AbstractProgram.prototype._makeBlocksMoveableAndResizableAndEditable=function(){var a=this.getApp(),b=a.getWillowDom(),c=this,d=this.getGridSize();this.getStump().on(BrowserEvents.mouseover,".BlockContainer",function(e){var f=b.getStumpFromElement(this);if(0<f.find(".ui-resizable-handle").length)return!0;c.makeGroupDraggable(f,[d,d]);f.resizable({handles:"se",grid:d,create:function(a,b){f.find(".ui-resizable-handle").attr("title","Drag to resize")},stop:function(){return a.getMountedProgram().updateCustomPointWithWidthAndHeight()}})})};
AbstractProgram.prototype.getContextMenuCommands=function(){return'<a tabindex="-1" data-command="app saveCompiledCommand">Save compiled \''+this.compilesTo()+"' file</a>"};AbstractProgram.prototype.getAttributes=function(){return'data-contextmenucommand="ac _openProgramContextMenuCommand" data-dblclickcommand="app insertMorphBlockCommand"'};AbstractProgram.prototype._openProgramContextMenuCommand=function(){return this.getApp().toggleAndRender("programContextMenu")};
AbstractProgram.prototype._getSelectedBlockStumps=function(){return this.getApp().getWillowDom().getStumps(".BlockContainer.ui-selected")};AbstractProgram.prototype.updateSelectedOnMove=function(a,b){var c=this._getSelectedBlockStumps(),d=this.getApp().getWillowDom();0!==c.length&&(c.not(a).each(function(){var a=d.getStumpFromElement(this),c=parseFloat(a.css("top")),g=parseFloat(a.css("left"));a.css({transform:"",top:c+b.top+"px",left:g+b.left+"px"})}),a.closest(".ui-selectable").selectable("refresh"))};
AbstractProgram.prototype.makeGroupDraggable=function(a,b){if(a.hasClass("draggable"))return!0;var c,d=this,e=this.getApp(),f={stop:function(b,f){a.removeClass("noTransition");a.attr("data-translate","undefined undefined");b=d._getPinChangeInPixels(f,c);d.updateSelectedOnMove(a,b);c=f;e.getMountedProgram().updateCustomPoint()},handle:".BlockGrabber",drag:function(b,e){a.hasClass("ui-selected")&&(b=d._getPinChangeInPixels(e,c),d._getSelectedBlockStumps().not(a).css("transform","translate("+b.left+
"px, "+b.top+"px)"))},start:function(b,d){c=d.offset;a.addClass("noTransition");if(b=a.attr("data-translate"))parseInt(b.split(" ")[0]),parseInt(b.split(" ")[1])}};b&&(f.grid=b);a.draggable(f).addClass("draggable")};window.AbstractProgram=AbstractProgram;var BlockDimension=function(a,b){a=a.getSuggestedSize();this.width=a.width;this.height=a.height;Object.assign(this,b)};
...
GlobalShortcutNode.prototype.execute=function(a){if(!this.isEnabled(a))return!1;var b=this.getFn();a.logCommand("app "+b);a[b]()};var MountedShortcutNode=function(a){return GlobalShortcutNode.apply(this,arguments)||this};$jscomp.inherits(MountedShortcutNode,GlobalShortcutNode);MountedShortcutNode.prototype.isEnabled=function(a){return!!a.getMountedProgram()};var KeyboardShortcutNotation=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(KeyboardShortcutNotation,TreeNotation);
KeyboardShortcutNotation.prototype.parseNodeType=function(a){if(a.startsWith("panel"))return GlobalShortcutNode;if(a.startsWith("mounted"))return MountedShortcutNode;throw Error("bad keyboard node type");};window.KeyboardShortcutNotation=KeyboardShortcutNotation;var BinPacker=function(){};
...
SearchContainer.prototype.onEnter=function(){var a=this.getApp(),b=a.getWillowDom(),c=this._getInputElement(),d=c.typeahead("val"),b=b.getStumpByClass("tt-input").val();b.startsWith("?")?a.universalSearchCommand(b.substr(1)):b.startsWith("!")?a.executeCommandLine(["app",b.substr(1)]):this.tryOpenByNameCommand(d,b);c.blur()};
...
var StorageKeys={openPrograms:"__openPrograms",autoSave:"__autoSave",theme:"__theme",visitCount:"__visitCount",newUser:"__newUser",mountedProgram:"__mountedProgram"},_storageKeysmap={};Object.values(StorageKeys).forEach(function(a){_storageKeysmap[a]=!0});StorageKeys.isKey=function(a){return _storageKeysmap[a]};window.StorageKeys=StorageKeys;
...
AbstractChartBlock.prototype.getBlockHtmlFooter=function(){var a=this.getInputBinder().getCardCount();return this.getBlockToolbarButton()+" In: "+a};AbstractChartBlock.prototype.toDisplayString=function(a,b){return void 0===a?"":this.getInputBinder().getBinderColumnByName(b).toDisplayString(a)};window.AbstractChartBlock=AbstractChartBlock;var AbstractCommandBlock=function(a){return AbstractBlock.apply(this,arguments)||this};$jscomp.inherits(AbstractCommandBlock,AbstractBlock);
...
AbstractHeaderlessChartBlock.prototype.getBlockHtmlPage=function(){return'<div class="BlockGrabber"></div>\n\t<div class="BlockBody HeaderLess">'+this.getBlockHtmlBody()+'</div>\n  <div class="BlockFooter">'+this.getBlockHtmlFooter()+'</div>\n  <div class="BlockGrabber"></div>'};AbstractHeaderlessChartBlock.prototype.getHeaderHeight=function(){return 0};window.AbstractHeaderlessChartBlock=AbstractHeaderlessChartBlock;
var AbstractProviderBlock=function(a){return AbstractBlock.apply(this,arguments)||this};$jscomp.inherits(AbstractProviderBlock,AbstractBlock);AbstractProviderBlock._mountedComponents=AbstractBlock._mountedComponents;AbstractProviderBlock.loadCode=AbstractBlock.loadCode;AbstractProviderBlock.prototype.getBlockHtmlFooter=function(){var a=this.getOutputBinder().getCardCount(),b=_.round(this.getTTL()/1E3,1);return this.getBlockToolbarButton()+" Out: "+a+" Time: "+b+"s "};
AbstractProviderBlock.prototype.isProvider=function(){return!0};window.AbstractProviderBlock=AbstractProviderBlock;var AbstractTransformerBlock=function(a){return AbstractProviderBlock.apply(this,arguments)||this};$jscomp.inherits(AbstractTransformerBlock,AbstractProviderBlock);AbstractTransformerBlock._mountedComponents=AbstractProviderBlock._mountedComponents;AbstractTransformerBlock.loadCode=AbstractProviderBlock.loadCode;
AbstractTransformerBlock.prototype.getBlockHtmlFooter=function(){var a=this.getInputBinder().getCardCount(),b=this.getOutputBinder().getCardCount();return this.getBlockToolbarButton()+" In: "+a+" Out: "+b};AbstractTransformerBlock.prototype.getOutputColumnsTree=function(){return this.getNode("columns")||new TreeNotation};AbstractTransformerBlock.prototype.fetchCards=function(){return Promise.resolve(this.transformCards())};window.AbstractTransformerBlock=AbstractTransformerBlock;
...
AbstractGoogleBase.prototype._draw=function(){if(!this.isNode()){var a=this._getChartClass(),b=this._getGoogElement(),a=new a(b),b=this._getGoogleOptions(),c=this._getGoogleData();a.draw(c,b)}};AbstractGoogleBase.prototype.componentDidMount=function(){AbstractHeaderlessChartBlock.prototype.componentDidMount.call(this);if(!this.getInputBinder().getCardCount())return"";this._draw()};AbstractGoogleBase.prototype.getLabelValue=function(){return this.getSomeData(["label","value"])};
...
HeatCalendarChart.prototype.getSvg=function(){var a=this.getInputBinder(),b=a.getCards();if(!b.length)return"";var c=this.getStruct(),d=c.day,e=c.count;if(!d||!e)return"";a.getBinderColumnByName(d);var f=a.getBinderColumnByName(e),c=moment(Date.now()).clone().subtract(365,"days"),a=365/6*12,g=this.getTheme(),h=f.getQuintiles(),n={};b.forEach(function(a){var b=a.getCardNumeric(),c=moment(b[d]).format("MM/DD/YYYY");a:{for(var f=0;f<h.length;f++)if(b[e]<=h[f].value){b=h[f].percent;break a}b=void 0}n[c]=
{quintile:b,card:a}});for(var b=[],f=parseInt(c.format("e")),k=0;365>=k;k++){var p=c.clone().add(k,"days");b.push({day:p,row:parseInt(p.format("e")),col:Math.floor((f+k)/7)})}var c="<g>"+[{day:"Mon",row:2},{day:"Wed",row:4},{day:"Fri",row:6}].map(function(a){return'<text x="0" y="'+(20+12*a.row-3)+'">'+a.day+"</text>"}).join("")+"</g>",m={},f="<g>"+b.map(function(a){var b=a.day.format("MMM"),c=a.day.format("MM/YYYY");if(m[c])return"";m[c]=!0;return'<text x="'+(40+12*a.col)+'" y="10">'+b+"</text>"}).join("")+
"</g>",q=moment(Date.now()).format("MM/DD/YYYY"),b="<g>"+b.map(function(a){var b=a.day.format("MM/DD/YYYY"),c=20+12*a.row;a=40+12*a.col;var d=n[b],e=d?'id="t'+d.card.getPuid()+'"':"",f=b===q?"stroke-width:2;stroke:rgb(0,0,0);":"";return'<rect style="'+((d?"fill: "+g.getHeatColor(1-d.quintile):"")+";"+f)+'" '+e+' data-day="'+b+'" width="10" height="10" x="'+a+'" y="'+c+'"></rect>'}).join("")+"</g>",k=this.getLegend(h,12,{top:110,left:60});return'<svg width="'+a+'" height="184">'+(c+b+f+k)+"</svg>"};
...
KpiChart.prototype.getBlockHtmlBody=function(){var a=this.getStruct(),b=a.column,c=a.reduction;if(!b)return"";var d=this.getInputBinder().getBinderColumnByName(b).getReductions()[c],d=this.toDisplayString(d,b);return'<div style="text-align: center;"><div style="padding-top: 10px;">\n      <a data-property="column">'+b+'</a>\n      <a data-property="reduction">'+c+"</a>\n      </div>\n      "+(a.title?"<h2>"+a.title+"</h2>":"")+"\n      <h1>"+d+"</h1></div>"};window.KpiChart=KpiChart;
...
ListChart.prototype.getBlockHtmlBody=function(){var a=this.getStruct(),b=a.link,c=a.label;return"<ol>"+this.getCardsWithStructQuery().map(function(a){var d=Strip($jscomp$templatelit$13,a.getCardValue(c));return"<li><a "+(b?'href="'+Strip($jscomp$templatelit$14,a.getCardValue(b))+'"':"")+">"+d+"</a></li>"}).join("")+"</ol>"};window.ListChart=ListChart;var MarkdownChart=function(a){return AbstractHeaderlessChartBlock.apply(this,arguments)||this};$jscomp.inherits(MarkdownChart,AbstractHeaderlessChartBlock);
MarkdownChart._mountedComponents=AbstractHeaderlessChartBlock._mountedComponents;MarkdownChart.loadCode=AbstractHeaderlessChartBlock.loadCode;MarkdownChart.prototype.getHakon=function(){return".MarkdownChart\n div\n  overflow scroll"};MarkdownChart.prototype.getBlockHtmlBody=function(){var a=this.getStruct(),b=this.getStruct().column,a=a.content||(b?this.getInputBinder().getMonadCellContent(b):"");return marked(a)};window.MarkdownChart=MarkdownChart;
var OutChart=function(a){return AbstractHeaderlessChartBlock.apply(this,arguments)||this};$jscomp.inherits(OutChart,AbstractHeaderlessChartBlock);OutChart._mountedComponents=AbstractHeaderlessChartBlock._mountedComponents;OutChart.loadCode=AbstractHeaderlessChartBlock.loadCode;OutChart.prototype.getBlockHtmlBody=function(){return this.getInputBinder().getMonadCellContent(this.getStruct().column)};window.OutChart=OutChart;
var TableBlock=function(a){return AbstractChartBlock.apply(this,arguments)||this};$jscomp.inherits(TableBlock,AbstractChartBlock);TableBlock._mountedComponents=AbstractChartBlock._mountedComponents;TableBlock.loadCode=AbstractChartBlock.loadCode;
TableBlock.prototype.getHakon=function(){var a=this.getTheme();return".TableContainer\n overflow scroll\n font-size 12px\n box-sizing border-box\n width 100%\n height 100%\n "+a.enableTextSelect(1)+"\n top 34px\n tr\n  white-space nowrap\n  padding 0\n td:first-child,th:first-child\n  padding-left 5px\n td,th\n  padding-right 30px\n  overflow hidden\n  text-overflow ellipsis\n  max-width 250px\n td:hover,th:hover\n  overflow visible\n th\n  cursor pointer\n input,textarea\n  border 0\n  font-size 14px\n  box-sizing border-box\n  padding 0\n  font-family "+a.fonts};
TableBlock.prototype._getTrHtml=function(a,b){var c="";this.getCardsWithStructQuery().forEach(function(b,e){var d=b.getPuid();b.getCardNumeric();var g=a.map(function(a){var c=a.getColumnName(),c=b.getCardValue(c),d="";void 0!==c&&(c=Format.stripHtml(c),d=a.isLink()?'<a href="'+c+'">'+c+"</a>":c);return"<td>"+d+"</td>"}).join("");c+='<tr data-contextmenucommand="ac openCardEditorByPuidCommand" value="'+d+'"><td>'+(e+1)+"</td>"+g+"</tr>\n"});return c};TableBlock.prototype.getContextMenuHtml=function(){return'<a data-command="app deleteAllCardsInTargetBlockCommand">Delete all cards</a>'};
...
AbstractUrlProvider.prototype.fetchCards=function(){var a=this.getStruct(),b=this.getUrl();if(!b)return Promise.resolve([]);b=encodeURI(b);b.match(/\.json/);var c=a.format||this._getFormat(b);return this.getApp().getWillowDom().get(b).then(function(b){a.extract&&(b=b[a.extract]);var d=new CardParser;return"string"===typeof b?d.parse(b,c):d.parseFromObject(b,c)})};window.AbstractUrlProvider=AbstractUrlProvider;var DataBlockCard=function(a){ObjectBackedCard.apply(this,arguments)};
$jscomp.inherits(DataBlockCard,ObjectBackedCard);DataBlockCard._uniqueId=ObjectBackedCard._uniqueId;var DataBlock=function(a){return AbstractProviderBlock.apply(this,arguments)||this};$jscomp.inherits(DataBlock,AbstractProviderBlock);DataBlock._mountedComponents=AbstractProviderBlock._mountedComponents;DataBlock.loadCode=AbstractProviderBlock.loadCode;DataBlock.prototype._getData=function(){var a=this.getNode("content");return a?a.getTailWithChildren():""};
DataBlock.prototype.getBlockHtmlBody=function(){return'<textarea data-command="ac _saveDataCommand" class="BlockTextArea">'+Format.stripHtml(this._getData())+"</textarea>"};DataBlock.prototype._saveDataCommand=function(a){this.touchNode("content").setTailWithChildren(a);this.autosaveBlock();return this.executeLoadNewBinderAndRender()};DataBlock.prototype.getCardClass=function(){return DataBlockCard};
DataBlock.prototype.fetchCards=function(){return Promise.resolve((new CardParser).parse(this._getData(),this.getStruct().format))};DataBlock.prototype._getFormatted=function(a,b){switch(b){case "tree":return(new TreeNotation(a)).toString();case "json":return(new TreeNotation(a)).toJson();default:return(new TreeNotation(a)).toCsv()}};DataBlock.prototype.createCards=function(a){var b=this.getStruct().format,c=this._getData(),c=(new CardParser).parse(c,b);a=_.concat(c,a);b=this._getFormatted(a,b);return this._saveDataCommand(b)};
DataBlock.prototype.updateCards=function(a){return this.autosaveBlock()};DataBlock.prototype.deleteCards=function(a){var b=this.getOutputBinder().getCards();_.remove(b,function(b){return a.indexOf(b)});b=this._getFormatted(b.map(function(a){return a.getCardSource()}),this.getStruct().format);return this._saveDataCommand(b)};window.DataBlock=DataBlock;var OhayoProgramCard=function(a){ObjectBackedCard.apply(this,arguments)};$jscomp.inherits(OhayoProgramCard,ObjectBackedCard);
OhayoProgramCard._uniqueId=ObjectBackedCard._uniqueId;OhayoProgramCard.prototype.destroyCardCommand=function(){return this.getCardApp().deleteFileCommand(this.getCardValue("permalink"))};OhayoProgramCard.prototype.updateCardCommand=function(){};var ProgramsBlock=function(a){return AbstractProviderBlock.apply(this,arguments)||this};$jscomp.inherits(ProgramsBlock,AbstractProviderBlock);ProgramsBlock._mountedComponents=AbstractProviderBlock._mountedComponents;ProgramsBlock.loadCode=AbstractProviderBlock.loadCode;
ProgramsBlock.prototype.getCardClass=function(){return OhayoProgramCard};ProgramsBlock.prototype.fetchCards=function(){return this.getApp().fetchLinks()};window.ProgramsBlock=ProgramsBlock;var QueryBlock=function(a){return AbstractUrlProvider.apply(this,arguments)||this};$jscomp.inherits(QueryBlock,AbstractUrlProvider);QueryBlock._mountedComponents=AbstractUrlProvider._mountedComponents;QueryBlock.loadCode=AbstractUrlProvider.loadCode;QueryBlock.prototype.getUrl=function(){return"/sql?q="+this.getStruct().query};
...
RedditBlock.prototype.getUrl=function(){var a=this.getStruct();return"https://www.reddit.com/"+((a.subreddit?"/r/"+a.subreddit+"/top/.json?sort=top&t=all":"")||a.get)};RedditBlock.prototype.fetchCards=function(){return AbstractUrlProvider.prototype.fetchCards.call(this).then(function(a){return a[0].data.children.map(function(a){return a.data})})};window.RedditBlock=RedditBlock;var StoreBlock=function(a){return DataBlock.apply(this,arguments)||this};$jscomp.inherits(StoreBlock,DataBlock);
...
AbstractContextMenu.prototype.getClasses=function(){return"AC AbstractContextMenu "+this.constructor.name};AbstractContextMenu.prototype.componentDidMount=function(){var a=this.getStump(),b=this.getApp(),c=b.getWillowDom(),d=c.getBodyStump(),e=function(){d.off(BrowserEvents.click,e);b.closeContextMenu()};setTimeout(function(){return d.on(BrowserEvents.click,e)},100);var f=b.getContextMenuEvent();a.css(this._getContextMenuPosition(c.getWindowStump(),f.clientX,f.clientY,a))};
...
AbstractMenuContainer.prototype._toggleDropdownMenuCommand=function(a){var b=this.getApp().getWillowDom(),c=b.getStumpById(a),d=b.getStumpByClass("dropdownMenu");if(0<c.find(".dropdownMenu").length)return d.remove();d.remove();a=(new Bray(this[a]())).toHtml();var e=b.makeStumpFromString('<div style="top: 30px; left: '+c.position().left+'px;" class="dropdownMenu">\n      '+a+"\n    </div>");c.append(e);var f=b.getBodyStump(),g=function(){f.off(BrowserEvents.click,g);e.remove()};setTimeout(function(){return f.on(BrowserEvents.click,
g)},100)};
...
BlockToolbarContainer.prototype._getFormHtml=function(){var a=this.getChildBlock();this.getApp();var b=a.getBlock().getPropertyNodes(),c=(new CardParser).getEncodingNames(),d=a.getInputBinder().getColumnNames(),e=a.getStruct(),f=function(a,b,c,d){return'<select data-command="block '+a+'" name="'+b+'">\n  <option value=""></option>'+c.map(function(a){return"<option "+(d===a?"selected":"")+' value="'+a+'">'+a+"</option>"})+"\n  </select>"},b=b.map(function(a){var b=a.getPropertyName(),g=e[b]||"",h=
typeof g,n=a.type,t='<input data-command="block changePropertyCommand" name="'+b+'" value="'+g+'">';if("boolean"===n)t='<input data-command="block changePropertyCommand" name="'+b+'" '+(!0===g?"checked":"")+' type="checkbox">';else if("int"===n)t='<input data-command="block changePropertyCommand" type="number" name="'+b+'" value="'+g+'">';else if("column"===n)t=f("changePropertyCommand",b,d,g);else if("format"===n)t=f("changePropertyCommand",b,c,g);else if("enum"===n)t=f("changePropertyCommand",b,
Object.keys(a.getChoices()),g);else if("javascript"===n||"content"===n||"object"===h)t='<textarea data-command="block changePropertyCommand" name="'+b+'">'+g+"</textarea>";return[b,t]}),g=a.getPathVector().join(" "),h='<select data-command="block changeParentCommand">\n  <option value=""></option>'+a.getProgram().getDescendantBlocks().map(function(a){return{name:a.getPathName(),value:a.getPathVector().join(" ")}}).map(function(a){return"<option "+(g===a.value?"selected":"")+' value="'+a.value+'">'+
a.name+"</option>"})+"\n  </select>";b.unshift(["parent",h]);h=a.getParser().getBlockNames();h.sort();a=f("changeTypeCommand","",h,a.getHead());b.unshift(["type",a]);return"<form>\n    <table>\n      "+b.map(function(a){return"<tr><td>"+a[0]+"</td><td>"+a[1]+"</td></tr>"}).join("")+"\n    </table>\n    </form>"};window.BlockToolbarContainer=BlockToolbarContainer;var MenuContainer=function(a){return AbstractMenuContainer.apply(this,arguments)||this};$jscomp.inherits(MenuContainer,AbstractMenuContainer);
...
PanelContainer.prototype._updateLocationForRestoreOnRefresh=function(){var a=this.getApp(),b=this.getMountedProgram(),c=b?b.getUrl():"/";b?a.storeValue(StorageKeys.mountedProgram,b.getUrl()):a.removeValue(StorageKeys.mountedProgram);a.setRefreshUrl(c).getWillowDom().setWindowTitle(b?(b.hasUnsavedChanges()?"*":"")+(b.getFileName()+" - "+Say($jscomp$templatelit$17)):Say($jscomp$templatelit$18))};
...
AbstractHelpModal.prototype.getHtml=function(){var a=this.getApp(),b=[FlowProgram.getParser(a),FireProgram.getParser(a)].map(function(a){return a.getDocs()}).join("<br><br>");a.getMountedProgram();return"<h4>About "+Say($jscomp$templatelit$21)+'</h4>\n      <p>ohayo is the fastest programming tool in the solar system.</p>\n\n\n      <p>\n      <a data-command="app openOhayoProgramCommand" value="ohayo.flow">Welcome Page</a> |\n      <a data-command="app openOhayoProgramCommand" value="readme.flow">Read Me</a> |\n      <a data-command="app openOhayoProgramCommand" value="faq.flow">FAQ</a> |\n      <a data-command="app openOhayoProgramCommand" value="releasenotes.flow">Release Notes</a> |\n      <a data-command="app openOhayoProgramCommand" value="fib.fire">Fire Example</a>\n      </p>\n\n      <a class="helpToggle">'+
...
AbstractHelpModal.prototype.componentDidMount=function(){AbstractModal.prototype.componentDidMount.call(this);var a=this.getStump();a.find(".helpSection").hide();var b=this.getApp().getWillowDom();a.find(".helpToggle").on(BrowserEvents.click,function(){b.getStumpFromElement(this).next().toggle()})};window.AbstractHelpModal=AbstractHelpModal;var BlockInspectorModal=function(a){return AbstractModal.apply(this,arguments)||this};$jscomp.inherits(BlockInspectorModal,AbstractModal);
BlockInspectorModal._mountedComponents=AbstractModal._mountedComponents;BlockInspectorModal.prototype._getChildBlock=function(){return this.getApp().getTargetNode()};BlockInspectorModal.prototype.componentDidMount=function(){AbstractModal.prototype.componentDidMount.call(this);var a=this._getChildBlock();this.getApp().getWillowDom().getWindowElement().block=a;console.log("Block set to window.block")};
BlockInspectorModal.prototype.getHakon=function(){return AbstractModal.prototype.getHakon.call(this)+"\n.BlockInspectorModal\n pre\n  width 600px\n  overflow-x scroll\n textarea\n  width 600px\n  height 200px"};
BlockInspectorModal.prototype.getHtml=function(){var a=this._getChildBlock(),b=a.getInputBinder(),c=a.getOutputBinder(),d=c.getColumnsArrayOfObjects(),e=b.getColumnsArrayOfObjects(),f=b.getCardCount(),g=c.getCardCount(),h=a.getBlock().getPropertyNodes().map(function(a){return a.getPropertyName()+" "+a.getPropertyTypeName()+" "+a.getDescription()}).join("\n"),n=a.getStruct(),k=a.getParent().getHead();return"<div>Input cards: "+f+" Output cards: "+g+"<br>\nLoad time: "+a.getTTL()+" Render time: "+a.getNewestTimeToRender()+
"\nBlockClass: "+a.constructor.name+" Parent: "+k+"<br>\nTree:<br>\n<pre>"+a.toString()+"</pre><br>\nBlockStruct:\n<pre>"+JSON.stringify(n,null,2)+"</pre><br>\nAll Block Properties:\n<pre>"+h+"</pre><br>\nInput Columns:<br>\n<pre>"+(new TreeNotation(e)).toFixedWidthTable()+"</pre><br>\nOutput Columns:<br>\n<pre>"+(new TreeNotation(d)).toFixedWidthTable()+"</pre><br>\nOutput Numeric Values:<br>\n<pre>"+(new TreeNotation(c.getNumericValues())).toFixedWidthTable()+"</pre>\nTypeScript Interface:<br>\n<pre>"+
c.toTypeScriptInterface()+"</pre>\nInput Numeric Values:<br>\n<pre>"+(new TreeNotation(b.getNumericValues())).toFixedWidthTable()+"</pre>\n</div>"};window.BlockInspectorModal=BlockInspectorModal;var BuildProgramModal=function(a){return AbstractModal.apply(this,arguments)||this};$jscomp.inherits(BuildProgramModal,AbstractModal);BuildProgramModal._mountedComponents=AbstractModal._mountedComponents;BuildProgramModal.prototype.getHakon=function(){return AbstractModal.prototype.getHakon.call(this)+"\n.BuildProgramModal\n textarea\n  font-family monospace\n  outline 0\n  font-size 14px\n  width 100%\n  height 400px"};
BuildProgramModal.prototype.getBray=function(){var a=this.getApp().getMountedProgram(),b=a.buildProgram(),a=a.getTail()+" compiled to "+a.compilesTo(),a=new TreeNotation("@ h4\n content "+a+"\n@ textarea\n readonly\n content\n@ br\n@ button\n content Save\n data-command app saveCompiledCommand");a.nodeAt(1).getNode("content").setTailWithChildren(b);return a.toString()};window.BuildProgramModal=BuildProgramModal;var BulkInsertModal=function(a){return AbstractModal.apply(this,arguments)||this};
$jscomp.inherits(BulkInsertModal,AbstractModal);BulkInsertModal._mountedComponents=AbstractModal._mountedComponents;BulkInsertModal.prototype.componentDidMount=function(){AbstractModal.prototype.componentDidMount.call(this);this._getBulkTextarea().focus()};BulkInsertModal.prototype._getChildBlock=function(){return this.getApp().getTargetNode()};BulkInsertModal.prototype._getBulkTextarea=function(){return this.getApp().getWillowDom().getStumpById("bulkTextarea")};
BulkInsertModal.prototype._getBulkAdvanced=function(){return this.getApp().getWillowDom().getStumpById("bulkAdvanced")};BulkInsertModal.prototype._getBulkType=function(){return this.getApp().getWillowDom().getStumpById("bulkType")};BulkInsertModal.prototype._updateBulkTextAreaPlaceholderCommand=function(){var a=this._getBulkTextarea().val(),a=(new CardParser).getExample(a)||"";this._getBulkTextarea().attr("placeholder","Example:\n"+a);this._updateBulkTextAreaAdvancedCommand()};
BulkInsertModal.prototype._updateBulkTextAreaAdvancedCommand=function(){var a=this._getBulkTextarea(),b=this._getBulkAdvanced(),c=this._getBulkType().val();""===c?b.html("Detected: "+(new CardParser).inferEncoding(a.val())):"delimited"===c?b.html('Delimiter: <input placeholder="," id="bulkDelimiter">\n        <br>Enclosing Char: <input placeholder=\'"\' id="bulkEnclosingChar">\n        <br>Has Headers: <input type="checkbox" id="bulkHasHeader" checked>'):b.html("")};
BulkInsertModal.prototype._submitBulkInsertCommand=function(){var a=this.getApp(),b=this._getChildBlock(),c=this._getBulkTextarea().val(),d=this._getBulkType().val(),e=a.getWillowDom().getStumpById;if("advanced"===d){d=e("bulkDelimiter").val()||",";var f=e("bulkEnclosingChar").val()||'"';e=e("bulkHasHeader").is(":checked");c=(new CardParser).parseAdvancedDelimited(c,e,d,f)}else c=(new CardParser).parse(c,d);a.emitGlobalMessageAndFade(Say($jscomp$templatelit$23));b.createCards(c);a.closeModal()};
BulkInsertModal.prototype.getHtml=function(){return'\n<div id="bulkCardsPopup">\n  <h4>Insert Nodes</h4>\n  <p>Enter nodes in any format: csv, newlines, tsv, json, or tree.</p>\n  <div class="form-group">\n    <textarea data-command="ac _updateBulkTextAreaAdvancedCommand" class="bigInput" rows="15" id="bulkTextarea" wrap="off"></textarea>\n  </div>\n  <br>\n  <div class="form-group">\n    <label for="bulkType">Format</label>\n    <select data-command="ac _updateBulkTextAreaPlaceholderCommand" class="bigInput" id="bulkType">\n      <option value="">Detect</option>\n      <option value="csv">CSV</option>\n      <option value="tsv">TSV</option>\n      <option value="json">JSON</option>\n      <option value="ssv">SSV</option>\n      <option value="rss">RSS</option>\n      <option value="tree">Tree</option>\n      <option value="list">List</option>\n      <option value="spaced">Spaced Trees</option>\n      <option value="sections">Sections</option>\n      <option value="advanced">Advanced Delimited</option>\n    </select>\n  </div>\n    <div id="bulkAdvanced">\n    </div>\n    <br>\n  <button type="button" class="buttonPrimary" data-command="ac _submitBulkInsertCommand">Insert</button>\n'};
window.BulkInsertModal=BulkInsertModal;var CardEditorModal=function(a){return AbstractModal.apply(this,arguments)||this};$jscomp.inherits(CardEditorModal,AbstractModal);CardEditorModal._mountedComponents=AbstractModal._mountedComponents;CardEditorModal.prototype.componentDidMount=function(){AbstractModal.prototype.componentDidMount.call(this);this._getTextArea().val(this.getCard().cardToString())};CardEditorModal.prototype._getTextArea=function(){return this.getApp().getWillowDom().getStumpById("editCardTextarea")};
CardEditorModal.prototype._deleteCardCommand=function(){this.getApp().closeModal();var a=this.getCard().getCardBlock();return this.getCard().destroyCardCommand().then(function(){a.executeLoadNewBinderAndRender()})};CardEditorModal.prototype._saveCardCommand=function(){var a=this.getCard();a.reloadFromStr(this._getTextArea().val());a.getCardBlock().updateCards([a]);this.getApp().closeModal()};
CardEditorModal.prototype.getHtml=function(){var a='<button title="Save" class="rightButton" data-command="ac _saveCardCommand">'+MakeSVG("check",30)+"</button>";return'<h4>Editing node</h4>\n    <textarea class="bigInput" rows="20" id="editCardTextarea"></textarea>\n    <button title="'+Say($jscomp$templatelit$24)+'" class="leftButton" data-command="ac _deleteCardCommand">'+MakeSVG("trash",30)+"</button>\n    "+a};CardEditorModal.prototype.getCard=function(){return this.getApp().getTargetNode()};
window.CardEditorModal=CardEditorModal;var CustomConfirmModal=function(a){return AbstractModal.apply(this,arguments)||this};$jscomp.inherits(CustomConfirmModal,AbstractModal);CustomConfirmModal._mountedComponents=AbstractModal._mountedComponents;
CustomConfirmModal.prototype.getHtml=function(){return"<h4>"+this.getTail()+'</h4>\n    <button value="0" data-command="ac _resolveCommand">'+Say($jscomp$templatelit$25)+'</button><button value="1" data-command="ac _resolveCommand">'+Say($jscomp$templatelit$26)+"</button>"};CustomConfirmModal.prototype._resolveCommand=function(a){this.resolve("1"===a);this.getApp().closeModal();return Promise.resolve()};
...
NodePickerModal.prototype.componentDidMount=function(){AbstractModal.prototype.componentDidMount.call(this);var a=this.getApp(),b=a.getWillowDom();b.getStumpByClass("head").on(BrowserEvents.click,function(){var c=b.getStumpFromElement(this).parent().attr("data-pathVector").split(" ").map(function(a){return parseInt(a)}),c=c.splice(2);a.closeModal();a.openNodeEditorModalCommand(c)})};
NodePickerModal.prototype.getHtml=function(){return'<h4>Click a property to edit</h4>\n    <div class="monospaceModal"><div>'+this.getProgram().toHtml()+"</div></div>"};window.NodePickerModal=NodePickerModal;var SingleInsertModal=function(a){return AbstractModal.apply(this,arguments)||this};$jscomp.inherits(SingleInsertModal,AbstractModal);SingleInsertModal._mountedComponents=AbstractModal._mountedComponents;
SingleInsertModal.prototype.componentDidMount=function(){AbstractModal.prototype.componentDidMount.call(this);var a=this._getChildBlock();this._getTextArea().val(a.getOutputBinder().toBlankFormTemplate());this._getTextArea().focus()};SingleInsertModal.prototype._getChildBlock=function(){return this.getApp().getTargetNode()};SingleInsertModal.prototype._getTextArea=function(){return this.getApp().getWillowDom().getStumpById("newCardTextarea")};
SingleInsertModal.prototype._submitCardCommand=function(){var a=new TreeNotation(this._getTextArea().val());this._getChildBlock().createCards([a]);this.getApp().closeModal()};SingleInsertModal.prototype.getHtml=function(){return'\n  <h4>Insert</h4>\n  <textarea rows="20" class="bigInput" wrap="off" id="newCardTextarea"></textarea>\n  <button title="Save" data-command="ac _submitCardCommand" class="SVGIcon rightButton">'+MakeSVG("check",30)+"</button>"};window.SingleInsertModal=SingleInsertModal;
var SourceEditorModal=function(a){return AbstractModal.apply(this,arguments)||this};$jscomp.inherits(SourceEditorModal,AbstractModal);SourceEditorModal._mountedComponents=AbstractModal._mountedComponents;SourceEditorModal.prototype.hasChanges=function(){return this._getTextarea().val()!==this.getApp().getMountedProgram().childrenToString()};SourceEditorModal.prototype._getTextarea=function(){return this.getStump().find("textarea")};
SourceEditorModal.prototype._saveChangesCommand=function(){var a=this.getApp(),b=this._getTextarea(),c=a.getMountedProgram(),b=b.val();c.setChildren(b);a.closeModal();c.autosaveAndRender()};SourceEditorModal.prototype.componentDidMount=function(){this._getTextarea().val(this.getApp().getMountedProgram().childrenToString())};
...
FireProgram.prototype.compilesTo=function(){return"js"};FireProgram.prototype.buildProgram=function(){return this.getChildrenByNodeType(AbstractBlock).map(function(a){return a.toJavascript()}).join("\n")};FireProgram.prototype.getTopNodeTypes=function(){var a=(new TreeNotation(FireBlocks)).getChildren().slice(0);a.sort(Util.sortByAccessor(function(a){return a.findTail("inserts")||1}));a.reverse();return a.slice(0,20).map(function(a){return a.getHead()})};
...
FlowProgram.prototype.compilesTo=function(){return"html"};FlowProgram.prototype.buildProgram=function(){return this.getDescendantBlocks().filter(function(a){return!(a instanceof ParserETN.BlockPropertyNode)}).map(function(a){return a.getBlockHtmlBody()}).join("\n")};FlowProgram.prototype.getCatchAllBlockClass=function(a,b,c,d){a=a.getDidYouMeanBlock().getJSClass(d);return c.startsWith(">")?a:ParserETN.BlockPropertyNode};FlowProgram.clearParser=function(){delete this._parser};
FlowProgram.getParser=function(a){this._parser||(this._parser=new ParserETN(a.getFlowBlocks(),"flow",a));return this._parser};window.FlowProgram=FlowProgram;var SpeedTestTemplate=function(a,b){return">data\n pin 45 32 17 5\n content "+b.replace(/\n/g,"\n  ")+"\n columns\n  timeToLoad\n   type number\n  timeToRender\n   type number\n >text\n  content "+a+"\n  pin 45 0 23 3\n >table\n  link url\n  title Slow Load Times\n  x timeToLoad\n  y timeToRender\n  orderBy -timeToLoad\n  pin 0 0 43 18\n >table\n  link url\n  title Slow Render Times\n  x timeToLoad\n  y timeToRender\n  orderBy -timeToRender\n  pin 0 20 41 17\n >kpi\n  pin 45 4 11 7\n  column timeToLoad\n  reduction average\n >kpi\n  pin 45 15 11 7\n  column timeToRender\n  reduction average\n >kpi\n  pin 45 24 11 7\n  column timeToRender\n  reduction median\n >kpi\n  pin 57 4 11 7\n  column timeToLoad\n  reduction sum\n >kpi\n  pin 57 15 11 7\n  column timeToRender\n  reduction sum\n >kpi\n  pin 57 24 11 7\n  column timeToRender\n  reduction count"};
window.SpeedTestTemplate=SpeedTestTemplate;var OhayoApp=function(a){return AbstractApp.apply(this,arguments)||this};$jscomp.inherits(OhayoApp,AbstractApp);OhayoApp._mountedComponents=AbstractApp._mountedComponents;OhayoApp.prototype.fetchProgram=function(a){a.setChildrenAndDiskAndUndoStack(this.getFromStore(a.getUrl()));return Promise.resolve()};OhayoApp.prototype.componentWillMount=function(){AbstractApp.prototype.componentWillMount.call(this);1===this._getVisitCount()&&this.playFirstVisitCommand()};
OhayoApp.prototype.playFirstVisitCommand=function(){var a=this;return this.openOhayoProgramCommand("readme.flow faq.flow releasenotes.flow fib.fire").then(function(){return a.openOhayoProgramCommand("ohayo.flow")})};OhayoApp.prototype.saveProgramToDisk=function(a,b){this.storeValue(a.getFileName(),b.newVersion);return Promise.resolve()};OhayoApp.prototype.getLinks=function(){return this.getStoreKeys().filter(function(a){return!StorageKeys.isKey(a)}).map(function(a){return{link:a,title:a}})};
OhayoApp.prototype.getProgramToOpen=function(){return this.getFromStore(StorageKeys.mountedProgram)};OhayoApp.prototype.doesFileExistSync=function(a){return void 0!==this.getFromStore(a)};OhayoApp.prototype.setRefreshUrl=function(a){return this};OhayoApp.prototype.deleteFileCommand=function(a){this.removeValue(a);return Promise.resolve()};OhayoApp.prototype.renameFileCommand=function(a,b,c){this.storeValue(b,this.getFromStore(a)||"");this.removeValue(a);return Promise.resolve(b)};
OhayoApp.prototype._createFile=function(a,b,c){a=this._getAvailablePermalink(a);this.storeValue(a,b);return Promise.resolve(a)};OhayoApp.prototype.createAndOpen=function(a,b,c){var d=this;return this._createFile(b,a,c).then(function(a){return d.openUrlInNewSpaceAndFocus(a)})};window.OhayoApp=OhayoApp;WillowDom.startApp(OhayoApp);window.PR_SHOULD_USE_CONTINUATION=!0;
(function(){function a(a){function b(a){var b=a.charCodeAt(0);if(92!==b)return b;var c=a.charAt(1);return(b=k[c])?b:"0"<=c&&"7">=c?parseInt(a.substring(1),8):"u"===c||"x"===c?parseInt(a.substring(2),16):a.charCodeAt(1)}function c(a){if(32>a)return(16>a?"\\x0":"\\x")+a.toString(16);a=String.fromCharCode(a);if("\\"===a||"-"===a||"["===a||"]"===a)a="\\"+a;return a}function d(a){var d=a.substring(1,a.length-1).match(/\\u[0-9A-Fa-f]{4}|\\x[0-9A-Fa-f]{2}|\\[0-3][0-7]{0,2}|\\[0-7]{1,2}|\\[\s\S]|-|[^-\\]/g);
a=[];for(var e=[],f="^"===d[0],g=f?1:0,h=d.length;g<h;++g){var l=d[g];if(/\\[bdsw]/i.test(l))a.push(l);else{var l=b(l);if(g+2<h&&"-"===d[g+1]){var r=b(d[g+2]);g+=2}else r=l;e.push([l,r]);65>r||122<l||(65>r||90<l||e.push([Math.max(65,l)|32,Math.min(r,90)|32]),97>r||122<l||e.push([Math.max(97,l)&-33,Math.min(r,122)&-33]))}}e.sort(function(a,b){return a[0]-b[0]||b[1]-a[1]});h=[];l=[NaN,NaN];for(g=0;g<e.length;++g)d=e[g],d[0]<=l[1]+1?l[1]=Math.max(l[1],d[1]):h.push(l=d);e=["["];f&&e.push("^");e.push.apply(e,
a);for(g=0;g<h.length;++g)d=h[g],e.push(c(d[0])),d[1]>d[0]&&(d[1]+1>d[0]&&e.push("-"),e.push(c(d[1])));e.push("]");return e.join("")}function e(a){for(var b,c=a.source.match(/(?:\[(?:[^\x5C\x5D]|\\[\s\S])*\]|\\u[A-Fa-f0-9]{4}|\\x[A-Fa-f0-9]{2}|\\[0-9]+|\\[^ux0-9]|\(\?[:!=]|[\(\)\^]|[^\x5B\x5C\(\)\^]+)/g),e=c.length,f=[],l=0,r=0;l<e;++l)b=c[l],"("===b?++r:"\\"===b.charAt(0)&&(b=+b.substring(1))&&b<=r&&(f[b]=-1);for(l=1;l<f.length;++l)-1===f[l]&&(f[l]=++g);for(r=l=0;l<e;++l)b=c[l],"("===b?(++r,void 0===
f[r]&&(c[l]="(?:")):"\\"===b.charAt(0)&&(b=+b.substring(1))&&b<=r&&(c[l]="\\"+f[r]);for(r=l=0;l<e;++l)"^"===c[l]&&"^"!==c[l+1]&&(c[l]="");if(a.ignoreCase&&h)for(l=0;l<e;++l)b=c[l],a=b.charAt(0),2<=b.length&&"["===a?c[l]=d(b):"\\"!==a&&(c[l]=b.replace(/[a-zA-Z]/g,function(a){a=a.charCodeAt(0);return"["+String.fromCharCode(a&-33,a|32)+"]"}));return c.join("")}for(var f,g=0,h=!1,r=!1,n=0,F=a.length;n<F;++n)if(f=a[n],f.ignoreCase)r=!0;else if(/[a-z]/i.test(f.source.replace(/\\u[0-9a-f]{4}|\\x[0-9a-f]{2}|\\[^ux]/gi,
""))){h=!0;r=!1;break}for(var k={b:8,t:9,n:10,v:11,f:12,r:13},p=[],n=0,F=a.length;n<F;++n){f=a[n];if(f.global||f.multiline)throw Error(""+f);p.push("(?:"+e(f)+")")}return new RegExp(p.join("|"),r?"gi":"g")}function b(a){function b(a){switch(a.nodeType){case 1:if(c.test(a.className))break;for(var h=a.firstChild;h;h=h.nextSibling)b(h);h=a.nodeName;if("BR"===h||"LI"===h)d[g]="\n",f[g<<1]=e++,f[g++<<1|1]=a;break;case 3:case 4:h=a.nodeValue,h.length&&(h=r?h.replace(/\r\n?/g,"\n"):h.replace(/[ \t\r\n]+/g,
" "),d[g]=h,f[g<<1]=e,e+=h.length,f[g++<<1|1]=a)}}var c=/(?:^|\s)nocode(?:\s|$)/,d=[],e=0,f=[],g=0,h;a.currentStyle?h=a.currentStyle.whiteSpace:window.getComputedStyle&&(h=document.defaultView.getComputedStyle(a,null).getPropertyValue("white-space"));var r=h&&"pre"===h.substring(0,3);b(a);return{sourceCode:d.join("").replace(/\n$/,""),spans:f}}function c(a,b,c,d){b&&(a={sourceCode:b,basePos:a},c(a),d.push.apply(d,a.decorations))}function d(b,d){var e={},f;(function(){for(var c=b.concat(d),g=[],h=
{},r=0,n=c.length;r<n;++r){var k=c[r],p=k[3];if(p)for(var l=p.length;0<=--l;)e[p.charAt(l)]=k;k=k[1];p=""+k;h.hasOwnProperty(p)||(g.push(k),h[p]=null)}g.push(/[\0-\uffff]/);f=a(g)})();var g=d.length,r=function(a){for(var b=a.basePos,n=[b,"pln"],k=0,p=a.sourceCode.match(f)||[],G={},E=0,l=p.length;E<l;++E){var z=p[E],u=G[z],y=void 0;if("string"===typeof u)var w=!1;else{var m=e[z.charAt(0)];if(m)y=z.match(m[1]),u=m[0];else{for(w=0;w<g;++w)if(m=d[w],y=z.match(m[1])){u=m[0];break}y||(u="pln")}!(w=5<=u.length&&
"lang-"===u.substring(0,5))||y&&"string"===typeof y[1]||(w=!1,u="src");w||(G[z]=u)}m=k;k+=z.length;if(w){w=y[1];var q=z.indexOf(w),t=q+w.length;y[2]&&(t=z.length-y[2].length,q=t-w.length);u=u.substring(5);c(b+m,z.substring(0,q),r,n);c(b+m+q,w,h(u,w),n);c(b+m+t,z.substring(t),r,n)}else n.push(b+m,u)}a.decorations=n};return r}function e(a){var b=[],c=[];a.tripleQuotedStrings?b.push(["str",/^(?:\'\'\'(?:[^\'\\]|\\[\s\S]|\'{1,2}(?=[^\']))*(?:\'\'\'|$)|\"\"\"(?:[^\"\\]|\\[\s\S]|\"{1,2}(?=[^\"]))*(?:\"\"\"|$)|\'(?:[^\\\']|\\[\s\S])*(?:\'|$)|\"(?:[^\\\"]|\\[\s\S])*(?:\"|$))/,
...
null]);return d(b,c)}function f(a,b){function c(a){switch(a.nodeType){case 1:if(e.test(a.className))break;if("BR"===a.nodeName)d(a),a.parentNode&&a.parentNode.removeChild(a);else for(a=a.firstChild;a;a=a.nextSibling)c(a);break;case 3:case 4:if(n){var b=a.nodeValue,h=b.match(f);if(h){var l=b.substring(0,h.index);a.nodeValue=l;(b=b.substring(h.index+h[0].length))&&a.parentNode.insertBefore(g.createTextNode(b),a.nextSibling);d(a);l||a.parentNode.removeChild(a)}}}}function d(a){function b(a,c){c=c?a.cloneNode(!1):
a;var d=a.parentNode;if(d){d=b(d,1);a=a.nextSibling;d.appendChild(c);for(var e=a;e;e=a)a=e.nextSibling,d.appendChild(e)}return c}for(;!a.nextSibling;)if(a=a.parentNode,!a)return;a=b(a.nextSibling,0);for(var c;(c=a.parentNode)&&1===c.nodeType;)a=c;r.push(a)}var e=/(?:^|\s)nocode(?:\s|$)/,f=/\r\n?|\n/,g=a.ownerDocument,h;a.currentStyle?h=a.currentStyle.whiteSpace:window.getComputedStyle&&(h=g.defaultView.getComputedStyle(a,null).getPropertyValue("white-space"));var n=h&&"pre"===h.substring(0,3);for(h=
g.createElement("LI");a.firstChild;)h.appendChild(a.firstChild);for(var r=[h],k=0;k<r.length;++k)c(r[k]);b===(b|0)&&r[0].setAttribute("value",b);var p=g.createElement("OL");p.className="linenums";b=Math.max(0,b-1|0)||0;for(var k=0,m=r.length;k<m;++k)h=r[k],h.className="L"+(k+b)%10,h.firstChild||h.appendChild(g.createTextNode("\u00a0")),p.appendChild(h);a.appendChild(p)}function g(a,b){for(var c=b.length;0<=--c;){var d=b[c];A.hasOwnProperty(d)?window.console&&console.warn("cannot override language handler %s",
d):A[d]=a}}function h(a,b){a&&A.hasOwnProperty(a)||(a=/^\s*</.test(b)?"default-markup":"default-code");return A[a]}function n(a){var c=a.langExtension;try{var d=b(a.sourceNode),e=d.sourceCode;a.sourceCode=e;a.spans=d.spans;a.basePos=0;h(c,e)(a);var f,g=/\bMSIE\b/.test(navigator.userAgent),c=/\n/g,n=a.sourceCode,k=n.length,d=0,p=a.spans,r=p.length,e=0,m=a.decorations,q=m.length;a=0;m[q]=k;var t,l;for(l=t=0;l<q;)m[l]!==m[l+2]?(m[t++]=m[l++],m[t++]=m[l++]):l+=2;q=t;for(l=t=0;l<q;){var z=m[l],u=m[l+1];
for(f=l+2;f+2<=q&&m[f+1]===u;)f+=2;m[t++]=z;m[t++]=u;l=f}for(m.length=t;e<r;){var y=p[e+2]||k,v=m[a+2]||k;f=Math.min(y,v);var x=p[e+1],A;if(1!==x.nodeType&&(A=n.substring(d,f))){g&&(A=A.replace(c,"\r"));x.nodeValue=A;var B=x.ownerDocument,C=B.createElement("SPAN");C.className=m[a+1];var H=x.parentNode;H.replaceChild(C,x);C.appendChild(x);d<y&&(p[e+1]=x=B.createTextNode(n.substring(f,y)),H.insertBefore(x,C.nextSibling))}d=f;d>=y&&(e+=2);d>=v&&(a+=2)}}catch(D){"console"in window&&console.log(D&&D.stack?
D.stack:D)}}var k=["break,continue,do,else,for,if,return,while"],p=[[k,"auto,case,char,const,default,double,enum,extern,float,goto,int,long,register,short,signed,sizeof,static,struct,switch,typedef,union,unsigned,void,volatile"],"catch,class,delete,false,import,new,operator,private,protected,public,this,throw,true,try,typeof"],m=[p,"alignof,align_union,asm,axiom,bool,concept,concept_map,const_cast,constexpr,decltype,dynamic_cast,explicit,export,friend,inline,late_check,mutable,namespace,nullptr,reinterpret_cast,static_assert,static_cast,template,typeid,typename,using,virtual,where"],
q=[p,"abstract,boolean,byte,extends,final,finally,implements,import,instanceof,null,native,package,strictfp,super,synchronized,throws,transient"],t=[q,"as,base,by,checked,decimal,delegate,descending,dynamic,event,fixed,foreach,from,group,implicit,in,interface,internal,into,is,lock,object,out,override,orderby,params,partial,readonly,ref,sbyte,sealed,stackalloc,string,select,uint,ulong,unchecked,unsafe,ushort,var"],p=[p,"debugger,eval,export,function,get,null,set,undefined,var,with,Infinity,NaN"],v=
[k,"and,as,assert,class,def,del,elif,except,exec,finally,from,global,import,in,is,lambda,nonlocal,not,or,pass,print,raise,try,with,yield,False,True,None"],x=[k,"alias,and,begin,case,class,def,defined,elsif,end,ensure,false,in,module,next,nil,not,or,redo,rescue,retry,self,super,then,true,undef,unless,until,when,yield,BEGIN,END"],k=[k,"case,done,elif,esac,eval,fi,function,in,local,set,then,until"],B=/^(DIR|FILE|vector|(de|priority_)?queue|list|stack|(const_)?iterator|(multi)?(set|map)|bitset|u?(int|float)\d*)/,
I=/\S/,J=e({keywords:[m,t,p,"caller,delete,die,do,dump,elsif,eval,exit,foreach,for,goto,if,import,last,local,my,next,no,our,print,package,redo,require,sub,undef,unless,until,use,wantarray,while,BEGIN,END"+v,x,k],hashComments:!0,cStyleComments:!0,multiLineStrings:!0,regexLiterals:!0}),A={};g(J,["default-code"]);g(d([],[["pln",/^[^<?]+/],["dec",/^<!\w[^>]*(?:>|$)/],["com",/^<\!--[\s\S]*?(?:-\->|$)/],["lang-",/^<\?([\s\S]+?)(?:\?>|$)/],["lang-",/^<%([\s\S]+?)(?:%>|$)/],["pun",/^(?:<[%?]|[%?]>)/],["lang-",
...
["pun",/^[=<>\/]+/],["lang-js",/^on\w+\s*=\s*\"([^\"]+)\"/i],["lang-js",/^on\w+\s*=\s*\'([^\']+)\'/i],["lang-js",/^on\w+\s*=\s*([^\"\'>\s]+)/i],["lang-css",/^style\s*=\s*\"([^\"]+)\"/i],["lang-css",/^style\s*=\s*\'([^\']+)\'/i],["lang-css",/^style\s*=\s*([^\"\'>\s]+)/i]]),["in.tag"]);g(d([],[["atv",/^[\s\S]+/]]),["uq.val"]);g(e({keywords:m,hashComments:!0,cStyleComments:!0,types:B}),"c cc cpp cxx cyc m".split(" "));g(e({keywords:"null,true,false"}),["json"]);g(e({keywords:t,hashComments:!0,cStyleComments:!0,
verbatimStrings:!0,types:B}),["cs"]);g(e({keywords:q,cStyleComments:!0}),["java"]);g(e({keywords:k,hashComments:!0,multiLineStrings:!0}),["bsh","csh","sh"]);g(e({keywords:v,hashComments:!0,multiLineStrings:!0,tripleQuotedStrings:!0}),["cv","py"]);g(e({keywords:"caller,delete,die,do,dump,elsif,eval,exit,foreach,for,goto,if,import,last,local,my,next,no,our,print,package,redo,require,sub,undef,unless,until,use,wantarray,while,BEGIN,END",hashComments:!0,multiLineStrings:!0,regexLiterals:!0}),["perl",
"pl","pm"]);g(e({keywords:x,hashComments:!0,multiLineStrings:!0,regexLiterals:!0}),["rb"]);g(e({keywords:p,cStyleComments:!0,regexLiterals:!0}),["js"]);g(e({keywords:"all,and,by,catch,class,else,extends,false,finally,for,if,in,is,isnt,loop,new,no,not,null,of,off,on,or,return,super,then,true,try,unless,until,when,while,yes",hashComments:3,cStyleComments:!0,multilineStrings:!0,tripleQuotedStrings:!0,regexLiterals:!0}),["coffee"]);g(d([],[["str",/^[\s\S]+/]]),["regex"]);window.prettyPrintOne=function(a,
b,c){var d=document.createElement("PRE");d.innerHTML=a;c&&f(d,c);n({langExtension:b,numberLines:c,sourceNode:d});return d.innerHTML};window.prettyPrint=function(a){function b(){for(var c=window.PR_SHOULD_USE_CONTINUATION?k.now()+250:Infinity;m<d.length&&k.now()<c;m++){var e=d[m],g=e.className;if(0<=g.indexOf("prettyprint")){var g=g.match(r),h;if(h=!g){var t=e;h=void 0;for(var q=t.firstChild;q;q=q.nextSibling){var v=q.nodeType;h=1===v?h?t:q:3===v?I.test(q.nodeValue)?t:h:h}h=t=h===t?void 0:h}h&&"CODE"===
t.tagName&&(g=t.className.match(r));g&&(g=g[1]);h=!1;for(q=e.parentNode;q;q=q.parentNode)if(("pre"===q.tagName||"code"===q.tagName||"xmp"===q.tagName)&&q.className&&0<=q.className.indexOf("prettyprint")){h=!0;break}h||((h=(h=e.className.match(/\blinenums\b(?::(\d+))?/))?h[1]&&h[1].length?+h[1]:!0:!1)&&f(e,h),p={langExtension:g,sourceNode:e,numberLines:h},n(p))}}m<d.length?setTimeout(b,250):a&&a()}for(var c=[document.getElementsByTagName("pre"),document.getElementsByTagName("code"),document.getElementsByTagName("xmp")],
d=[],e=0;e<c.length;++e)for(var g=0,h=c[e].length;g<h;++g)d.push(c[e][g]);var c=null,k=Date;k.now||(k={now:function(){return+new Date}});var m=0,p,r=/\blang(?:uage)?-([\w.]+)(?!\S)/;b()};window.PR={createSimpleLexer:d,registerLangHandler:g,sourceDecorator:e,PR_ATTRIB_NAME:"atn",PR_ATTRIB_VALUE:"atv",PR_COMMENT:"com",PR_DECLARATION:"dec",PR_KEYWORD:"kwd",PR_LITERAL:"lit",PR_NOCODE:"nocode",PR_PLAIN:"pln",PR_PUNCTUATION:"pun",PR_SOURCE:"src",PR_STRING:"str",PR_TAG:"tag",PR_TYPE:"typ"}})();
...
var addSorting=function(){function a(){return document.querySelector(".coverage-summary")}function b(b){return a().querySelector("thead tr").querySelectorAll("th")[b]}function c(a,b){var c=f[a].key,d=function(a,b){a=a.data[c];b=b.data[c];return a<b?-1:a>b?1:0};a=d;var e=document.querySelector(".coverage-summary tbody"),g=e.querySelectorAll("tr"),h=[];b&&(a=function(a,b){return-1*d(a,b)});for(b=0;b<g.length;b+=1)h.push(g[b]),e.removeChild(g[b]);h.sort(a);for(b=0;b<h.length;b+=1)e.appendChild(h[b])}
function d(){b(g.index).className+=g.desc?" sorted-desc":" sorted"}function e(){var a,e=function(a){var e=f[a];return function(){var f=e.defaultDescSort;g.index===a&&(f=!g.desc);c(a,f);var h=b(g.index),k=h.className,k=k.replace(/ sorted$/,"").replace(/ sorted-desc$/,"");h.className=k;g.index=a;g.desc=f;d()}};for(a=0;a<f.length;a+=1)if(f[a].sortable){var k=b(a).querySelector(".sorter").parentElement;k.addEventListener?k.addEventListener("click",e(a)):k.attachEvent("onclick",e(a))}}var f,g={index:0,
desc:!1};return function(){if(a()){var b=a().querySelector("thead tr").querySelectorAll("th"),c=[],g;for(g=0;g<b.length;g+=1){var p=b[g];var m={key:p.getAttribute("data-col"),sortable:!p.getAttribute("data-nosort"),type:p.getAttribute("data-type")||"string"};c.push(m);m.sortable&&(m.defaultDescSort="number"===m.type,p.innerHTML+='<span class="sorter"></span>')}f=c;b=a().querySelector("tbody").querySelectorAll("tr");for(p=0;p<b.length;p+=1){var c=b[p],q=b[p].querySelectorAll("td"),t={};for(m=0;m<q.length;m+=
1){var v=q[m];g=f[m];v=v.getAttribute("data-value");"number"===g.type&&(v=Number(v));t[g.key]=v}c.data=t}d();e()}}}();window.addEventListener("load",addSorting);
