...
window.CodeMirrorTerminalChisel=CodeMirrorTerminalChisel;var GutterChisel=function(a){return AbstractChisel.apply(this,arguments)||this};$jscomp.inherits(GutterChisel,AbstractChisel);GutterChisel._mountedChisels=AbstractChisel._mountedChisels;GutterChisel.prototype.getSymbolMap=function(){return{console:ConsoleChisel,terminal:this.isNodeJs()?BasicTerminalChisel:CodeMirrorTerminalChisel}};
...
return f}())};
TileCommander.prototype.exportTileDataCommand=function(){var a=this;return $jscomp.executeAsyncGenerator(function(){function b(b,e,h){for(;;)switch(c){case 0:d=a.getTarget(),d.getApp().getWillowProgram().downloadFile(d.getOutputBinder().toDelimited(","),d.getSymbol()+".csv","text/csv"),c=-1;default:return{value:void 0,done:!0}}}var c=0,d,e={next:function(a){return b(0,a,void 0)},throw:function(a){return b(1,void 0,a)},return:function(a){throw Error("Not yet implemented");}};$jscomp.initSymbolIterator();e[Symbol.iterator]=
function(){return this};return e}())};window.TileCommander=TileCommander;var GrammarConstants={preface:"@preface",prefaceBlock:{}};GrammarConstants.prefaceBlock.fileExtension="@fileExtension";GrammarConstants.prefaceBlock.targetExtension="@targetExtension";GrammarConstants.prefaceBlock.shellCommand="@shellCommand";GrammarConstants.symbols="@symbols";GrammarConstants.parameters="@parameters";GrammarConstants.catchAllNode="@catchAllNode";GrammarConstants.defaults="@defaults";
...
AbstractBlazeNode.prototype.getDefinition=function(){var a=this.getSymbol();return this.getGrammarProgram().getDefinitionByName(a)};AbstractBlazeNode.prototype.isProgram=function(){return!1};AbstractBlazeNode.prototype._getParameterMap=function(){var a={};this.getBlazeCellArray().forEach(function(b){var c=b.getType();a[c]||(a[c]=[]);a[c].push(b.getWord())});return a};
...
var BlazeNonTerminalNode=function(a){return AbstractBlazeNode.apply(this,arguments)||this};$jscomp.inherits(BlazeNonTerminalNode,AbstractBlazeNode);BlazeNonTerminalNode.formatStr=AbstractBlazeNode.formatStr;BlazeNonTerminalNode.prototype.getSymbolMap=function(){return this.getDefinition().getRunTimeSymbolMap()};BlazeNonTerminalNode.prototype.getCatchAllNodeClass=function(a){return this.getDefinition().getCatchAllNodeClass()};
...
var TileSettingNonTerminalNode=function(a){return AbstractTileSettingNode.apply(this,arguments)||this};$jscomp.inherits(TileSettingNonTerminalNode,AbstractTileSettingNode);TileSettingNonTerminalNode.formatStr=AbstractTileSettingNode.formatStr;TileSettingNonTerminalNode.loadCode=AbstractTileSettingNode.loadCode;TileSettingNonTerminalNode.prototype.getSettingValue=function(){return this.childrenToString()};
...
window.GrammarStressTest=GrammarStressTest;var HakonPropertyNode=function(a){return TreeProgram.apply(this,arguments)||this};$jscomp.inherits(HakonPropertyNode,TreeProgram);HakonPropertyNode.prototype.toCss=function(a){return""+a+this.getSymbol()+": "+this.getBeam()+";"};var HakonSelectorNode=function(a){return TreeProgram.apply(this,arguments)||this};$jscomp.inherits(HakonSelectorNode,TreeProgram);HakonSelectorNode.prototype.parseNodeType=function(a){return a.includes(" ")?HakonPropertyNode:HakonSelectorNode};
HakonSelectorNode.prototype.getSelector=function(){var a=this.getParent().getSelector();return this.getSymbol().split(",").map(function(b){return b.startsWith("&")?a+b.substr(1):a?a+" "+b:b}).join(",")};HakonSelectorNode.prototype.toCss=function(){var a=this.getChildrenByNodeType(HakonPropertyNode);return a.length?this.getSelector()+" {\n"+a.map(function(a){return a.toCss("  ")}).join("\n")+"\n}\n":""};var HakonProgram=function(a){return TreeProgram.apply(this,arguments)||this};
...
TileToolbarChisel.prototype._getTileTypeDropdownBray=function(){var a=this.getTargetTile(),b=this.getApp().getMountedTab().getTabProgram().getGrammarProgram().getBlazeNodeNames();b.sort();var c=a.getSymbol();return"@select\n data-onChangeCommand tile changeTileTypeCommand\n @option\n"+b.map(function(a){return" @option "+a+"\n  value "+a+"\n  "+(c===a?"selected":"notselected")}).join("\n")};
TileToolbarChisel.prototype._getParentDropdownBray=function(){var a=this.getTargetTile(),b=a.getPathVector().join(" ");return"@select\n data-onChangeCommand tile changeParentCommand\n @option\n"+a.getTileProcess().getProcessTiles().map(function(a){return{name:a.getSymbolPath(),value:a.getPathVector().join(" ")}}).map(function(a){return" @option "+a.name+"\n  value "+a.value+"\n  "+(b===a.value?"selected":"notselected")}).join("\n")};
TileToolbarChisel.prototype._getFormBray=function(){var a=this.getTargetTile(),b=a.getSettingsStruct(),c=a.getDefinition().getAllTileSettingsDefinitions().map(function(c){var d=c.getSymbol();return[d,c.toFormBray(b[d]||"",a)]}),d=a.getBeam()||"";c.unshift(["parent",this._getParentDropdownBray()]);c.unshift(["type",this._getTileTypeDropdownBray()]);c.unshift(["beam","@input\n data-onChangeCommand tile changeBeamAndRenderCommand\n value "+d]);return"@form\n @table\n"+c.map(function(a){return"  @tr\n   @td "+
...
StumpProgram.prototype.findStumpByChildString=function(a){return this.getTopDownArray().find(function(b){return b.getChildren().map(function(a){return a.getLine()}).join("\n").includes(a)})};StumpProgram.prototype.findStumpByBase=function(a){return this._findStumpsByBase(a)[0]};StumpProgram.prototype._findStumpsByBase=function(a){return this.getTopDownArray().filter(function(b){return b instanceof StumpProgram&&b.getSymbol()===a})};
...
AbstractTileChisel._mountedChisels=AbstractChisel._mountedChisels;AbstractTileChisel.prototype.parseNodeType=function(a){var b=a.split(" ")[0],c=this.getDefinition();return c.getRunTimeSymbolMap()[b]?c.getDefinitionByName(b).getDefinitionTileClass():this.getCatchAllNodeClass(a)};AbstractTileChisel.prototype.getCatchAllNodeClass=function(){return TileErrorNode};AbstractTileChisel.prototype.getCommander=function(){return new TileCommander(this)};AbstractTileChisel.prototype._getSettingsChildren=function(){return this.getChildrenByNodeType(AbstractTileSettingNode)};
AbstractTileChisel.prototype.getSettingsStruct=function(){this._initSettingsAndConstsCache();return this._cache_settingsObject};AbstractTileChisel.prototype._initSettingsAndConstsCache=function(){if(!this._cache_settingsObject){var a={};this._getSettingsChildren().forEach(function(b){a[b.getSymbol()]=b.getSettingValue()});var b=this.getDefinition().getConstantsObject();Object.assign(a,b);this._cache_settingsObject=a}};AbstractTileChisel.prototype.getApp=function(){return this.getTileProcess().getApp()};
AbstractTileChisel.prototype.runTile=function(){return $jscomp.executeAsyncGenerator(function(){function a(a,c,f){for(;;)switch(b){case 0:b=-1;default:return{value:void 0,done:!0}}}var b=0,c={next:function(b){return a(0,b,void 0)},throw:function(b){return a(1,void 0,b)},return:function(a){throw Error("Not yet implemented");}};$jscomp.initSymbolIterator();c[Symbol.iterator]=function(){return this};return c}())};AbstractTileChisel.prototype.getDefinition=function(){var a=this.getSymbol();return this.getTileProcess().getGrammarProgram().getDefinitionByName(a)};
...
AbstractTileChisel.prototype.getTileHeaderBern=function(){return""+this.getSymbol()};AbstractTileChisel.prototype.cloneAndOffset=function(){var a=this.duplicate(),b=this.getLeft(),c=this.getTop();b&&a.touchNode(TileConstants.left).setBeam(parseInt(b)+1);c&&a.touchNode(TileConstants.top).setBeam(parseInt(c)+1);return a};
...
AbstractTileChisel.prototype.getInspection=function(){var a=this.getMessageBuffer().getChildren().map(function(a){return"@li "+moment(a.getMTime()).fromNow()+" - "+a.childrenToString()}),b=this.getDefinition().getAllTileSettingsDefinitions().map(function(a){return a.getSymbol()+" "+a.getDescription()}).join("\n"),c=this.getSettingsStruct(),d=this.getParent().getSymbol();return"@div TileClass: "+this.constructor.name+" Parent: "+d+"\n@div Messages:\n@ol\n "+a+"\n@div Tree:\n@pre\n bern"+TreeProgram.nest(this.toString(),
...
TileProcess.prototype.run=function(){var a=this;return $jscomp.executeAsyncGenerator(function(){function b(b,f,k){for(;;)switch(c){case 0:return e=a.getApp(),d=lodash.uniq(a.getTopDownArray().filter(function(a){return a instanceof AbstractTileChisel}).map(function(a){return a.getSymbol()})),c=1,{value:Promise.all(d.map(function(b){return a._loadTileCode(b,e)})),done:!1};case 1:if(1!=b){c=2;break}c=-1;throw k;case 2:return c=3,{value:Promise.all(a.getProcessRootTiles().map(function(a){return a.runTile()})),
...
TileProcess.prototype.selectFirstTile=function(){var a=this.getProcessTiles()[0];a&&a.selectTile()};TileProcess.prototype.selectNext=function(){for(var a=this.getFirstSelectedTile().getNext();!a.getSymbol().startsWith(">");)a=this.getFirstSelectedTile().getNext();this.clearSelection();a.selectTile()};TileProcess.prototype.selectionToString=function(){return this.getSelectedTiles().map(function(a){return a.toString()}).join("\n")};
TileProcess.prototype.cutSelection=function(a){if(a=this._copySelection(a))return this.deleteSelection(),this.getApp().logMessageBray("@div Items cut"),a};TileProcess.prototype.selectPrevious=function(){for(var a=this.getFirstSelectedTile().getPrevious();!a.getSymbol().startsWith(">");)a=this.getFirstSelectedTile().getPrevious();this.clearSelection();a.selectTile()};TileProcess.prototype.getOutputBinder=function(){this._outputBinder||(this._outputBinder=new Binder(this));return this._outputBinder};
...
BrayTile.prototype.getHtmlContent=function(){return this.getBeam()};BrayTile.prototype.getTileBodyBray=function(){var a=this.getSettingsStruct(),b=this.getPipishInput(),c=a.element||this.getSymbol().substr(1),d="true"===a.editable.toString();return"@"+c+"\n style "+a.style+TreeProgram.nest(a.src?"src "+a.src:"",1)+"\n data-onBlurCommand chisel updateBeamFromHtmlCommand\n contenteditable "+(d?"true":"false")+"\n bern"+TreeProgram.nest(b,2)};window.BrayTile=BrayTile;
...
AbstractGrammarDefinition.prototype.getRunTimeSymbolMap=function(){this._initSymbolsMapCache();return this._cache_symbolsMap};AbstractGrammarDefinition.prototype.getRunTimeSymbolMapWithDefinitions=function(){var a=this._getDefinitionCache();return lodash.mapValues(this.getRunTimeSymbolMap(),function(b,c){return a[c]})};
AbstractGrammarDefinition.prototype._initSymbolsMapCache=function(){if(!this._cache_symbolsMap){var a=this._getDefinitionCache(),b={};this._cache_symbolsMap=b;var c=this.getAllowableSymbols();Object.keys(c).length&&Object.keys(a).filter(function(b){return a[b].isASymbol(c)}).forEach(function(c){b[c]=a[c].getJavascriptClassForNode()})}};
AbstractGrammarDefinition.prototype.getTopNodeTypes=function(){var a=this._getDefinitionCache(),b=this.getRunTimeSymbolMap();b=Object.keys(b).map(function(b){return a[b]});b.sort(Util.sortByAccessor(function(a){return a.getFrequency()}));b.reverse();return b.map(function(a){return a.getSymbol()})};AbstractGrammarDefinition.prototype.getDefinitionByName=function(a){return this._getDefinitionCache()[a]||this._getCatchAllDefinition()};
AbstractGrammarDefinition.prototype._getCatchAllDefinition=function(){var a=this._getCatchAllSymbol();return(a=this._getDefinitionCache()[a])?a:this.getParent()._getCatchAllDefinition()};AbstractGrammarDefinition.prototype._initCatchCallNodeCache=function(){this._cache_catchAll||(this._cache_catchAll=this._getCatchAllDefinition().getJavascriptClassForNode())};AbstractGrammarDefinition.prototype.isDefined=function(a){return!!this._getDefinitionCache()[a.toLowerCase()]};
AbstractGrammarDefinition.prototype.getCatchAllNodeClass=function(){this._initCatchCallNodeCache();return this._cache_catchAll};window.AbstractGrammarDefinition=AbstractGrammarDefinition;var GrammarConstNode=function(a){return TreeProgram.apply(this,arguments)||this};$jscomp.inherits(GrammarConstNode,TreeProgram);GrammarConstNode.prototype.getValue=function(){return this.length?this.childrenToString():this.getWords(2).join(" ")};GrammarConstNode.prototype.getName=function(){return this.getSymbol()};
...
$jscomp.inherits(GrammarDefinitionErrorNode,TreeProgram);GrammarDefinitionErrorNode.prototype.getErrors=function(){return['Unknown type "'+this.getSymbol()+'" at line '+this.getPoint().y]};GrammarDefinitionErrorNode.prototype.getTagLine=function(){return["symbol"].concat(this.getWords(1).map(function(a){return"any"})).join(" ")};var GrammarDefinition=function(a){return AbstractGrammarDefinition.apply(this,arguments)||this};$jscomp.inherits(GrammarDefinition,AbstractGrammarDefinition);
GrammarDefinition.prototype.getSymbolMap=function(){var a={};[GrammarConstants.frequency,GrammarConstants.openChildren,GrammarConstants.closeChildren,GrammarConstants.symbols,GrammarConstants.parameters,GrammarConstants.svg,GrammarConstants.tileSize,GrammarConstants.description,GrammarConstants.blazeClass,GrammarConstants.improvs,GrammarConstants.defaults,GrammarConstants.compiled,GrammarConstants.listDelimiter,GrammarConstants.tileClass,GrammarConstants.script,GrammarConstants.cssScript].forEach(function(b){a[b]=
TreeProgram});a[GrammarConstants.constants]=GrammarConstantsNode;return a};GrammarDefinition.prototype._getCatchAllSymbol=function(){return this.findBeam(GrammarConstants.catchAllNode)};GrammarDefinition.prototype.isASymbol=function(a){var b=this._getSymbolChain();return Object.keys(a).some(function(a){return b[a]})};GrammarDefinition.prototype._getSymbolChain=function(){this._initSymbolChainCache();return this._cache_symbolChain};
GrammarDefinition.prototype._initSymbolChainCache=function(){if(!this._cache_symbolChain){var a={};a[this.getSymbol()]=!0;var b=this.getBeam();b&&(a[b]=!0,b=this._getDefinitionCache()[b],Object.assign(a,b._getSymbolChain()));this._cache_symbolChain=a}};GrammarDefinition.prototype.getAllowableSymbols=function(){var a=this.getNode(GrammarConstants.symbols);return a?a.toObject():{}};GrammarDefinition.prototype._getDefinitionCache=function(){return this.getParent()._getDefinitionCache()};
...
GrammarDefinition.prototype._initClassCache=function(){if(!this._cache_class){var a=this.findBeam(GrammarConstants.blazeClass)||"/aientist/client/blaze/BlazeNonTerminalNode.js";this._cache_class=this.isNodeJs()?require(a):window[Util.getClassNameFromFilePath(a)]}};GrammarDefinition.prototype.getDoc=function(){return this.getSymbol()};GrammarDefinition.prototype.getOpenChildrenString=function(){return this.findBeam(GrammarConstants.openChildren)||""};
...
GrammarProgram.prototype.getExtensionName=function(){return this._getPrefaceNode().findBeam(GrammarConstants.prefaceBlock.fileExtension)};GrammarProgram.prototype.getAllowableSymbols=function(){var a=this._getPrefaceNode().getNode(GrammarConstants.symbols);return a?a.toObject():{}};GrammarProgram.prototype.getDocs=function(){return this.toString()};
GrammarProgram.prototype._initDefinitionCache=function(){if(!this._cache_definitions){var a={};this.getChildrenByNodeType(GrammarDefinition).forEach(function(b){var c=b.getSymbol();a[c]=b});this._cache_definitions=a}};GrammarProgram.prototype._getDefinitionCache=function(){this._initDefinitionCache();return this._cache_definitions};GrammarProgram.prototype._getDefinitions=function(){return Object.values(this._getDefinitionCache())};GrammarProgram.prototype._getCatchAllSymbol=function(){return this._getPrefaceNode().findBeam(GrammarConstants.catchAllNode)};
...
GrammarProgram.prototype.execute=function(a){return Util.compileProgramToJavascriptFile(a)};window.GrammarProgram=GrammarProgram;var BlazeProgram=function(a){return TreeProgram.apply(this,arguments)||this};$jscomp.inherits(BlazeProgram,TreeProgram);BlazeProgram.prototype.getSymbolMap=function(){return this.getGrammarProgram().getRunTimeSymbolMap()};BlazeProgram.prototype.getCatchAllNodeClass=function(a){return this.getGrammarProgram().getCatchAllNodeClass()};
...
throw n;case 2:c=-1;default:return{value:void 0,done:!0}}}var c=0,d,e,f,g,h,k={next:function(a){return b(0,a,void 0)},throw:function(a){return b(1,void 0,a)},return:function(a){throw Error("Not yet implemented");}};$jscomp.initSymbolIterator();k[Symbol.iterator]=function(){return this};return k}())};TestBlock.prototype.execute=function(){return this.isNodeJs()?this._executeNode():this._executeBrowser()};TestBlock.prototype.getSymbolMap=function(){var a={};a[SwarmConstants.setup]=TestSetup;return a};
...
var HashBang=function(a){return TreeProgram.apply(this,arguments)||this};$jscomp.inherits(HashBang,TreeProgram);var SwarmProgram=function(a){return TreeProgram.apply(this,arguments)||this};$jscomp.inherits(SwarmProgram,TreeProgram);SwarmProgram.prototype.getSymbolMap=function(){var a={};a[SwarmConstants.hashBang]=HashBang;a[SwarmConstants.setup]=TestSetup;a[SwarmConstants.testBlock]=TestBlock;a[SwarmConstants.skippedTestBlog]=SkippedTestBlock;a[SwarmConstants.soloTestBlock]=TestBlockSolo;return a};
...
$jscomp.inherits(TrooperProgram,SwarmProgram);TrooperProgram.prototype.getSymbolMap=function(){var a=SwarmProgram.prototype.getSymbolMap.call(this);a[SwarmConstants.setup]=TooperTestSetupNode;return a};TrooperProgram.prototype.getCommandParent=function(a){return a.getCommander()};window.TrooperProgram=TrooperProgram;var TurtleProgram=function(a){return BlazeProgram.apply(this,arguments)||this};$jscomp.inherits(TurtleProgram,BlazeProgram);TurtleProgram.getGrammarProgram=BlazeProgram.getGrammarProgram;
...
a.activeTabColor+"\n  border-bottom 0"};window.TabsChisel=TabsChisel;var PanelChisel=function(a){return AbstractChisel.apply(this,arguments)||this};$jscomp.inherits(PanelChisel,AbstractChisel);PanelChisel._mountedChisels=AbstractChisel._mountedChisels;PanelChisel.prototype.getSymbolMap=function(a){return{tabs:TabsChisel,gutter:GutterChisel}};
...
WillowBrowserProgram.prototype.appendScript=function(a){var b=this;return $jscomp.executeAsyncGenerator(function(){function c(c,e,h){for(;;)switch(d){case 0:if(a){d=1;break}d=-1;return{value:void 0,done:!0};case 1:b._loadingPromises||(b._loadingPromises={});if(!b._loadingPromises[a]){d=2;break}d=-1;return{value:b._loadingPromises[a],done:!0};case 2:if(!b.isNodeJs()){d=3;break}d=-1;return{value:void 0,done:!0};case 3:return b._loadingPromises[a]=b._appendScript(a),d=-1,{value:promise,done:!0};default:return{value:void 0,
done:!0}}}var d=0,e={next:function(a){return c(0,a,void 0)},throw:function(a){return c(1,void 0,a)},return:function(a){throw Error("Not yet implemented");}};$jscomp.initSymbolIterator();e[Symbol.iterator]=function(){return this};return e}())};
...
OhayoAppChisel.prototype.getSymbolMap=function(){return{theme:ThemeChisel,menu:MenuChisel,panel:PanelChisel,tabContextMenu:TabContextMenuChisel,tileContextMenu:TileContextMenuChisel,helpModal:HelpModal}};OhayoAppChisel.prototype.getHakon=function(){return".OhayoAppChisel\n height 100%\n width 100%"};OhayoAppChisel.prototype.goRed=function(a){a=this.getMountedTab();this.logMessageBray("@div error on tab: "+(a?a.getUrl():"")+".")};
