...
var $jscomp$templatelit$17=["My programs"];$jscomp$templatelit$17.raw=["My programs"];var $jscomp$templatelit$16=["",""];$jscomp$templatelit$16.raw=["",""];var $jscomp$templatelit$15=["Click to sort."];$jscomp$templatelit$15.raw=["Click to sort."];var $jscomp$templatelit$14=["",""];$jscomp$templatelit$14.raw=["",""];var $jscomp$templatelit$13=["",""];$jscomp$templatelit$13.raw=["",""];var $jscomp$templatelit$12=["Layout set to '","'"];$jscomp$templatelit$12.raw=["Layout set to '","'"];
var $jscomp$templatelit$11=["Items cut"];$jscomp$templatelit$11.raw=["Items cut"];var $jscomp$templatelit$10=["Items copied"];$jscomp$templatelit$10.raw=["Items copied"];var $jscomp$templatelit$9=["Drop to create a new program. Hold shift key to insert cards into current program."];$jscomp$templatelit$9.raw=["Drop to create a new program. Hold shift key to insert cards into current program."];var $jscomp$templatelit$8=["Created '","'"];$jscomp$templatelit$8.raw=["Created '","'"];
...
$jscomp.inherits(BlockPropertyNode,TreeNotation);BlockPropertyNode.prototype.getPropertyName=function(){return this.getWord(1)};BlockPropertyNode.prototype.getProbability=function(){var a=this.findBeam("percentage");return a?parseFloat(a):.01};
...
Wall.prototype.execute=function(a){this.getSectionsToRun().map(function(b){Tape(b.getBase(),function(c){var d=a(b);c.equal(d.actual,d.expected,d.message);c.end()})})};window.Wall=Wall;var AbstractProgramNodeChisel=function(a){return Chisel.apply(this,arguments)||this};$jscomp.inherits(AbstractProgramNodeChisel,Chisel);AbstractProgramNodeChisel._mountedComponents=Chisel._mountedComponents;
...
"}\n":k+c};window.AbstractFireBlock=AbstractFireBlock;var Shadow=function(a){this._stump=a};Shadow.prototype.getShadowStump=function(){return this._stump};Shadow.prototype.getShadowValue=function(){return""};Shadow.prototype.setShadowValue=function(a){return this};Shadow.prototype.removeShadow=function(){return this};Shadow.prototype.makeResizable=function(){return this};Shadow.prototype.makeDraggable=function(){return this};Shadow.prototype.makeTypeahead=function(){return this};
Shadow.prototype.makeSelectable=function(){return this};Shadow.prototype.focusShadow=function(){return this};Shadow.prototype.isShadowChecked=function(){return!1};Shadow.prototype.getShadowHtml=function(){return""};Shadow.prototype.getShadowOffset=function(){return{left:111,top:111}};Shadow.prototype.getShadowWidth=function(){return 111};Shadow.prototype.getTypeaheadValue=function(){return""};Shadow.prototype.getShadowHeight=function(){return 111};Shadow.prototype.isShadowResizable=function(){return!1};
Shadow.prototype.bindShadow=function(){return this};Shadow.prototype.toggleShadow=function(){};Shadow.prototype.setShadowHtml=function(a){return this};Shadow.prototype.onShadowEvent=function(){return this};Shadow.prototype.offShadowEvent=function(){return this};Shadow.prototype.triggerShadowEvent=function(a){return this};Shadow.prototype.getShadowPosition=function(){return{left:111,top:111}};Shadow.prototype.getShadowOuterHeight=function(){return 11};Shadow.prototype.getShadowOuterWidth=function(){return 11};
Shadow.prototype.getShadowCss=function(){return""};Shadow.prototype.setShadowCss=function(){return this};Shadow.prototype.clearHtml=function(){};Shadow.prototype.insertHtmlNode=function(){};Shadow.prototype.getShadowElement=function(){};Shadow.prototype.removeShadowAttr=function(a){return this};Shadow.prototype.setShadowAttr=function(a,b){return this};var BrowserShadow=function(a){Shadow.apply(this,arguments)};$jscomp.inherits(BrowserShadow,Shadow);
...
BrowserShadow.prototype.makeResizable=function(a){this._getJQ().resizable(a);return this};BrowserShadow.prototype.getShadowOffset=function(){return this._getJQ().offset()};BrowserShadow.prototype.removeShadow=function(){this._getJQ().remove();return this};BrowserShadow.prototype.getTypeaheadValue=function(){return this._getJQ().typeahead("val")};BrowserShadow.prototype.makeDraggable=function(a){this._getJQ().draggable(a);return this};BrowserShadow.prototype.getShadowCss=function(a){return this._getJQ().css(a)};
BrowserShadow.prototype.setShadowCss=function(a){this._getJQ().css(a);return this};BrowserShadow.prototype.focusShadow=function(){this._getJQ().focus();return this};BrowserShadow.prototype.makeTypeahead=function(a,b){this._getJQ().typeahead(a,b);return this};BrowserShadow.prototype.makeSelectable=function(a){this._getJQ().selectable(a);return this};BrowserShadow.prototype.bindShadow=function(a,b){this._getJQ().bind(a,b);return this};BrowserShadow.prototype.isShadowResizable=function(){return 0<this._getJQ().find(".ui-resizable-handle").length};
Shadow.BrowserShadow=BrowserShadow;window.Shadow=Shadow;var WillowContentNode=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(WillowContentNode,TreeNotation);WillowContentNode.prototype._toHtml=function(){return this.getBeamWithChildren()};var WillowAttributeNode=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(WillowAttributeNode,TreeNotation);WillowAttributeNode.prototype._toHtml=function(){return""};
WillowAttributeNode.prototype.getAttribute=function(){return" "+this.getBase()+'="'+this.getBeam()+'"'};var Stump=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(Stump,TreeNotation);Stump.prototype.getTag=function(){return this.getWord(1)};Stump.prototype.parseNodeType=function(a){return a.startsWith("@")?Stump:a.startsWith("content ")||"content"===a?WillowContentNode:WillowAttributeNode};Stump.prototype._childrenToHtml=function(a){return this.getChildren().map(function(b){return b._toHtml(a)}).join("")};
...
AbstractAppChisel.prototype.closeAllContextMenus=function(){this.getChildren().filter(function(a){return a instanceof AbstractContextMenuChisel}).forEach(function(a){return a.unmountAndDestroy()})};AbstractAppChisel.prototype.closeAllDropDownMenus=function(){this.getTopDownArray().forEach(function(a){a.getLine().includes("DropDownMenu")&&a.unmountAndDestroy()})};AbstractAppChisel.prototype.renderApp=function(){this.render(this.getWillowDocument().getBodyStump());return this};
...
AbstractAppChisel.prototype.appendBlockAndSelectCommand=function(a,b){var c=this._appendBlocks(a,b);c.forEach(function(a){return a.executeLoadNewBinder()});a=this.getMountedProgram();a.clearSelection();return a.autosaveAndRender().then(function(){c.forEach(function(a){return a.selectBlock()})})};AbstractAppChisel.prototype.insertMorphBlockCommand=function(){var a=this.getMountedProgram(),b=this.getDblClickEvent();this.getNodeCursors().forEach(function(c){c.append(">morph","pin "+a.makePin(b))});return a.autosaveAndRender()};
AbstractAppChisel.prototype.getNodeCursors=function(){var a=this.getMountedProgram().getSelectedBlocks();return a.length?a:[this.getMountedProgram()]};AbstractAppChisel.prototype.deleteAllCardsInTargetBlockCommand=function(){var a=this,b=this.getTargetNode().getInputBinder();return Promise.all(b.getCards().map(function(a){return a.destroyCardCommand()})).then(function(){a.renderApp()})};AbstractAppChisel.prototype.openOhayoProgramCommand=function(a){var b=this;return Promise.all(a.split(" ").map(function(a){return b._openOhayoProgramCommand(a)}))};
...
AbstractAppChisel.prototype.openManyPrompt=function(){var a=this;return this.prompt(Say($jscomp$templatelit$3),"").then(function(b){if(b)return a.openManyCommand(b)})};AbstractAppChisel.prototype.openManyCommand=function(a){var b=this,c=new RegExp(a,"i");return Promise.all(this.getLinks().map(function(a){a.link.match(c)&&b.openUrlInNewSpace(a.link)}))};AbstractAppChisel.prototype.openUrlInNewSpace=function(a){var b=this.getFocusedPanel().getOpenTabByUrl(a);return b?Promise.resolve(b):this.getFocusedPanel().openUrlInNewSpace(a)};
AbstractAppChisel.prototype.openUrlInNewSpaceAndFocus=function(a){var b=this;return this.openUrlInNewSpace(a).then(function(a){return b.getFocusedPanel().setMountedProgram(a)})};AbstractAppChisel.prototype.mountTabByIndexCommand=function(a){return this.getFocusedPanel().mountTabByIndex(a)};AbstractAppChisel.prototype.closeTabByIndexCommand=function(a){return this.getFocusedPanel().closeTabByIndex(a)};AbstractAppChisel.prototype.getFolder=function(){return""};
AbstractAppChisel.prototype.tabDidOpen=function(){};AbstractAppChisel.prototype.isAutoSaveEnabled=function(){return"false"!==this.getFromStore(StorageKeys.autoSave)};AbstractAppChisel.prototype.toggleAutoSaveCommand=function(){var a=!this.isAutoSaveEnabled();a?this.removeValue(StorageKeys.autoSave):this.storeValue(StorageKeys.autoSave,"false");this.logMessage(Say($jscomp$templatelit$4,a));return Promise.resolve()};
...
AbstractAppChisel.prototype.clearStore=function(){this.getStore().disabled||this.getStore().clearAll()};AbstractAppChisel.prototype._makeDocumentCopyableAndCuttable=function(){var a=this;a.getWillowDocument().setCopyHandler(function(b){return a.copySelectionCommand(b)}).setCutHandler(function(b){return a.cutSelectionCommand(b)})};AbstractAppChisel.prototype.copySelectionCommand=function(a){return this.getMountedProgram().copySelection(a)};AbstractAppChisel.prototype.cutSelectionCommand=function(a){return this.getMountedProgram().cutSelection(a)};
AbstractAppChisel.prototype._handleLinkClick=function(a,b){var c=a.getStumpAttr("href");if(c&&!a.getStumpAttr("target")){b.preventDefault();if(Util.isExternalLink(c,this.getWillowDocument().getHostname()))return this.openExternalLink(c),!1;"true"===a.getStumpAttr("data-focus")?this.openUrlInNewSpaceAndFocus(c):this.openUrlInNewSpace(c)}};AbstractAppChisel.prototype.saveProgramAndNotifyCommand=function(){var a=this,b=this.getMountedProgram();b.forceSaveToDisk().then(function(){a.renderApp()}).catch(function(a){b.handleProgramError(a)})};
...
b.preventDefault();b.stopPropagation();a.stumpHasClass("dragOver")||(a.insertChildNode("@ div\n id dragOverHelp\n content "+Say($jscomp$templatelit$9)),a.addClassToStump("dragOver"),setTimeout(function(){c.onShadowEvent(ShadowEvents.dragleave,e)},50))});c.onShadowEvent(ShadowEvents.drop,function(b){b.preventDefault();b.stopPropagation();a.removeClassFromStump("dragOver");a.findStumpByChild("id dragOverHelp").removeStump();f(b.originalEvent.dataTransfer.items,b.shiftKey)});c.onShadowEvent(ShadowEvents.dragenter,
...
AbstractAppChisel.prototype._makeWindowResizable=function(){var a=this;a.getWillowDocument().setResizeEndHandler(function(b){a.renderApp()})};AbstractAppChisel.prototype._makeWindowPastable=function(){var a=this,b=a.getWillowDocument();b.setPasteHandler(function(c){if(b.someInputHasFocus())return!0;c.clipboardData&&c.clipboardData.getData&&a.pasteCommand(c.clipboardData.getData("text/plain"))})};AbstractAppChisel.prototype.setContextMenuEvent=function(a){this._contextMenuEvent=a;return this};
AbstractAppChisel.prototype.setDblClickEvent=function(a){this._dblClickEvent=a;return this};AbstractAppChisel.prototype.getDblClickEvent=function(){return this._dblClickEvent};AbstractAppChisel.prototype.getContextMenuEvent=function(){return this._contextMenuEvent};
...
moment().format("MM/DD/YYYY")+" version "+a.getVersion()+". Run time: "+d;return a.createAndOpen(SpeedTestTemplate(d,b.toCsv()),"program-load-times")})};AbstractAppChisel.prototype.executeCommandOnFirstSelectedBlock=function(a,b,c){return this.getMountedProgram().getFirstSelectedBlock()[a](b,c)};AbstractAppChisel.prototype.toggleShadowById=function(a){this.getWillowDocument().findStumpByChild("id "+a).getShadow().toggleShadow()};AbstractAppChisel.prototype.getStumpString=function(){return this.getWillowDocument().getHtmlStump().toString()};
AbstractAppChisel.prototype._makeProgramLinksOpenImmediately=function(){var a=this,b=this.getWillowDocument();b.getBodyStump().getShadow().onShadowEvent(ShadowEvents.click,"a",function(c){a._handleLinkClick(b.getStumpFromElement(this),c)})};
AbstractAppChisel.prototype.executeStumpCommand=function(a,b){var c=a.getStumpChisel(),d=a.getShadow(),d=a.isStumpCheckbox()?d.isShadowChecked()?!0:!1:a.getStumpAttr("contenteditable")?d.getShadowHtml():d.getShadowValue()?d.getShadowValue():a.getStumpAttr("value");a=a.getStumpAttr("name");this.logCommand([b,d,a].filter(function(a){return a}).join(" "));this.closeAllContextMenus();this.closeAllDropDownMenus();var e=b.split(" ");b=e.shift();var e=e.shift(),f;"block"===b?f=c.getChildBlock():"context"===
...
AbstractProgramChisel.prototype.getDiskFolder=function(){var a=(this.isFolder()?this.getUrl():this.getFolder())||"/";return require("path").normalize(a.replace("file://",""))};AbstractProgramChisel.prototype.getFolder=function(){var a=this.getUrl().split("/");a.pop();return a.join("/")};AbstractProgramChisel.prototype.setLayout=function(a){this.touchNode("layout").setBeam(a);return this};
AbstractProgramChisel.prototype.cloneBlock=function(a){var b=a.duplicate();(a=a.findBeam("pin"))&&b.touchNode("pin").setBeam(this.getAvailableSpot(a));return b};AbstractProgramChisel.prototype.updateCustomPoint=function(){return this._updateCustomLayout()};AbstractProgramChisel.prototype.updateCustomPointWithWidthAndHeight=function(){return this._updateCustomLayout(!0)};
AbstractProgramChisel.prototype._updateCustomLayout=function(a){a=void 0===a?!1:a;var b=this,c=this.getApp();c.getWillowDocument().findStumpsWithClass("BlockChisel").forEach(function(c){return b._updateBlockLayout(c,a)});this.setLayout("custom");this.autosaveProgram();c.renderApp()};
AbstractProgramChisel.prototype._updateBlockLayout=function(a,b){var c=a.getShadow(),d=a.getStumpChisel(),e=c.getShadowOffset(),f=this.getGridSize();a=a.getParent().getShadow().getShadowOffset();c=[Math.floor((e.left-a.left)/f),Math.floor((e.top-a.top)/f),Math.floor(c.getShadowWidth()/f),Math.floor(c.getShadowHeight()/f)];b=b?c:c.slice(0,2);d.delete("pin");d.prepend("pin "+b.join(" "))};
AbstractProgramChisel.prototype.getAvailableSpot=function(a){a=a.split(" ").map(function(a){return parseInt(a)});a[0]++;a[1]++;return a.join(" ")};AbstractProgramChisel.prototype.toggleLayout=function(){var a=this.toggle("layout",["custom","bin","tree"]);this.getDescendantBlocks().forEach(function(a){return a.makeDirty()});this.getApp().logMessage(Say($jscomp$templatelit$12,a));return this.autosaveAndRender()};AbstractProgramChisel.prototype.getGridSize=function(){return 20};
...
AbstractProgramChisel.prototype._getSelectedBlockStumps=function(){return this.getApp().getWillowDocument().findStumpsWithClass("ui-selected")};AbstractProgramChisel.prototype.updateSelectedOnMove=function(a,b){var c=this._getSelectedBlockStumps();c.length&&c.filter(function(b){return b!==a}).forEach(function(a){var c=parseFloat(a.getStumpCss("top")),d=parseFloat(a.getStumpCss("left"));a.setStumpCss({transform:"",top:c+b.top+"px",left:d+b.left+"px"})})};
...
ProgramsBlock.loadCode=AbstractProviderBlock.loadCode;ProgramsBlock.prototype.getCardClass=function(){return OhayoProgramCard};ProgramsBlock.prototype.fetchCards=function(){return Promise.resolve(this.getApp().getLinks())};window.ProgramsBlock=ProgramsBlock;var QueryBlock=function(a){return AbstractUrlProvider.apply(this,arguments)||this};$jscomp.inherits(QueryBlock,AbstractUrlProvider);QueryBlock._mountedComponents=AbstractUrlProvider._mountedComponents;QueryBlock.loadCode=AbstractUrlProvider.loadCode;
QueryBlock.prototype.getUrl=function(){return"/sql?q="+this.getStruct().query};QueryBlock.prototype.getBlockContentBray=function(){return"@ textarea\n data-onChangeCommand chisel changePropertyCommand\n name query\n class BlockTextArea\n content "+Util.indent(Strip($jscomp$templatelit$16,this.getStruct().query))};window.QueryBlock=QueryBlock;var RedditBlock=function(a){return AbstractUrlProvider.apply(this,arguments)||this};$jscomp.inherits(RedditBlock,AbstractUrlProvider);
RedditBlock._mountedComponents=AbstractUrlProvider._mountedComponents;RedditBlock.loadCode=AbstractUrlProvider.loadCode;RedditBlock.prototype.getUrl=function(){var a=this.getStruct();return"https://www.reddit.com/"+((a.subreddit?"/r/"+a.subreddit+"/top/.json?sort=top&t=all":"")||a.get)};RedditBlock.prototype.fetchCards=function(){return AbstractUrlProvider.prototype.fetchCards.call(this).then(function(a){return a.length?a[0].data.children.map(function(a){return a.data}):[]})};window.RedditBlock=RedditBlock;
var StoreBlock=function(a){return DataBlock.apply(this,arguments)||this};$jscomp.inherits(StoreBlock,DataBlock);StoreBlock._mountedComponents=DataBlock._mountedComponents;StoreBlock.loadCode=DataBlock.loadCode;StoreBlock.prototype.getDataContent=function(){return this.getApp().getStore().get(this._getKey())||""};StoreBlock.prototype._getKey=function(){return this.getStruct().key||this.getProgram().getUrl()};
StoreBlock.prototype._saveDataCommand=function(a){this.getApp().getStore().set(this._getKey(),a)};window.StoreBlock=StoreBlock;var TopBlock=function(a){return AbstractUrlProvider.apply(this,arguments)||this};$jscomp.inherits(TopBlock,AbstractUrlProvider);TopBlock._mountedComponents=AbstractUrlProvider._mountedComponents;TopBlock.loadCode=AbstractUrlProvider.loadCode;TopBlock.prototype.getUrl=function(){this.getStruct();return"/samples/presidents.csv"};window.TopBlock=TopBlock;
var AbstractExtendBlock=function(a){return AbstractTransformerBlock.apply(this,arguments)||this};$jscomp.inherits(AbstractExtendBlock,AbstractTransformerBlock);AbstractExtendBlock._mountedComponents=AbstractTransformerBlock._mountedComponents;AbstractExtendBlock.loadCode=AbstractTransformerBlock.loadCode;AbstractExtendBlock.prototype.getBlockClassColumns=function(){return this.getStructColumns().filter(function(a){return!!a.source})};
...
AbstractDropDownMenuChisel.prototype.componentDidMount=function(){var a=this.getApp(),b=a.getWillowDocument().getBodyStump().getShadow(),c=function(){b.offShadowEvent(ShadowEvents.click,c);a.closeAllDropDownMenus()};setTimeout(function(){return b.onShadowEvent(ShadowEvents.click,c)},100)};
...
OpenDropDownMenuChisel._mountedComponents=AbstractDropDownMenuChisel._mountedComponents;OpenDropDownMenuChisel.prototype.getDropDownBray=function(){return this.getApp().getLinks().map(function(a){return"@ a\n data-focus true\n href "+a.link+"\n @ span\n  content "+Format.stripHtml(a.link)}).join("\n")};OpenDropDownMenuChisel.prototype.getAnchorId=function(){return"openToggle"};window.OpenDropDownMenuChisel=OpenDropDownMenuChisel;var PanelChisel=function(a){return Chisel.apply(this,arguments)||this};
$jscomp.inherits(PanelChisel,Chisel);PanelChisel._mountedComponents=Chisel._mountedComponents;PanelChisel.prototype.parseNodeType=function(a){var b=this.getApp(),c=a.split(" ")[0];return"program"===c?b.getProgramClass(Util.getFileExtension(a)):{programs:ProgramSwitcherChisel,search:SearchChisel,sourceGutter:SourceGutter}[c]};
...
CustomConfirmModal.prototype.getModalBray=function(){return"@ h4\n content "+this.getBeam()+"\n@ button\n value 0\n data-onClickCommand chisel _resolveCommand\n content "+Say($jscomp$templatelit$21)+"\n@ button\n value 1\n data-onClickCommand chisel _resolveCommand\n content "+Say($jscomp$templatelit$22)};CustomConfirmModal.prototype._resolveCommand=function(a){this.resolve("1"===a);this.getApp().closeModal();return Promise.resolve()};
...
FlowProgram.prototype.buildProgram=function(){return this.getDescendantBlocks().filter(function(a){return!(a instanceof ParserETN.BlockPropertyNode)}).map(function(a){return a.getBlockContentBray()}).join("\n")};FlowProgram.prototype.getCatchAllBlockClass=function(a,b,c,d){a=a.getDidYouMeanBlock().getJSClass(d);return c.startsWith(">")?a:ParserETN.BlockPropertyNode};window.FlowProgram=FlowProgram;
var FlowCodeEditorTemplate=function(a,b){return">editor\n format text\n etn "+b+"\n content "+Util.indent(a,2)+"\n >3d\n >outline\n >types\n  >pre\n   >wc\n    >wordcloud\nlayout bin"};window.FlowCodeEditorTemplate=FlowCodeEditorTemplate;var SpeedTestTemplate=function(a,b){return">data\n pin 45 32 17 5\n content "+b.replace(/\n/g,"\n  ")+"\n columns\n  timeToLoad\n   type number\n  timeToRender\n   type number\n >text\n  content "+a+"\n  pin 45 0 23 3\n >table\n  link url\n  title Slow Load Times\n  x timeToLoad\n  y timeToRender\n  orderBy -timeToLoad\n  pin 0 0 43 18\n >table\n  link url\n  title Slow Render Times\n  x timeToLoad\n  y timeToRender\n  orderBy -timeToRender\n  pin 0 20 41 17\n >kpi\n  pin 45 4 11 7\n  column timeToLoad\n  reduction average\n >kpi\n  pin 45 15 11 7\n  column timeToRender\n  reduction average\n >kpi\n  pin 45 24 11 7\n  column timeToRender\n  reduction median\n >kpi\n  pin 57 4 11 7\n  column timeToLoad\n  reduction sum\n >kpi\n  pin 57 15 11 7\n  column timeToRender\n  reduction sum\n >kpi\n  pin 57 24 11 7\n  column timeToRender\n  reduction count"};
...
OhayoApp.prototype.getLinks=function(){return this.getStoreKeys().filter(function(a){return!StorageKeys.isKey(a)}).map(function(a){return{link:a,title:a}})};OhayoApp.prototype.getProgramToOpen=function(){return this.getFromStore(StorageKeys.mountedProgram)};OhayoApp.prototype.doesFileExistSync=function(a){return void 0!==this.getFromStore(a)};OhayoApp.prototype.deleteFileCommand=function(a){this.removeValue(a);return Promise.resolve()};
