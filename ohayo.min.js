...
function(){return this};return e}())};window.TileCommander=TileCommander;var HakonPropertyNode=function(a){return jtree.TreeNode.apply(this,arguments)||this};$jscomp.inherits(HakonPropertyNode,jtree.TreeNode);HakonPropertyNode.prototype.toCss=function(a){return""+a+this.getKeyword()+": "+this.getBeam()+";"};var HakonSelectorNode=function(a){return jtree.TreeNode.apply(this,arguments)||this};$jscomp.inherits(HakonSelectorNode,jtree.TreeNode);
...
AbstractTileChisel.prototype.getTileToolbarButtonBray=function(){return"@span "+Icons("pencil",16)+"\n class TilePencilButton\n data-onClickCommand chisel toggleToolbarCommand"};AbstractTileChisel.prototype.getSvg=function(){return this.getDefinition().getConstantsObject()[TileConstants.tileSvg]||"table"};
...
var TileProcess=function(a){return jtree.TreeNode.apply(this,arguments)||this};$jscomp.inherits(TileProcess,jtree.TreeNode);TileProcess.prototype.parseNodeType=function(a){var b=a.split(" ")[0],c=this.getProcessGrammarProgram();return c.getRunTimeKeywordMap()[b]?TileGrammar.getDefinitionTileClass(c.getDefinitionByName(b)):this.getCatchAllNodeClass(a)};TileProcess.prototype.getCatchAllNodeClass=function(){return DidYouMeanTile};TileProcess.prototype.getProcessGrammarProgram=function(){return this.getTab().getTabGrammarProgram()};
...
OhayoAppChisel.prototype.getGrammars=function(){if(!this._grammars){this._grammars={};var a=this._getGrammarProgramClass(),b=(new jtree.TreeNode(FlowGrammar)).getExpanded(1,2);b=new a(b);var c=(new jtree.TreeNode(fireGrammar)).getExpanded(1,2);a=new a(c,"/aientist/client/fire/fire.grammar");this._registerGrammar("flow",b);this._registerGrammar("fire",a)}return this._grammars};OhayoAppChisel.prototype.getTargetNode=function(){return this._targetNode};
OhayoAppChisel.prototype.setTargetNode=function(a){this._targetNode=a;return this};OhayoAppChisel.prototype.getWillowProgram=function(){this._willowBrowser||(this._willowBrowser="undefined"===typeof jQuery?new WillowProgram("http://localhost:8000/"):new WillowBrowserProgram(""));return this._willowBrowser};OhayoAppChisel.prototype.getVersion=function(){return Version};OhayoAppChisel.prototype._startVisitCounter=function(){var a=this._getVisitCount();a++;this.setVisitCount(a)};
OhayoAppChisel.prototype.setVisitCount=function(a){this.storeValue(StorageKeys.visitCount,a)};OhayoAppChisel.prototype.getTerminalCode=function(){return this.getNode("panel gutter terminal").getCode()};OhayoAppChisel.prototype._getVisitCount=function(){var a=this.getFromStore(StorageKeys.visitCount);return a?parseInt(a):0};OhayoAppChisel.prototype.getTileCache=function(){this._cache_tiles||(this._cache_tiles={});return this._cache_tiles};
