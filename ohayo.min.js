...
TileProcess.prototype.run=function(){var a=this,b=this.getApp(),c=lodash.uniq(this.getTopDownArray().filter(function(a){return a instanceof AbstractTileChisel}).map(function(a){return a.getBase()}));return Promise.all(c.map(function(c){return a._loadTileCode(c,b)})).then(function(){return Promise.all(a.getProcessRootTiles().map(function(a){return a.runTile()})).then(function(){return a})})};TileProcess.prototype.getTileProcess=function(){return this};TileProcess.prototype.getSelectedTiles=function(){return this.getProcessTiles().filter(function(a){return a.isSelected()})};
...
Binder.prototype.getFirstColumnAsString=function(){return this.getCards().map(function(a){return a.getFirstCell()}).join("")};Binder.prototype._getColumnTextVector=function(a){return this.getCards().map(function(b){return b.getCardValue(a)})};Binder.prototype.getColumnNumericVector=function(a){return this.getCards().map(function(b){return b.getCardNumeric()[a]})};
...
BasicTerminalChisel.prototype._makeProgram=function(a){var b=new TreeProgram(this._getCode()),c=this._getProgram().constructor;a=b.getTopDownArray()[a];return new c(a.toString())};BasicTerminalChisel.prototype._updateConsole=function(){this.getParent().getChildren()[1].render()};
BasicTerminalChisel.prototype.getDependencyTimestamps=function(){var a=this.getParent().getGutterDependencies(),b=this._getTab();(b=b&&b.getTabProcess())&&this._getProgramSource()!==this._getCode()&&a.push(b.getTreeMTime());a.push(this.getParent().getParent().getMTime());return a};BasicTerminalChisel.prototype.updateHtml=function(){};BasicTerminalChisel.prototype._getCode=function(){return""};
BasicTerminalChisel.prototype.hasChanges=function(){var a=this._getProgram();return a&&this._getCode()!==a.childrenToString()};BasicTerminalChisel.prototype.hasFocus=function(){return!1};BasicTerminalChisel.prototype._makeFullProgram=function(){var a=this._getCode();return new (this._getProgram().constructor)(a,void 0,this.getApp())};window.BasicTerminalChisel=BasicTerminalChisel;var CodeMirrorTerminalChisel=function(a){return BasicTerminalChisel.apply(this,arguments)||this};
$jscomp.inherits(CodeMirrorTerminalChisel,BasicTerminalChisel);CodeMirrorTerminalChisel._mountedChisels=BasicTerminalChisel._mountedChisels;CodeMirrorTerminalChisel.prototype._getCode=function(){return this._getCodeMirror().getValue()};CodeMirrorTerminalChisel.prototype._getCodeMirror=function(){return this._codeMirror};CodeMirrorTerminalChisel.prototype.hasFocus=function(){var a=this._getCodeMirror();return a&&a.hasFocus()};
...
OhayoAppChisel.prototype.getETNs=function(){this._etns||(this._etns={},this.registerETN("flow",FlowProgram),this.registerETN("fire",FireProgram),this.registerETN("turtle",TurtleProgram));return this._etns};OhayoAppChisel.prototype.getTargetNode=function(){return this._targetNode};OhayoAppChisel.prototype.setTargetNode=function(a){this._targetNode=a;return this};
...
TabChisel.prototype.getTabProcess=function(){return this._tileProcess};TabChisel.prototype.getTabProgram=function(){return this._program};TabChisel.prototype.getTabWall=function(){return this.getParent().getNode("wall")};
...
WallChisel.prototype._resizeTiles=function(a){var b=this,c=this._getSelectedTileStumps();1<c.length?c.forEach(function(a){return b._resizeStump(a)}):this._resizeStump(a);app.getMountedTab().getCommander().setTabLayoutToCustomCommand()};WallChisel.prototype._resizeStump=function(a){var b=a.getStumpChisel();a=a.getShadow();var c=this.getGridSize(),b=b.getCommander();a=a.getPositionAndDimensions(c);b.changeDetailCommand(TileConstants.width,a.width);b.changeDetailCommand(TileConstants.height,a.height)};
WallChisel.prototype._moveStump=function(a){var b=a.getStumpChisel();a=a.getShadow();var c=this.getGridSize();a=a.getPositionAndDimensions(c);b.getCommander().changeDetailCommand(TileConstants.left,a.left);b.getCommander().changeDetailCommand(TileConstants.top,a.top)};WallChisel.prototype.getGridSize=function(){return 20};WallChisel.prototype.chiselDidUpdate=function(){this._fixLargeBug()};
...
"px","min-width":a+"px"};d.setStumpCss(f);c.setStumpCss(f)};WallChisel.prototype.chiselDidMount=function(){this._makeSelectable();this._makeTilesMoveableAndResizableAndEditable();this._fixLargeBug()};WallChisel.prototype._tileMouseOverHandler=function(a){var b=a.getShadow();b.isShadowResizable()||this._makeShadowResizable(b);b.isShadowDraggable()||this._makeGroupDraggable(a)};
WallChisel.prototype._makeShadowResizable=function(a){var b=this.getGridSize(),c=this,d=this.getApp().getWillowProgram();a.makeResizable({handles:"se",grid:b,resize:function(a){a.stopPropagation();a.preventDefault();return!1},stop:function(a){return c._resizeTiles(d.getStumpFromElement(a.target))}})};
WallChisel.prototype._makeTilesMoveableAndResizableAndEditable=function(){var a=this.getApp(),b=this;this.getStump().getShadow().onShadowEvent(WillowShadowEvents.mouseover,".TileChisel",function(){var c=a.getWillowProgram().getStumpFromElement(this);b._tileMouseOverHandler(c)})};WallChisel.prototype.getBray=function(){return"@div\n class WallChisel\n data-onContextMenuCommand chisel openWallContextMenuCommand\n data-onDblClickCommand app insertMorphTileCommand"};
WallChisel.prototype._getSelectedTileStumps=function(){return this.getApp().getWillowProgram().findStumpsWithClass("ui-selected")};WallChisel.prototype._updateSelectedOnMove=function(a,b){this._getSelectedTileStumps().filter(function(b){return b!==a}).forEach(function(a){var c=parseFloat(a.getStumpCss("top")),e=parseFloat(a.getStumpCss("left"));a.setStumpCss({transform:"",top:c+b.top+"px",left:e+b.left+"px"})})};
...
AppCommander.prototype.moveTilesFromShadowsCommand=function(){var a=this.getTarget(),b=a.getAppWall();a.getWillowProgram().findStumpsWithClass("TileChisel").filter(function(a){return a.getStumpChisel().isVisible()}).forEach(function(a){return b._moveStump(a)});return a.getMountedTab().getCommander().setTabLayoutToCustomCommand()};
AppCommander.prototype.printProcessStatsCommand=function(){var a=this.getTarget(),b=a.getMountedTab(),c=(new TreeProgram(a.getMountedProcess().getProcessStats())).toString();b.logMessageText(c);a.renderApp();return Promise.resolve()};AppCommander.prototype.createProgramFromFileCommand=function(a,b){var c=this.getTarget(),d=Util.getFileExtension(a);if(c.getETNs()[d])return c._createAndOpen(b,a);b=(d=FlowTemplates[d])?d(a,b):">text No visualization templates for "+a;return c._createAndOpen(b,a+".flow")};
...
AppCommander.prototype.openDeleteAllTabsPromptCommand=function(){var a=this,b=this.getTarget(),c=b.getFocusedPanel().getTabs();return b.getWillowProgram().confirmThen("Are you sure you want to delete "+c.length+" open programs?").then(function(b){return b?Promise.all(c.map(function(b){return a.deleteFileCommand(b.getFileName())})):Promise.resolve(!1)})};AppCommander.prototype.toggleAndRenderNewDropDownCommand=function(){this.getTarget().getNode("menu").toggleAndRender("newDropDownMenu");return Promise.resolve()};
...
AppCommander.prototype.insertMorphTileCommand=function(){var a=this.getTarget(),b=a.getMountedTab(),c=a.getMouseEvent(),d=this._getMorphBlock(c);a.getNodeCursors().forEach(function(a){return a.append(">morph",d)});return b.autosaveAndRender()};AppCommander.prototype._getMorphBlock=function(a){return TileConstants.left+" "+Math.floor((a.offsetX-0)/20)+"\n"+TileConstants.top+" "+Math.floor(a.offsetY/20)};
AppCommander.prototype.appendTileCommand=function(a,b){var c=this.getTarget();c._appendTiles(a,b).forEach(function(a){return a.runTile()});return c.getMountedTab().autosaveAndRender()};AppCommander.prototype.deleteAllCardsInTargetTileCommand=function(){var a=this.getTarget(),b=a.getTargetNode().getInputBinder();return Promise.all(b.getCards().map(function(a){return a.destroyCard()})).then(function(){a.renderApp()})};
AppCommander.prototype.openOhayoProgramCommand=function(a){var b=this.getTarget();return Promise.all(a.split(" ").map(function(a){return b._openOhayoProgram(a)}))};AppCommander.prototype.deleteFileCommand=function(a){this.getTarget().removeValue(a);return Promise.resolve()};AppCommander.prototype.renameFileCommand=function(a,b){var c=this.getTarget();c.storeValue(b,c.getFromStore(a)||"");c.removeValue(a);return Promise.resolve(b)};
...
ChiselCommander.prototype.unmountAndDestroyCommand=function(){this.getTarget().unmountAndDestroy();return Promise.resolve()};window.ChiselCommander=ChiselCommander;var TabCommander=function(a){ChiselCommander.apply(this,arguments)};$jscomp.inherits(TabCommander,ChiselCommander);TabCommander.prototype.setTabLayoutToCustomCommand=function(){var a=this.getTarget();a.getTabProcess().setLayout("custom");return a.autosaveAndRender()};window.TabCommander=TabCommander;
var TerminalCommander=function(a){AbstractCommander.apply(this,arguments)};$jscomp.inherits(TerminalCommander,AbstractCommander);TerminalCommander.prototype.saveChangesCommand=function(){var a=this.getTarget();if(a.hasChanges())return a._getTab().autosaveAndReloadWith(a._getCode())};TerminalCommander.prototype.executeLineCommand=function(a){var b=this.getTarget();return b._makeProgram(a).execute(b.getApp()).then(function(a){b._getTab().logMessageText(a.join("\n"));b._updateConsole()})};
...
$jscomp.inherits(WallCommander,AbstractCommander);WallCommander.prototype.openWallContextMenuCommand=function(){return this.getTarget().getApp().toggleAndRender("tabContextMenu")};window.WallCommander=WallCommander;var AbstractContextMenuChisel=function(a){return AbstractChisel.apply(this,arguments)||this};$jscomp.inherits(AbstractContextMenuChisel,AbstractChisel);AbstractContextMenuChisel._mountedChisels=AbstractChisel._mountedChisels;
...
DataTile.prototype.createCards=function(a){var b=this.getStruct().format,c=this.getDataSlang(),c=(new CardParser).parse(c,b);a=lodash.concat(c,a);b=this._getFormatted(a,b);return this.getCommander().updateSlangCommand(b)};window.DataTile=DataTile;var OhayoProgramCard=function(a){ObjectBackedCard.apply(this,arguments)};$jscomp.inherits(OhayoProgramCard,ObjectBackedCard);OhayoProgramCard._uniqueId=ObjectBackedCard._uniqueId;OhayoProgramCard.prototype.destroyCard=function(){return this.getCardApp().deleteFileCommand(this.getCardValue("link"))};
var ProgramsTile=function(a){return AbstractProviderTile.apply(this,arguments)||this};$jscomp.inherits(ProgramsTile,AbstractProviderTile);ProgramsTile._mountedChisels=AbstractProviderTile._mountedChisels;ProgramsTile.loadCode=AbstractProviderTile.loadCode;ProgramsTile.prototype.getCardClass=function(){return OhayoProgramCard};ProgramsTile.prototype.fetchCards=function(){return Promise.resolve(this.getApp().getCaddies().map(function(a){return a.toCaddyObject()}))};window.ProgramsTile=ProgramsTile;
var QueryTile=function(a){return AbstractUrlProvider.apply(this,arguments)||this};$jscomp.inherits(QueryTile,AbstractUrlProvider);QueryTile._mountedChisels=AbstractUrlProvider._mountedChisels;QueryTile.loadCode=AbstractUrlProvider.loadCode;QueryTile.prototype.getUrl=function(){return"/sql?q="+this.getStruct().query};QueryTile.prototype.getTileBodyBray=function(){return"@textarea\n data-onChangeCommand chisel changeDetailAndRenderCommand\n name query\n class TileTextArea\n bern"+TreeProgram.nest(Format.stripHtml(this.getStruct().query))};
window.QueryTile=QueryTile;var RedditTile=function(a){return AbstractUrlProvider.apply(this,arguments)||this};$jscomp.inherits(RedditTile,AbstractUrlProvider);RedditTile._mountedChisels=AbstractUrlProvider._mountedChisels;RedditTile.loadCode=AbstractUrlProvider.loadCode;RedditTile.prototype.getUrl=function(){var a=this.getStruct();return"https://www.reddit.com/"+((a.subreddit?"/r/"+a.subreddit+"/top/.json?sort=top&t=all":"")||a.get)};
RedditTile.prototype.fetchCards=function(){return AbstractUrlProvider.prototype.fetchCards.call(this).then(function(a){return a.length?a[0].data.children.map(function(a){return a.data}):[]})};window.RedditTile=RedditTile;var TextTile=function(a){return AbstractProviderTile.apply(this,arguments)||this};$jscomp.inherits(TextTile,AbstractProviderTile);TextTile._mountedChisels=AbstractProviderTile._mountedChisels;TextTile.loadCode=AbstractProviderTile.loadCode;TextTile.prototype.fetchCards=function(){return Promise.resolve([{text:this.getStruct().slang}])};
TextTile.prototype.isVisible=function(){return!0};window.TextTile=TextTile;var TopTile=function(a){return AbstractUrlProvider.apply(this,arguments)||this};$jscomp.inherits(TopTile,AbstractUrlProvider);TopTile._mountedChisels=AbstractUrlProvider._mountedChisels;TopTile.loadCode=AbstractUrlProvider.loadCode;TopTile.prototype.getUrl=function(){this.getStruct();return"/samples/presidents.csv"};window.TopTile=TopTile;
