var $jscomp$templatelit$23=["Adding..."];$jscomp$templatelit$23.raw=["Adding..."];var $jscomp$templatelit$22=["Keyboard Shortcuts"];$jscomp$templatelit$22.raw=["Keyboard Shortcuts"];var $jscomp$templatelit$21=["ohayo"];$jscomp$templatelit$21.raw=["ohayo"];var $jscomp$templatelit$20=["Ok"];$jscomp$templatelit$20.raw=["Ok"];var $jscomp$templatelit$19=["Cancel"];$jscomp$templatelit$19.raw=["Cancel"];var $jscomp$templatelit$18=["Delete card"];$jscomp$templatelit$18.raw=["Delete card"];
var $jscomp$templatelit$17=["",""];$jscomp$templatelit$17.raw=["",""];var $jscomp$templatelit$16=["Click to sort."];$jscomp$templatelit$16.raw=["Click to sort."];var $jscomp$templatelit$15=["",""];$jscomp$templatelit$15.raw=["",""];var $jscomp$templatelit$14=["",""];$jscomp$templatelit$14.raw=["",""];var $jscomp$templatelit$13=["Layout set to '","'"];$jscomp$templatelit$13.raw=["Layout set to '","'"];var $jscomp$templatelit$12=["Items cut"];$jscomp$templatelit$12.raw=["Items cut"];
var $jscomp$templatelit$11=["Items copied"];$jscomp$templatelit$11.raw=["Items copied"];var $jscomp$templatelit$10=["Drop to create a new program. Hold shift key to insert cards into current program."];$jscomp$templatelit$10.raw=["Drop to create a new program. Hold shift key to insert cards into current program."];var $jscomp$templatelit$9=["Created '","'"];$jscomp$templatelit$9.raw=["Created '","'"];var $jscomp$templatelit$8=["Created '","'"];$jscomp$templatelit$8.raw=["Created '","'"];
var $jscomp$templatelit$7=["Are you sure you want to delete "," programs?"];$jscomp$templatelit$7.raw=["Are you sure you want to delete "," programs?"];var $jscomp$templatelit$6=["Are you sure you want to delete ","?"];$jscomp$templatelit$6.raw=["Are you sure you want to delete ","?"];var $jscomp$templatelit$5=["Switched to "," theme"];$jscomp$templatelit$5.raw=["Switched to "," theme"];var $jscomp$templatelit$4=["Autosave is ",""];$jscomp$templatelit$4.raw=["Autosave is ",""];
var $jscomp$templatelit$3=["Enter a regex to open multiple matching files"];$jscomp$templatelit$3.raw=["Enter a regex to open multiple matching files"];var $jscomp$templatelit$2=["Enter a url to open"];$jscomp$templatelit$2.raw=["Enter a url to open"];var $jscomp$templatelit$1=["Created '","'"];$jscomp$templatelit$1.raw=["Created '","'"];var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;
...
$jscomp.arrayIterator=function(a){var b=0;return $jscomp.iteratorPrototype(function(){return b<a.length?{done:!1,value:a[b++]}:{done:!0}})};$jscomp.iteratorPrototype=function(a){$jscomp.initSymbolIterator();a={next:a};a[$jscomp.global.Symbol.iterator]=function(){return this};return a};$jscomp.makeIterator=function(a){$jscomp.initSymbolIterator();$jscomp.initSymbol();$jscomp.initSymbolIterator();var b=a[Symbol.iterator];return b?b.call(a):$jscomp.arrayIterator(a)};
...
window.CardStringSpecimen=CardStringSpecimen;var Chisel=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(Chisel,TreeNotation);Chisel.prototype.getApp=function(){return this.getRootNode()};Chisel.prototype.getStump=function(){return this._htmlStump};Chisel.prototype._stopPropagationCommand=function(){};Chisel.prototype.isNode=function(){return"undefined"!==typeof exports};Chisel.prototype.getHakon=function(){return""};Chisel.prototype.getTheme=function(){return this.getApp().getTheme()};
Chisel.prototype.getCommandsBuffer=function(){this._commandsBuffer||(this._commandsBuffer=[]);return this._commandsBuffer};Chisel.prototype.logCommand=function(a){this.getCommandsBuffer().push({command:a,time:this._getNow()})};Chisel.prototype.getMessageBuffer=function(){this._messageBuffer||(this._messageBuffer=new TreeNotation);return this._messageBuffer};Chisel.prototype.clearCommand=function(){delete this._messageBuffer;return Promise.resolve()};
Chisel.prototype.logMessage=function(a){this.getMessageBuffer().append("message",a)};Chisel.prototype.unmount=function(){this.isMounted()&&(this._getChildChisels().forEach(function(a){return a.unmount()}),this.componentWillUnmount(),this._removeCss(),this._removeHtml(),delete this._lastRenderedTime,this.componentDidUnmount())};Chisel.prototype._removeCss=function(){this._cssStump.removeStump();delete this._cssStump};Chisel.prototype._removeHtml=function(){this._htmlStump.removeStump();delete this._htmlStump};
Chisel.prototype._confirmAndUnmountCommand=function(){var a=this;return(this.hasChanges()?this.getApp().confirm("Drop changes?"):Promise.resolve(!0)).then(function(b){if(!b)return!1;b=a.getApp();a.unmountAndDestroy();b.renderApp()})};Chisel.prototype.getBray=function(){return"@ div\n class "+this.constructor.name};Chisel.prototype.componentWillMount=function(){};Chisel.prototype.componentDidMount=function(){void 0===Chisel._mountedComponents&&(Chisel._mountedComponents=0);Chisel._mountedComponents++};
Chisel.prototype.componentDidUnmount=function(){Chisel._mountedComponents--};Chisel.prototype.componentWillUnmount=function(){};Chisel.prototype.forceUpdate=function(){};Chisel.prototype.getNewestTimeToRender=function(){return this._lastTimeToRender};Chisel.prototype._setLastRenderedTime=function(a){this._lastRenderedTime=a;return this};Chisel.prototype.componentDidUpdate=function(){};Chisel.prototype._getChildChisels=function(){return this.getChildren().filter(function(a){return a instanceof Chisel})};
...
Chisel.prototype.getLastRenderedTime=function(){return this._lastRenderedTime};Chisel.prototype.makeDirty=function(){this._setLastRenderedTime(0)};Chisel.prototype._getCss=function(){return this.getTheme().hakonToCss(this.getHakon())};Chisel.prototype._getCssBray=function(){return"@ style\n styleFor "+this.constructor.name+"\n bern"+TreeNotation.nest(this._getCss(),2)};
Chisel.prototype._update=function(){if(!this._shouldComponentUpdate())return!1;this._setLastRenderedTime(this._getNow());this._removeCss();this._mountCss();if(this.hasChildren())return!1;this.updateHtml();this._lastTimeToRender=this._getNow()-this.getLastRenderedTime();return!0};Chisel.prototype._mountCss=function(a){this._cssStump=this.getApp().getWillowDocument().getHeadStump().insertChildNode(this._getCssBray())};
Chisel.prototype._mountHtml=function(a,b){this._htmlStump=a.insertChildNode(this.getBray(),b);this._htmlStump.setStumpChisel(this)};Chisel.prototype.updateHtml=function(){var a=this._htmlStump.getParent(),b=this._htmlStump.getIndex();this._removeHtml();this._mountHtml(a,b)};
Chisel.prototype._mount=function(a,b){if(!this.shouldComponentMount())return this;this._setLastRenderedTime(this._getNow());this.componentWillMount();this.getApp().getWillowDocument();this._mountCss(a);this._mountHtml(a,b);this._lastTimeToRender=this._getNow()-this.getLastRenderedTime();return this};Chisel.prototype.unmountAndDestroy=function(){this.unmount();return this.destroy()};
...
Chisel.prototype.toggleAndRender=function(a,b){this.toggle(a,b);this.getApp().renderApp();return Promise.resolve()};Chisel.prototype.appendAndRender=function(a,b){this.append(a,b);this.getApp().renderApp();return Promise.resolve()};Chisel.prototype.swapAndRender=function(a,b){var c=this.has(a)?b:a;a=this.has(a)?a:b;a=this.getNode(a);b=a.getIndex();this.insert(c,void 0,b);a.unmountAndDestroy();this.getApp().renderApp();return Promise.resolve()};
Chisel.prototype._shouldComponentUpdate=function(){var a=this.getLastRenderedTime();return!a||a<this.getMTime()?!0:this.getDependencyTimestamps().some(function(b){return b>a})};Chisel.prototype.getDependencyTimestamps=function(){return[]};Chisel.prototype.shouldComponentMount=function(){return!0};Chisel.prototype.render=function(a,b){var c=this.isMounted(),d=!1;c?d=this._update():this._mount(a,b);this.isMounted()&&this._renderChildren();c?d&&this.componentDidUpdate():this.componentDidMount();return this};
...
var CompileTimeError=function(a){var b=Error.apply(this,arguments);this.message=b.message;"stack"in b&&(this.stack=b.stack)};$jscomp.inherits(CompileTimeError,Error);var CrystalProgram=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(CrystalProgram,TreeNotation);CrystalProgram.prototype.parseNodeType=function(a){return CrystalCommandNode};CrystalProgram.prototype.execute=function(a){return Promise.all(this.getChildren().map(function(b){return b.execute(a)}))};
var CrystalArgNode=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(CrystalArgNode,TreeNotation);var CrystalCommandNode=function(a){return CrystalProgram.apply(this,arguments)||this};$jscomp.inherits(CrystalCommandNode,CrystalProgram);CrystalCommandNode.prototype.parseNodeType=function(a){return a.startsWith("%%")?CrystalArgNode:CrystalProgram.prototype.parseNodeType.call(this,a)};
CrystalCommandNode.prototype.getArgs=function(){var a=this.getChildren().filter(function(a){return a instanceof CrystalArgNode}).map(function(a){return a.getBeamWithChildren()}),b=this.getWord(0)+"Command",a=a.length?a:this.getWords(1);a.unshift(b);return a};CrystalCommandNode.prototype.execute=function(a){var b=this;return a.executeCommandLine(this.getArgs()).then(function(){return CrystalProgram.prototype.execute.call(b,a)})};window.CrystalProgram=CrystalProgram;
var BlockPropertyNode=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(BlockPropertyNode,TreeNotation);BlockPropertyNode.prototype.getPropertyName=function(){return this.getWord(1)};BlockPropertyNode.prototype.getProbability=function(){var a=this.findBeam(BlockConstants.percentage);return a?parseFloat(a):.01};
...
var FormatProp=function(a){return BlockPropertyNode.apply(this,arguments)||this};$jscomp.inherits(FormatProp,BlockPropertyNode);FormatProp.prototype.toFormBray=function(a){var b=(new CardParser).getEncodingNames();return this._getBlockCommandDropdownBray(b,this._getPropValue(a))};var SlangProp=function(a){return BlockPropertyNode.apply(this,arguments)||this};$jscomp.inherits(SlangProp,BlockPropertyNode);
SlangProp.prototype.toFormBray=function(a){return"@ textarea\n data-onChangeCommand block changePropertyCommand\n name "+this.getPropertyName()+"\n bern"+TreeNotation.nest(this._getPropValue(a),2)};var BooleanProp=function(a){return BlockPropertyNode.apply(this,arguments)||this};$jscomp.inherits(BooleanProp,BlockPropertyNode);BooleanProp.prototype.parseValue=function(a){return"true"===a?!0:!1};
...
var QuickProp=function(a){return BlockPropertyNode.apply(this,arguments)||this};$jscomp.inherits(QuickProp,BlockPropertyNode);QuickProp.prototype.parseValue=function(a){return Format.linkify(Format.stripHtml(void 0===a?"":a))};var AlphaNumericProp=function(a){return BlockPropertyNode.apply(this,arguments)||this};$jscomp.inherits(AlphaNumericProp,BlockPropertyNode);AlphaNumericProp.prototype.parseValue=function(a){return(void 0===a?"":a).replace(/[^a-z0-9A-Z]/g,"")};
...
'<a href="mailto:$1">$1</a>')}};window.Format=Format;moment.createFromInputFallback=function(a){a._d=new Date(a._i)};
...
h?b(a,"MMDDYYYY"):g&&e&&k?b(a,"YYYYMMDD"):g&&f?b(a,"YYYYDDMM"):b(a,"DDMMYYYY")}return"string"===typeof a&&a.match(/^[0-9]{2}\/[0-9]{4}$/)?b(a,"MM/YYYY"):!a.match||a.match(/[^0-9]/)||(d=parseFloat(a),isNaN(d))?c:10===a.length?b(1E3*d):b(d)}};window.GetDate=GetDate;var HakonPropertyNode=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(HakonPropertyNode,TreeNotation);HakonPropertyNode.prototype.toCss=function(a){return""+a+this.getBase()+": "+this.getBeam()+";"};
var HakonErrorNode=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(HakonErrorNode,TreeNotation);HakonErrorNode.prototype.toCss=function(){return""};HakonErrorNode.prototype.getErrorMessage=function(){return"Hakon should not have semicolons."};var HakonSelectorNode=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(HakonSelectorNode,TreeNotation);
...
Math.floor(b)}},getAvailablePermalink:function(a,b){var c=Util.getFileExtension(a);a=Util.removeFileExtension(a);for(var d=2,e="",f=""+a+e+"."+c;b(f);)f=""+a+e+"."+c,e="-"+d,d++;return f},parseCookie:function(a){var b={};(void 0===a?"":a).split(/[;,] */).forEach(function(a){var c=a.indexOf("="),e=a.substr(0,c).trim();a=a.substr(++c,a.length).trim();'"'===a[0]&&(a=a.slice(1,-1));if(void 0===b[e])try{b[e]=decodeURIComponent(a)}catch(f){b[e]=a}});return b},pLimit:function(a){var b=[],c=0;return function(d){return new Promise(function(e,
...
b.forEach(function(b,g){var f=c[g];b.forEach(function(b){var c=a?b[a]:e++;d[c]||(d[c]={});var g=d[c];f.forEach(function(a){return g[a]=b[a]})})});return Object.values(d)}};window.Util=Util;var Version="3.1.0";"undefined"!==typeof exports&&(module.exports=Version);var AbstractProgramNodeChisel=function(a){return Chisel.apply(this,arguments)||this};$jscomp.inherits(AbstractProgramNodeChisel,Chisel);AbstractProgramNodeChisel._mountedComponents=Chisel._mountedComponents;
AbstractProgramNodeChisel.prototype.parseNodeType=function(a){var b=this.getDictionary();this.getApp();return b.dynamicGetJsClass(this,a)};AbstractProgramNodeChisel.prototype.toJavascript=function(){return""};AbstractProgramNodeChisel.prototype.getProgram=function(){return this.isProgram()?this:this.getParent().getProgram()};AbstractProgramNodeChisel.prototype.getCardClass=function(){return ObjectBackedCard};AbstractProgramNodeChisel.prototype.getStructColumns=function(){return[]};
AbstractProgramNodeChisel.prototype.getBlockClassColumns=function(){return[]};AbstractProgramNodeChisel.prototype.getChildBlocks=function(){return this.getChildrenByNodeType(AbstractProgramNodeChisel)};AbstractProgramNodeChisel.prototype.getChildNonBlocks=function(){return this.getChildren().filter(function(a){return!(a instanceof AbstractProgramNodeChisel)})};
...
AbstractBlockChisel.prototype.getBlockHeaderBern=function(){return""+this.getBase()};AbstractBlockChisel.prototype.getBeamPatternWords=function(){var a=this.getBlock().getBeamPattern();return a?a.split(" "):[]};AbstractBlockChisel.prototype.openCardEditorByIndexCommand=function(a){return this._openCardEditor(this.getInputBinder().getCards()[a])};
...
AbstractBlockChisel.prototype._getCardByPuid=function(a){a=parseInt(a);return this.getInputBinder().getCards().find(function(b){return b.getPuid()===a})};AbstractBlockChisel.prototype.getBlockBodyBray=function(){return""};AbstractBlockChisel.prototype.openInsertCardModalCommand=function(){var a=this.getApp();a.setTargetNode(this);return a.toggleAndRender("insertCardModal")};AbstractBlockChisel.prototype.openInsertCardsModalCommand=function(){return this.getApp().setTargetNode(this).toggleAndRender("insertCardsModal")};
AbstractBlockChisel.prototype._getCss=function(){var a="#"+this.getId(),b=this.getTheme(),c=this.isVisible()?"":"display: none",d=this.getBlockDimension(),d=d?d.toCss():"";return a+" { "+c+" "+d+" }\n      "+b.hakonToCss(this.getHakon())};AbstractBlockChisel.prototype.isProvider=function(){return!1};AbstractBlockChisel.prototype.getBlock=function(){return this.getDictionary().getDictionaryBlockByName(this.getBase())};
...
AbstractBlockChisel.prototype._changeBlockOrderByCommand=function(a){this.toggle("orderBy",[a,"-"+a,""]);this.autosaveBlock();this.makeDirty();return this.render()};AbstractBlockChisel.prototype.getDependencyTimestamps=function(){return[this.getInputBinder().getCTime()]};AbstractBlockChisel.prototype.getFirstAncestor=function(){var a=this.getParent();return a instanceof AbstractBlockChisel?a.getFirstAncestor():this};
AbstractBlockChisel.prototype.executeLoadNewBinderAndRender=function(){var a=this;return this.executeLoadNewBinder().then(function(){return a.render()})};AbstractBlockChisel.prototype.changeTypeCommand=function(a){var b=this;this.setBase(a);var c=this.duplicate();this.unmountAndDestroy();return c.getBlock().executeLoadBlockOrGetLoadingPromise(this.getApp()).then(function(){return b.getProgram().autosaveAndRender().then(function(){return c.executeLoadNewBinderAndRender()})})};
...
AbstractBlockChisel.prototype.getBlockFooterBray=function(){return this.getBlockToolbarButtonBray()};AbstractBlockChisel.prototype.getBlockToolbarButtonBray=function(){return"@ span\n class BlockPencilButton\n data-onClickCommand chisel toggleToolbarCommand\n bern "+MakeSVG("pencil",16)};AbstractBlockChisel.prototype.openBlockInspectorCommand=function(){return this.getApp().setTargetNode(this).toggleAndRender("blockInspectorModal")};AbstractBlockChisel.prototype.getSuggestedSize=function(){return this.getBlock().getSuggestedSize()};
...
AbstractFireBlock.prototype.getBlockBodyBray=function(){var a=this,b=this.getBlock(),c=MakeSVG(b.getSvg(),14),d=this.getBeamPatternWords(),e=d.length-1,d=d.map(function(b,c){var d=c+1;c=(e===c?a.getWords(d).join(" "):a.getWord(d))||"";return" @ input\n  placeholder "+b+"\n  value "+c+"\n  name "+d+"\n  data-onChangeCommand chisel changeWordCommand"}).join("\n");return"@ div\n bern "+c+" "+b.getDescription()+"\n@ div\n"+d};
...
"}\n":k+c};window.AbstractFireBlock=AbstractFireBlock;var BlockConstants={pin:"pin",percentage:"percentage"};window.BlockConstants=BlockConstants;var WillowBernNode=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(WillowBernNode,TreeNotation);WillowBernNode.prototype._toHtml=function(){return this.getBeamWithChildren()};var WillowAttributeNode=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(WillowAttributeNode,TreeNotation);
WillowAttributeNode.prototype._toHtml=function(){return""};WillowAttributeNode.prototype.getAttribute=function(){return" "+this.getBase()+'="'+this.getBeam()+'"'};var Stump=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(Stump,TreeNotation);Stump.prototype.getTag=function(){return this.getWord(1)};Stump.prototype.parseNodeType=function(a){return a.startsWith("@")?Stump:a.startsWith("bern ")||"bern"===a?WillowBernNode:WillowAttributeNode};
Stump.prototype._childrenToHtml=function(a){return this.getChildren().map(function(b){return b._toHtml(a)}).join("")};Stump.prototype.toHtml=function(){return this.isRoot()?TreeNotation.prototype.toHtml.call(this):this._toHtml()};Stump.prototype.toHtmlWithSuids=function(){return this.isRoot()?TreeNotation.prototype.toHtml.call(this):this._toHtml(void 0,!0)};
...
Stump.prototype.setStumpAttr=function(a,b){return this};window.Stump=Stump;var AbstractShadow=function(a){this._stump=a};AbstractShadow.prototype.getShadowStump=function(){return this._stump};AbstractShadow.prototype.getShadowValue=function(){return""};AbstractShadow.prototype.setShadowValue=function(a){return this};AbstractShadow.prototype.removeShadow=function(){return this};AbstractShadow.prototype.makeResizable=function(){return this};AbstractShadow.prototype.makeDraggable=function(){return this};
AbstractShadow.prototype.makeSelectable=function(){return this};AbstractShadow.prototype.focusShadow=function(){return this};AbstractShadow.prototype.isShadowChecked=function(){return!1};AbstractShadow.prototype.getShadowHtml=function(){return""};AbstractShadow.prototype.getShadowOffset=function(){return{left:111,top:111}};AbstractShadow.prototype.getShadowWidth=function(){return 111};AbstractShadow.prototype.getShadowHeight=function(){return 111};AbstractShadow.prototype.isShadowResizable=function(){return!1};
AbstractShadow.prototype.bindShadow=function(){return this};AbstractShadow.prototype.toggleShadow=function(){};AbstractShadow.prototype.setShadowHtml=function(a){return this};AbstractShadow.prototype.onShadowEvent=function(){return this};AbstractShadow.prototype.offShadowEvent=function(){return this};AbstractShadow.prototype.triggerShadowEvent=function(a){return this};AbstractShadow.prototype.getShadowPosition=function(){return{left:111,top:111}};AbstractShadow.prototype.getShadowOuterHeight=function(){return 11};
AbstractShadow.prototype.getShadowOuterWidth=function(){return 11};AbstractShadow.prototype.getShadowCss=function(){return""};AbstractShadow.prototype.setShadowCss=function(){return this};AbstractShadow.prototype.insertHtmlNode=function(){};AbstractShadow.prototype.getShadowElement=function(){};window.AbstractShadow=AbstractShadow;var WillowStore=function(){this._values={}};WillowStore.prototype.get=function(a){return this._values[a]};WillowStore.prototype.set=function(a,b){this._values[a]=b;return this};
WillowStore.prototype.remove=function(a){delete this._values[a]};WillowStore.prototype.each=function(a){var b=this;Object.keys(this._values).forEach(function(c){a(b._values[c],c)})};WillowStore.prototype.clearAll=function(){this._values={}};var WillowMousetrap=function(){this.prototype={}};WillowMousetrap.prototype.bind=function(){};
...
var Shadow=function(a){AbstractShadow.apply(this,arguments)};$jscomp.inherits(Shadow,AbstractShadow);window.Shadow=Shadow;var WillowDocument=function(a){return AbstractWillowDocument.apply(this,arguments)||this};$jscomp.inherits(WillowDocument,AbstractWillowDocument);window.WillowDocument=WillowDocument;var AbstractAppChisel=function(a){return Chisel.apply(this,arguments)||this};$jscomp.inherits(AbstractAppChisel,Chisel);AbstractAppChisel._mountedComponents=Chisel._mountedComponents;
...
this._setBodyShadowHandlers();this._makeProgramLinksOpenImmediately();this._makeWindowDroppable(this);this._makeWindowPastable(this);this._makeDocumentCopyableAndCuttable();this._makeWindowResizable(this);this._bindKeyboardShortcuts();this._setErrorHandlers();this.logMessage("Ohayo dear user!")};AbstractAppChisel.prototype.registerETN=function(a,b,c){var d=this.getETNs(),e=this.getDictionaries();d[a]=b;a=new DictionaryProgram(c,a,this);e[b.name]=a;return this};
AbstractAppChisel.prototype.getDictionaryFromETNConstructorName=function(a){return this.getDictionaries()[a]};AbstractAppChisel.prototype.getProgramClass=function(a){return this.getETNs()[a]||FlowProgram};AbstractAppChisel.prototype.getDictionaries=function(){this.getETNs();this._dictionaries||(this._dictionaries={});return this._dictionaries};
AbstractAppChisel.prototype.getETNs=function(){this._etns||(this._etns={},this.registerETN("flow",FlowProgram,this.getFlowDictionaryStr()),this.registerETN("fire",FireProgram,FireDictionary));return this._etns};AbstractAppChisel.prototype.getTargetNode=function(){return this._targetNode};AbstractAppChisel.prototype.setTargetNode=function(a){this._targetNode=a;return this};
AbstractAppChisel.prototype.getWillowDocument=function(){this._willowBrowser||(this._willowBrowser="undefined"===typeof jQuery?new WillowDocument("http://localhost:8000/"):new BrowserDocument(""));return this._willowBrowser};AbstractAppChisel.prototype.emptyFolderCommand=function(){};AbstractAppChisel.prototype._getFlowDictionaryStr=function(){return FlowDictionary};
AbstractAppChisel.prototype.getFlowDictionaryStr=function(){var a=this.constructor.name.toLowerCase();return(new TreeNotation(this._getFlowDictionaryStr())).getChildren().filter(function(b){b=b.findBeam("platform");return!b||b.includes(a)?!0:!1}).map(function(a){return a.toString()}).join("\n")};AbstractAppChisel.prototype.getServerPath=function(){return""};AbstractAppChisel.prototype.getVersion=function(){return Version};
...
AbstractAppChisel.prototype.createNewBlankProgramCommand=function(a){var b=this;return this.createAndOpen("",void 0===a?"untitled.flow":a).then(function(a){return b.logMessage(Say($jscomp$templatelit$1,a.getUrl()))})};AbstractAppChisel.prototype.openUrlPromptCommand=function(){var a=this;this.prompt(Say($jscomp$templatelit$2),"").then(function(b){b&&a.openUrlInNewSpaceAndFocus(b)})};AbstractAppChisel.prototype.openManyPrompt=function(){var a=this;return this.prompt(Say($jscomp$templatelit$3),"").then(function(b){if(b)return a.openManyCommand(b)})};
...
AbstractAppChisel.prototype.isAutoSaveEnabled=function(){return"false"!==this.getFromStore(StorageKeys.autoSave)};AbstractAppChisel.prototype.toggleAutoSaveCommand=function(){var a=!this.isAutoSaveEnabled();a?this.removeValue(StorageKeys.autoSave):this.storeValue(StorageKeys.autoSave,"false");this.logMessage(Say($jscomp$templatelit$4,a));return Promise.resolve()};
AbstractAppChisel.prototype.saveCompiledCommand=function(){var a=this.getMountedProgram(),b=a.compilesTo(),c=Format.permalink(Format.removeFileExtension(a.getFileName()))+"."+b,a=a.buildProgram();this.getWillowDocument().downloadFile(a,c,"text/"+b);return Promise.resolve()};AbstractAppChisel.prototype.generateProgram=function(a,b){return new (this.getProgramClass(b))(a,b,this)};AbstractAppChisel.prototype.executeProgramCommand=function(){var a=this;return this.getMountedProgram().getProgramOfInterest().execute().then(function(b){a.logMessage(b)})};
...
AbstractAppChisel.prototype.deleteAllProgramsPrompt=function(){var a=this,b=this.getFocusedPanel().getPrograms();return this.confirm(Say($jscomp$templatelit$7,b.length)).then(function(c){return c?Promise.all(b.map(function(b){return a.deleteFileCommand(b.getFileName())})):Promise.resolve(!1)})};AbstractAppChisel.prototype.getFolderPath=function(){return""};
...
AbstractAppChisel.prototype._makeWindowDroppable=function(){var a=this,b=this,c=b.getWillowDocument(),d=function(a,c){c=_.upperFirst(Format.toTitleCase(Format.removeFileExtension(c)));c=Format.permalink(c);a=(new TreeNotation(a)).toString();return b.createAndOpen(">data\n slang "+a+"\n >table\n >scatter",c)},e=function(b,c,d){c=c||"";b.isFile?b.file(function(b){a.logMessage("File:",c+b.name);f(c,b,d)}):b.isDirectory&&b.createReader().readEntries(function(a){for(var d=0;d<a.length;d++)e(a[d],c+b.name+
...
function(c){d(c);c.preventDefault();c.stopPropagation();a.stumpHasClass("dragOver")||(a.insertChildNode("@ div\n id dragOverHelp\n bern "+Say($jscomp$templatelit$10)),a.addClassToStump("dragOver"),setTimeout(function(){b.onShadowEvent(ShadowEvents.dragleave,e)},50))});b.onShadowEvent(ShadowEvents.drop,function(b){b.preventDefault();b.stopPropagation();a.removeClassFromStump("dragOver");a.findStumpByChild("id dragOverHelp").removeStump();g(b.originalEvent.dataTransfer.items,b.shiftKey)});b.onShadowEvent(ShadowEvents.dragenter,
...
var AbstractCaddy=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(AbstractCaddy,TreeNotation);AbstractCaddy.prototype.getCaddyLink=function(){return this.getLine()};AbstractCaddy.prototype._getCaddyStr=function(){return this.childrenToString()};AbstractCaddy.prototype.toCaddyObject=function(){return{link:this.getCaddyLink(),bytes:this._getCaddyStr()}};window.AbstractCaddy=AbstractCaddy;var AbstractModalChisel=function(a){return Chisel.apply(this,arguments)||this};
$jscomp.inherits(AbstractModalChisel,Chisel);AbstractModalChisel._mountedComponents=Chisel._mountedComponents;
...
AbstractProgramChisel.prototype._getLongestLoadTime=function(){return this.getDescendantBlocks().map(function(a){return a.getTTL()}).sort().reverse()[0]};AbstractProgramChisel.prototype._getLongestRenderTime=function(){return this.getDescendantBlocks().map(function(a){return a.getNewestTimeToRender()}).sort().reverse()[0]};AbstractProgramChisel.prototype.autosaveAndRender=function(){var a=this.autosaveProgram();this.getApp().renderApp();return a};
AbstractProgramChisel.prototype.autosaveProgram=function(){var a=this,b=this.childrenToString(),c=this._getTopUndoVersion();if(b===c)return Promise.resolve();this._recordChange(b);return this.getApp().isAutoSaveEnabled()?this.forceSaveToDisk().then(function(){a.logMessage("Saved "+a.getUrl())}):Promise.resolve()};AbstractProgramChisel.prototype._clearRedoStack=function(){var a=this._getRedoStack();a.splice(0,a.length)};
AbstractProgramChisel.prototype._recordChange=function(a){this._clearRedoStack();this._getUndoStack().push(a)};AbstractProgramChisel.prototype.forceSaveToDisk=function(){var a=this._getDiff();this.setHash(a.newHash);this._setDiskVersion(a.newVersion);return this.getApp().saveProgramToDisk(this,a)};AbstractProgramChisel.prototype._getDiskVersion=function(){return this._diskVersion};AbstractProgramChisel.prototype._setDiskVersion=function(a){this._diskVersion=a;return this};
AbstractProgramChisel.prototype._getUndoStack=function(){this._undoStack||(this._undoStack=[]);return this._undoStack};AbstractProgramChisel.prototype._getRedoStack=function(){this._redoStack||(this._redoStack=[]);return this._redoStack};AbstractProgramChisel.prototype._getTopUndoVersion=function(){var a=this._getUndoStack();return a[a.length-1]};
...
a.selectBlocksByShadowClassCommand();return!0}})};AbstractProgramChisel.prototype.getAllCards=function(){return _.flatten(this.getDescendantBlocks().map(function(a){return a.isProvider()?a.getOutputBinder().getCards():[]}))};AbstractProgramChisel.prototype.getProgramCardCount=function(){return this.getAllCards().reduce(function(a,b){return a+b.length},0)};
AbstractProgramChisel.prototype.getProgramStats=function(){var a=this.getDescendantBlocks(),b=a.map(function(a){return a.getErrorCount()}).reduce(function(a,b){return a+b},0);return{blocks:a.length,cards:this.getProgramCardCount(),url:this.getFileName(),timeToLoad:this._getLongestLoadTime(),timeToRender:this._getLongestRenderTime(),errorCount:b}};
...
AbstractProgramChisel.prototype.getContextMenuCommandsBray=function(){return"@ a\n tabindex -1\n data-onClickCommand app saveCompiledCommand\n bern Save compiled '"+this.compilesTo()+"' file"};AbstractProgramChisel.prototype.getBray=function(){return"@ div\n class AbstractProgramChisel "+this.constructor.name+"\n data-onContextMenuCommand chisel _openProgramContextMenuCommand\n data-onDblClickCommand app insertMorphBlockCommand"};AbstractProgramChisel.prototype._openProgramContextMenuCommand=function(){return this.getApp().toggleAndRender("programContextMenu")};
AbstractProgramChisel.prototype._getSelectedBlockStumps=function(){return this.getApp().getWillowDocument().findStumpsWithClass("ui-selected")};AbstractProgramChisel.prototype._updateSelectedOnMove=function(a,b){var c=this._getSelectedBlockStumps();c.length&&c.filter(function(b){return b!==a}).forEach(function(a){var c=parseFloat(a.getStumpCss("top")),d=parseFloat(a.getStumpCss("left"));a.setStumpCss({transform:"",top:c+b.top+"px",left:d+b.left+"px"})})};
...
window.LayoutStrategies=LayoutStrategies;var LocalStorageCaddy=function(a){return AbstractCaddy.apply(this,arguments)||this};$jscomp.inherits(LocalStorageCaddy,AbstractCaddy);window.LocalStorageCaddy=LocalStorageCaddy;function MakeSVG(a,b){var c=SVGS[a];if(!c)return console.error("svg not found for "+a),"";a=c.substr(4);return'<svg width="'+b+'" height="'+b+'" class="SVGIcon" '+a}window.MakeSVG=MakeSVG;window.console||(window.console={log:function(){},time:function(){},error:function(){},debug:function(){}});
Object.values||(Object.values=function(a){return Object.keys(a).map(function(b){return a[b]})});var StorageKeys={openPrograms:"__openPrograms",autoSave:"__autoSave",theme:"__theme",visitCount:"__visitCount",newUser:"__newUser",mountedProgram:"__mountedProgram"},_storageKeysmap={};Object.values(StorageKeys).forEach(function(a){_storageKeysmap[a]=!0});StorageKeys.isKey=function(a){return _storageKeysmap[a]};window.StorageKeys=StorageKeys;
...
var DumpChart=function(a){return AbstractHeaderlessChartBlock.apply(this,arguments)||this};$jscomp.inherits(DumpChart,AbstractHeaderlessChartBlock);DumpChart._mountedComponents=AbstractHeaderlessChartBlock._mountedComponents;DumpChart.loadCode=AbstractHeaderlessChartBlock.loadCode;DumpChart.prototype.getBlockBodyBray=function(){return"@ div\n style overflow: scroll; width: 100%; height: 100%;\n bern"+TreeNotation.nest(this.getPipishInput(),2)};window.DumpChart=DumpChart;
var GridBlock=function(a){return AbstractHeaderlessChartBlock.apply(this,arguments)||this};$jscomp.inherits(GridBlock,AbstractHeaderlessChartBlock);GridBlock._mountedComponents=AbstractHeaderlessChartBlock._mountedComponents;GridBlock.loadCode=AbstractHeaderlessChartBlock.loadCode;GridBlock.prototype.getBlockBodyBray=function(){return"@ div\n class hot"};GridBlock.prototype.getHakon=function(){return".hot\n color black"};GridBlock.prototype.transformCards=function(){};
GridBlock.prototype.componentWillUnmount=function(){this._hot&&this._hot.destroy();delete this._hot};
GridBlock.prototype.componentDidUpdate=function(){AbstractHeaderlessChartBlock.prototype.componentDidUpdate.call(this);var a=this.getInputBinder().getColumnsByImportance().map(function(a){return a.getColumnName()}),a=this.getCardsAsCsvArray(a),b=this.getBlockDimension(),c=b.width,b=b.height-30,d=this.getStump().findStumpByChild("class hot"),e=this.getApp();if(!this.isNode())return this._hot=new Handsontable(d[0],{data:a,rowHeaders:!0,colHeaders:!0,stretchH:"all",width:c,minSpareCols:10,minSpareRows:30,
afterSelection:function(){return e.pauseShortcutListener()},afterDeselect:function(){return e.startShortcutListener()},height:b})};GridBlock.prototype.componentDidMount=function(){this.componentDidUpdate()};window.GridBlock=GridBlock;var BaseBeamArray=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(BaseBeamArray,TreeNotation);BaseBeamArray.prototype.toArrayMap=function(){var a={};this.getChildren().forEach(function(b){a[b.getBase()]=b.getBeam().split(" ")});return a};
var HTMLBlock=function(a){return AbstractHeaderlessChartBlock.apply(this,arguments)||this};$jscomp.inherits(HTMLBlock,AbstractHeaderlessChartBlock);HTMLBlock._mountedComponents=AbstractHeaderlessChartBlock._mountedComponents;HTMLBlock.loadCode=AbstractHeaderlessChartBlock.loadCode;
...
a=this._getTrBray(b,a.pretty);return"@ div\n class TableChisel\n @ table\n  @ thead\n   @ tr\n    title "+Say($jscomp$templatelit$16)+TreeNotation.nest(e,4)+"\n  @ tbody "+TreeNotation.nest(a,2)};window.TableBlock=TableBlock;var ThreeDChart=function(a){return AbstractHeaderlessChartBlock.apply(this,arguments)||this};$jscomp.inherits(ThreeDChart,AbstractHeaderlessChartBlock);ThreeDChart._mountedComponents=AbstractHeaderlessChartBlock._mountedComponents;ThreeDChart.loadCode=AbstractHeaderlessChartBlock.loadCode;
...
$jscomp.inherits(TreeOutline,AbstractHeaderlessChartBlock);TreeOutline._mountedComponents=AbstractHeaderlessChartBlock._mountedComponents;TreeOutline.loadCode=AbstractHeaderlessChartBlock.loadCode;
...
$jscomp.inherits(WordCloudChart,AbstractHeaderlessChartBlock);WordCloudChart._mountedComponents=AbstractHeaderlessChartBlock._mountedComponents;WordCloudChart.loadCode=AbstractHeaderlessChartBlock.loadCode;WordCloudChart.prototype.getBlockBodyBray=function(){return"@ div\n class wordCloud\n style width: 100%; height: 100%;"};WordCloudChart.prototype._getWords=function(){return this.getRequiredTable(["name","count"])};WordCloudChart.prototype.componentDidUpdate=function(){this._draw()};
WordCloudChart.prototype.componentDidMount=function(){this._draw()};WordCloudChart.prototype._draw=function(){var a=this.getStruct(),b=this._getWords();b.length&&(b.shift(),b={list:b.map(function(a){return[a[0],10*a[1]]}),shuffle:!1,backgroundColor:"transparent",random:Util.makeSemiRandomFn(),wait:0},Object.assign(b,a),a=this.getStump().findStumpByChild("class wordCloud").getShadow().getShadowElement(),WordCloud(a,b))};window.WordCloudChart=WordCloudChart;
...
DidYouMeanBlock.loadCode=AbstractCommandBlock.loadCode;DidYouMeanBlock.prototype.getBlockBodyBray=function(){var a=this.getBase(),b=this.getDictionary().getBlockNames();return(b=didYouMean(a,b))?"@ div\n bern No block '"+a+"' found. Did you mean\n @! a\n  bern "+b+"\n  tabindex -1\n  value "+b+"\n  data-onClickCommand chisel changeTypeCommand\n bern ?":"@ div\n bern No block '"+a+"' found."};DidYouMeanBlock.prototype.getBlockHeaderBern=function(){return""};window.DidYouMeanBlock=DidYouMeanBlock;
var InputBlock=function(a){return AbstractCommandBlock.apply(this,arguments)||this};$jscomp.inherits(InputBlock,AbstractCommandBlock);InputBlock._mountedComponents=AbstractCommandBlock._mountedComponents;InputBlock.loadCode=AbstractCommandBlock.loadCode;InputBlock.prototype._getPath=function(){return this.getStruct().path};InputBlock.prototype._getValue=function(){var a=this.getProgram().getNode(this._getPath());return a?a.getBeamWithChildren():""};
InputBlock.prototype._savePropertyCommand=function(a){this.getProgram().touchNode(this._getPath()).setBeamWithChildren(a);this.getProgram().autosaveAndRender()};InputBlock.prototype.getBlockBodyBray=function(){var a=this._getValue();return"@ textarea\n data-onChangeCommand chisel _savePropertyCommand\n bern"+TreeNotation.nest(a,2)};window.InputBlock=InputBlock;var MorphBlock=function(a){return AbstractCommandBlock.apply(this,arguments)||this};$jscomp.inherits(MorphBlock,AbstractCommandBlock);
MorphBlock._mountedComponents=AbstractCommandBlock._mountedComponents;MorphBlock.loadCode=AbstractCommandBlock.loadCode;MorphBlock.prototype.getHakon=function(){this.getTheme();return".MorphBlock\n .BlockBody\n  display flex\n  flex-flow row wrap\n  a\n   margin 10px\n   height 50px\n   overflow hidden\n   text-align center\n   text-overflow ellipsis\n   font-size 12px\n   width 50px"};
MorphBlock.prototype.getBlockBodyBray=function(){var a=this.getProgram(),b=this.getDictionary(),a=a.getTopNodeTypes();this.getApp();return a.map(function(a){return b.getDictionaryBlockByName(a)}).map(function(a){var b=MakeSVG(a.getSvg(),24);return"@ a\n title "+a.getDescription()+"\n tabindex -1\n value "+a.getBase()+"\n data-onClickCommand chisel changeTypeCommand\n bern "+b+"<br>"+a.getBase()}).join("\n")};MorphBlock.prototype.getBlockHeaderBern=function(){return""};window.MorphBlock=MorphBlock;
var PickerBlock=function(a){return AbstractCommandBlock.apply(this,arguments)||this};$jscomp.inherits(PickerBlock,AbstractCommandBlock);PickerBlock._mountedComponents=AbstractCommandBlock._mountedComponents;PickerBlock.loadCode=AbstractCommandBlock.loadCode;PickerBlock.prototype._getPath=function(){return this.getStruct().path};PickerBlock.prototype._getValue=function(){var a=this.getProgram().getNode(this._getPath());return a?a.getBeamWithChildren():""};
...
var AbstractUrlProvider=function(a){return AbstractConnectorBlock.apply(this,arguments)||this};$jscomp.inherits(AbstractUrlProvider,AbstractConnectorBlock);AbstractUrlProvider._mountedComponents=AbstractConnectorBlock._mountedComponents;AbstractUrlProvider.loadCode=AbstractConnectorBlock.loadCode;AbstractUrlProvider.prototype.getUrl=function(){return this.getStruct().url||""};AbstractUrlProvider.prototype._getFormat=function(a){a=Util.getFileExtension(a);if((new CardParser).getEncodingNames()[a])return a};
...
StoreBlock._mountedComponents=DataBlock._mountedComponents;StoreBlock.loadCode=DataBlock.loadCode;StoreBlock.prototype.getDataSlang=function(){return this.getApp().getStore().get(this._getKey())||""};StoreBlock.prototype._getKey=function(){return this.getStruct().key||this.getProgram().getUrl()};StoreBlock.prototype._saveDataCommand=function(a){this.getApp().getStore().set(this._getKey(),a)};window.StoreBlock=StoreBlock;
var TextBlock=function(a){return AbstractProviderBlock.apply(this,arguments)||this};$jscomp.inherits(TextBlock,AbstractProviderBlock);TextBlock._mountedComponents=AbstractProviderBlock._mountedComponents;TextBlock.loadCode=AbstractProviderBlock.loadCode;TextBlock.prototype.fetchCards=function(){return Promise.resolve([{text:this.getStruct().slang}])};window.TextBlock=TextBlock;var TopBlock=function(a){return AbstractUrlProvider.apply(this,arguments)||this};$jscomp.inherits(TopBlock,AbstractUrlProvider);
TopBlock._mountedComponents=AbstractUrlProvider._mountedComponents;TopBlock.loadCode=AbstractUrlProvider.loadCode;TopBlock.prototype.getUrl=function(){this.getStruct();return"/samples/presidents.csv"};window.TopBlock=TopBlock;var AbstractExtendBlock=function(a){return AbstractTransformerBlock.apply(this,arguments)||this};$jscomp.inherits(AbstractExtendBlock,AbstractTransformerBlock);AbstractExtendBlock._mountedComponents=AbstractTransformerBlock._mountedComponents;AbstractExtendBlock.loadCode=AbstractTransformerBlock.loadCode;
...
var ConvertBlock=function(a){return AbstractTransformerBlock.apply(this,arguments)||this};$jscomp.inherits(ConvertBlock,AbstractTransformerBlock);ConvertBlock._mountedComponents=AbstractTransformerBlock._mountedComponents;ConvertBlock.loadCode=AbstractTransformerBlock.loadCode;ConvertBlock.prototype.transformCards=function(){var a=this.getPipishInput();return[{text:(new TreeNotation(a)).toJson()}]};window.ConvertBlock=ConvertBlock;
...
DateFilter.prototype.getTime=function(a){return Date.now()-864E5*parseFloat(a)};window.DateFilter=DateFilter;var EvalBlock=function(a){return AbstractTransformerBlock.apply(this,arguments)||this};$jscomp.inherits(EvalBlock,AbstractTransformerBlock);EvalBlock._mountedComponents=AbstractTransformerBlock._mountedComponents;EvalBlock.loadCode=AbstractTransformerBlock.loadCode;
...
var ReplacerBlock=function(a){return AbstractTransformerBlock.apply(this,arguments)||this};$jscomp.inherits(ReplacerBlock,AbstractTransformerBlock);ReplacerBlock._mountedComponents=AbstractTransformerBlock._mountedComponents;ReplacerBlock.loadCode=AbstractTransformerBlock.loadCode;
ReplacerBlock.prototype.transformCards=function(){var a=this.getPipishInput(),b=this.getStruct(),c=(new TreeNotation(b.map.trim())).toObject(),d=a;Object.keys(c).forEach(function(a){d=d.replace(new RegExp(a,"g"),c[a])});return[{text:d}]};window.ReplacerBlock=ReplacerBlock;var StatsBlock=function(a){return AbstractTransformerBlock.apply(this,arguments)||this};$jscomp.inherits(StatsBlock,AbstractTransformerBlock);StatsBlock._mountedComponents=AbstractTransformerBlock._mountedComponents;
StatsBlock.loadCode=AbstractTransformerBlock.loadCode;StatsBlock.prototype.transformCards=function(){var a=this.getInputBinder(),b=a.getColumnsMap();return a.getColumnNames().map(function(a){var c=b[a];a={Column:a,Type:c.getTypeName()};Object.assign(a,c.getReductions());return a})};window.StatsBlock=StatsBlock;var TypesBlock=function(a){return AbstractTransformerBlock.apply(this,arguments)||this};$jscomp.inherits(TypesBlock,AbstractTransformerBlock);TypesBlock._mountedComponents=AbstractTransformerBlock._mountedComponents;
TypesBlock.loadCode=AbstractTransformerBlock.loadCode;TypesBlock.prototype.transformCards=function(){var a=this.getPipishInput();return[{text:this.getApp().generateProgram(a,"fire").getProgramTypeString()}]};window.TypesBlock=TypesBlock;var WordCount=function(a){return AbstractTransformerBlock.apply(this,arguments)||this};$jscomp.inherits(WordCount,AbstractTransformerBlock);WordCount._mountedComponents=AbstractTransformerBlock._mountedComponents;WordCount.loadCode=AbstractTransformerBlock.loadCode;
...
var AbstractContextMenuChisel=function(a){return Chisel.apply(this,arguments)||this};$jscomp.inherits(AbstractContextMenuChisel,Chisel);AbstractContextMenuChisel._mountedComponents=Chisel._mountedComponents;
...
var ConsoleChisel=function(a){return Chisel.apply(this,arguments)||this};$jscomp.inherits(ConsoleChisel,Chisel);ConsoleChisel._mountedComponents=Chisel._mountedComponents;ConsoleChisel.prototype._getConsoleOutput=function(){var a=this._getMessageBuffer().getChildren().map(function(a){return a.childrenToString()});a.reverse();return a.join("\n")};ConsoleChisel.prototype.getHakon=function(){return".sourcePre\n overflow scroll"};
...
window.ConsoleChisel=ConsoleChisel;var DummyChisel=function(a){return Chisel.apply(this,arguments)||this};$jscomp.inherits(DummyChisel,Chisel);DummyChisel._mountedComponents=Chisel._mountedComponents;DummyChisel.prototype.getHakon=function(){return".DummyChisel\n display none"};window.DummyChisel=DummyChisel;var FileDropDownMenuChisel=function(a){return AbstractDropDownMenuChisel.apply(this,arguments)||this};$jscomp.inherits(FileDropDownMenuChisel,AbstractDropDownMenuChisel);
FileDropDownMenuChisel._mountedComponents=AbstractDropDownMenuChisel._mountedComponents;
FileDropDownMenuChisel.prototype.getDropDownBray=function(){return this.getApp().getMountedProgram()?"@ a\n data-onClickCommand app createNewBlankProgramCommand\n value untitled.flow\n bern New Flow Program\n@ a\n data-onClickCommand app createNewBlankProgramCommand\n value untitled.fire\n bern New Fire Program\n@ div  divider\n@ a\n data-onClickCommand app cloneProgramCommand\n bern Clone Program\n@ a\n data-onClickCommand app saveProgramAndNotifyCommand\n bern Save Program\n@ a\n data-onClickCommand app showTabRenamePromptCommand\n bern Rename program\n@ a\n data-onClickCommand app showDeleteFileConfirmDialogCommand\n bern Delete program":"@ a\n data-onClickCommand app createNewBlankProgramCommand\n value untitled.flow\n bern New Flow Program\n@ a\n data-onClickCommand app createNewBlankProgramCommand\n value untitled.fire\n bern New Fire Program"};
FileDropDownMenuChisel.prototype.getAnchorId=function(){return"fileToggle"};window.FileDropDownMenuChisel=FileDropDownMenuChisel;var GutterChisel=function(a){return Chisel.apply(this,arguments)||this};$jscomp.inherits(GutterChisel,Chisel);GutterChisel._mountedComponents=Chisel._mountedComponents;GutterChisel.prototype.parseNodeType=function(a){return a.startsWith("console")?ConsoleChisel:TerminalChisel};
GutterChisel.prototype.getHakon=function(){var a=this.getTheme(),b=this.getGutterWidth();return Chisel.prototype.getHakon.call(this)+"\n.Gutter\n width "+b+"px\n left 0\n background "+a.backgroundColor+"\n border-color "+a.borderColor+"\n position absolute\n border-right-width 1px\n border-right-style solid\n box-sizing border-box\n top 0\n bottom 0\n padding 20px"};GutterChisel.prototype.getGutterDependencies=function(){return[this.getParent().getNode("programs").getMTime()]};
GutterChisel.prototype.getBray=function(){return"@ div\n class Gutter"};GutterChisel.prototype.hasChanges=function(){return this.getNode("terminal").hasChanges()};GutterChisel.prototype.getGutterWidth=function(){return 400};window.GutterChisel=GutterChisel;var MenuChisel=function(a){return Chisel.apply(this,arguments)||this};$jscomp.inherits(MenuChisel,Chisel);MenuChisel._mountedComponents=Chisel._mountedComponents;
MenuChisel.prototype.getNodeTypes=function(){return{fileDropDownMenu:FileDropDownMenuChisel,openDropDownMenu:OpenDropDownMenuChisel}};MenuChisel.prototype.parseNodeType=function(a){return this.getNodeTypes()[a]};
...
MenuChisel.prototype.getBray=function(){return"@ div\n class MenuChisel "+this.constructor.name+"\n @ a\n  data-onClickCommand app toggleHelpCommand\n  bern ohayo\n @ a\n  id fileToggle\n  data-onClickCommand chisel toggleAndRender\n  value fileDropDownMenu\n  bern File \u25be\n @ a\n  id openToggle\n  data-onClickCommand chisel toggleAndRender\n  value openDropDownMenu\n  bern Open \u25be"};window.MenuChisel=MenuChisel;
var OpenDropDownMenuChisel=function(a){return AbstractDropDownMenuChisel.apply(this,arguments)||this};$jscomp.inherits(OpenDropDownMenuChisel,AbstractDropDownMenuChisel);OpenDropDownMenuChisel._mountedComponents=AbstractDropDownMenuChisel._mountedComponents;
OpenDropDownMenuChisel.prototype.getDropDownBray=function(){var a=this.getApp().getCaddies();return a.length?a.map(function(a){return"@ a\n data-onClickCommand app openUrlInNewSpaceAndFocus\n value "+a.getCaddyLink()+"\n href "+a.getCaddyLink()+"\n @ span\n  bern "+Format.stripHtml(a.getCaddyLink())}).join("\n"):"@ div\n class message\n bern You don't have any saved programs."};OpenDropDownMenuChisel.prototype.getAnchorId=function(){return"openToggle"};window.OpenDropDownMenuChisel=OpenDropDownMenuChisel;
var PanelChisel=function(a){return Chisel.apply(this,arguments)||this};$jscomp.inherits(PanelChisel,Chisel);PanelChisel._mountedComponents=Chisel._mountedComponents;PanelChisel.prototype.parseNodeType=function(a){var b=this.getApp(),c=a.split(" ")[0];return"program"===c?b.getProgramClass(Util.getFileExtension(a)):{programs:ProgramSwitcherChisel,gutter:GutterChisel}[c]};
...
window.PanelChisel=PanelChisel;var ProgramSwitcherChisel=function(a){return Chisel.apply(this,arguments)||this};$jscomp.inherits(ProgramSwitcherChisel,Chisel);ProgramSwitcherChisel._mountedComponents=Chisel._mountedComponents;ProgramSwitcherChisel.prototype.getDependencyTimestamps=function(){return[this.getParent().getMTime()]};
...
var TerminalChisel=function(a){return Chisel.apply(this,arguments)||this};$jscomp.inherits(TerminalChisel,Chisel);TerminalChisel._mountedComponents=Chisel._mountedComponents;TerminalChisel.prototype.getHakon=function(){return".sourceTextarea\n height "+this._getHeight()+"px"};TerminalChisel.prototype._getProgramSource=function(){var a=this._getProgram();return a?a.childrenToString():""};TerminalChisel.prototype._getProgram=function(){return this.getParent().getParent().getMountedProgram()};
...
BlockInspectorModal.prototype.getModalBray=function(){var a=this._getChildBlock(),b=a.getInputBinder(),c=a.getOutputBinder(),d=c.getColumnsArrayOfObjects(),e=b.getColumnsArrayOfObjects(),f=b.getCardCount(),g=c.getCardCount(),h=a.getMessageBuffer().getChildren().map(function(a){return"@ li\n bern "+moment(a.getMTime()).fromNow()+" - "+a.childrenToString()}),k=a.getBlock().getPropertyNodes().map(function(a){return a.getPropertyName()+" "+a.getPropertyTypeName()+" "+a.getDescription()}).join("\n"),l=
a.getStruct(),m=a.getParent().getBase();return"@ div\n bern Input cards: "+f+" Output cards: "+g+"\n@ div\n bern Load time: "+a.getTTL()+" Render time: "+a.getNewestTimeToRender()+"\n@ div\n bern BlockClass: "+a.constructor.name+" Parent: "+m+"\n@ div\n bern Messages:\n@ ol\n "+h+"\n@ div\n bern Tree:\n@ pre\n bern"+TreeNotation.nest(a.toString(),2)+"\n@ div\n bern BlockStruct:\n@ pre\n bern"+TreeNotation.nest(JSON.stringify(l,null,2),2)+"\n@ div\n bern All Block Properties:\n@ pre\n bern"+TreeNotation.nest(k,
2)+"\n@ div\n bern Input Columns:\n@ pre\n bern"+TreeNotation.nest((new TreeNotation(e)).toFixedWidthTable(),2)+"\n@ div\n bern Output Columns\n@ pre\n bern"+TreeNotation.nest((new TreeNotation(d)).toFixedWidthTable(),2)+"\n@ div\n bern Output Numeric Values:\n@ pre\n bern"+TreeNotation.nest((new TreeNotation(c.getNumericValues())).toFixedWidthTable(),2)+"\n@ div\n bern TypeScript Interface:\n@ pre\n bern"+TreeNotation.nest(c.toTypeScriptInterface(),2)+"\n@ div\n bern Input Numeric Values:\n@ pre\n bern"+
TreeNotation.nest((new TreeNotation(b.getNumericValues())).toFixedWidthTable(),2)};window.BlockInspectorModal=BlockInspectorModal;var CardEditorModal=function(a){return AbstractModalChisel.apply(this,arguments)||this};$jscomp.inherits(CardEditorModal,AbstractModalChisel);CardEditorModal._mountedComponents=AbstractModalChisel._mountedComponents;CardEditorModal.prototype.componentDidMount=function(){AbstractModalChisel.prototype.componentDidMount.call(this);this._getTextArea().getShadow().setShadowValue(this.getCard().cardToString())};
...
CardEditorModal.prototype.getModalBray=function(){return"@ h4\n bern Editing node\n@ textarea\n class bigInput\n rows 20\n id editCardTextarea\n@ button\n title "+Say($jscomp$templatelit$18)+"\n class leftButton\n data-onClickCommand chisel _deleteCardCommand\n bern "+MakeSVG("trash",30)+"\n@ button\n title Save\n class rightButton\n data-onClickCommand chisel _saveCardCommand\n bern "+MakeSVG("check",30)};CardEditorModal.prototype.getCard=function(){return this.getApp().getTargetNode()};
...
CustomConfirmModal.prototype.getModalBray=function(){return"@ h4\n bern "+this.getBeam()+"\n@ button\n value 0\n data-onClickCommand chisel _resolveCommand\n bern "+Say($jscomp$templatelit$19)+"\n@ button\n value 1\n data-onClickCommand chisel _resolveCommand\n bern "+Say($jscomp$templatelit$20)};CustomConfirmModal.prototype._resolveCommand=function(a){this.resolve("1"===a);this.getApp().closeModal();return Promise.resolve()};
...
HelpModal.prototype.getModalBray=function(){var a=this.getApp(),b=Object.values(a.getETNs()),c=Object.values(a.getDictionaries()),d=c.map(function(a){return a.getDocs()}).join("<br><br>"),c=c.map(function(a){return a.getLine()}).join(", ");a.getMountedProgram();return"@ h4\n bern About "+Say($jscomp$templatelit$21)+"\n@ p\n bern ohayo will be the fastest programming tool in the solar system.\n@ p\n @ a\n  data-onClickCommand app openOhayoProgramCommand\n  value ohayo.flow\n  bern Welcome Page\n @ span\n  bern |\n @ a\n  data-onClickCommand app openOhayoProgramCommand\n  value readme.flow\n  bern Read Me\n @ span\n  bern |\n @ a\n  data-onClickCommand app openOhayoProgramCommand\n  value faq.flow\n  bern FAQ\n @ span\n  bern |\n @ a\n  data-onClickCommand app openOhayoProgramCommand\n  value releasenotes.flow\n  bern Release Notes\n @ span\n  bern |\n @ a\n  data-onClickCommand app openOhayoProgramCommand\n  value helloWorld.fire\n  bern Fire Hello World\n @ span\n  bern |\n @ a\n  data-onClickCommand app openOhayoProgramCommand\n  value fib.fire\n  bern Fire Fibonacci\n@ a\n class helpToggle\n data-onClickCommand app toggleShadowById\n value shortcutsHelp\n bern "+
Say($jscomp$templatelit$22)+"\n"+this._getShortcutsHelpBray()+"\n@ a\n class helpToggle\n data-onClickCommand app toggleShadowById\n value etnHelpSection\n bern ETN help\n@ div\n class helpSection\n id etnHelpSection\n @ p\n  bern ohayo currently supports "+b.length+" ETNs ("+c+"). Here are the available blocks.\n @ pre\n  bern"+TreeNotation.nest(d,3)+"\n@ p\n bern Version "+a.getVersion()+" "+a.constructor.name};window.HelpModal=HelpModal;
var InsertCardModal=function(a){return AbstractModalChisel.apply(this,arguments)||this};$jscomp.inherits(InsertCardModal,AbstractModalChisel);InsertCardModal._mountedComponents=AbstractModalChisel._mountedComponents;InsertCardModal.prototype.componentDidMount=function(){AbstractModalChisel.prototype.componentDidMount.call(this);var a=this._getChildBlock(),b=this._getTextArea();b.getShadow().setShadowValue(a.getOutputBinder().toBlankFormTemplate());b.getShadow().focusShadow()};
InsertCardModal.prototype._getChildBlock=function(){return this.getApp().getTargetNode()};InsertCardModal.prototype._getTextArea=function(){return this.getStump().findStumpByChild("id newCardTextarea")};InsertCardModal.prototype._submitCardCommand=function(){var a=new TreeNotation(this._getTextArea().getShadow().getShadowValue());this._getChildBlock().createCards([a]);this.getApp().closeModal()};
InsertCardModal.prototype.getModalBray=function(){return"\n@ h4\n bern Insert\n@ textarea\n rows 20\n wrap off\n class bigInput\n id newCardTextarea\n@ button\n title Save\n data-onClickCommand chisel _submitCardCommand\n class SVGIcon rightButton\n bern "+MakeSVG("check",30)};window.InsertCardModal=InsertCardModal;var InsertCardsModal=function(a){return AbstractModalChisel.apply(this,arguments)||this};$jscomp.inherits(InsertCardsModal,AbstractModalChisel);InsertCardsModal._mountedComponents=AbstractModalChisel._mountedComponents;
InsertCardsModal.prototype.componentDidMount=function(){AbstractModalChisel.prototype.componentDidMount.call(this);this._getBulkTextarea().getShadow().focusShadow()};InsertCardsModal.prototype._getChildBlock=function(){return this.getApp().getTargetNode()};InsertCardsModal.prototype._getBulkTextarea=function(){return this.getStump().findStumpByChild("id bulkTextarea")};InsertCardsModal.prototype._getBulkAdvanced=function(){return this.getStump().findStumpByChild("id bulkAdvanced")};
...
OhayoApp.prototype.renameFileCommand=function(a,b,c){this.storeValue(b,this.getFromStore(a)||"");this.removeValue(a);return Promise.resolve(b)};OhayoApp.prototype._createFile=function(a,b){a=this._getAvailablePermalink(a);this.storeValue(a,b);return Promise.resolve(a)};OhayoApp.prototype.createAndOpen=function(a,b){var c=this;return this._createFile(b,a).then(function(a){return c.openUrlInNewSpaceAndFocus(a)})};window.OhayoApp=OhayoApp;BrowserDocument.startApp(OhayoApp);
