...
k+"}\n":k+d};window.AbstractFireBlock=AbstractFireBlock;var AbstractBrowserApplication=function(a){return AbstractApp.apply(this,arguments)||this};$jscomp.inherits(AbstractBrowserApplication,AbstractApp);AbstractBrowserApplication._mountedComponents=AbstractApp._mountedComponents;
...
AbstractBrowserApplication.prototype._getAvailablePermalink=function(a){var b=Util.getFileExtension(a);a=Util.removeFileExtension(a);for(var c=2,d="",e=""+a+d+"."+b;this.doesFileExistSync(e);)e=""+a+d+"."+b,d="-"+c,c++;return e};AbstractBrowserApplication.prototype._appendBlocks=function(a,b){return this.getNodeCursors().map(function(c){c=c.append(a,b);c.executeLoadNewPlane();return c})};AbstractBrowserApplication.prototype.isPaid=function(){return!!Util.parseCookie(this.getWindowCookie()).paidToken};
...
AbstractBrowserApplication.prototype.getNodeCursors=function(){var a=this.getMountedProgram().getSelectedBlocks();return a.length?a:[this.getMountedProgram()]};AbstractBrowserApplication.prototype.deleteAllRowsInTargetBlockCommand=function(){var a=this,b=this.getTargetNode().getInputPlane();return Promise.all(b.getRows().map(function(a){return a.destroyRowCommand()})).then(function(){a.renderApp()})};
...
AbstractBrowserApplication.prototype.showTabRenamePromptCommand=function(){var a=this,b=this.getMountedProgram();this.promptToRenameFile(b.getFullPath()).then(function(c){if(!c)return!1;a.openUrlInNewSpaceAndFocus(""+a.getFolderPath()+c).then(function(c){a.getFocusedPanel().closeProgram(b)});a.refreshLinks()});return Promise.resolve()};AbstractBrowserApplication.prototype.refreshLinks=function(){};AbstractBrowserApplication.prototype.refreshLinksCommand=function(){return this.refreshLinks()};
