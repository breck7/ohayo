...
AbstractChisel.prototype._shouldComponentUpdate=function(){var a=this.getLastRenderedTime();return!a||a<this.getMTime()?!0:this.getDependencyTimestamps().some(function(b){return b>a})};AbstractChisel.prototype.getDependencyTimestamps=function(){return[]};AbstractChisel.prototype.shouldComponentMount=function(){return!0};
AbstractChisel.prototype.render=function(a,b){var c=this.isMounted(),d=!1;c?d=this._update():this._mount(a,b);this.isMounted()&&this._renderChildren();c?d&&this.componentDidUpdate():this.componentDidMount();return this};window.AbstractChisel=AbstractChisel;var AbstractProgramNodeChisel=function(a){return AbstractChisel.apply(this,arguments)||this};$jscomp.inherits(AbstractProgramNodeChisel,AbstractChisel);AbstractProgramNodeChisel._mountedComponents=AbstractChisel._mountedComponents;
AbstractProgramNodeChisel.prototype.parseNodeType=function(a){var b=this.getDictionary();this.getApp();return b.dynamicGetJsClass(this,a)};AbstractProgramNodeChisel.prototype.getProgram=function(){return this.isProgram()?this:this.getParent().getProgram()};AbstractProgramNodeChisel.prototype.getCardClass=function(){return ObjectBackedCard};AbstractProgramNodeChisel.prototype.getStructColumns=function(){return[]};AbstractProgramNodeChisel.prototype.getBlockClassColumns=function(){return[]};
AbstractProgramNodeChisel.prototype.getChildBlocks=function(){return this.getChildrenByNodeType(AbstractProgramNodeChisel)};AbstractProgramNodeChisel.prototype.getDescendantBlocks=function(){var a=[];this.getChildBlocks().forEach(function(b){return b._getDescendantBlocks(a)});return a};AbstractProgramNodeChisel.prototype._getDescendantBlocks=function(a){a.push(this);this.getChildBlocks().forEach(function(b){return b._getDescendantBlocks(a)})};
AbstractProgramNodeChisel.prototype.getHierarchyWithNonTerminals=function(){return{children:this.getChildBlocks().map(function(a){return a._getHierarchyWithNonTerminals()})}};AbstractProgramNodeChisel.prototype._getHierarchyWithNonTerminals=function(){var a=this.getChildBlocks().map(function(a){return a._getHierarchyWithNonTerminals()});a.unshift({block:this});return{children:a}};AbstractProgramNodeChisel.prototype.getTTL=function(){return this._ttl||0};
AbstractProgramNodeChisel.prototype.getHierarchy=function(){return{block:this,children:this.getChildBlocks().map(function(a){return a.getHierarchy()})}};AbstractProgramNodeChisel.prototype.getInputBinder=function(){var a=this.getParent();return a.isProvider()?a.getOutputBinder():a.getInputBinder()};AbstractProgramNodeChisel.prototype.getOutputBinder=function(){if(!this.isProvider())return this.getInputBinder();this._outputBinder||(this._outputBinder=new Binder(this));return this._outputBinder};
window.AbstractProgramNodeChisel=AbstractProgramNodeChisel;var AbstractProgramRootChisel=function(a){return AbstractProgramNodeChisel.apply(this,arguments)||this};$jscomp.inherits(AbstractProgramRootChisel,AbstractProgramNodeChisel);AbstractProgramRootChisel._mountedComponents=AbstractProgramNodeChisel._mountedComponents;AbstractProgramRootChisel.prototype.isProvider=function(){return!0};AbstractProgramRootChisel.prototype.getGuess=function(){return{guess:this.getParseErrorCount(),name:this.getExtensionName()}};
AbstractProgramRootChisel.prototype.getProgramOfInterest=function(){return this};AbstractProgramRootChisel.prototype.getDictionary=function(){var a=this.getExtensionName();this._dictionary||(this._dictionary=new DictionaryProgram(this.getDictionaryString(),a,this));return this._dictionary};AbstractProgramRootChisel.prototype.isProgram=function(){return!0};AbstractProgramRootChisel.prototype.getProgramTypeString=function(){return this.getTopDownArray().map(function(a){return a.getIndentation()+a.getTypeLine()}).join("\n")};
AbstractProgramRootChisel.prototype.executeLoadProgramCode=function(){var a=this,b=this.getDictionary(),c=lodash.uniq(this.getDescendantBlocks().map(function(a){return a.getBase()}));return Promise.all(c.map(function(c){return b.loadBlockCode(c,a.getApp())}))};AbstractProgramRootChisel.prototype.executeLoadProgramCodeAndData=function(){var a=this;return this.executeLoadProgramCode().then(function(){return Promise.all(a.getChildBlocks().map(function(a){return a.executeLoadNewBinder()}))})};
AbstractProgramRootChisel.prototype.getBlockDimensionMap=function(a,b){return(new (this._getLayoutStrategyClass())(this,a,b)).makeBlockDimensionMap()};AbstractProgramRootChisel.prototype._getLayoutStrategyClass=function(){return LayoutStrategies[this.findBeam(">settings layout")]||LayoutStrategies.custom};
AbstractProgramRootChisel.prototype.getProgramDimension=function(){var a=this.getApp().getWillowDocument().getBodyStump().getShadow();return{width:a.getShadowWidth()-this.getParent().getGutterWidth(),height:a.getShadowHeight()}};AbstractProgramRootChisel.prototype.getSelectedBlocks=function(){return this.getDescendantBlocks().filter(function(a){return a.isSelected()})};AbstractProgramRootChisel.prototype.clearSelection=function(){this.getSelectedBlocks().forEach(function(a){return a.unselect()})};
AbstractProgramRootChisel.prototype.selectAll=function(){this.getDescendantBlocks().forEach(function(a){return a.selectBlock()})};AbstractProgramRootChisel.prototype.getFirstSelectedBlock=function(){return this.getSelectedBlocks()[0]};AbstractProgramRootChisel.prototype.selectNext=function(){for(var a=this.getFirstSelectedBlock().getNext();!a.getBase().startsWith(">");)a=this.getFirstSelectedBlock().getNext();this.clearSelection();a.selectBlock();return Promise.resolve()};
AbstractProgramRootChisel.prototype.copySelection=function(a){a=this._copySelection(a);if(!a)return Promise.resolve();this.getApp().logMessage("Items copied");return Promise.resolve(a)};AbstractProgramRootChisel.prototype._copySelection=function(a){var b=this.getApp().getWillowDocument();if(b.someInputHasFocus())return"";var c=this.selectionToString();if(!c)return"";b.setCopyData(a,c);return c};AbstractProgramRootChisel.prototype.selectionToString=function(){return this.getSelectedBlocks().map(function(a){return a.toString()}).join("\n")};
AbstractProgramRootChisel.prototype.selectBlocksByShadowClass=function(a){a=void 0===a?"ui-selected":a;this.getApp().getWillowDocument().findStumpsByShadowClass(a).forEach(function(a){return a.getStumpChisel().selectBlock()})};AbstractProgramRootChisel.prototype._getPinChangeInPixels=function(a,b){return{left:a.offset.left-b.left,top:a.offset.top-b.top}};
AbstractProgramRootChisel.prototype.cutSelection=function(a){a=this._copySelection(a);if(!a)return Promise.resolve();this.deleteSelection();this.getApp().logMessage("Items cut");return Promise.resolve(a)};AbstractProgramRootChisel.prototype.deleteSelection=function(){var a=this.getSelectedBlocks();if(!a.length)return Promise.resolve();a.forEach(function(a){return a.unmountAndDestroy()});return this.autosaveAndRender()};
AbstractProgramRootChisel.prototype.duplicateSelection=function(){var a=this,b=this.getSelectedBlocks().map(function(b){return a.cloneBlock(b)}),c=this.autosaveAndRender();this.clearSelection();b.forEach(function(a){return a.selectBlock()});return c};AbstractProgramRootChisel.prototype.selectPrevious=function(){for(var a=this.getFirstSelectedBlock().getPrevious();!a.getBase().startsWith(">");)a=this.getFirstSelectedBlock().getPrevious();this.clearSelection();a.selectBlock();return Promise.resolve()};
AbstractProgramRootChisel.prototype.appendFromPaste=function(a){var b=this,c=this.concat(a).filter(function(a){return a instanceof AbstractBlockChisel});a=this.autosaveAndRender();this.clearSelection();return a.then(function(){return b.executeLoadProgramCodeAndData().then(function(){c.forEach(function(a){return a.selectBlock()})}).catch(function(a){console.error(a)})})};
AbstractProgramRootChisel.prototype.getAutocompleteWords=function(a){var b=this.getDictionary().getBlockNames().join("\n")+"\n"+this.childrenToString();return Util.getUniqueWordsArray(b).filter(function(b){return b.word.includes(a)&&b.word!==a}).map(function(a){return a.word})};AbstractProgramRootChisel.prototype.setLayout=function(a){this.touchNode(">settings layout").setBeam(a);return this};
AbstractProgramRootChisel.prototype.cloneBlock=function(a){var b=a.duplicate();(a=a.findBeam(BlockConstants.pin))&&b.touchNode(BlockConstants.pin).setBeam(this.getAvailableSpot(a));return b};AbstractProgramRootChisel.prototype._updateCustomPoint=function(){return this._updateCustomLayout()};AbstractProgramRootChisel.prototype._updateCustomPointWithWidthAndHeight=function(){return this._updateCustomLayout(!0)};
AbstractProgramRootChisel.prototype._updateCustomLayout=function(a){a=void 0===a?!0:a;var b=this,c=this.getApp();c.getWillowDocument().findStumpsWithClass("BlockChisel").forEach(function(c){return b._updateBlockLayout(c,a)});this.setLayout("custom");this.autosaveProgram();c.renderApp()};
AbstractProgramRootChisel.prototype._updateBlockLayout=function(a,b){var c=a.getShadow(),d=a.getStumpChisel();if(d.isVisible()){var e=c.getShadowOffset(),f=this.getGridSize();a=a.getParent().getShadow().getShadowOffset();c=[Math.floor((e.left-a.left)/f),Math.floor((e.top-a.top)/f),Math.floor(c.getShadowWidth()/f),Math.floor(c.getShadowHeight()/f)];b=(b?c:c.slice(0,2)).join(" ");d.findBeam(BlockConstants.pin)!==b&&(d.delete(BlockConstants.pin),d.prepend(BlockConstants.pin+" "+b))}};
AbstractProgramRootChisel.prototype.getAvailableSpot=function(a){a=a.split(" ").map(function(a){return parseInt(a)});a[0]++;a[1]++;return a.join(" ")};AbstractProgramRootChisel.prototype.toggleLayout=function(){var a=this.toggle(">settings layout",["custom","bin","tree"]);this.getDescendantBlocks().forEach(function(a){return a.makeDirty()});this.getApp().logMessage("Layout set to '"+a+"'");return this.autosaveAndRender()};AbstractProgramRootChisel.prototype.getGridSize=function(){return 20};
AbstractProgramRootChisel.prototype._getLongestLoadTime=function(){return this.getDescendantBlocks().map(function(a){return a.getTTL()}).sort().reverse()[0]};AbstractProgramRootChisel.prototype._getLongestRenderTime=function(){return this.getDescendantBlocks().map(function(a){return a.getNewestTimeToRender()}).sort().reverse()[0]};AbstractProgramRootChisel.prototype.autosaveAndRender=function(){var a=this.autosaveProgram();this.getApp().renderApp();return a};
AbstractProgramRootChisel.prototype.autosaveProgram=function(){var a=this,b=this.childrenToString(),c=this._getTopUndoVersion();if(b===c)return Promise.resolve();this._recordChange(b);return this.getApp().isAutoSaveEnabled()?this.forceSaveToDisk().then(function(){a.logMessage("Saved "+a.getUrl())}):Promise.resolve()};AbstractProgramRootChisel.prototype._clearRedoStack=function(){var a=this._getRedoStack();a.splice(0,a.length)};
AbstractProgramRootChisel.prototype._recordChange=function(a){this._clearRedoStack();this._getUndoStack().push(a)};AbstractProgramRootChisel.prototype.forceSaveToDisk=function(){var a=this._getDiff();this.setHash(a.newHash);this._setDiskVersion(a.newVersion);return this.getApp().saveProgramToDisk(this,a)};AbstractProgramRootChisel.prototype._getDiskVersion=function(){return this._diskVersion};AbstractProgramRootChisel.prototype._setDiskVersion=function(a){this._diskVersion=a;return this};
AbstractProgramRootChisel.prototype._getUndoStack=function(){this._undoStack||(this._undoStack=[]);return this._undoStack};AbstractProgramRootChisel.prototype._getRedoStack=function(){this._redoStack||(this._redoStack=[]);return this._redoStack};AbstractProgramRootChisel.prototype._getTopUndoVersion=function(){var a=this._getUndoStack();return a[a.length-1]};
AbstractProgramRootChisel.prototype.undoCommand=function(){var a=this._getUndoStack(),b=this._getRedoStack();if(1===a.length)return Promise.resolve();b.push(a.pop());return this._reloadFromUndoTop()};AbstractProgramRootChisel.prototype._reloadFromUndoTop=function(){this.unmount();this.setChildren(this._getTopUndoVersion());return this._reloadProgram()};AbstractProgramRootChisel.prototype.autosaveAndReloadWith=function(a){this.unmount();this.setChildren(a);this.autosaveProgram();return this._reloadProgram()};
AbstractProgramRootChisel.prototype._reloadProgram=function(){var a=this;return this.executeLoadProgramCodeAndData().then(function(){a.getParent().setMountedProgram(a);a.getApp().renderApp()})};AbstractProgramRootChisel.prototype.redoCommand=function(){var a=this._getUndoStack(),b=this._getRedoStack();if(!b.length)return Promise.resolve();a.push(b.pop());return this._reloadFromUndoTop()};AbstractProgramRootChisel.prototype.hasUnsavedChanges=function(){return this.childrenToString()!==this._getDiskVersion()};
AbstractProgramRootChisel.prototype.getHash=function(){return this._hash||""};AbstractProgramRootChisel.prototype.setHash=function(a){this._hash=a};AbstractProgramRootChisel.prototype._getDiff=function(){var a=this.getHash(),b=this.childrenToString(),c=this._getDiskVersion(),c=diff.compareStr(c,b,"\n"),d=new jsSHA("SHA-1","TEXT");d.update(a+JSON.stringify(c));d=d.getHash("HEX");return{oldHash:a,newHash:d,patch:c,newVersion:b}};
AbstractProgramRootChisel.prototype.setChildrenAndDiskAndUndoStack=function(a){this.setChildren(a);this._setDiskVersion(a);this._getUndoStack().push(a);return this};AbstractProgramRootChisel.prototype.getFileName=function(){return this.getUrl().split("/").pop()};AbstractProgramRootChisel.prototype.getUrl=function(){return this.getBeam()};AbstractProgramRootChisel.prototype.getCTime=function(){return this._ctime||0};
AbstractProgramRootChisel.prototype.getHakon=function(){var a=this.getTheme(),b=this.getParent().getGutterWidth();return".AbstractProgramRootChisel\n background "+a.surfaceBackground+"\n position relative\n left "+b+"px\n right 0\n bottom 0\n height calc(100% - 60px)\n\n.ui-selectable-helper\n position absolute\n z-index 100\n border-radius 2px\n background "+a.selectionBackground+"\n\n.ui-selecting,.ui-selected,.StaySelected\n outline 3px solid "+a.selectedOutline};
AbstractProgramRootChisel.prototype.makePin=function(a){var b=this.getGridSize();return[Math.floor((a.offsetX-0)/b),Math.floor(a.offsetY/b)].join(" ")};AbstractProgramRootChisel.prototype.componentDidUpdate=function(){this._fixBigBug()};
AbstractProgramRootChisel.prototype._fixBigBug=function(){var a={"min-height":"","min-width":"",width:"",height:""},b=this.getApp(),c=this.getStump(),d=c.getParent(),e=b.getWillowDocument(),f=e.getHtmlStump(),b=(b=b.getMenuChisel())&&b.getStump();c.setStumpCss(a);d.setStumpCss(a);f.setStumpCss(a);e.forceRepaint();e=e.getDocumentSize();b&&b.setStumpCss(a);f.setStumpCss(a);a=e.width;e=e.height;b&&b.setStumpCss({width:a});f.setStumpCss({"min-height":"100%","min-width":"100%",width:a,height:e});f={"min-height":e-
60+"px","min-width":a+"px"};d.setStumpCss(f);c.setStumpCss(f)};AbstractProgramRootChisel.prototype.componentDidMount=function(){this._makeSelectable();this._makeBlocksMoveableAndResizableAndEditable();this._fixBigBug()};
AbstractProgramRootChisel.prototype._makeSelectable=function(){var a=this.getApp(),b=this.getStump().getShadow(),c=a.getWillowDocument();b.onShadowEvent(ShadowEvents.click,function(a){a.target===b.getShadowElement()&&c.blurFocusedInput()});b.makeSelectable({cancel:".BlockChisel",distance:10,filter:".BlockChisel",start:function(b){b.shiftKey?c.findStumpsWithClass("ui-selected").forEach(function(a){return a.addClassToStump("StaySelected")}):a.clearSelectionCommand()},stop:function(){c.findStumpsWithClass("StaySelected").forEach(function(a){return a.addClassToStump("ui-selected").removeClassFromStump("StaySelected")});
a.selectBlocksByShadowClassCommand();return!0}})};AbstractProgramRootChisel.prototype.getAllCards=function(){return lodash.flatten(this.getDescendantBlocks().map(function(a){return a.isProvider()?a.getOutputBinder().getCards():[]}))};AbstractProgramRootChisel.prototype.getProgramCardCount=function(){return this.getAllCards().reduce(function(a,b){return a+b.length},0)};
AbstractProgramRootChisel.prototype.getProgramStats=function(){var a=this.getDescendantBlocks(),b=a.map(function(a){return a.getBlockErrorCount()}).reduce(function(a,b){return a+b},0);return{blocks:a.length,cards:this.getProgramCardCount(),url:this.getFileName(),timeToLoad:this._getLongestLoadTime(),timeToRender:this._getLongestRenderTime(),errorCount:b}};
AbstractProgramRootChisel.prototype.shouldComponentMount=function(){return AbstractProgramNodeChisel.prototype.shouldComponentMount.call(this)&&this.getParent().getMountedProgram()===this};
AbstractProgramRootChisel.prototype._makeBlocksMoveableAndResizableAndEditable=function(){var a=this.getApp(),b=a.getWillowDocument(),c=this,d=this.getGridSize();this.getStump().getShadow().onShadowEvent(ShadowEvents.mouseover,".BlockChisel",function(e){e=b.getStumpFromElement(this);var f=e.getShadow();if(f.isShadowResizable())return!0;c._makeGroupDraggable(e,[d,d]);f.makeResizable({handles:"se",grid:d,resize:function(a){a.stopPropagation();a.preventDefault();return!1},stop:function(){return a.getMountedProgram()._updateCustomPointWithWidthAndHeight()}})})};
AbstractProgramRootChisel.prototype.getContextMenuCommandsBray=function(){return"@ a\n tabindex -1\n data-onClickCommand app saveCompiledCommand\n bern Save compiled '"+this.compilesTo()+"' file"};AbstractProgramRootChisel.prototype.getBray=function(){return"@ div\n class AbstractProgramRootChisel "+this.constructor.name+"\n data-onContextMenuCommand chisel _openProgramContextMenuCommand\n data-onDblClickCommand app insertMorphBlockCommand"};
AbstractProgramRootChisel.prototype._openProgramContextMenuCommand=function(){return this.getApp().toggleAndRender("programContextMenu")};AbstractProgramRootChisel.prototype._getSelectedBlockStumps=function(){return this.getApp().getWillowDocument().findStumpsWithClass("ui-selected")};
AbstractProgramRootChisel.prototype._updateSelectedOnMove=function(a,b){var c=this._getSelectedBlockStumps();c.length&&c.filter(function(b){return b!==a}).forEach(function(a){var c=parseFloat(a.getStumpCss("top")),d=parseFloat(a.getStumpCss("left"));a.setStumpCss({transform:"",top:c+b.top+"px",left:d+b.left+"px"})})};
AbstractProgramRootChisel.prototype._makeGroupDraggable=function(a,b){if(a.stumpHasClass("draggable"))return!0;var c,d=this,e=this.getApp(),f={stop:function(b,f){a.removeClassFromStump("noTransition");a.setStumpAttr("data-translate","undefined undefined");b=d._getPinChangeInPixels(f,c);d._updateSelectedOnMove(a,b);c=f;e.getMountedProgram()._updateCustomPoint()},handle:".BlockGrabber",drag:function(b,e){if(a.stumpHasClass("ui-selected")){var f=d._getPinChangeInPixels(e,c);d._getSelectedBlockStumps().filter(function(b){return b!==
a}).forEach(function(a){return a.setStumpCss({transform:"translate("+f.left+"px, "+f.top+"px)"})})}},start:function(b,d){c=d.offset;a.addClassToStump("noTransition");if(b=a.getStumpAttr("data-translate"))parseInt(b.split(" ")[0]),parseInt(b.split(" ")[1])}};b&&(f.grid=b);a.addClassToStump("draggable").getShadow().makeDraggable(f)};window.AbstractProgramRootChisel=AbstractProgramRootChisel;
...
TreeBackedCard.prototype.cardToString=function(){return this.getCardSource().childrenToString()};TreeBackedCard.prototype.getCardValue=function(a){return this.getCardSource().findBeam(a)||""};window.TreeBackedCard=TreeBackedCard;var AbstractBlockChisel=function(a){return AbstractProgramNodeChisel.apply(this,arguments)||this};$jscomp.inherits(AbstractBlockChisel,AbstractProgramNodeChisel);AbstractBlockChisel._mountedComponents=AbstractProgramNodeChisel._mountedComponents;
AbstractBlockChisel.prototype.getStruct=function(){this._blockStruct||(this._blockStruct=this.getBlock().computeStruct(this));return this._blockStruct};AbstractBlockChisel.prototype.getDictionary=function(){return this.getProgram().getDictionary()};AbstractBlockChisel.prototype.getPipishInput=function(){return this.getStruct().slang||this.getInputBinder().getFirstColumnAsString()||""};AbstractBlockChisel.prototype.isVisible=function(){return"false"!==this.findBeam("visible")};
AbstractBlockChisel.prototype.selectBlock=function(){this._selected=!0;this.isMounted()&&this.getStump().addClassToStump("ui-selected")};AbstractBlockChisel.prototype.unselect=function(){delete this._selected;this.isMounted()&&this.getStump().removeClassFromStump("ui-selected")};AbstractBlockChisel.prototype.isSelected=function(){return this._selected};
...
return d};AbstractBlockChisel.loadCode=function(){return Promise.resolve()};AbstractBlockChisel.prototype.createCardsFromTNCommand=function(a){return this.createCards((new CardParser).parse(a,"tree"))};AbstractBlockChisel.prototype.createCards=function(a){return Promise.resolve()};AbstractBlockChisel.prototype.fetchCards=function(){return Promise.resolve([])};
...
AbstractBlockChisel.prototype.getBlockFooterBray=function(){return this.getBlockToolbarButtonBray()};AbstractBlockChisel.prototype.getBlockToolbarButtonBray=function(){return"@ span\n class BlockPencilButton\n data-onClickCommand chisel toggleToolbarCommand\n bern "+Icons("pencil",16)};AbstractBlockChisel.prototype.openBlockInspectorCommand=function(){return this.getApp().setTargetNode(this).toggleAndRender("blockInspectorModal")};AbstractBlockChisel.prototype.getSuggestedSize=function(){return this.getBlock().getSuggestedSize()};
...
AbstractBlockChisel.prototype.getTypeLine=function(){this.getBlock();var a=this.getBeamPatternWords(),b=this.getWords(1),c=a.length-1;a.forEach(function(a,d){d===c&&b.slice(d).join(" ")});var a=["instruction"].concat(a),d=a[a.length-1];if(d.endsWith("+")){d=d.replace("+","");a[a.length-1]=d;for(var e=this.getWords();e.length>a.length;)a.push(d)}return a.join(" ")};window.AbstractBlockChisel=AbstractBlockChisel;var BinPacker=function(){};
...
window.BinPacker=BinPacker;var BlockConstants={pin:"pin",percentage:"percentage"};window.BlockConstants=BlockConstants;var BlockDimension=function(a,b){a=a.getSuggestedSize();this.width=a.width;this.height=a.height;Object.assign(this,b)};BlockDimension.prototype.getScaledCss=function(a){a=void 0===a?1:a;return this._toCss({width:this.width*a,height:this.height*a,left:this.left*a,top:this.top*a})};BlockDimension.prototype.toCss=function(){return this._toCss(this)};
BlockDimension.prototype._toCss=function(a){return"width: "+a.width+"px; height: "+a.height+"px; left: "+a.left+"px; top: "+a.top+"px"};window.BlockDimension=BlockDimension;var DidYouMeanBlock=function(a){return AbstractBlockChisel.apply(this,arguments)||this};$jscomp.inherits(DidYouMeanBlock,AbstractBlockChisel);DidYouMeanBlock._mountedComponents=AbstractBlockChisel._mountedComponents;DidYouMeanBlock.loadCode=AbstractBlockChisel.loadCode;
...
var TreeLayout=function(a){AbstractLayoutStrategy.apply(this,arguments)};$jscomp.inherits(TreeLayout,AbstractLayoutStrategy);TreeLayout.prototype.makeBlockDimensionMap=function(){var a=this.getProgram().getHierarchy(),a=d3.hierarchy(a),b=d3.tree().size([.8*this._getLayoutBoxWidth(),.8*this._getLayoutBoxHeight()]),c=new Map;b(a).descendants().forEach(function(a){var b=a.data.block;b.isProgram()||(a=new BlockDimension(b,{width:80,height:80,left:a.x,top:a.y}),c.set(b,a))});return c};
...
var LayoutStrategies={custom:CustomLayout,column:ColumnLayout,tree:TreeLayout,bin:BinLayout};window.LayoutStrategies=LayoutStrategies;var MorphBlock=function(a){return AbstractBlockChisel.apply(this,arguments)||this};$jscomp.inherits(MorphBlock,AbstractBlockChisel);MorphBlock._mountedComponents=AbstractBlockChisel._mountedComponents;MorphBlock.loadCode=AbstractBlockChisel.loadCode;MorphBlock.prototype.getHakon=function(){this.getTheme();return".MorphBlock\n .BlockBody\n  display flex\n  flex-flow row wrap\n  overflow scroll\n  a\n   margin 10px\n   height 50px\n   overflow hidden\n   text-align center\n   text-overflow ellipsis\n   font-size 12px\n   width 50px"};
MorphBlock.prototype.getBlockBodyBray=function(){var a=this.getDictionary(),b=a.getTopNodeTypes();this.getApp();return b.map(function(b){return a.getDictionaryBlockByName(b)}).map(function(a){var b=Icons(a.getSvg(),24);return"@ a\n title "+a.getDescription()+"\n tabindex -1\n value "+a.getBase()+"\n data-onClickCommand chisel changeTypeCommand\n bern "+b+"<br>"+a.getBase()}).join("\n")};MorphBlock.prototype.getBlockHeaderBern=function(){return""};window.MorphBlock=MorphBlock;
var AbstractCaddy=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(AbstractCaddy,TreeNotation);AbstractCaddy.prototype.getCaddyLink=function(){return this.getLine()};AbstractCaddy.prototype._getCaddyStr=function(){return this.childrenToString()};AbstractCaddy.prototype.toCaddyObject=function(){return{link:this.getCaddyLink(),bytes:this._getCaddyStr()}};window.AbstractCaddy=AbstractCaddy;var AbstractAppChisel=function(a){return AbstractChisel.apply(this,arguments)||this};
$jscomp.inherits(AbstractAppChisel,AbstractChisel);AbstractAppChisel._mountedComponents=AbstractChisel._mountedComponents;
AbstractAppChisel.prototype.componentWillMount=function(){var a=this;this._startVisitCounter();var b=this.getFromStore(StorageKeys.openPrograms),b=(b=b?b.replace("!",""):"")?b.split(" "):[],b=lodash.uniq(b),c=this.getProgramToOpen();c&&-1===b.indexOf(c)&&b.push(c);b=b.map(function(a){return a===c?"!"+a:a});b=b.slice(0,30);this.concat("theme\nmenu\npanel\n programs "+b+"\n gutter\n  terminal\n  console");b.forEach(function(b){return b.startsWith("!")?a.openUrlInNewSpaceAndFocus(b.substr(1)):a.openUrlInNewSpace(b)});
...
var AbstractDropDownMenuChisel=function(a){return AbstractChisel.apply(this,arguments)||this};$jscomp.inherits(AbstractDropDownMenuChisel,AbstractChisel);AbstractDropDownMenuChisel._mountedComponents=AbstractChisel._mountedComponents;
...
BlockToolbarChisel._mountedComponents=AbstractChisel._mountedComponents;BlockToolbarChisel.prototype.getHakon=function(){var a=this.getTheme();return".BlockToolbarChisel\n background "+a.contextMenuBackground+"\n border 1px solid "+a.lineColor+"\n font-size 12px\n position absolute\n padding 8px\n z-index 991\n min-width 300px\n top 100%\n left 0\n cursor pointer\n svg\n  fill "+a.greyish+"\n  padding 1px 3px 3px 3px\n  &:hover\n   fill "+a.foregroundColor};
BlockToolbarChisel.prototype.getChildBlock=function(){return this.getParent()};
...
var ConsoleChisel=function(a){return AbstractChisel.apply(this,arguments)||this};$jscomp.inherits(ConsoleChisel,AbstractChisel);ConsoleChisel._mountedComponents=AbstractChisel._mountedComponents;ConsoleChisel.prototype._getConsoleOutput=function(){var a=this._getMessageBuffer().getChildren().map(function(a){return a.childrenToString()});a.reverse();return a.join("\n")};ConsoleChisel.prototype.getHakon=function(){return".sourcePre\n overflow scroll"};
...
window.ConsoleChisel=ConsoleChisel;var DummyChisel=function(a){return AbstractChisel.apply(this,arguments)||this};$jscomp.inherits(DummyChisel,AbstractChisel);DummyChisel._mountedComponents=AbstractChisel._mountedComponents;DummyChisel.prototype.getHakon=function(){return".DummyChisel\n display none"};window.DummyChisel=DummyChisel;var FileDropDownMenuChisel=function(a){return AbstractDropDownMenuChisel.apply(this,arguments)||this};$jscomp.inherits(FileDropDownMenuChisel,AbstractDropDownMenuChisel);
...
FileDropDownMenuChisel.prototype.getAnchorId=function(){return"fileToggle"};window.FileDropDownMenuChisel=FileDropDownMenuChisel;var GutterChisel=function(a){return AbstractChisel.apply(this,arguments)||this};$jscomp.inherits(GutterChisel,AbstractChisel);GutterChisel._mountedComponents=AbstractChisel._mountedComponents;GutterChisel.prototype.parseNodeType=function(a){return a.startsWith("console")?ConsoleChisel:TerminalChisel};
...
window.PanelChisel=PanelChisel;var ProgramSwitcherChisel=function(a){return AbstractChisel.apply(this,arguments)||this};$jscomp.inherits(ProgramSwitcherChisel,AbstractChisel);ProgramSwitcherChisel._mountedComponents=AbstractChisel._mountedComponents;ProgramSwitcherChisel.prototype.getDependencyTimestamps=function(){return[this.getParent().getMTime()]};
...
var TerminalChisel=function(a){return AbstractChisel.apply(this,arguments)||this};$jscomp.inherits(TerminalChisel,AbstractChisel);TerminalChisel._mountedComponents=AbstractChisel._mountedComponents;TerminalChisel.prototype.getHakon=function(){return".sourceTextarea\n height "+this._getHeight()+"px"};TerminalChisel.prototype._getProgramSource=function(){var a=this._getProgram();return a?a.childrenToString():""};TerminalChisel.prototype._getProgram=function(){return this.getParent().getParent().getMountedProgram()};
...
CrystalCommandNode.prototype.execute=function(a){var b=this;return a.executeCommandLine(this.getArgs()).then(function(){return CrystalProgram.prototype.execute.call(b,a)})};window.CrystalProgram=CrystalProgram;var SubBlockProperty=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(SubBlockProperty,TreeNotation);SubBlockProperty.prototype.getParseErrorCount=function(){return 0};SubBlockProperty.prototype.getTypeLine=function(){return"instruction"};
var AbstractBlockPropertyNode=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(AbstractBlockPropertyNode,TreeNotation);AbstractBlockPropertyNode.prototype.getPropertyName=function(){return this.getWord(1)};AbstractBlockPropertyNode.prototype.getProbability=function(){var a=this.findBeam(BlockConstants.percentage);return a?parseFloat(a):.01};AbstractBlockPropertyNode.prototype.getTypeLine=function(){return"instruction"};
AbstractBlockPropertyNode.prototype._getBlockCommandDropdownBray=function(a,b){a=a.map(function(a){return" @ option\n  value "+a+"\n  bern "+a+"\n  "+(b===a?"selected":"notselected")}).join("\n");return"@ select\n data-onChangeCommand block changePropertyCommand\n name "+this.getPropertyName()+"\n @ option\n"+a};AbstractBlockPropertyNode.prototype.getPropertyTypeName=function(){return this.getWord(0).substr(1)};
AbstractBlockPropertyNode.prototype.getDescription=function(){return this.findBeam("description")||""};AbstractBlockPropertyNode.prototype.parseNodeType=function(a){return SubBlockProperty};AbstractBlockPropertyNode.prototype.getDefaultValue=function(){var a=this.getWords(2),a=a.length?a.join(" "):"";return this.has("default")?this.getNode("default").getBeamWithChildren():a};AbstractBlockPropertyNode.prototype._parseValue=function(a){return a};AbstractBlockPropertyNode.prototype.isMonad=function(){return this.has("monad")};
AbstractBlockPropertyNode.prototype._getUserValue=function(a){var b=this.getDefaultValue();if(this.has("const"))return b;var c=a.getNode(this.getPropertyName()),d=this.isMonad()&&a.getBeam(),c=c&&c.getBeamWithChildren()||d||void 0;return void 0===c&&void 0!==b?b:c?this.has("template")&&c.includes("{")?a.getProgram().format(c):c:c};
AbstractBlockPropertyNode.prototype._addValue=function(a,b){b=this._parseValue(this._getUserValue(b),b);var c=this.findBeam("path");c?lodash.set(a,c,b):a[this.getPropertyName()]=b};AbstractBlockPropertyNode.prototype._getPropValue=function(a){return a.getStruct()[this.getPropertyName()]||""};AbstractBlockPropertyNode.prototype.toFormBray=function(a){return"@ input\n data-onChangeCommand block changePropertyCommand\n name "+this.getPropertyName()+"\n value "+this._getPropValue(a)};
window.AbstractBlockPropertyNode=AbstractBlockPropertyNode;var AlphaNumericProp=function(a){return AbstractBlockPropertyNode.apply(this,arguments)||this};$jscomp.inherits(AlphaNumericProp,AbstractBlockPropertyNode);AlphaNumericProp.prototype._parseValue=function(a){return(void 0===a?"":a).replace(/[^a-z0-9A-Z]/g,"")};window.AlphaNumericProp=AlphaNumericProp;var BooleanProp=function(a){return AbstractBlockPropertyNode.apply(this,arguments)||this};$jscomp.inherits(BooleanProp,AbstractBlockPropertyNode);
BooleanProp.prototype._parseValue=function(a){return"true"===a?!0:!1};BooleanProp.prototype.toFormBray=function(a){return"@ input\n data-onChangeCommand block changePropertyCommand\n name "+this.getPropertyName()+"\n type checkbox\n "+(!0===this._getPropValue(a)?"checked":"unchecked")};window.BooleanProp=BooleanProp;var ColumnProp=function(a){return AbstractBlockPropertyNode.apply(this,arguments)||this};$jscomp.inherits(ColumnProp,AbstractBlockPropertyNode);
ColumnProp.prototype._parseValue=function(a,b){var c=b.getInputBinder(),d=c.getColumnsMap(),e=this.getNode("auto");if(d[a])return a;if(e){if(e.getBeam())return this._getAutoColumn(b,e.getBeam());a=c.getColumnsByImportance();if(a=a.length&&a[0].getColumnName())return a}};ColumnProp.prototype.toFormBray=function(a){var b=a.getInputBinder().getColumnNames();return this._getBlockCommandDropdownBray(b,this._getPropValue(a))};
...
window.ColumnProp=ColumnProp;var DictionaryBlock=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(DictionaryBlock,TreeNotation);DictionaryBlock.prototype.parseNodeType=function(a){if(a.startsWith("&")){var b={boolean:BooleanProp,int:IntProp,prob:ProbProp,format:FormatProp,alphanumeric:AlphaNumericProp,plaintext:PlainTextProp,quick:QuickProp,slang:SlangProp,column:ColumnProp,enum:EnumProp};a=a.split(" ")[0].substr(1);return b[a]||OtherBlockPropertyNode}return TreeNotation};
DictionaryBlock.prototype.getDoc=function(){return this.getBase()};DictionaryBlock.prototype.getMonadName=function(){return this.getPropertyNodes().filter(function(a){return a.isMonad()}).map(function(a){return a.getPropertyName()}).join("")};DictionaryBlock.prototype.getBeamPattern=function(){return this._getExtended().findBeam("beamPattern")};DictionaryBlock.prototype.getDescription=function(){return this.findBeam("description")||""};
DictionaryBlock.prototype.getSvg=function(){return this._getExtended().findBeam("svg")||"table"};DictionaryBlock.prototype._getExtended=function(){this._extended||(this._extended=this._makeExtended());return this._extended};DictionaryBlock.prototype._makeExtended=function(){var a=this.getGraph(),b=new DictionaryBlock;a.forEach(function(a){b.extend(a)});return b};
...
DictionaryBlock.prototype.getSuggestedSize=function(){var a=(this._getExtended().findBeam("size")||"280 220").split(" ").map(function(a){return parseInt(a)});return{width:a[0],height:a[1]}};DictionaryBlock.prototype.getPropertyNodes=function(){var a=[];this.getGraph().forEach(function(b){b.getChildrenByNodeType(AbstractBlockPropertyNode).forEach(function(b){a.push(b)})});return a};
DictionaryBlock.prototype.getPropertiesMap=function(){var a={};this.getPropertyNodes().forEach(function(b){a[b.getPropertyName()]=b});return a};DictionaryBlock.prototype.computeStruct=function(a){var b={};this.getPropertyNodes().forEach(function(c){c._addValue(b,a)});return b};
DictionaryBlock.prototype.getBlockJSClass=function(){if(this._class)return this._class;var a=this._getExtended().findBeam("require").split(" "),b=a[0],c=a[1],d="undefined"!==typeof require,a=d?process:window;d&&!a[b]&&(c=require(c),a[c.name]=c);return this._class=a[b]};DictionaryBlock.prototype.getPercentage=function(){var a=this.findBeam(BlockConstants.percentage);return a?parseFloat(a):0};window.DictionaryBlock=DictionaryBlock;
var DictionaryProgram=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(DictionaryProgram,TreeNotation);DictionaryProgram.prototype.parseNodeType=function(a){return DictionaryBlock};DictionaryProgram.prototype.getTopNodeTypes=function(){var a=this.getChildren().slice(0);a.sort(Util.sortByAccessor(function(a){return a.getPercentage()}));a.reverse();return a.map(function(a){return a.getBase()})};
...
DictionaryProgram.prototype.loadBlockCode=function(a,b){this._loadedBlocks||(this._loadedBlocks={});this._loadedBlocks[a]||(this._loadedBlocks[a]=this.getDictionaryBlockByName(a).executeLoadBlockOrGetLoadingPromise(b));return this._loadedBlocks[a]};window.DictionaryProgram=DictionaryProgram;var EnumProp=function(a){return AbstractBlockPropertyNode.apply(this,arguments)||this};$jscomp.inherits(EnumProp,AbstractBlockPropertyNode);
EnumProp.prototype.getChoices=function(){var a=this.getNode("options"),b={};a.length?a.getChildren().forEach(function(a){b[a.getBase()]=a.getBeam()}):a.getBeam().split(" ").forEach(function(a){b[a]=a});return b};EnumProp.prototype._parseValue=function(a){return this.getChoices()[a]?a:void 0};EnumProp.prototype.toFormBray=function(a){var b=Object.keys(this.getChoices());return this._getBlockCommandDropdownBray(b,this._getPropValue(a))};window.EnumProp=EnumProp;
var FormatProp=function(a){return AbstractBlockPropertyNode.apply(this,arguments)||this};$jscomp.inherits(FormatProp,AbstractBlockPropertyNode);FormatProp.prototype.toFormBray=function(a){var b=(new CardParser).getEncodingNames();return this._getBlockCommandDropdownBray(b,this._getPropValue(a))};window.FormatProp=FormatProp;var IntProp=function(a){return AbstractBlockPropertyNode.apply(this,arguments)||this};$jscomp.inherits(IntProp,AbstractBlockPropertyNode);IntProp.prototype._parseValue=function(a){return parseInt(a)};
IntProp.prototype.toFormBray=function(a){return"@ input\n data-onChangeCommand block changePropertyCommand\n name "+this.getPropertyName()+"\n type number\n value "+this._getPropValue(a)};window.IntProp=IntProp;var OtherBlockPropertyNode=function(a){return AbstractBlockPropertyNode.apply(this,arguments)||this};$jscomp.inherits(OtherBlockPropertyNode,AbstractBlockPropertyNode);OtherBlockPropertyNode.prototype.getParseErrorCount=function(){return this.getTopDownArray().length};
window.OtherBlockPropertyNode=OtherBlockPropertyNode;var PlainTextProp=function(a){return AbstractBlockPropertyNode.apply(this,arguments)||this};$jscomp.inherits(PlainTextProp,AbstractBlockPropertyNode);PlainTextProp.prototype._parseValue=function(a){return Format.stripHtml(void 0===a?"":a)};window.PlainTextProp=PlainTextProp;var ProbProp=function(a){return AbstractBlockPropertyNode.apply(this,arguments)||this};$jscomp.inherits(ProbProp,AbstractBlockPropertyNode);ProbProp.prototype._parseValue=function(a){return parseFloat(a)};
window.ProbProp=ProbProp;var QuickProp=function(a){return AbstractBlockPropertyNode.apply(this,arguments)||this};$jscomp.inherits(QuickProp,AbstractBlockPropertyNode);QuickProp.prototype._parseValue=function(a){return Format.linkify(Format.stripHtml(void 0===a?"":a))};window.QuickProp=QuickProp;var SlangProp=function(a){return AbstractBlockPropertyNode.apply(this,arguments)||this};$jscomp.inherits(SlangProp,AbstractBlockPropertyNode);
SlangProp.prototype.toFormBray=function(a){return"@ textarea\n data-onChangeCommand block changePropertyCommand\n name "+this.getPropertyName()+"\n bern"+TreeNotation.nest(this._getPropValue(a),2)};window.SlangProp=SlangProp;var GlobalShortcutNode=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(GlobalShortcutNode,TreeNotation);GlobalShortcutNode.prototype.getKeyCombo=function(){return this.getWord(3)};GlobalShortcutNode.prototype.getFn=function(){return this.getWord(2)};
...
AbstractFireBlock.prototype.getBlockBodyBray=function(){var a=this,b=this.getBlock(),c=Icons(b.getSvg(),14),d=this.getBeamPatternWords(),e=d.length-1,d=d.map(function(b,c){var d=c+1;c=(e===c?a.getWords(d).join(" "):a.getWord(d))||"";return" @ input\n  placeholder "+b+"\n  value "+c+"\n  name "+d+"\n  data-onChangeCommand chisel changeWordCommand"}).join("\n");return"@ div\n bern "+c+" "+b.getDescription()+"\n@ div\n"+d};
...
window.FireDictionary=FireDictionary;var BlankLine=function(a){return AbstractBlockChisel.apply(this,arguments)||this};$jscomp.inherits(BlankLine,AbstractBlockChisel);BlankLine._mountedComponents=AbstractBlockChisel._mountedComponents;BlankLine.loadCode=AbstractBlockChisel.loadCode;var FireProgram=function(a){return AbstractProgramRootChisel.apply(this,arguments)||this};$jscomp.inherits(FireProgram,AbstractProgramRootChisel);FireProgram._mountedComponents=AbstractProgramRootChisel._mountedComponents;
FireProgram.prototype.getCatchAllBlockClass=function(a,b,c){return c.trim().length?a.getDidYouMeanBlock().getBlockJSClass():BlankLine};FireProgram.prototype.getDictionaryString=function(){return FireDictionary};FireProgram.prototype.getExtensionName=function(){return"fire"};FireProgram.prototype.compilesTo=function(){return"js"};FireProgram.prototype.buildProgram=function(){return this.getChildrenByNodeType(AbstractBlockChisel).map(function(a){return a.toJavascript()}).filter(function(a){return a}).join("\n")};
FireProgram.prototype.execute=function(){var a=[],b=console.log;console.log=function(b){for(var c=[],e=0;e<arguments.length;++e)c[e-0]=arguments[e];return a.push(c)};eval(this.buildProgram());console.log=b;b=a.join("\n");console.log(b);return Promise.resolve(b)};window.FireProgram=FireProgram;var AbstractChartBlock=function(a){return AbstractBlockChisel.apply(this,arguments)||this};$jscomp.inherits(AbstractChartBlock,AbstractBlockChisel);AbstractChartBlock._mountedComponents=AbstractBlockChisel._mountedComponents;
AbstractChartBlock.loadCode=AbstractBlockChisel.loadCode;AbstractChartBlock.prototype.getBlockHeaderBern=function(){return this.getStruct().title||""};AbstractChartBlock.prototype.getBlockFooterBray=function(){var a=this.getInputBinder().getCardCount();return this.getBlockToolbarButtonBray()+"\n@ span\n bern In: "+a};AbstractChartBlock.prototype.toDisplayString=function(a,b){return void 0===a?"":this.getInputBinder().getBinderColumnByName(b).toDisplayString(a)};window.AbstractChartBlock=AbstractChartBlock;
var AbstractClayBlock=function(a){return AbstractBlockChisel.apply(this,arguments)||this};$jscomp.inherits(AbstractClayBlock,AbstractBlockChisel);AbstractClayBlock._mountedComponents=AbstractBlockChisel._mountedComponents;AbstractClayBlock.loadCode=AbstractBlockChisel.loadCode;window.AbstractClayBlock=AbstractClayBlock;var AbstractFlowBlock=function(a){return AbstractBlockChisel.apply(this,arguments)||this};$jscomp.inherits(AbstractFlowBlock,AbstractBlockChisel);
AbstractFlowBlock._mountedComponents=AbstractBlockChisel._mountedComponents;AbstractFlowBlock.loadCode=AbstractBlockChisel.loadCode;window.AbstractFlowBlock=AbstractFlowBlock;var AbstractHeaderlessChartBlock=function(a){return AbstractChartBlock.apply(this,arguments)||this};$jscomp.inherits(AbstractHeaderlessChartBlock,AbstractChartBlock);AbstractHeaderlessChartBlock._mountedComponents=AbstractChartBlock._mountedComponents;AbstractHeaderlessChartBlock.loadCode=AbstractChartBlock.loadCode;
...
GoogleTimeline.prototype._getTimelineCards=function(){var a=this.getInputBinder().getCards(),b=this.getStruct().label;return a.map(function(a){var c=a.getCardNumeric();a=a.getCardValue(b);var e=moment(c.start).toDate(),c=moment(c.end).toDate();return[a,e,c]})};window.GoogleTimeline=GoogleTimeline;var InputBlock=function(a){return AbstractClayBlock.apply(this,arguments)||this};$jscomp.inherits(InputBlock,AbstractClayBlock);InputBlock._mountedComponents=AbstractClayBlock._mountedComponents;
InputBlock.loadCode=AbstractClayBlock.loadCode;InputBlock.prototype._getPath=function(){return this.getStruct().path};InputBlock.prototype._getValue=function(){var a=this.getProgram().getNode(this._getPath());return a?a.getBeamWithChildren():""};InputBlock.prototype._savePropertyCommand=function(a){this.getProgram().touchNode(this._getPath()).setBeamWithChildren(a);this.getProgram().autosaveAndRender()};
InputBlock.prototype.getBlockBodyBray=function(){var a=this._getValue();return"@ textarea\n data-onChangeCommand chisel _savePropertyCommand\n bern"+TreeNotation.nest(a,2)};window.InputBlock=InputBlock;var PickerBlock=function(a){return AbstractClayBlock.apply(this,arguments)||this};$jscomp.inherits(PickerBlock,AbstractClayBlock);PickerBlock._mountedComponents=AbstractClayBlock._mountedComponents;PickerBlock.loadCode=AbstractClayBlock.loadCode;PickerBlock.prototype._getPath=function(){return this.getStruct().path};
PickerBlock.prototype._getValue=function(){var a=this.getProgram().getNode(this._getPath());return a?a.getBeamWithChildren():""};PickerBlock.prototype._saveValueCommand=function(a){this.getProgram().touchNode(this._getPath()).setBeamWithChildren(a);this.getProgram().autosaveAndRender()};PickerBlock.prototype.getHakon=function(){return".PickerBlock\n font-size 12px\n height 100%\n width 100%\n overflow scroll\n padding 3px\n box-sizing border-box\n a\n  display block"};
...
ProgramsBlock.prototype.fetchCards=function(){return Promise.resolve(this.getApp().getCaddies().map(function(a){return a.toCaddyObject()}))};window.ProgramsBlock=ProgramsBlock;var QueryBlock=function(a){return AbstractUrlProvider.apply(this,arguments)||this};$jscomp.inherits(QueryBlock,AbstractUrlProvider);QueryBlock._mountedComponents=AbstractUrlProvider._mountedComponents;QueryBlock.loadCode=AbstractUrlProvider.loadCode;QueryBlock.prototype.getUrl=function(){return"/sql?q="+this.getStruct().query};
...
AbstractModalChisel._mountedComponents=AbstractChisel._mountedComponents;
...
BlockInspectorModal.prototype.componentDidMount=function(){AbstractModalChisel.prototype.componentDidMount.call(this);this._getChildBlock();this.getApp()};BlockInspectorModal.prototype.getHakon=function(){return AbstractModalChisel.prototype.getHakon.call(this)+"\n.BlockInspectorModal\n ol\n  list-style decimal\n  padding 20px\n pre\n  width 600px\n  overflow-x scroll\n textarea\n  width 600px\n  height 200px"};
...
var CustomConfirmModal=function(a){return AbstractModalChisel.apply(this,arguments)||this};$jscomp.inherits(CustomConfirmModal,AbstractModalChisel);CustomConfirmModal._mountedComponents=AbstractModalChisel._mountedComponents;CustomConfirmModal.prototype.getModalBray=function(){return"@ h4\n bern "+this.getBeam()+"\n@ button\n value 0\n data-onClickCommand chisel _resolveCommand\n bern Cancel\n@ button\n value 1\n data-onClickCommand chisel _resolveCommand\n bern Ok"};
...
var CustomPromptModal=function(a){return AbstractModalChisel.apply(this,arguments)||this};$jscomp.inherits(CustomPromptModal,AbstractModalChisel);CustomPromptModal._mountedComponents=AbstractModalChisel._mountedComponents;CustomPromptModal.prototype.getModalBray=function(){return"@ h4\n bern "+this.findBeam("message")+"\n@ input\n value "+this.findBeam("value")+"\n@ button\n data-onClickCommand chisel _resolveCommand\n bern Ok"};CustomPromptModal.prototype.parseNodeType=function(a){return TreeNotation};
...
InsertCardModal.prototype.getModalBray=function(){return"\n@ h4\n bern Insert\n@ textarea\n rows 20\n wrap off\n class bigInput\n id newCardTextarea\n@ button\n title Save\n data-onClickCommand chisel _submitCardCommand\n class SVGIcon rightButton\n bern "+Icons("check",30)};window.InsertCardModal=InsertCardModal;var InsertCardsModal=function(a){return AbstractModalChisel.apply(this,arguments)||this};$jscomp.inherits(InsertCardsModal,AbstractModalChisel);InsertCardsModal._mountedComponents=AbstractModalChisel._mountedComponents;
...
SourceEditorModal.prototype.getModalBray=function(){return"@ h4\n bern Edit Source\n@ textarea\n rows 20\n class bigInput\n wrap off\n@ button\n title Save\n data-onClickCommand chisel _saveChangesCommand\n class SVGIcon rightButton\n bern "+Icons("check",30)};window.SourceEditorModal=SourceEditorModal;var OhayoApp=function(a){return AbstractAppChisel.apply(this,arguments)||this};$jscomp.inherits(OhayoApp,AbstractAppChisel);OhayoApp._mountedComponents=AbstractAppChisel._mountedComponents;
OhayoApp.prototype.fetchProgram=function(a){a.setChildrenAndDiskAndUndoStack(this.getFromStore(a.getUrl()));return Promise.resolve()};OhayoApp.prototype.componentWillMount=function(){AbstractAppChisel.prototype.componentWillMount.call(this);1===this._getVisitCount()&&this.playFirstVisitCommand()};OhayoApp.prototype.playFirstVisitCommand=function(){var a=this;return this.openOhayoProgramCommand("readme.flow faq.flow releasenotes.flow helloWorld.fire").then(function(){return a.openOhayoProgramCommand("ohayo.flow")})};
