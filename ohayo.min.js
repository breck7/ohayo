...
TreeParser.prototype.parseTrees=function(a){a=a instanceof jtree.TreeNode?a:new jtree.TreeNode(a);var b=a.getChildren().filter(function(a){return a.getBeam()}).length,c=a.getChildren().filter(function(a){return 0===a.length}).length;if(!b&&!c)return a;b=new jtree.TreeNode;b.pushBeamAndChildren(void 0,a);return b};TreeParser.prototype.getProbForCardSpecimen=function(a){return 1>a.indentedLineCount?0:.1};TreeParser.prototype.getFormatName=function(){return"tree"};
...
BasicTerminalChisel.prototype._makeProgram=function(a){var b=new jtree.TreeNode(this.getCode()),c=this._getProgram().constructor;a=b.getTopDownArray()[a];return new c(a.toString())};BasicTerminalChisel.prototype._updateConsole=function(){this.getParent().getChildren()[1].render()};
...
WallCommander.prototype.insertMorphTileCommand=function(){var a=this.getTarget(),b=a.getApp(),c=b.getMountedTab(),d=b.getMouseEvent(),e=a.getMorphBlock(d);b.getNodeCursors().forEach(function(a){return a.appendLineAndChildren(">morph",e)});return c.autosaveAndRender()};window.WallCommander=WallCommander;var GlobalShortcutNode=function(a){return jtree.TreeNode.apply(this,arguments)||this};$jscomp.inherits(GlobalShortcutNode,jtree.TreeNode);GlobalShortcutNode.prototype.getKeyCombo=function(){return this.getWord(3)};
...
var MountedShortcutNode=function(a){return GlobalShortcutNode.apply(this,arguments)||this};$jscomp.inherits(MountedShortcutNode,GlobalShortcutNode);MountedShortcutNode.prototype.isEnabled=function(a){return!!a.getMountedTab()};var DrumsProgram=function(a){return jtree.TreeNode.apply(this,arguments)||this};$jscomp.inherits(DrumsProgram,jtree.TreeNode);DrumsProgram.prototype.getKeywordMap=function(){return{panel:GlobalShortcutNode,mounted:MountedShortcutNode}};window.DrumsProgram=DrumsProgram;
var fireProgram=function(a){return jtree.program.apply(this,arguments)||this};$jscomp.inherits(fireProgram,jtree.program);
fireProgram.prototype.execute=function(){var a=this;return $jscomp.executeAsyncGenerator(function(){function b(b,g,l){for(;;)switch(c){case 0:return f=[],e=console.log,d=function(a){for(var b=[],c=0;c<arguments.length;++c)b[c-0]=arguments[c];return f.push(b)},console.log=d,eval(a.compile("js")),console.log=e,console.log(f.join("\n")),c=-1,{value:f,done:!0};default:return{value:void 0,done:!0}}}var c=0,d,e,f,g={next:function(a){return b(0,a,void 0)},throw:function(a){return b(1,void 0,a)},return:function(a){throw Error("Not yet implemented");
}};$jscomp.initSymbolIterator();g[Symbol.iterator]=function(){return this};return g}())};window.fireProgram=fireProgram;var FlowConstants={setting:"setting",orderBy:"orderBy",slang:"slang",columnsObject:"columnsObject"};window.FlowConstants=FlowConstants;var AbstractFile=function(a){return jtree.TreeNode.apply(this,arguments)||this};$jscomp.inherits(AbstractFile,jtree.TreeNode);AbstractFile.prototype.getFileLink=function(){return this.getLine()};
AbstractFile.prototype.toFileObject=function(){return{link:this.getFileLink(),bytes:this.childrenToString()}};window.AbstractFile=AbstractFile;var AbstractFolder=function(a){this._app=a};AbstractFolder.prototype.getApp=function(){return this._app};window.AbstractFolder=AbstractFolder;var FolderConstants={bytes:"bytes",link:"link"};window.FolderConstants=FolderConstants;
...
TileCommander.prototype.changeParentCommand=function(a){var b=this.getTarget(),c=b.getTileProcess();c=(a=a?a.split(" ").map(function(a){return parseInt(a)}):"")?b.getApp().nodeAt(a):c;b.copyTo(c,c.length);b.unmountAndDestroy();return b.getTileProcess().getTab().autosaveAndRender()};
...
return f}())};
TileCommander.prototype.copyDataAsTreeCommand=function(){var a=this;return $jscomp.executeAsyncGenerator(function(){function b(b,f,k){for(;;)switch(c){case 0:e=a.getTarget(),d=e.getOutputBinder().toTree().toString(),e.getApp().getWillowProgram().copyTextToClipboard(d),c=-1;default:return{value:void 0,done:!0}}}var c=0,d,e,f={next:function(a){return b(0,a,void 0)},throw:function(a){return b(1,void 0,a)},return:function(a){throw Error("Not yet implemented");}};$jscomp.initSymbolIterator();f[Symbol.iterator]=
function(){return this};return f}())};
...
e[Symbol.iterator]=function(){return this};return e}())};window.TileCommander=TileCommander;var HakonPropertyNode=function(a){return jtree.TreeNode.apply(this,arguments)||this};$jscomp.inherits(HakonPropertyNode,jtree.TreeNode);HakonPropertyNode.prototype.toCss=function(a){return""+a+this.getKeyword()+": "+this.getBeam()+";"};var HakonSelectorNode=function(a){return jtree.TreeNode.apply(this,arguments)||this};$jscomp.inherits(HakonSelectorNode,jtree.TreeNode);
HakonSelectorNode.prototype.parseNodeType=function(a){return a.includes(" ")?HakonPropertyNode:HakonSelectorNode};HakonSelectorNode.prototype.getSelector=function(){var a=this.getParent().getSelector();return this.getKeyword().split(",").map(function(b){return b.startsWith("&")?a+b.substr(1):a?a+" "+b:b}).join(",")};
HakonSelectorNode.prototype.toCss=function(){var a=this.getChildrenByNodeType(HakonPropertyNode);return a.length?this.getSelector()+" {\n"+a.map(function(a){return a.toCss("  ")}).join("\n")+"\n}\n":""};var HakonProgram=function(a){return jtree.TreeNode.apply(this,arguments)||this};$jscomp.inherits(HakonProgram,jtree.TreeNode);HakonProgram.prototype.parseNodeType=function(a){return a?HakonSelectorNode:jtree.TreeNode};HakonProgram.prototype.getSelector=function(){return""};
...
TileToolbarChisel.prototype._getFormBray=function(){var a=this.getTargetTile(),b=a.getSettingsStruct(),c=a.getAllTileSettingsDefinitions().map(function(a){a=a.getId();return[a,"@input\n data-onChangeCommand tile changeTileSettingAndRenderCommand\n name "+a+"\n value "+(b[a]||"")]});a=a.getBeam()||"";c.unshift(["parent",this._getParentDropdownBray()]);c.unshift(["type",this._getTileTypeDropdownBray()]);c.unshift(["beam","@input\n data-onChangeCommand tile changeBeamAndRenderCommand\n value "+a]);return"@form\n @table\n"+
c.map(function(a){return"  @tr\n   @td "+a[0]+"\n   @td"+jtree.TreeNode.nest(a[1],4)}).join("\n")};window.TileToolbarChisel=TileToolbarChisel;var LocalStorageFile=function(a){return AbstractFile.apply(this,arguments)||this};$jscomp.inherits(LocalStorageFile,AbstractFile);window.LocalStorageFile=LocalStorageFile;var StorageKeys={autoSave:"__autoSave",appState:"__appState",visitCount:"__visitCount"},_storageKeysmap={};Object.values(StorageKeys).forEach(function(a){_storageKeysmap[a]=!0});
StorageKeys.isKey=function(a){return _storageKeysmap[a]};window.StorageKeys=StorageKeys;var AbstractModalChisel=function(a){return AbstractChisel.apply(this,arguments)||this};$jscomp.inherits(AbstractModalChisel,AbstractChisel);AbstractModalChisel._mountedChisels=AbstractChisel._mountedChisels;
...
HelpModal.prototype.getModalBray=function(){var a=this.getApp();return"@h4 About ohayo\n@p ohayo is the data dashboard builder\n@p\n @a Welcome Page\n  id welcomePageButton\n  data-onClickCommand app openOhayoProgramCommand\n  value ohayo.flow\n@a Keyboard Shortcuts\n class helpToggle\n data-onClickCommand app toggleShadowByIdCommand\n value shortcutsHelp\n"+this._getShortcutsHelpBray()+"\n@p Version "+a.getVersion()+" "+a.constructor.name};window.HelpModal=HelpModal;
var ServerStorageFile=function(a){return AbstractFile.apply(this,arguments)||this};$jscomp.inherits(ServerStorageFile,AbstractFile);window.ServerStorageFile=ServerStorageFile;var ServerStorageFolder=function(a){AbstractFolder.apply(this,arguments)};$jscomp.inherits(ServerStorageFolder,AbstractFolder);
...
}};$jscomp.initSymbolIterator();g[Symbol.iterator]=function(){return this};return g}())};ServerStorageFolder.prototype.readFile=function(a){return this._getWillow().post("/serverStorage.read",{filename:a})};window.ServerStorageFolder=ServerStorageFolder;var StumpBernNode=function(a){return jtree.TreeNode.apply(this,arguments)||this};$jscomp.inherits(StumpBernNode,jtree.TreeNode);StumpBernNode.prototype._toHtml=function(){return this.childrenToString()};
var StumpAttributeNode=function(a){return jtree.TreeNode.apply(this,arguments)||this};$jscomp.inherits(StumpAttributeNode,jtree.TreeNode);StumpAttributeNode.prototype._toHtml=function(){return""};StumpAttributeNode.prototype.getAttribute=function(){return" "+this.getKeyword()+'="'+this.getBeam()+'"'};var StumpProgram=function(a){return jtree.TreeNode.apply(this,arguments)||this};$jscomp.inherits(StumpProgram,jtree.TreeNode);StumpProgram.prototype.getTag=function(){return this.getWord(0).substr(1)};
...
whiteColors.bodyBackground="white";whiteColors.foregroundColor="black";whiteColors.tileBackgroundColor="transparent";Themes.white=new Theme(whiteColors);Themes.glass=new Theme(glassColors);glassColors.tileBackgroundColor="transparent";Themes.clearGlass=new Theme(glassColors);window.Themes=Themes;var AbstractTileSettingNode=function(a){return jtree.TerminalNode.apply(this,arguments)||this};$jscomp.inherits(AbstractTileSettingNode,jtree.TerminalNode);
...
window.BinPacker=BinPacker;var TileConstants={left:"left",top:"top",width:"width",height:"height",wall:"@wall",tileCssScript:"tileCssScript",tileScript:"tileScript",tileClass:"tileClass",tileSize:"tileSize",tileSvg:"tileSvg"};window.TileConstants=TileConstants;var TileDimension=function(a,b){a=a.getSuggestedSize();this.width=a.width;this.height=a.height;Object.assign(this,b)};
TileDimension.prototype.getScaledCss=function(a){a=void 0===a?1:a;return this._toCss({width:this.width*a,height:this.height*a,left:this.left*a,top:this.top*a})};TileDimension.prototype.toCss=function(){return this._toCss(this)};TileDimension.prototype._toCss=function(a){return"width: "+a.width+"px; height: "+a.height+"px; left: "+a.left+"px; top: "+a.top+"px"};window.TileDimension=TileDimension;var TileErrorNode=function(a){return jtree.TreeNode.apply(this,arguments)||this};
$jscomp.inherits(TileErrorNode,jtree.TreeNode);TileErrorNode.prototype.getErrors=function(){return["Unknown type"]};window.TileErrorNode=TileErrorNode;var TileGrammar=function(){};
TileGrammar._initTileClassCache=function(a){if(!a._cache_tileClass){var b=(a.getConstantsObject()[TileConstants.tileClass]||"AbstractTileChisel /aientist/client/tiles/AbstractTileChisel.js").split(" "),c=b[0],d=b[1],e="undefined"!==typeof require;b=e?process:window;e&&!b[c]&&(d=require(d),b[d.name]=d);a._cache_tileClass=b[c]}};TileGrammar.getDefinitionTileClass=function(a){this._initTileClassCache(a);return a._cache_tileClass};window.TileGrammar=TileGrammar;
var TileSettingNonTerminalNode=function(a){return AbstractTileSettingNode.apply(this,arguments)||this};$jscomp.inherits(TileSettingNonTerminalNode,AbstractTileSettingNode);TileSettingNonTerminalNode.loadCode=AbstractTileSettingNode.loadCode;TileSettingNonTerminalNode.prototype.getSettingValue=function(){return this.childrenToString()};TileSettingNonTerminalNode.prototype.getCatchAllNodeClass=function(){return jtree.TreeNode};
TileSettingNonTerminalNode.prototype.toFormBray=function(a){return"@textarea\n data-onChangeCommand tile changeTileSettingAndRenderCommand\n name "+this.getKeyword()+"\n bern"+jtree.TreeNode.nest(a,2)};window.TileSettingNonTerminalNode=TileSettingNonTerminalNode;var TileSettingTerminalNode=function(a){return AbstractTileSettingNode.apply(this,arguments)||this};$jscomp.inherits(TileSettingTerminalNode,AbstractTileSettingNode);TileSettingTerminalNode.loadCode=AbstractTileSettingNode.loadCode;
TileSettingTerminalNode.prototype.getSettingValue=function(){return this.getBeam()};TileSettingTerminalNode.prototype.toFormBray=function(a){return"@input\n data-onChangeCommand tile changeTileSettingAndRenderCommand\n name "+this.getKeyword()+"\n value "+a};window.TileSettingTerminalNode=TileSettingTerminalNode;var TileWallNode=function(a){return jtree.TreeNode.apply(this,arguments)||this};$jscomp.inherits(TileWallNode,jtree.TreeNode);TileWallNode.prototype.getLineSyntax=function(){return"wall ".repeat(this.getWords().length).trim()};
...
window.LocalStorageFolder=LocalStorageFolder;var FlowCodeEditorTemplate=function(a,b){return">data\n format text\n treeLanguage "+b+"\n >lc\n  >kpi Total lines\n   column lines\n   reduction median\n >wc\n  >kpi Total words\n   column count\n   reduction sum\n >3d\n >outline\n >types\n  >pre\n   >wc\n    >table\n    >wordcloud\n slang"+jtree.TreeNode.nest(a,2)+"\n@wall\n layout bin"};window.FlowCodeEditorTemplate=FlowCodeEditorTemplate;var AppCommander=function(a){AbstractCommander.apply(this,arguments)};
$jscomp.inherits(AppCommander,AbstractCommander);
AppCommander.prototype.playFirstVisitCommand=function(){var a=this;return $jscomp.executeAsyncGenerator(function(){function b(b,d,g){for(;;)switch(c){case 0:return c=1,{value:a.openOhayoProgramCommand("ohayo.flow"),done:!1};case 1:if(1!=b){c=2;break}c=-1;throw g;case 2:c=-1;default:return{value:void 0,done:!0}}}var c=0,d={next:function(a){return b(0,a,void 0)},throw:function(a){return b(1,void 0,a)},return:function(a){throw Error("Not yet implemented");}};$jscomp.initSymbolIterator();d[Symbol.iterator]=
function(){return this};return d}())};AppCommander.prototype.moveTilesFromShadowsCommand=function(){return this.getTarget().getAppWall().getCommander().moveTilesFromShadowsCommand()};
...
function(){return this};return f}())};
AppCommander.prototype.typeCheckProgramCommand=function(){var a=this;return $jscomp.executeAsyncGenerator(function(){function b(b,h,m){for(;;)switch(c){case 0:g=a.getTarget(),f=g.getMountedTab(),e=f.getTabProgram(),d=e.getProgramErrors(),f.logMessageBray("@strong "+d.length+" Errors\n@div - "+d.join("\n@div - ")),g.renderApp(),c=-1;default:return{value:void 0,done:!0}}}var c=0,d,e,f,g,h={next:function(a){return b(0,a,void 0)},throw:function(a){return b(1,void 0,a)},return:function(a){throw Error("Not yet implemented");
}};$jscomp.initSymbolIterator();h[Symbol.iterator]=function(){return this};return h}())};
AppCommander.prototype.printProcessStatsCommand=function(){var a=this;return $jscomp.executeAsyncGenerator(function(){function b(b,g,l){for(;;)switch(c){case 0:f=a.getTarget(),e=f.getMountedTab(),d=(new jtree.TreeNode(f.getMountedProcess().getProcessStats())).toString(),e.logMessageText(d),f.renderApp(),c=-1;default:return{value:void 0,done:!0}}}var c=0,d,e,f,g={next:function(a){return b(0,a,void 0)},throw:function(a){return b(1,void 0,a)},return:function(a){throw Error("Not yet implemented");}};
$jscomp.initSymbolIterator();g[Symbol.iterator]=function(){return this};return g}())};AppCommander.prototype.createProgramFromFileCommand=function(a,b){var c=this.getTarget(),d=Util.getFileExtension(a);if(c.getGrammars()[d])return c._createAndOpen(b,a);b=(d=FlowTemplates[d])?d(a,b):">h1 No visualization templates for "+a;return c._createAndOpen(b,a+".flow")};
...
return f}())};
AppCommander.prototype.openDeleteAllTabsPromptCommand=function(){var a=this;return $jscomp.executeAsyncGenerator(function(){function b(b,h,m){for(;;)switch(c){case 0:return g=a.getTarget(),f=g.getFocusedPanel().getTabs(),c=1,{value:g.getWillowProgram().confirmThen("Are you sure you want to delete "+f.length+" open dashboards?"),done:!1};case 1:if(1!=b){c=2;break}c=-1;throw m;case 2:return d=e=h,c=-1,{value:d?Promise.all(f.map(function(a){return a.getFolder().unlinkFile(a.getFileName())})):!1,done:!0};
...
AppCommander.prototype.toggleGutterCommand=function(){var a=this;return $jscomp.executeAsyncGenerator(function(){function b(b,g,l){for(;;)switch(c){case 0:f=a.getTarget(),f.makeAllDirty(),e=f.getFocusedPanel(),(d=e.getNode("gutter"))?d.unmountAndDestroy():(b=e.touchNode("gutter"),b.appendLine("terminal"),b.appendLine("console")),f.renderApp(),c=-1;default:return{value:void 0,done:!0}}}var c=0,d,e,f,g={next:function(a){return b(0,a,void 0)},throw:function(a){return b(1,void 0,a)},return:function(a){throw Error("Not yet implemented");
}};$jscomp.initSymbolIterator();g[Symbol.iterator]=function(){return this};return g}())};
...
AbstractTileChisel.prototype.parseNodeType=function(a){var b=a.split(" ")[0],c=this.getDefinition();return c.getRunTimeKeywordMap()[b]?TileGrammar.getDefinitionTileClass(c.getDefinitionByName(b)):this.getCatchAllNodeClass(a)};AbstractTileChisel.prototype.getCatchAllNodeClass=function(){return TileErrorNode};AbstractTileChisel.prototype.getCommander=function(){return new TileCommander(this)};AbstractTileChisel.prototype._getSettingsChildren=function(){return this.getChildrenByNodeType(AbstractTileSettingNode)};
...
AbstractTileChisel.prototype.getOutputBinder=function(){if(!this.isProvider())return this.getInputBinder();this._outputBinder||(this._outputBinder=new Binder(this));return this._outputBinder};AbstractTileChisel.prototype.isProvider=function(){return!1};AbstractTileChisel.prototype.isProcess=function(){return!1};AbstractTileChisel.prototype.getTileProcess=function(){return this.getParent().getTileProcess()};
AbstractTileChisel.prototype.getAllTileSettingsDefinitions=function(){var a=this.getDefinition().getRunTimeKeywordMapWithDefinitions();return Object.values(a).filter(function(a){return a.isAKeyword({setting:!0})})};AbstractTileChisel.prototype.getTab=function(){return this.getTileProcess().getParent()};AbstractTileChisel.prototype.getChildTiles=function(){return this.getChildrenByNodeType(AbstractTileChisel)};AbstractTileChisel.prototype.getHierarchyForLayout=function(){return{node:this,children:this.getChildTiles().map(function(a){return a.getHierarchyForLayout()})}};
...
AbstractTileChisel.prototype.getTileToolbarButtonBray=function(){return"@span "+Icons("pencil",16)+"\n class TilePencilButton\n data-onClickCommand chisel toggleToolbarCommand"};AbstractTileChisel.prototype.getSuggestedSize=function(){var a=(this.getDefinition().getConstantsObject()[TileConstants.tileSize]||"280 220").split(" ").map(function(a){return parseInt(a)});return{width:a[0],height:a[1]}};AbstractTileChisel.prototype.getLeft=function(){return this.findBeam(TileConstants.left)};
...
AbstractTileChisel.prototype.getInspection=function(){var a=this.getMessageBuffer().getChildren().map(function(a){return"@li "+moment(a.getMTime()).fromNow()+" - "+a.childrenToString()}),b=this.getAllTileSettingsDefinitions().map(function(a){return a.getKeyword()+" "+a.getDescription()}).join("\n"),c=this.getSettingsStruct(),d=this.getParent().getKeyword();return"@div TileClass: "+this.constructor.name+" Parent: "+d+"\n@div Messages:\n@ol\n "+a+"\n@div Tree:\n@pre\n bern"+jtree.TreeNode.nest(this.toString(),
...
h,c=4,{value:Promise.all(a.getChildTiles().map(function(a){return a.runTile()})).catch(function(b){console.error(b);a.getTab().logMessageBray("@div\n bern\n  Error occurred. See console.\n style color:red;")}),done:!1};case 4:if(1!=b){c=5;break}c=-1;throw n;case 5:return c=-1,{value:a,done:!0};default:return{value:void 0,done:!0}}}var c=0,d,e,f,g,h,k={next:function(a){return b(0,a,void 0)},throw:function(a){return b(1,void 0,a)},return:function(a){throw Error("Not yet implemented");}};$jscomp.initSymbolIterator();
...
afterSelection:function(){return e.pauseShortcutListener()},afterDeselect:function(){return e.startShortcutListener()},height:b})};GridTile.prototype.chiselDidMount=function(){this.chiselDidUpdate()};window.GridTile=GridTile;var BaseBeamArray=function(a){return jtree.TreeNode.apply(this,arguments)||this};$jscomp.inherits(BaseBeamArray,jtree.TreeNode);BaseBeamArray.prototype.toArrayMap=function(){var a={};this.getChildren().forEach(function(b){a[b.getKeyword()]=b.getBeam().split(" ")});return a};
...
MarkdownChart.prototype.getTileBodyBray=function(){var a=this.getPipishInput();a=marked(a);return"@div\n bern"+jtree.TreeNode.nest(a,2)};window.MarkdownChart=MarkdownChart;var TableTile=function(a){return AbstractChartTile.apply(this,arguments)||this};$jscomp.inherits(TableTile,AbstractChartTile);TableTile._mountedChisels=AbstractChartTile._mountedChisels;TableTile.loadCode=AbstractChartTile.loadCode;
...
ThreeDChart.prototype._tryVis=function(){var a=this,b=this.getSettingsStruct(),c=this.getPipishInput(),d=this.getApp(),e=d.getLanguageBestGuess(c);c=d.generateProgram(c,e);c=this._treeTo3D(c);var f=new vis.DataSet;c.forEach(function(a){return f.add(a)});b=b.size;c=this.getTileDimension();var g=this.getNode("cameraPosition")||(new jtree.TreeNode("cameraPosition 4 .1 1.5")).getNode("cameraPosition");d=parseFloat(g.getWord(1));e=parseFloat(g.getWord(2));g=parseFloat(g.getWord(3));b={width:c.width+"px",
...
TreeOutline.prototype.getTileBodyBray=function(){var a=new jtree.TreeNode(this.getPipishInput());a=">dotline"===this.getKeyword()?a.toMappedOutline(function(a){return"o"+a.getLine().split(" ").map(function(a){return"\u00ba"}).join("")}):a.toOutline();return"@pre\n style overflow: scroll; width: 100%; height: 100%; margin: 0; box-sizing: border-box;\n bern"+jtree.TreeNode.nest(a,2)};window.TreeOutline=TreeOutline;
var WordCloudChart=function(a){return AbstractHeaderlessChartTile.apply(this,arguments)||this};$jscomp.inherits(WordCloudChart,AbstractHeaderlessChartTile);WordCloudChart._mountedChisels=AbstractHeaderlessChartTile._mountedChisels;WordCloudChart.loadCode=AbstractHeaderlessChartTile.loadCode;WordCloudChart.prototype.getTileBodyBray=function(){return"@div\n class wordCloud\n style width: 100%; height: 100%;"};WordCloudChart.prototype._getAllWords=function(){return this.getRequiredTable(["name","count"])};
WordCloudChart.prototype.chiselDidUpdate=function(){this._draw()};WordCloudChart.prototype.chiselDidMount=function(){this._draw()};WordCloudChart.prototype._draw=function(){var a=this.getSettingsStruct(),b=this._getAllWords();b.length&&(b.shift(),b={list:b.map(function(a){return[a[0],a[1]]}),shuffle:!1,backgroundColor:"transparent",random:Util.makeSemiRandomFn(),wait:0},Object.assign(b,a),a=this.getStump().findStumpByChild("class wordCloud").getShadow().getShadowElement(),WordCloud(a,b))};
window.WordCloudChart=WordCloudChart;var YouTubeTile=function(a){return AbstractHeaderlessChartTile.apply(this,arguments)||this};$jscomp.inherits(YouTubeTile,AbstractHeaderlessChartTile);YouTubeTile._mountedChisels=AbstractHeaderlessChartTile._mountedChisels;YouTubeTile.loadCode=AbstractHeaderlessChartTile.loadCode;
YouTubeTile.prototype.getTileBodyBray=function(){var a=this.getTileDimension().width,b=this.getBeam();return"@iframe\n width "+a+"\n height "+a+"\n src https://www.youtube.com/embed/"+b+"\n frameborder 0\n allowfullscreen"};window.YouTubeTile=YouTubeTile;var MockGoogle=function(){this.visualization={}},AbstractGoogleBase=function(a){return AbstractHeaderlessChartTile.apply(this,arguments)||this};$jscomp.inherits(AbstractGoogleBase,AbstractHeaderlessChartTile);AbstractGoogleBase._mountedChisels=AbstractHeaderlessChartTile._mountedChisels;
AbstractGoogleBase.loadCode=AbstractHeaderlessChartTile.loadCode;AbstractGoogleBase.loadPackages=function(a){return"undefined"===typeof google?Promise.resolve():new Promise(function(b,c){return google.charts.load("current",{packages:a,callback:function(){return b()}})})};AbstractGoogleBase.prototype.getGoogle=function(){this._google||(this._google=this.isNodeJs()?new MockGoogle:google);return this._google};AbstractGoogleBase.prototype.getTileBodyBray=function(){return"@div\n class goog"};
AbstractGoogleBase.prototype.getHakon=function(){return".goog\n .TilePage\n  overflow scroll"};AbstractGoogleBase.prototype._getGoogElement=function(){return this.getStump().findStumpByChild("class goog").getShadow().getShadowElement()};AbstractGoogleBase.prototype._getGoogleOptions=function(){var a={},b=this.getSettingsStruct();Object.assign(a,b);b=this.getTileBodyDimension();a.width=b.width;a.height=b.height;a.backgroundColor=this.getTheme().tileBackgroundColor;return a};
...
DataTile.prototype._getFormatted=function(a,b){switch(b){case "tree":return(new jtree.TreeNode(a)).toString();case "json":return(new jtree.TreeNode(a)).toJson();default:return(new jtree.TreeNode(a)).toCsv()}};DataTile.prototype.createCards=function(a){var b=this.getSettingsStruct().format,c=this.getDataSlang();c=(new CardParser).parse(c,b);a=lodash.concat(c,a);b=this._getFormatted(a,b);return this.getCommander().updateSlangCommand(b)};window.DataTile=DataTile;
...
FuzzTile.prototype.transformCards=function(){var a=this.getParent();if(a.isProcess())return[];var b=a.getParent();if(b.isProcess())return a.getOutputBinder().getCardSources();a=[a,b].map(function(a){return a.getOutputBinder().getCardSources()});return this.addFuzz(a[0],a[1])};FuzzTile.prototype.isVisible=function(){return!0};
...
GroupTile._mountedChisels=AbstractTransformerTile._mountedChisels;GroupTile.loadCode=AbstractTransformerTile.loadCode;GroupTile.prototype._makePivotResult=function(){var a=this.getBeam();if(!a)return{cards:[],columns:[]};var b=this.getInputBinder(),c=b.getColumnsArrayOfObjects(),d={};c.forEach(function(a){return d[a.name]=!0});a=a.split(/ /g).filter(function(a){return d[a]});b=b.getNumericValues();return(new PivotTable(b,c,this.getSettingsStructColumns())).getNewCards(a)};
GroupTile.prototype.transformCards=function(){return this._getPivotResult().cards};GroupTile.prototype._getPivotResult=function(){var a=this.getInputBinder().getCTime();this._pivotCTime!==a&&delete this._result;this._result||(this._result=this._makePivotResult(),this._pivotCTime=a);return this._result};GroupTile.prototype.getTileClassColumns=function(){return this._getPivotResult().columns};window.GroupTile=GroupTile;var JoinTile=function(a){return AbstractTransformerTile.apply(this,arguments)||this};
$jscomp.inherits(JoinTile,AbstractTransformerTile);JoinTile._mountedChisels=AbstractTransformerTile._mountedChisels;JoinTile.loadCode=AbstractTransformerTile.loadCode;
JoinTile.prototype.transformCards=function(){var a=this.getParent();if(a.isProcess())return[];var b=a.getParent();if(b.isProcess())return a.getOutputBinder().getCardSources();var c=[a,b];a=c.map(function(a){return a.getOutputBinder().getCardSources()});b=this.getBeam();if(!b)return lodash.flatten(a);c=c.map(function(a){return a.getOutputBinder().getColumnNames()});return Util.joinArraysOn(b,a,c)};window.JoinTile=JoinTile;
...
MorphTile.prototype.getTileBodyBray=function(){var a=this.getTileProcess().getProcessGrammarProgram(),b=a.getTopNodeTypes();this.getApp();return b.map(function(b){return a.getDefinitionByName(b)}).map(function(a){var b=a.getConstantsObject()[TileConstants.tileSvg]||"table";return"@a "+Icons(b,24)+"<br>"+a.getId()+"\n title "+a.getDescription()+"\n tabindex -1\n value "+a.getId()+"\n data-onClickCommand chisel changeTileTypeCommand"}).join("\n")};MorphTile.prototype.getTileHeaderBern=function(){return""};
window.MorphTile=MorphTile;var TileProcess=function(a){return jtree.TreeNode.apply(this,arguments)||this};$jscomp.inherits(TileProcess,jtree.TreeNode);TileProcess.prototype.parseNodeType=function(a){var b=a.split(" ")[0],c=this.getProcessGrammarProgram();return c.getRunTimeKeywordMap()[b]?TileGrammar.getDefinitionTileClass(c.getDefinitionByName(b)):this.getCatchAllNodeClass(a)};TileProcess.prototype.getCatchAllNodeClass=function(){return DidYouMeanTile};
TileProcess.prototype.getProcessGrammarProgram=function(){return this.getTab().getTabGrammarProgram()};TileProcess.prototype.getAllCards=function(){return lodash.flatten(this.getProcessTiles().map(function(a){return a.isProvider()?a.getOutputBinder().getCards():[]}))};TileProcess.prototype._getProgramCardCount=function(){return this.getAllCards().reduce(function(a,b){return a+b.length},0)};TileProcess.prototype.getApp=function(){return this.getTab().getApp()};TileProcess.prototype.getTab=function(){return this.getParent()};
...
TileProcess.prototype.loadTileCodeOrGetLoadingPromise=function(a,b){var c=this;return $jscomp.executeAsyncGenerator(function(){function d(d,k,n){for(;;)switch(e){case 0:return h=b.getConstantsObject(),c._loadTileCss(a,h),g=TileGrammar.getDefinitionTileClass(b),f=h[TileConstants.tileScript],e=1,{value:a.getWillowProgram().appendScript(f),done:!1};case 1:if(1!=d){e=2;break}e=-1;throw n;case 2:return e=-1,{value:g.loadCode(),done:!0};default:return{value:void 0,done:!0}}}var e=0,f,g,h,k={next:function(a){return d(0,
a,void 0)},throw:function(a){return d(1,void 0,a)},return:function(a){throw Error("Not yet implemented");}};$jscomp.initSymbolIterator();k[Symbol.iterator]=function(){return this};return k}())};window.TileProcess=TileProcess;var TabChisel=function(a){return AbstractChisel.apply(this,arguments)||this};$jscomp.inherits(TabChisel,AbstractChisel);TabChisel._mountedChisels=AbstractChisel._mountedChisels;
...
NewDropDownMenuChisel._mountedChisels=AbstractDropDownMenuChisel._mountedChisels;NewDropDownMenuChisel.prototype.getDropDownBray=function(){return this.getApp().getMountedTab()?"@a New Dashboard\n data-onClickCommand app createNewBlankProgramCommand\n value untitled.flow\n@a New From Url\n data-onClickCommand app openCreateNewProgramFromUrlDialogCommand\n@div\n class divider\n@a Clone Dashboard\n data-onClickCommand app cloneTabCommand":"@a New Dashboard\n data-onClickCommand app createNewBlankProgramCommand\n value untitled.flow\n@a New From Url\n data-onClickCommand app openCreateNewProgramFromUrlDialogCommand"};
...
TabsChisel.prototype.addTab=function(a){return this.getWall()?this.insertLine("tab "+a,-1):this.appendLine("tab "+a)};TabsChisel.prototype.getGutterWidth=function(){return this.getParent().getGutterWidth()};
...
OhayoAppChisel.prototype._registerGrammar=function(a,b){this.getGrammars()[a]=b;return this};OhayoAppChisel.prototype.executeCommandLine=function(a){this.addToCommandLog(a.join(" "));return this.getCommander()[a[0]].apply(this,a.slice(1))};OhayoAppChisel.prototype.getProgramClass=function(a){var b=this.getGrammars();return(b[a]||b.flow).getRootParserClass()};OhayoAppChisel.prototype._getGrammarProgramClass=function(){return this.isNodeJs()?jtree.GrammarProgram:window.GrammarProgram};
...
}};$jscomp.initSymbolIterator();g[Symbol.iterator]=function(){return this};return g}())};OhayoAppChisel.prototype.isAutoSaveEnabled=function(){return"false"!==this.getFromStore(StorageKeys.autoSave)};OhayoAppChisel.prototype.getLanguageBestGuess=function(a){var b=this.getGrammars();b=Object.values(b).map(function(b){var c=new (b.getRootParserClass())(a);return{name:b.getExtensionName(),errorCount:c.getProgramErrors().length}});b.sort(Util.sortByAccessor(function(a){return a.errorCount}));return b[0].name};
OhayoAppChisel.prototype.generateProgram=function(a,b){return new (this.getProgramClass(b))(a)};OhayoAppChisel.prototype._getThemeName=function(){return this.findBeam("theme")};OhayoAppChisel.prototype.getTheme=function(){return Themes[this._getThemeName()]||Themes.glass};
OhayoAppChisel.prototype._toggleTheme=function(){var a=Util.toggle(this._getThemeName(),Object.keys(Themes));this.logMessageBray("@div Switched to "+a+" theme");this.getNode("theme").setBeam(a);this.makeAllDirty();this.saveAppState();this.renderApp()};
