...
TreeParser.prototype.parseTrees=function(a){a=a instanceof otree.TreeNode?a:new otree.TreeNode(a);var b=a.getChildren().filter(function(a){return a.getBeam()}).length,c=a.getChildren().filter(function(a){return 0===a.length}).length;if(!b&&!c)return a;b=new otree.TreeNode;b.pushBeamAndChildren(void 0,a);return b};TreeParser.prototype.getProbForCardSpecimen=function(a){return 1>a.indentedLineCount?0:.1};TreeParser.prototype.getFormatName=function(){return"tree"};
...
BasicTerminalChisel.prototype._getTab=function(){return this.getApp().getMountedTab()};BasicTerminalChisel.prototype.getBray=function(){var a=this._getProgramSource()||"";return"@div\n style font-size: 14px;\n @textarea\n  class sourceTextarea\n  bern"+otree.TreeNode.nest(a,3)};BasicTerminalChisel.prototype._getHeight=function(){return 600};BasicTerminalChisel.prototype._getTextarea=function(){return this.getStump().getNode("@textarea").getShadow().getShadowElement()};
BasicTerminalChisel.prototype._makeProgram=function(a){var b=new otree.TreeNode(this.getCode()),c=this._getProgram().constructor;a=b.getTopDownArray()[a];return new c(a.toString())};BasicTerminalChisel.prototype._updateConsole=function(){this.getParent().getChildren()[1].render()};
...
WallCommander.prototype.insertMorphTileCommand=function(){var a=this.getTarget(),b=a.getApp(),c=b.getMountedTab(),d=b.getMouseEvent(),e=a.getMorphBlock(d);b.getNodeCursors().forEach(function(a){return a.append(">morph",e)});return c.autosaveAndRender()};window.WallCommander=WallCommander;var GlobalShortcutNode=function(a){return otree.TreeNode.apply(this,arguments)||this};$jscomp.inherits(GlobalShortcutNode,otree.TreeNode);GlobalShortcutNode.prototype.getKeyCombo=function(){return this.getWord(3)};
...
var MountedShortcutNode=function(a){return GlobalShortcutNode.apply(this,arguments)||this};$jscomp.inherits(MountedShortcutNode,GlobalShortcutNode);MountedShortcutNode.prototype.isEnabled=function(a){return!!a.getMountedTab()};var DrumsProgram=function(a){return otree.TreeNode.apply(this,arguments)||this};$jscomp.inherits(DrumsProgram,otree.TreeNode);DrumsProgram.prototype.getKeywordMap=function(){return{panel:GlobalShortcutNode,mounted:MountedShortcutNode}};window.DrumsProgram=DrumsProgram;
var fireProgram=function(a){return otree.program.apply(this,arguments)||this};$jscomp.inherits(fireProgram,otree.program);
...
}};$jscomp.initSymbolIterator();g[Symbol.iterator]=function(){return this};return g}())};window.fireProgram=fireProgram;var FlowConstants={setting:"setting",orderBy:"orderBy",slang:"slang",columnsObject:"columnsObject"};window.FlowConstants=FlowConstants;var AbstractFile=function(a){return otree.TreeNode.apply(this,arguments)||this};$jscomp.inherits(AbstractFile,otree.TreeNode);AbstractFile.prototype.getFileLink=function(){return this.getLine()};
...
function(){return this};return e}())};window.TileCommander=TileCommander;var HakonPropertyNode=function(a){return otree.TreeNode.apply(this,arguments)||this};$jscomp.inherits(HakonPropertyNode,otree.TreeNode);HakonPropertyNode.prototype.toCss=function(a){return""+a+this.getKeyword()+": "+this.getBeam()+";"};var HakonSelectorNode=function(a){return otree.TreeNode.apply(this,arguments)||this};$jscomp.inherits(HakonSelectorNode,otree.TreeNode);
...
HakonSelectorNode.prototype.toCss=function(){var a=this.getChildrenByNodeType(HakonPropertyNode);return a.length?this.getSelector()+" {\n"+a.map(function(a){return a.toCss("  ")}).join("\n")+"\n}\n":""};var HakonProgram=function(a){return otree.TreeNode.apply(this,arguments)||this};$jscomp.inherits(HakonProgram,otree.TreeNode);HakonProgram.prototype.parseNodeType=function(a){return a?HakonSelectorNode:otree.TreeNode};HakonProgram.prototype.getSelector=function(){return""};
...
}};$jscomp.initSymbolIterator();g[Symbol.iterator]=function(){return this};return g}())};ServerStorageFolder.prototype.readFile=function(a){return this._getWillow().post("/serverStorage.read",{filename:a})};window.ServerStorageFolder=ServerStorageFolder;var StumpBernNode=function(a){return otree.TreeNode.apply(this,arguments)||this};$jscomp.inherits(StumpBernNode,otree.TreeNode);StumpBernNode.prototype._toHtml=function(){return this.childrenToString()};
var StumpAttributeNode=function(a){return otree.TreeNode.apply(this,arguments)||this};$jscomp.inherits(StumpAttributeNode,otree.TreeNode);StumpAttributeNode.prototype._toHtml=function(){return""};StumpAttributeNode.prototype.getAttribute=function(){return" "+this.getKeyword()+'="'+this.getBeam()+'"'};var StumpProgram=function(a){return otree.TreeNode.apply(this,arguments)||this};$jscomp.inherits(StumpProgram,otree.TreeNode);StumpProgram.prototype.getTag=function(){return this.getWord(0).substr(1)};
StumpProgram.prototype.parseNodeType=function(a){if(a.startsWith("@"))return StumpProgram;if(a.startsWith("@ "))throw Error(a);return a.startsWith("bern ")||"bern"===a?StumpBernNode:StumpAttributeNode};StumpProgram.prototype._childrenToHtml=function(a){return this.getChildren().map(function(b){return b._toHtml(a)}).join("")};StumpProgram.prototype.toHtml=function(){return this.isRoot()?otree.TreeNode.prototype.toHtml.call(this):this._toHtml()};
...
whiteColors.bodyBackground="white";whiteColors.foregroundColor="black";whiteColors.tileBackgroundColor="transparent";Themes.white=new Theme(whiteColors);Themes.glass=new Theme(glassColors);glassColors.tileBackgroundColor="transparent";Themes.clearGlass=new Theme(glassColors);window.Themes=Themes;var AbstractTileSettingNode=function(a){return otree.TerminalNode.apply(this,arguments)||this};$jscomp.inherits(AbstractTileSettingNode,otree.TerminalNode);
...
window.BinPacker=BinPacker;var TileConstants={left:"left",top:"top",width:"width",height:"height",wall:"@wall",ohayoTileCssScript:"@ohayoTileCssScript",ohayoTileScript:"@ohayoTileScript",ohayoTileClass:"@ohayoTileClass"};window.TileConstants=TileConstants;var TileDimension=function(a,b){a=a.getSuggestedSize();this.width=a.width;this.height=a.height;Object.assign(this,b)};
TileDimension.prototype.getScaledCss=function(a){a=void 0===a?1:a;return this._toCss({width:this.width*a,height:this.height*a,left:this.left*a,top:this.top*a})};TileDimension.prototype.toCss=function(){return this._toCss(this)};TileDimension.prototype._toCss=function(a){return"width: "+a.width+"px; height: "+a.height+"px; left: "+a.left+"px; top: "+a.top+"px"};window.TileDimension=TileDimension;var TileErrorNode=function(a){return otree.TreeNode.apply(this,arguments)||this};
$jscomp.inherits(TileErrorNode,otree.TreeNode);TileErrorNode.prototype.getErrors=function(){return["Unknown type"]};window.TileErrorNode=TileErrorNode;var TileGrammar=function(){};TileGrammar._initTileClassCache=function(a){if(!a._cache_tileClass){var b=(a.findBeam(TileConstants.ohayoTileClass)||"AbstractTileChisel /aientist/client/tiles/AbstractTileChisel.js").split(" "),c=b[0],d=b[1],e="undefined"!==typeof require;b=e?process:window;e&&!b[c]&&(d=require(d),b[d.name]=d);a._cache_tileClass=b[c]}};
TileGrammar.getDefinitionTileClass=function(a){this._initTileClassCache(a);return a._cache_tileClass};window.TileGrammar=TileGrammar;var TileSettingNonTerminalNode=function(a){return AbstractTileSettingNode.apply(this,arguments)||this};$jscomp.inherits(TileSettingNonTerminalNode,AbstractTileSettingNode);TileSettingNonTerminalNode.loadCode=AbstractTileSettingNode.loadCode;TileSettingNonTerminalNode.prototype.getSettingValue=function(){return this.childrenToString()};
TileSettingNonTerminalNode.prototype.getCatchAllNodeClass=function(){return otree.TreeNode};TileSettingNonTerminalNode.prototype.toFormBray=function(a){return"@textarea\n data-onChangeCommand tile changeTileSettingAndRenderCommand\n name "+this.getKeyword()+"\n bern"+otree.TreeNode.nest(a,2)};window.TileSettingNonTerminalNode=TileSettingNonTerminalNode;var TileSettingTerminalNode=function(a){return AbstractTileSettingNode.apply(this,arguments)||this};$jscomp.inherits(TileSettingTerminalNode,AbstractTileSettingNode);
TileSettingTerminalNode.loadCode=AbstractTileSettingNode.loadCode;TileSettingTerminalNode.prototype.getSettingValue=function(){return this.getBeam()};TileSettingTerminalNode.prototype.toFormBray=function(a){return"@input\n data-onChangeCommand tile changeTileSettingAndRenderCommand\n name "+this.getKeyword()+"\n value "+a};window.TileSettingTerminalNode=TileSettingTerminalNode;var TileWallNode=function(a){return otree.TreeNode.apply(this,arguments)||this};$jscomp.inherits(TileWallNode,otree.TreeNode);
...
Binder.prototype.getSortedCardsWithLimit=function(a,b){return this.getSortedCards(a).slice(0,b)};Binder.prototype.toTree=function(){return new otree.TreeNode(this.getCardSources())};Binder.prototype.toDelimited=function(a){return this.toTree().toDelimited(a,this.getColumnNames())};
...
AppCommander.prototype.printProcessStatsCommand=function(){var a=this;return $jscomp.executeAsyncGenerator(function(){function b(b,g,l){for(;;)switch(c){case 0:f=a.getTarget(),e=f.getMountedTab(),d=(new otree.TreeNode(f.getMountedProcess().getProcessStats())).toString(),e.logMessageText(d),f.renderApp(),c=-1;default:return{value:void 0,done:!0}}}var c=0,d,e,f,g={next:function(a){return b(0,a,void 0)},throw:function(a){return b(1,void 0,a)},return:function(a){throw Error("Not yet implemented");}};
...
HeatCalendarChart.prototype.getTileBodyBray=function(){return"@div\n class heatCal\n style padding: 30px 10px 10px;\n bern"+otree.TreeNode.nest(this.getSvg(),2)};HeatCalendarChart.prototype._getDayMap=function(a,b,c,d){var e={};b.forEach(function(b){var f=b.getCardNumeric(),h=moment(f[c]).format("MM/DD/YYYY");a:{for(var k=0;k<a.length;k++)if(f[d]<=a[k].value){f=a[k].percent;break a}f=void 0}e[h]={Quin:f,card:b}});return e};
...
otree.TreeNode.nest(d,4)+"\n  @tbody "+otree.TreeNode.nest(a,2)};window.TableTile=TableTile;var ThreeDChart=function(a){return AbstractHeaderlessChartTile.apply(this,arguments)||this};$jscomp.inherits(ThreeDChart,AbstractHeaderlessChartTile);ThreeDChart._mountedChisels=AbstractHeaderlessChartTile._mountedChisels;ThreeDChart.loadCode=AbstractHeaderlessChartTile.loadCode;ThreeDChart.prototype.getTileBodyBray=function(){return"@div\n class visjs"};
...
ThreeDChart.prototype._tryVis=function(){var a=this,b=this.getSettingsStruct(),c=this.getPipishInput(),d=this.getApp(),e=d.getLanguageBestGuess(c);c=d.generateProgram(c,e);c=this._treeTo3D(c);var f=new vis.DataSet;c.forEach(function(a){return f.add(a)});b=b.size;c=this.getTileDimension();var g=this.getNode("cameraPosition")||(new otree.TreeNode("cameraPosition 4 .1 1.5")).getNode("cameraPosition");d=parseFloat(g.getWord(1));e=parseFloat(g.getWord(2));g=parseFloat(g.getWord(3));b={width:c.width+"px",
...
TreeOutline.prototype.getTileBodyBray=function(){var a=new otree.TreeNode(this.getPipishInput());a=">dotline"===this.getKeyword()?a.toOutline(function(a){return"o"+a.getLine().split(" ").map(function(a){return"\u00ba"}).join("")}):a.toOutline();return"@pre\n style overflow: scroll; width: 100%; height: 100%; margin: 0; box-sizing: border-box;\n bern"+otree.TreeNode.nest(a,2)};window.TreeOutline=TreeOutline;var WordCloudChart=function(a){return AbstractHeaderlessChartTile.apply(this,arguments)||this};
...
DataTile.prototype._getFormatted=function(a,b){switch(b){case "tree":return(new otree.TreeNode(a)).toString();case "json":return(new otree.TreeNode(a)).toJson();default:return(new otree.TreeNode(a)).toCsv()}};DataTile.prototype.createCards=function(a){var b=this.getSettingsStruct().format,c=this.getDataSlang();c=(new CardParser).parse(c,b);a=lodash.concat(c,a);b=this._getFormatted(a,b);return this.getCommander().updateSlangCommand(b)};window.DataTile=DataTile;
...
TileProcess.prototype.loadTileCodeOrGetLoadingPromise=function(a,b){var c=this;return $jscomp.executeAsyncGenerator(function(){function d(d,h,m){for(;;)switch(e){case 0:return c._loadTileCss(a,b),g=TileGrammar.getDefinitionTileClass(b),f=b.findBeam(TileConstants.ohayoTileScript),e=1,{value:a.getWillowProgram().appendScript(f),done:!1};case 1:if(1!=d){e=2;break}e=-1;throw m;case 2:return e=-1,{value:g.loadCode(),done:!0};default:return{value:void 0,done:!0}}}var e=0,f,g,h={next:function(a){return d(0,
...
AbstractDropDownMenuChisel.prototype.getBray=function(){var a=this.getDropDownBray(),b=this.getAnchorId();return"@div\n style top: 30px; left: "+this.getParent().getStump().findStumpByChild("id "+b).getShadow().getShadowPosition().left+"px;\n class dropdownMenu"+otree.TreeNode.nest(a,1)};window.AbstractDropDownMenuChisel=AbstractDropDownMenuChisel;var NewDropDownMenuChisel=function(a){return AbstractDropDownMenuChisel.apply(this,arguments)||this};$jscomp.inherits(NewDropDownMenuChisel,AbstractDropDownMenuChisel);
...
AbstractContextMenuChisel.prototype.getBray=function(){return"@div\n class AbstractContextMenuChisel "+this.constructor.name+otree.TreeNode.nest(this.getContextMenuBodyBray(),1)};
