...
window.BinPacker=BinPacker;var TileAnyNode=function(a){return TreeProgram.apply(this,arguments)||this};$jscomp.inherits(TileAnyNode,TreeProgram);TileAnyNode.prototype.getErrors=function(){return[]};TileAnyNode.prototype.compile=function(){return this.getIndentation()+this.getCompiledLine()};TileAnyNode.prototype.getTagLine=function(){return"any ".repeat(this.getWords().length).trim()};
...
TileToolbarChisel.prototype._getTileTypeDropdownBray=function(){var a=this.getTargetTile(),b=this.getApp().getMountedTab().getTabProgram().getGrammarProgram().getBlazeNodeNames();b.sort();var c=a.getKeyword();return"@select\n data-onChangeCommand tile changeTileTypeCommand\n @option\n"+b.map(function(a){return" @option "+a+"\n  value "+a+"\n  "+(c===a?"selected":"notselected")}).join("\n")};
...
AbstractGrammarDefinition.prototype._getCatchAllDefinition=function(){var a=this._getRunTimeCatchAllKeyword();return(a=this._getDefinitionCache()[a])?a:this.getParent()._getCatchAllDefinition()};AbstractGrammarDefinition.prototype._initCatchCallNodeCache=function(){this._cache_catchAll||(this._cache_catchAll=this._getCatchAllDefinition().getJavascriptClassForNode())};AbstractGrammarDefinition.prototype.isDefined=function(a){return!!this._getDefinitionCache()[a.toLowerCase()]};
AbstractGrammarDefinition.prototype.getRunTimeCatchAllNodeClass=function(){this._initCatchCallNodeCache();return this._cache_catchAll};window.AbstractGrammarDefinition=AbstractGrammarDefinition;var GrammarConstNode=function(a){return TreeProgram.apply(this,arguments)||this};$jscomp.inherits(GrammarConstNode,TreeProgram);GrammarConstNode.prototype.getValue=function(){return this.length?this.childrenToString():this.getWords(2).join(" ")};GrammarConstNode.prototype.getName=function(){return this.getKeyword()};
var GrammarConstantsNode=function(a){return TreeProgram.apply(this,arguments)||this};$jscomp.inherits(GrammarConstantsNode,TreeProgram);GrammarConstantsNode.prototype.getCatchAllNodeClass=function(a){return GrammarConstNode};GrammarConstantsNode.prototype.getConstantsObj=function(){var a={};this.getChildren().forEach(function(b){var c=b.getName();a[c]=b.getValue()});return a};var GrammarDefinitionErrorNode=function(a){return TreeProgram.apply(this,arguments)||this};
$jscomp.inherits(GrammarDefinitionErrorNode,TreeProgram);GrammarDefinitionErrorNode.prototype.getErrors=function(){return['Unknown type "'+this.getKeyword()+'" at line '+this.getPoint().y]};GrammarDefinitionErrorNode.prototype.getTagLine=function(){return["keyword"].concat(this.getWords(1).map(function(a){return"any"})).join(" ")};var GrammarDefinition=function(a){return AbstractGrammarDefinition.apply(this,arguments)||this};$jscomp.inherits(GrammarDefinition,AbstractGrammarDefinition);
...
GrammarProgram.prototype.toSublimeSyntaxFile=function(){return"%YAML 1.2\n---\nname: "+this.getExtensionName()+"\nfile_extensions: ["+this.getExtensionName()+"]\nscope: source."+this.getExtensionName()+"\n\ncontexts:\n main:\n   - match: (A|^) *[^ ]+\n     scope: storage.type.tree\n     set: [parameters]\n\n parameters:\n   - match: $\n     scope: entity.name.type.tree\n     pop: true"};GrammarProgram.prototype.getBlazeNodeNames=function(){return Object.keys(this._getDefinitionCache())};
GrammarProgram.prototype.execute=function(a){return Util.compileProgramToJavascriptFile(a)};window.GrammarProgram=GrammarProgram;var BlazeProgram=function(a){return TreeProgram.apply(this,arguments)||this};$jscomp.inherits(BlazeProgram,TreeProgram);BlazeProgram.prototype.getKeywordMap=function(){return this.getGrammarProgram().getRunTimeKeywordMap()};BlazeProgram.prototype.getCatchAllNodeClass=function(a){return this.getGrammarProgram().getRunTimeCatchAllNodeClass()};
BlazeProgram.prototype.getProgramErrors=function(){return lodash.flatten(this.getTopDownArray().map(function(a){return a.getErrors()}))};BlazeProgram.prototype.getErrorCount=function(){var a=this.getGrammarProgram();return{errorCount:this.getProgramErrors().length,name:a.getExtensionName()}};BlazeProgram.prototype.isProgram=function(){return!0};BlazeProgram.prototype.getProgram=function(){return this};
BlazeProgram.prototype.getBlazeTerminalNodes=function(){return this.getTopDownArray().filter(function(a){return a instanceof BlazeTerminalNode})};BlazeProgram.prototype.getBlazeNonTerminalNodes=function(){return this.getTopDownArray().filter(function(a){return a instanceof BlazeNonTerminalNode})};
...
BlazeProgram.prototype.getAutocompleteWords=function(a){var b=this.getGrammarProgram().getBlazeNodeNames().join("\n")+"\n"+this.childrenToString();return Util.getUniqueWordsArray(b).filter(function(b){return b.word.includes(a)&&b.word!==a}).map(function(a){return a.word})};BlazeProgram.prototype.compileFile=function(a){this.delete("#!");a=this.getCompiledFileName(a);require("fs").writeFileSync(a,this.compile(),"utf8")};BlazeProgram.prototype.getGrammarProgram=function(){return BlazeProgram.getGrammarProgram(this)};
BlazeProgram.prototype.getProgramTagString=function(){return this.getTopDownArray().map(function(a){return a.getIndentation()+a.getTagLine()}).join("\n")};BlazeProgram.prototype.getWordTypeAtPosition=function(a,b){var c=this.getTreeMTime();this._tagStringMTime!==c&&(this._tagTree=new TreeProgram(this.getProgramTagString()),this._tagStringMTime=c);return(a=this._tagTree.getTopDownArray()[a-1])?a.getWord(b-1):""};
