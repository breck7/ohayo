...
this._setBodyShadowHandlers();this._makeProgramLinksOpenImmediately();this._makeDocumentCopyableAndCuttable();this._bindKeyboardShortcuts();var d=this,e=d.getWillowProgram();e.setResizeEndHandler(function(a){d.renderApp()});e.setPasteHandler(function(a){if(e.someInputHasFocus())return!0;a.clipboardData&&a.clipboardData.getData&&d.pasteCommand(a.clipboardData.getData("text/plain"))});e.setLoadedDroppedFileHandler(function(b){a.createAndOpen(b.data,b.filename)},"Drop to create a new program.");this._setErrorHandlers();
this.logMessage("Ohayo dear user!")};AbstractAppChisel.prototype.registerETN=function(a,b){this.getETNs()[a]=b;return this};AbstractAppChisel.prototype.getProgramClass=function(a){return this.getETNs()[a]||FlowProgram};AbstractAppChisel.prototype.getETNs=function(){this._etns||(this._etns={},this.registerETN("flow",FlowProgram),this.registerETN("fire",FireProgram));return this._etns};AbstractAppChisel.prototype.getTargetNode=function(){return this._targetNode};
AbstractAppChisel.prototype.setTargetNode=function(a){this._targetNode=a;return this};AbstractAppChisel.prototype.getWillowProgram=function(){this._willowBrowser||(this._willowBrowser="undefined"===typeof jQuery?new WillowProgram("http://localhost:8000/"):new WillowBrowserProgram(""));return this._willowBrowser};AbstractAppChisel.prototype.emptyFolderCommand=function(){};AbstractAppChisel.prototype.getServerPath=function(){return""};AbstractAppChisel.prototype.getVersion=function(){return Version};
...
OtherTuple.prototype.getParseErrorCount=function(){return this.getTopDownArray().length};window.OtherTuple=OtherTuple;var ProbTuple=function(a){return AbstractTuple.apply(this,arguments)||this};$jscomp.inherits(ProbTuple,AbstractTuple);ProbTuple.prototype._parseValue=function(a){return parseFloat(a)};window.ProbTuple=ProbTuple;var QuickTuple=function(a){return AbstractTuple.apply(this,arguments)||this};$jscomp.inherits(QuickTuple,AbstractTuple);
QuickTuple.prototype._parseValue=function(a){return Format.linkify(Format.stripHtml(void 0===a?"":a))};window.QuickTuple=QuickTuple;var SlangTuple=function(a){return AbstractTuple.apply(this,arguments)||this};$jscomp.inherits(SlangTuple,AbstractTuple);SlangTuple.prototype.toFormBray=function(a){return"@textarea\n data-onChangeCommand cog changeTupleCommand\n name "+this.getTupleName()+"\n bern"+TreeNotation.nest(a,2)};SlangTuple.prototype.getValueFromNode=function(a){return a.childrenToString()};
window.SlangTuple=SlangTuple;var TitleTuple=function(a){return AbstractTuple.apply(this,arguments)||this};$jscomp.inherits(TitleTuple,AbstractTuple);TitleTuple.prototype._parseValue=function(a){return Format.stripHtml(void 0===a?"":a)};window.TitleTuple=TitleTuple;var GlobalShortcutNode=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(GlobalShortcutNode,TreeNotation);GlobalShortcutNode.prototype.getKeyCombo=function(){return this.getWord(3)};
GlobalShortcutNode.prototype.getFn=function(){return this.getWord(2)};GlobalShortcutNode.prototype.getCategory=function(){return this.getWord(1)};GlobalShortcutNode.prototype.getDescription=function(){return this.getWords(4).join(" ")};GlobalShortcutNode.prototype.isEnabled=function(){return!0};GlobalShortcutNode.prototype.execute=function(a){if(!this.isEnabled(a))return!1;var b=this.getFn();a.logCommand("app "+b);a[b]()};
var MountedShortcutNode=function(a){return GlobalShortcutNode.apply(this,arguments)||this};$jscomp.inherits(MountedShortcutNode,GlobalShortcutNode);MountedShortcutNode.prototype.isEnabled=function(a){return!!a.getMountedProgram()};var DrumsErrorNode=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(DrumsErrorNode,TreeNotation);var Drums=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(Drums,TreeNotation);
...
FlowProgram.prototype._createProgramFromDrop=function(a,b){b=lodash.upperFirst(Format.toTitleCase(Format.removeFileExtension(b)));b=Format.permalink(b);a=(new TreeNotation(a)).toString();return this.createAndOpen(">data\n slang\n  "+a+"\n >table\n >scatter",b)};FlowProgram.prototype._getProgramCardCount=function(){return this.getAllCards().reduce(function(a,b){return a+b.length},0)};
FlowProgram.prototype.getAllCards=function(){return lodash.flatten(this.getProgramCogs().map(function(a){return a.isProvider()?a.getOutputBinder().getCards():[]}))};FlowProgram.prototype.getProgramOfInterest=function(){var a=this.getProgramCogs().find(function(a){return">coder"===a.getBase()});if(a){var b=a.getStruct().etn;return this.getApp().generateProgram(a.getDataSlang(),b)}return this};window.FlowProgram=FlowProgram;
var AbstractChartCog=function(a){return AbstractFlowCog.apply(this,arguments)||this};$jscomp.inherits(AbstractChartCog,AbstractFlowCog);AbstractChartCog._mountedChisels=AbstractFlowCog._mountedChisels;AbstractChartCog.loadCode=AbstractFlowCog.loadCode;AbstractChartCog.prototype.getCogHeaderBern=function(){return this.getStruct().title||""};AbstractChartCog.prototype.getCogFooterBray=function(){var a=this.getInputBinder().getCardCount();return this.getCogToolbarButtonBray()+"\n@span In: "+a};
AbstractChartCog.prototype.toDisplayString=function(a,b){return void 0===a?"":this.getInputBinder().getBinderColumnByName(b).toDisplayString(a)};window.AbstractChartCog=AbstractChartCog;var AbstractHeaderlessChartCog=function(a){return AbstractChartCog.apply(this,arguments)||this};$jscomp.inherits(AbstractHeaderlessChartCog,AbstractChartCog);AbstractHeaderlessChartCog._mountedChisels=AbstractChartCog._mountedChisels;AbstractHeaderlessChartCog.loadCode=AbstractChartCog.loadCode;
...
DesktopTemplates.fileTypes.tree=function(a){return">files\n path "+a+"\n >read\n  >parse\n   column bytes\n   format tree\n   >tree"};DesktopTemplates.fileTypes.png=function(a){return'>html\n slang\n  <img src="'+a+'" />'};DesktopTemplates.fileTypes.gif=DesktopTemplates.fileTypes.png;DesktopTemplates.fileTypes.jpg=DesktopTemplates.fileTypes.png;DesktopTemplates.fileTypes.jpeg=DesktopTemplates.fileTypes.png;DesktopTemplates.fileTypes.md=function(a){return">file\n path "+a+"\n format text\n >text\n >kpidown"};
