var $jscomp$templatelit$23=["Adding..."];$jscomp$templatelit$23.raw=["Adding..."];var $jscomp$templatelit$22=["Ok"];$jscomp$templatelit$22.raw=["Ok"];var $jscomp$templatelit$21=["Cancel"];$jscomp$templatelit$21.raw=["Cancel"];var $jscomp$templatelit$20=["Delete card"];$jscomp$templatelit$20.raw=["Delete card"];var $jscomp$templatelit$19=["Keyboard Shortcuts"];$jscomp$templatelit$19.raw=["Keyboard Shortcuts"];var $jscomp$templatelit$18=["ohayo"];$jscomp$templatelit$18.raw=["ohayo"];
...
TreeParser.prototype.is=function(a){return 1>a.indentedLineCount?0:.1};TreeParser.prototype._getFormatName=function(){return"tree"};var SectionsParser=function(a){AbstractCardParser.apply(this,arguments)};$jscomp.inherits(SectionsParser,AbstractCardParser);SectionsParser.prototype.getExample=function(){return"name\nage\n\njohn\n12\n\nmary\n20"};SectionsParser.prototype._getFormatName=function(){return"sections"};
...
typeof a&&a.match(/^[0-9]{2}\/[0-9]{4}$/)?moment(a,"MM/YYYY"):!a.match||a.match(/[^0-9]/)||(c=parseFloat(a),isNaN(c))?b:10===a.length?moment(1E3*c):moment(c)}};window.GetDate=GetDate;var HakonPropertyNode=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(HakonPropertyNode,TreeNotation);HakonPropertyNode.prototype.toCss=function(a){return""+a+this.getBase()+": "+this.getBeam()+";"};var HakonErrorNode=function(a){return TreeNotation.apply(this,arguments)||this};
$jscomp.inherits(HakonErrorNode,TreeNotation);HakonErrorNode.prototype.toCss=function(){return""};HakonErrorNode.prototype.getErrorMessage=function(){return"Hakon should not have semicolons."};var HakonSelectorNode=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(HakonSelectorNode,TreeNotation);HakonSelectorNode.prototype.parseNodeType=function(a){return a.includes(";")?HakonErrorNode:a.includes(" ")?HakonPropertyNode:HakonSelectorNode};
HakonSelectorNode.prototype.getSelector=function(){var a=this.getParent().getSelector();return this.getBase().split(",").map(function(b){return b.startsWith("&")?a+b.substr(1):a?a+" "+b:b}).join(",")};HakonSelectorNode.prototype.toCss=function(){var a=this.getChildrenByNodeType(HakonPropertyNode);return a.length?this.getSelector()+" {\n"+a.map(function(a){return a.toCss("  ")}).join("\n")+"\n}\n":""};var Hakon=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(Hakon,TreeNotation);
Hakon.prototype.parseNodeType=function(a){return a?HakonSelectorNode:TreeNotation};Hakon.prototype.getSelector=function(){return""};Hakon.prototype.toCss=function(){return this.getTopDownArray().filter(function(a){return a instanceof HakonSelectorNode}).map(function(a){return a.toCss()}).join("")};window.Hakon=Hakon;var ObjectBackedCard=function(a){AbstractCard.apply(this,arguments)};$jscomp.inherits(ObjectBackedCard,AbstractCard);ObjectBackedCard._uniqueId=AbstractCard._uniqueId;
window.ObjectBackedCard=ObjectBackedCard;var BlockPropertyNode=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(BlockPropertyNode,TreeNotation);BlockPropertyNode.prototype.getPropertyName=function(){return this.getWord(1)};BlockPropertyNode.prototype.getProbability=function(){var a=this.findBeam(BlockConstants.percentage);return a?parseFloat(a):.01};
...
ParserBlock.prototype._loadCss=function(a){var b=this._getExtended().findBeam("css");if(b){var c=a.getServerPath();a.getWillowDocument().getBodyStump().insertChildNode(b.split(" ").map(function(a){return"@ link\n rel stylesheet\n media screen\n href "+(c+a)}).join("\n"))}};ParserBlock.prototype.executeLoadBlockOrGetLoadingPromise=function(a){this._loadCss(a);var b=this.getBlockJSClass(),c=this._getExtended().findBeam("script"),d=a.getServerPath(),c=c?c.match(/^https\:/)?c:d+c:void 0;return a.getWillowDocument().appendScript(c).then(function(){return b.loadCode()})};
...
ParserBlock.prototype.computeStruct=function(a){var b={};this.getPropertyNodes().forEach(function(c){c.addValue(b,a)});return b};ParserBlock.prototype.getBlockJSClass=function(){if(this._class)return this._class;var a=this._getExtended().findBeam("require").split(" "),b=a[0],c=a[1],d="undefined"!==typeof require,a=d?process:window;d&&!a[b]&&(c=require(c),a[c.name]=c);return this._class=a[b]};var ParserETN=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(ParserETN,TreeNotation);
ParserETN.prototype.parseNodeType=function(a){return ParserBlock};ParserETN.prototype.dynamicGetJsClass=function(a,b){var c=b.split(" ")[0];return(c=(c=this._getParserBlockMap()[c])&&c.getBlockJSClass())?c:a.getProgram().getCatchAllBlockClass(this,a,b)};ParserETN.prototype.getCatchAllBlockClass=function(a,b,c){return TreeNotation};ParserETN.prototype.getDocs=function(){return this.toString()};
...
Shadow.prototype.makeSelectable=function(){return this};Shadow.prototype.focusShadow=function(){return this};Shadow.prototype.isShadowChecked=function(){return!1};Shadow.prototype.getShadowHtml=function(){return""};Shadow.prototype.getShadowOffset=function(){return{left:111,top:111}};Shadow.prototype.getShadowWidth=function(){return 111};Shadow.prototype.getShadowHeight=function(){return 111};Shadow.prototype.isShadowResizable=function(){return!1};Shadow.prototype.bindShadow=function(){return this};
Shadow.prototype.toggleShadow=function(){};Shadow.prototype.setShadowHtml=function(a){return this};Shadow.prototype.onShadowEvent=function(){return this};Shadow.prototype.offShadowEvent=function(){return this};Shadow.prototype.triggerShadowEvent=function(a){return this};Shadow.prototype.getShadowPosition=function(){return{left:111,top:111}};Shadow.prototype.getShadowOuterHeight=function(){return 11};Shadow.prototype.getShadowOuterWidth=function(){return 11};Shadow.prototype.getShadowCss=function(){return""};
Shadow.prototype.setShadowCss=function(){return this};Shadow.prototype.clearHtml=function(){};Shadow.prototype.insertHtmlNode=function(){};Shadow.prototype.getShadowElement=function(){};Shadow.prototype.removeShadowAttr=function(a){return this};Shadow.prototype.setShadowAttr=function(a,b){return this};var BrowserShadow=function(a){Shadow.apply(this,arguments)};$jscomp.inherits(BrowserShadow,Shadow);
BrowserShadow.prototype._getJQ=function(){return jQuery('[data-suid="'+this.getShadowStump()._getUid()+'"]')};BrowserShadow.prototype.clearHtml=function(){this._getJQ().html("");return this};BrowserShadow.prototype.getShadowElement=function(){return this._getJQ()[0]};BrowserShadow.prototype.insertHtmlNode=function(a,b){var c=a.toHtmlWithSuids(),c=jQuery(c),d=this._getJQ();void 0===b?d.append(c):0===b?d.prepend(c):jQuery(d.children().get(b-1)).after(c);c.data("stump",a)};
BrowserShadow.prototype.getShadowPosition=function(){return this._getJQ().position()};BrowserShadow.prototype.setShadowHtml=function(a){this._getJQ().html(a);return this};BrowserShadow.prototype.onShadowEvent=function(a,b,c){this._getJQ().on(a,b,c);return this};BrowserShadow.prototype.offShadowEvent=function(a,b){this._getJQ().off(a,b);return this};BrowserShadow.prototype.triggerShadowEvent=function(a){this._getJQ().trigger(a);return this};BrowserShadow.prototype.getShadowHtml=function(){return this._getJQ().html()};
BrowserShadow.prototype.getShadowValue=function(){return this._getJQ().val()};BrowserShadow.prototype.getShadowOuterHeight=function(){return this._getJQ().outerHeight()};BrowserShadow.prototype.getShadowOuterWidth=function(){return this._getJQ().outerWidth()};BrowserShadow.prototype.setShadowValue=function(a){this._getJQ().val(a);return this};BrowserShadow.prototype.isShadowChecked=function(){return this._getJQ().is(":checked")};
BrowserShadow.prototype.toggleShadow=function(){this._getJQ().toggle();return this};BrowserShadow.prototype.removeShadowAttr=function(a){this._getJQ().removeAttr(a);return this};BrowserShadow.prototype.setShadowAttr=function(a,b){this._getJQ().attr(a,b);return this};BrowserShadow.prototype.getShadowWidth=function(){return this._getJQ().width()};BrowserShadow.prototype.getShadowHeight=function(){return this._getJQ().height()};
BrowserShadow.prototype.makeResizable=function(a){this._getJQ().resizable(a);return this};BrowserShadow.prototype.getShadowOffset=function(){return this._getJQ().offset()};BrowserShadow.prototype.removeShadow=function(){this._getJQ().remove();return this};BrowserShadow.prototype.makeDraggable=function(a){this._getJQ().draggable(a);return this};BrowserShadow.prototype.getShadowCss=function(a){return this._getJQ().css(a)};BrowserShadow.prototype.setShadowCss=function(a){this._getJQ().css(a);return this};
BrowserShadow.prototype.focusShadow=function(){this._getJQ().focus();return this};BrowserShadow.prototype.makeSelectable=function(a){this._getJQ().selectable(a);return this};BrowserShadow.prototype.bindShadow=function(a,b){this._getJQ().bind(a,b);return this};BrowserShadow.prototype.isShadowResizable=function(){return 0<this._getJQ().find(".ui-resizable-handle").length};Shadow.BrowserShadow=BrowserShadow;window.Shadow=Shadow;
var WillowBernNode=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(WillowBernNode,TreeNotation);WillowBernNode.prototype._toHtml=function(){return this.getBeamWithChildren()};var WillowAttributeNode=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(WillowAttributeNode,TreeNotation);WillowAttributeNode.prototype._toHtml=function(){return""};WillowAttributeNode.prototype.getAttribute=function(){return" "+this.getBase()+'="'+this.getBeam()+'"'};
...
AbstractDocument.prototype.getMousetrap=function(){this._mousetrap||(this._mousetrap=new WillowMousetrap);return this._mousetrap};AbstractDocument.prototype._getFocusedShadow=function(){return this._focusedShadow||this.getBodyStump().getShadow()};AbstractDocument.prototype.getHeadStump=function(){return this._headStump};AbstractDocument.prototype.getBodyStump=function(){return this._bodyStump};AbstractDocument.prototype.getHtmlStump=function(){return this._htmlStump};
AbstractDocument.prototype.getStore=function(){this._store||(this._store=new WillowStore);return this._store};AbstractDocument.prototype.someInputHasFocus=function(){var a=this._getFocusedShadow();return a?(a=a.getShadowStump())&&a.isInputType():!1};AbstractDocument.prototype.isNode=function(){return"undefined"!==typeof exports};AbstractDocument.prototype.copyTextToClipboard=function(){};AbstractDocument.prototype.getBaseUrlNoSlash=function(){return this.getBaseUrl().replace(/\/$/,"")};
AbstractDocument.prototype.setCopyData=function(a,b){};AbstractDocument.prototype.getBaseUrl=function(){return this._baseUrl};AbstractDocument.prototype._normalizeUrl=function(a){return a.startsWith("http://")||a.startsWith("https://")?a:this.getBaseUrlNoSlash()+a};AbstractDocument.prototype.get=function(a,b){a=this._normalizeUrl(a);return superagent.get(a).query(b).set(this._headers||{}).then(function(a){return a.body||a.text})};
AbstractDocument.prototype.post=function(a,b){a=this._normalizeUrl(a);return superagent.post(a).set(this._headers||{}).send(b).then(function(a){return a.body||a.text})};AbstractDocument.prototype.encodeURIComponent=function(a){return encodeURIComponent(a)};AbstractDocument.prototype.downloadFile=function(a,b,c){};AbstractDocument.prototype.appendScript=function(a){return Promise.resolve()};
AbstractDocument.prototype.getWindowTitle=function(){var a=this.getTopDownArray().find(function(a){return"title"===a.getBase()});return a?a.getBeam():""};AbstractDocument.prototype.setWindowTitle=function(a){this.getTopDownArray().find(function(a){return"head"===a.getWord(1)}).touchNode("title").setBeam(a);return this};AbstractDocument.prototype.getHostname=function(){return this.location.hostname||""};AbstractDocument.prototype.getIpc=function(){return new WillowIpc};
AbstractDocument.prototype.openUrl=function(a){};AbstractDocument.prototype.getPageHtml=function(){return this.toHtmlWithSuids()};AbstractDocument.prototype.getStumpFromElement=function(a){};AbstractDocument.prototype.setPasteHandler=function(a){return this};AbstractDocument.prototype.setErrorHandler=function(a){return this};AbstractDocument.prototype.setWindowBlurHandler=function(a){return this};AbstractDocument.prototype.setWindowFocusHandler=function(a){return this};
AbstractDocument.prototype.setCopyHandler=function(a){return this};AbstractDocument.prototype.setCutHandler=function(a){return this};AbstractDocument.prototype.setResizeEndHandler=function(a){return this};AbstractDocument.prototype.getCookie=function(){return{}};AbstractDocument.prototype.getWindowSize=function(){return{width:1111,height:1111}};AbstractDocument.prototype.getDocumentSize=function(){return this.getWindowSize()};AbstractDocument.prototype.forceRepaint=function(){};
AbstractDocument.prototype.blurFocusedInput=function(){};AbstractDocument.startApp=function(a){document.addEventListener("DOMContentLoaded",function(){window.app||(window.app=new a,window.app.renderApp())},!1)};var BrowserDocument=function(a){return AbstractDocument.apply(this,arguments)||this};$jscomp.inherits(BrowserDocument,AbstractDocument);BrowserDocument.startApp=AbstractDocument.startApp;BrowserDocument.prototype.getIpc=function(){return require("electron").ipcRenderer};
BrowserDocument.prototype.findStumpsByShadowClass=function(a){var b=[],c=this;jQuery("."+a).each(function(){b.push(c.getStumpFromElement(this))});return b};BrowserDocument.prototype.addSuidsToHtmlHeadAndBodyShadows=function(){jQuery("html").attr("data-suid",this.getHtmlStump()._getUid());jQuery("head").attr("data-suid",this.getHeadStump()._getUid());jQuery("body").attr("data-suid",this.getBodyStump()._getUid())};BrowserDocument.prototype.getShadowClass=function(){return Shadow.BrowserShadow};
...
BrowserDocument.prototype.getHostname=function(){return location.hostname};
...
BrowserDocument.prototype.getCookie=function(){return document.cookie};BrowserDocument.prototype.getBrowserHtml=function(){return document.documentElement.outerHTML};BrowserDocument.prototype.getWindowSize=function(){var a=jQuery(window);return{width:a.width(),height:a.height()}};BrowserDocument.prototype.getDocumentSize=function(){var a=jQuery(document);return{width:a.width(),height:a.height()}};BrowserDocument.prototype.blurFocusedInput=function(){document.activeElement.blur()};
BrowserDocument.prototype._getFocusedShadow=function(){var a=this.getStumpFromElement(document.activeElement);return a&&a.getShadow()};var WillowDocument=function(a){return AbstractDocument.apply(this,arguments)||this};$jscomp.inherits(WillowDocument,AbstractDocument);WillowDocument.startApp=AbstractDocument.startApp;WillowDocument.BrowserDocument=BrowserDocument;window.WillowDocument=WillowDocument;var AbstractAppChisel=function(a){return Chisel.apply(this,arguments)||this};
...
this._setBodyShadowHandlers();this._makeProgramLinksOpenImmediately();this._makeWindowDroppable(this);this._makeWindowPastable(this);this._makeDocumentCopyableAndCuttable();this._makeWindowResizable(this);this._bindKeyboardShortcuts();this._setErrorHandlers();this.logMessage("Ohayo dear user!")};AbstractAppChisel.prototype.registerETN=function(a,b,c){var d=this.getETNs(),e=this.getParsers();d[a]=b;a=new ParserETN(c,a,this);e[b.name]=a;return this};
AbstractAppChisel.prototype.getParserFromETNConstructorName=function(a){return this.getParsers()[a]};AbstractAppChisel.prototype.getProgramClass=function(a){return this.getETNs()[a]||FlowProgram};AbstractAppChisel.prototype.getParsers=function(){this.getETNs();this._parsers||(this._parsers={});return this._parsers};
AbstractAppChisel.prototype.getETNs=function(){this._etns||(this._etns={},this.registerETN("flow",FlowProgram,this.getFlowBluePrintsStr()),this.registerETN("fire",FireProgram,FireBluePrints));return this._etns};AbstractAppChisel.prototype.getTargetNode=function(){return this._targetNode};AbstractAppChisel.prototype.setTargetNode=function(a){this._targetNode=a;return this};
...
AbstractAppChisel.prototype.appendBlockAndWaitCommand=function(a,b){var c=this;return Promise.all(this._appendBlocks(a,b).map(function(a){return a.executeLoadNewBinder()})).then(function(){return c.getMountedProgram().autosaveAndRender()})};AbstractAppChisel.prototype._getAvailablePermalink=function(a){var b=this;return Util.getAvailablePermalink(a,function(a){return b.doesFileExistSync(a)})};
AbstractAppChisel.prototype._appendBlocks=function(a,b){return this.getNodeCursors().map(function(c){return c.append(a,b)})};AbstractAppChisel.prototype.isPaid=function(){return!!Util.parseCookie(this.getWillowDocument().getCookie()).paidToken};AbstractAppChisel.prototype.appendBlockAndSelectCommand=function(a,b){var c=this._appendBlocks(a,b);c.forEach(function(a){return a.executeLoadNewBinder()});a=this.getMountedProgram();a.clearSelection();return a.autosaveAndRender().then(function(){c.forEach(function(a){return a.selectBlock()})})};
...
AbstractAppChisel.prototype.deleteAllProgramsPrompt=function(){var a=this,b=this.getFocusedPanel().getPrograms();return this.confirm(Say($jscomp$templatelit$7,b.length)).then(function(c){return c?Promise.all(b.map(function(b){return a.deleteFileCommand(b.getDiskPath())})):Promise.resolve(!1)})};AbstractAppChisel.prototype.getFolderPath=function(){return""};
...
AbstractProgramChisel.prototype.getAutocompleteWords=function(a){var b=this.getParser().getBlockNames().join("\n")+"\n"+this.childrenToString();return Util.getUniqueWordsArray(b).filter(function(b){return b.word.includes(a)&&b.word!==a}).map(function(a){return a.word})};AbstractProgramChisel.prototype.getDiskFolder=function(){var a=(this.isFolder()?this.getUrl():this.getFolder())||"/";return require("path").normalize(a.replace("file://",""))};
AbstractProgramChisel.prototype.getFolder=function(){var a=this.getUrl().split("/");a.pop();return a.join("/")};AbstractProgramChisel.prototype.setLayout=function(a){this.touchNode(">settings layout").setBeam(a);return this};AbstractProgramChisel.prototype.cloneBlock=function(a){var b=a.duplicate();(a=a.findBeam(BlockConstants.pin))&&b.touchNode(BlockConstants.pin).setBeam(this.getAvailableSpot(a));return b};AbstractProgramChisel.prototype._updateCustomPoint=function(){return this._updateCustomLayout()};
AbstractProgramChisel.prototype._updateCustomPointWithWidthAndHeight=function(){return this._updateCustomLayout(!0)};AbstractProgramChisel.prototype._updateCustomLayout=function(a){a=void 0===a?!0:a;var b=this,c=this.getApp();c.getWillowDocument().findStumpsWithClass("BlockChisel").forEach(function(c){return b._updateBlockLayout(c,a)});this.setLayout("custom");this.autosaveProgram();c.renderApp()};
...
AbstractProgramChisel.prototype.getDiskPath=function(){var a=this.getDiskFolder()+"/"+this.getFileName();return require("path").normalize(a.replace("file://",""))};AbstractProgramChisel.prototype.isThrowaway=function(){return!0===this._throwaway};AbstractProgramChisel.prototype.setThrowaway=function(a){this._throwaway=a;return this};AbstractProgramChisel.prototype.autosaveAndRender=function(){var a=this.autosaveProgram();this.getApp().renderApp();return a};
...
GlobalShortcutNode.prototype.execute=function(a){if(!this.isEnabled(a))return!1;var b=this.getFn();a.logCommand("app "+b);a[b]()};var MountedShortcutNode=function(a){return GlobalShortcutNode.apply(this,arguments)||this};$jscomp.inherits(MountedShortcutNode,GlobalShortcutNode);MountedShortcutNode.prototype.isEnabled=function(a){return!!a.getMountedProgram()};var DrumsErrorNode=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(DrumsErrorNode,TreeNotation);
var Drums=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(Drums,TreeNotation);Drums.prototype.parseNodeType=function(a){return a.startsWith("panel")?GlobalShortcutNode:a.startsWith("mounted")?MountedShortcutNode:DrumsErrorNode};window.Drums=Drums;var BinPacker=function(){};
...
window.LayoutStrategies=LayoutStrategies;var LocalStorageCaddy=function(a){return AbstractCaddy.apply(this,arguments)||this};$jscomp.inherits(LocalStorageCaddy,AbstractCaddy);window.LocalStorageCaddy=LocalStorageCaddy;function MakeSVG(a,b){var c=SVGS[a];if(!c){console.error("svg not found for "+a);debugger;return""}a=c.substr(4);return'<svg width="'+b+'" height="'+b+'" class="SVGIcon" '+a}window.MakeSVG=MakeSVG;
...
MorphBlock.prototype.getBlockBodyBray=function(){var a=this.getProgram(),b=this.getParser(),a=a.getTopNodeTypes();this.getApp();return a.map(function(a){return b.getParserBlockByName(a)}).map(function(a){var b=MakeSVG(a.getSvg(),24);return"@ a\n title "+a.getDescription()+"\n tabindex -1\n value "+a.getBase()+"\n data-onClickCommand chisel changeTypeCommand\n bern "+b+"<br>"+a.getBase()}).join("\n")};MorphBlock.prototype.getBlockHeaderBern=function(){return""};window.MorphBlock=MorphBlock;
...
1)};BlockToolbarChisel.prototype._getTypeDropdownBray=function(){var a=this.getChildBlock(),b=a.getParser().getBlockNames();b.sort();var c=a.getBase();return"@ select\n data-onChangeCommand block changeTypeCommand\n @ option\n"+b.map(function(a){return" @ option\n  value "+a+"\n  bern "+a+"\n  "+(c===a?"selected":"notselected")}).join("\n")};
...
PanelChisel.prototype.getOpenTabByUrl=function(a){return this.getPrograms().find(function(b){return b.getUrl()===a})};PanelChisel.prototype.getPanelPath=function(){void 0===this._panelPath&&(this._panelPath="");return this._panelPath};PanelChisel.prototype.setPanelPath=function(a){this._panelPath=a;return this};
PanelChisel.prototype.setMountedProgram=function(a){var b=this.getMountedProgram();if(b===a)return Promise.resolve(a);b&&b.unmount();this._mountedProgram=a;this._updateProgramSwitcherChisel();this.getApp().renderApp();return Promise.resolve(a)};PanelChisel.prototype.openUrlInNewSpace=function(a){return this._executeFetchProgram(this.append("program "+a))};PanelChisel.prototype.closeTabByIndex=function(a){return this.closeProgram(this.getPrograms()[a])};
...
ProgramSwitcherChisel.prototype.getDependencyTimestamps=function(){return[this.getParent().getMTime()]};
...
var AbstractHelpModal=function(a){return AbstractModalChisel.apply(this,arguments)||this};$jscomp.inherits(AbstractHelpModal,AbstractModalChisel);AbstractHelpModal._mountedComponents=AbstractModalChisel._mountedComponents;
...
CustomConfirmModal.prototype.getModalBray=function(){return"@ h4\n bern "+this.getBeam()+"\n@ button\n value 0\n data-onClickCommand chisel _resolveCommand\n bern "+Say($jscomp$templatelit$21)+"\n@ button\n value 1\n data-onClickCommand chisel _resolveCommand\n bern "+Say($jscomp$templatelit$22)};CustomConfirmModal.prototype._resolveCommand=function(a){this.resolve("1"===a);this.getApp().closeModal();return Promise.resolve()};
...
FlowProgram.prototype.buildProgram=function(){return this.getDescendantBlocks().filter(function(a){return!(a instanceof ParserETN.BlockPropertyNode)}).map(function(a){return a.getBlockBodyBray()}).join("\n")};FlowProgram.prototype.getCatchAllBlockClass=function(a,b,c){a=a.getDidYouMeanBlock().getBlockJSClass();return c.startsWith(">")?a:ParserETN.BlockPropertyNode};window.FlowProgram=FlowProgram;
