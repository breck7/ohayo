...
MorphTile.prototype.getTileBodyBray=function(){var a=this.getTileProcess().getProcessGrammarProgram(),b=a.getTopNodeTypes();this.getApp();return b.map(function(b){return a.getDefinitionByName(b)}).map(function(a){var b=a.getConstantsObject()[TileConstants.tileSvg]||"table";return"@a "+Icons(b,24)+"<br>"+a.getKeyword()+"\n title "+a.getDescription()+"\n tabindex -1\n value "+a.getKeyword()+"\n data-onClickCommand chisel changeTileTypeCommand"}).join("\n")};MorphTile.prototype.getTileHeaderBern=function(){return""};
