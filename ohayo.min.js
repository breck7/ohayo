var $jscomp$templatelit$27=["Ok"];$jscomp$templatelit$27.raw=["Ok"];var $jscomp$templatelit$26=["Cancel"];$jscomp$templatelit$26.raw=["Cancel"];var $jscomp$templatelit$25=["Delete card"];$jscomp$templatelit$25.raw=["Delete card"];var $jscomp$templatelit$24=["Adding..."];$jscomp$templatelit$24.raw=["Adding..."];var $jscomp$templatelit$23=["Keyboard Shortcuts"];$jscomp$templatelit$23.raw=["Keyboard Shortcuts"];var $jscomp$templatelit$22=["ohayo"];$jscomp$templatelit$22.raw=["ohayo"];
var $jscomp$templatelit$21=["Copied old version to clipboard"];$jscomp$templatelit$21.raw=["Copied old version to clipboard"];var $jscomp$templatelit$20=["",""];$jscomp$templatelit$20.raw=["",""];var $jscomp$templatelit$19=["ohayo"];$jscomp$templatelit$19.raw=["ohayo"];var $jscomp$templatelit$18=["ohayo"];$jscomp$templatelit$18.raw=["ohayo"];var $jscomp$templatelit$17=["",""];$jscomp$templatelit$17.raw=["",""];var $jscomp$templatelit$16=["Click to sort."];$jscomp$templatelit$16.raw=["Click to sort."];
var $jscomp$templatelit$15=["",""];$jscomp$templatelit$15.raw=["",""];var $jscomp$templatelit$14=["",""];$jscomp$templatelit$14.raw=["",""];var $jscomp$templatelit$13=["My programs"];$jscomp$templatelit$13.raw=["My programs"];var $jscomp$templatelit$12=["Layout set to '","'"];$jscomp$templatelit$12.raw=["Layout set to '","'"];var $jscomp$templatelit$11=["Items cut"];$jscomp$templatelit$11.raw=["Items cut"];var $jscomp$templatelit$10=["Items copied"];$jscomp$templatelit$10.raw=["Items copied"];
var $jscomp$templatelit$9=["dragOverHelp"];$jscomp$templatelit$9.raw=["dragOverHelp"];var $jscomp$templatelit$8=["dragOverHelp"];$jscomp$templatelit$8.raw=["dragOverHelp"];var $jscomp$templatelit$7=["Drop to create a new program. Hold shift key to insert cards into current program."];$jscomp$templatelit$7.raw=["Drop to create a new program. Hold shift key to insert cards into current program."];var $jscomp$templatelit$6=["Are you sure you want to delete ","?"];
...
Binder.prototype._getColumnTextVector=function(a){return this.getCards().map(function(b){return b.getCardValue(a)})};Binder.prototype.getColumnNumericVector=function(a){return this.getCards().map(function(b){return b.getCardNumeric()[a]})};Binder.prototype._getUnionSample=function(){var a={};this.getSampleSet().forEach(function(b){b.getCardKeys().forEach(function(c){if(c){var d=a[c];if(void 0===d||""===d)a[c]=b.getCardValue(c)}})});return a};
Binder.prototype.getColumnsByImportance=function(){var a=this.getColumnsArray();a.sort(Util.sortByAccessor(function(a){return a.getRank()}));return a};Binder.prototype.getSampleSet=function(){this._sampleSet||(this._sampleSet=_.sampleSize(this.getCards(),30));return this._sampleSet};Binder.prototype.getCardCount=function(){return this.getCards().length};Binder.prototype.getCardSources=function(){return this.getCards().map(function(a){return a.getCardSource()})};Binder.prototype.getColumnNames=function(){return Object.keys(this.getColumnsMap())};
Binder.prototype.getColumnsMap=function(){return this._columnsMap};Binder.prototype.getCTime=function(){return this.getBinderOwner()._getNow()};Binder.prototype.getColumnsArray=function(){return Object.values(this.getColumnsMap())};Binder.prototype.getColumnsArrayOfObjects=function(){return this.getColumnsArray().map(function(a){return a.toObject()})};Binder.prototype.getNumericValues=function(){return this.getCards().map(function(a){return a.getCardNumeric()})};
Binder.prototype.getBinderColumnByName=function(a){return this.getColumnsMap()[a]};Binder.prototype._getDetectedColumns=function(){var a=this.getColumnsMap();return Object.keys(this._getUnionSample()).map(function(a){return a.trim()}).filter(function(a){return a}).filter(function(b){return!a[b]}).map(function(a){return{name:a}})};Binder.prototype.getBinderOwner=function(){return this._parentNode};Binder.prototype.getCardTypeName=function(){return"Card"};
Binder.prototype.toTypeScriptInterface=function(){var a=this.getColumnsArray().map(function(a){return"  "+a.getColumnName()+": "+a.getTypeName()+";"}).join("\n");return"interface "+this.getCardTypeName()+" {\n"+a+"\n}"};Binder.prototype.toBlankFormTemplate=function(){var a=this.getColumnNames().join(" \n");return(new TreeNotation(a?a+" ":a)).toString()};Binder.prototype.getSortedCards=function(a){if(!a)return this.getCards();var b=this.getCards().map(function(a){return a});Util.sortByFast(b,a);return b};
Binder.prototype.getSortedCardsWithLimit=function(a,b){return this.getSortedCards(a).slice(0,b)};Binder.prototype.toDelimited=function(a){return(new TreeNotation(this.getCardSources())).toDelimited(a,this.getColumnNames())};
...
AbstractCardParser.prototype._getFormatName=function(){return""};AbstractCardParser.prototype.parse=function(){return[]};var AbstractTreeCardParser=function(a){AbstractCardParser.apply(this,arguments)};$jscomp.inherits(AbstractTreeCardParser,AbstractCardParser);AbstractTreeCardParser.prototype.parse=function(a){return this.parseTrees(a).getChildren().filter(function(a){return a.length}).map(function(a){return a.toObject()})};var DelimitedParser=function(a){AbstractTreeCardParser.apply(this,arguments)};
$jscomp.inherits(DelimitedParser,AbstractTreeCardParser);DelimitedParser.prototype.getExample=function(){return"john~12~50\nmary~13~43"};DelimitedParser.prototype.parseTrees=function(a,b,c,d){return TreeNotation.fromDelimited(a,b,c,d)};DelimitedParser.prototype.is=function(){return 0};DelimitedParser.prototype._getFormatName=function(){return"delimited"};var CsvParser=function(a){AbstractTreeCardParser.apply(this,arguments)};$jscomp.inherits(CsvParser,AbstractTreeCardParser);
CsvParser.prototype.getExample=function(){return"name,age,height\njohn,12,50"};CsvParser.prototype.parseTrees=function(a){return TreeNotation.fromCsv(a)};CsvParser.prototype.is=function(a){return a.firstLineCommaCount?a.blankLineCount?.05:.49:0};CsvParser.prototype._getFormatName=function(){return"csv"};var TsvParser=function(a){AbstractTreeCardParser.apply(this,arguments)};$jscomp.inherits(TsvParser,AbstractTreeCardParser);TsvParser.prototype.getExample=function(){return"name\tage\theight\njohn\t12\t50"};
TsvParser.prototype.parseTrees=function(a){return TreeNotation.fromTsv(a)};TsvParser.prototype.is=function(a){return a.firstLineTabCount?5<a.tabCount?.9:.25:0};TsvParser.prototype._getFormatName=function(){return"tsv"};var PsvParser=function(a){AbstractTreeCardParser.apply(this,arguments)};$jscomp.inherits(PsvParser,AbstractTreeCardParser);PsvParser.prototype._getFormatName=function(){return"psv"};PsvParser.prototype.parseTrees=function(a){return TreeNotation.fromDelimited(a,"|")};
PsvParser.prototype.is=function(a){return a.firstLineVerticalBarCount?a.verticalBarCount>=a.lineCount?.8:.01:0};var SsvParser=function(a){AbstractTreeCardParser.apply(this,arguments)};$jscomp.inherits(SsvParser,AbstractTreeCardParser);SsvParser.prototype.getExample=function(){return"name age height\njohn 12 50"};SsvParser.prototype._getFormatName=function(){return"ssv"};SsvParser.prototype.parseTrees=function(a){return TreeNotation.fromSsv(a)};
SsvParser.prototype.is=function(a){return a.firstLineSpaceCount?a.blankLineCount?.05:.11:0};var XmlParser=function(a){AbstractTreeCardParser.apply(this,arguments)};$jscomp.inherits(XmlParser,AbstractTreeCardParser);XmlParser.prototype.is=function(a){return a.trimmedStr.match(/^ *\</)?1:0};XmlParser.prototype._getFormatName=function(){return"xml"};XmlParser.prototype.parseTrees=function(a){return"undefined"===typeof window?new TreeNotation(a):TreeNotation.fromXml(a)};
...
Hakon.prototype.toCss=function(){return this.getTopDownArray().filter(function(a){return a instanceof HakonSelectorNode}).map(function(a){return a.toCss()}).join("")};window.Hakon=Hakon;$(function(){window.app=bsMain()});var ObjectBackedCard=function(a){AbstractCard.apply(this,arguments)};$jscomp.inherits(ObjectBackedCard,AbstractCard);ObjectBackedCard._uniqueId=AbstractCard._uniqueId;window.ObjectBackedCard=ObjectBackedCard;
var BlockPropertyNode=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(BlockPropertyNode,TreeNotation);BlockPropertyNode.prototype.getPropertyName=function(){return this.getWord(1)};BlockPropertyNode.prototype.getProbability=function(){var a=this.findTail("inserts");return a?parseInt(a)/100:.1};BlockPropertyNode.prototype.getPropertyTypeName=function(){return this.getWord(2)};BlockPropertyNode.prototype.getDescription=function(){return this.findTail("description")||""};
BlockPropertyNode.prototype.parseNodeType=function(a){return TreeNotation};BlockPropertyNode.prototype.getDefaultValue=function(){var a=this.getWords(3),a=a.length?a.join(" "):"";return this.has("default")?this.getNode("default").getTailWithChildren():a};BlockPropertyNode.prototype.parseValue=function(a){return a};
...
var Util={_getColumnNamesFromObj:function(a){a=Object.keys(a);a.sort();return a},getFileExtension:function(a){return(a=(void 0===a?"":a).match(/\.([^\.]+)$/))&&a[1]||""},removeFileExtension:function(a){a=void 0===a?"":a;if(!a.includes("."))return a;a=a.split(".");a.pop();return a.join(".")},getAvailablePermalink:function(a,b){var c=Util.getFileExtension(a);a=Util.removeFileExtension(a);for(var d=2,e="",f=""+a+e+"."+c;b(f);)f=""+a+e+"."+c,e="-"+d,d++;return f},extractTables:function(a,b){if(!(b instanceof
Array)){var c=Util._getColumnNamesFromObj(b).join(" ");a[c]||(a[c]=0);a[c]++}Object.keys(b).forEach(function(c){c=b[c];"object"===typeof c&&Util.extractTables(a,c)})},parseCookie:function(a){var b={};(void 0===a?"":a).split(/[;,] */).forEach(function(a){var c=a.indexOf("="),e=a.substr(0,c).trim();a=a.substr(++c,a.length).trim();'"'===a[0]&&(a=a.slice(1,-1));if(void 0===b[e])try{b[e]=decodeURIComponent(a)}catch(f){b[e]=a}});return b},pLimit:function(a){var b=[],c=0;return function(d){return new Promise(function(e,
...
AbstractProgramNode.prototype.getInputBinder=function(){var a=this.getParent();return a.isProvider()?a.getOutputBinder():a.getInputBinder()};AbstractProgramNode.prototype.getOutputBinder=function(){if(!this.isProvider())return this.getInputBinder();this._outputBinder||(this._outputBinder=new Binder(this));return this._outputBinder};window.AbstractProgramNode=AbstractProgramNode;var AbstractBlock=function(a){return AbstractProgramNode.apply(this,arguments)||this};$jscomp.inherits(AbstractBlock,AbstractProgramNode);
...
AbstractBlock.prototype.copyBlockCommand=function(){this.getApp().getFakeDom().copyTextToClipboard(this.getFirstAncestor().toString());return Promise.resolve()};AbstractBlock.prototype.copyDataCommand=function(a){this.getApp().getFakeDom().copyTextToClipboard(this.getOutputBinder().toDelimited(a));return Promise.resolve()};AbstractBlock.prototype._exportDataCommand=function(){this.getApp().downloadFile(this.getOutputBinder().toDelimited(","),this.getHead()+".csv","text/csv")};
...
AbstractBrowserApplication.prototype.closeModal=function(){this.getOpenModals().forEach(function(a){return a.unmountAndDestroy()})};AbstractBrowserApplication.prototype.getOpenModals=function(){return this.getChildren().filter(function(a){return a instanceof AbstractModal})};AbstractBrowserApplication.prototype.closeContextMenu=function(){this.getChildren().filter(function(a){return a instanceof AbstractContextMenu}).forEach(function(a){return a.unmountAndDestroy()})};
AbstractBrowserApplication.prototype.getHtml=function(){return""};AbstractBrowserApplication.prototype.renderApp=function(){this.render(this.getBodyStump());return this};AbstractBrowserApplication.prototype.downloadFile=function(a,b,c){var d=this.getFakeDom(),e=d.createElement("a");e.setAttribute("href","data:"+c+","+d.encodeURIComponent(a));e.setAttribute("download",b);e.click()};AbstractBrowserApplication.prototype.appendBlockCommand=function(a,b){this._appendBlocks(a,b);return this.getMountedProgram().autosaveAndRender()};
AbstractBrowserApplication.prototype._getAvailablePermalink=function(a){var b=this;return Util.getAvailablePermalink(a,function(a){return b.doesFileExistSync(a)})};AbstractBrowserApplication.prototype._appendBlocks=function(a,b){return this.getNodeCursors().map(function(c){c=c.append(a,b);c.executeLoadNewBinder();return c})};AbstractBrowserApplication.prototype.isPaid=function(){return!!Util.parseCookie(this.getWindowCookie()).paidToken};
AbstractBrowserApplication.prototype.appendBlockAndSelectCommand=function(a,b){var c=this._appendBlocks(a,b);a=this.getMountedProgram();a.clearSelection();return a.autosaveAndRender().then(function(){c.forEach(function(a){return a.selectBlock()})})};AbstractBrowserApplication.prototype.insertMorphBlockCommand=function(){var a=this.getMountedProgram(),b=this.getDblClickEvent();this.getNodeCursors().forEach(function(c){c.append(">morph","pin "+a.makePin(b))});return a.autosaveAndRender()};
AbstractBrowserApplication.prototype.getNodeCursors=function(){var a=this.getMountedProgram().getSelectedBlocks();return a.length?a:[this.getMountedProgram()]};AbstractBrowserApplication.prototype.deleteAllCardsInTargetBlockCommand=function(){var a=this,b=this.getTargetNode().getInputBinder();return Promise.all(b.getCards().map(function(a){return a.destroyCardCommand()})).then(function(){a.renderApp()})};
...
AbstractBrowserApplication.prototype.getWindowElement=function(){return this.getFakeDom().getWindowElement()};AbstractBrowserApplication.prototype.openOhayoProgramCommand=function(a){var b=this;return Promise.all(a.split(" ").map(function(a){return b._openOhayoProgramCommand(a)}))};
AbstractBrowserApplication.prototype._openOhayoProgramCommand=function(a){var b=(new TreeNotation(DemoPrograms)).getNode(a).getTailWithChildren(),c=this.getFocusedPanel(),d=c.getOpenTabByUrl(a);return d?c.setMountedProgram(d):this.createAndOpen(b,a)};AbstractBrowserApplication.prototype.setWindowLocation=function(a){this.getDocumentElement().location=a;return this};AbstractBrowserApplication.prototype.getWindowPathName=function(){return this.getDocumentElement().location.pathname||""};
AbstractBrowserApplication.prototype.makeDataBlock=function(a){var b=(new CardParser).inferEncoding(a),b=new TreeNotation(">data\n format "+b+"\n content");b.getNode(">data content").setTailWithChildren(a);return b.toString()};AbstractBrowserApplication.prototype.onProgramsChange=function(){};AbstractBrowserApplication.prototype.getFocusedPanel=function(){return this.getNode("panel")};AbstractBrowserApplication.prototype.getMountedProgram=function(){return this.getFocusedPanel().getMountedProgram()};
AbstractBrowserApplication.prototype.getMenuContainer=function(){return this.getNode("menu")};AbstractBrowserApplication.prototype.getHtmlStump=function(){return this.getFakeDom().getHtmlStump()};AbstractBrowserApplication.prototype.emitGlobalMessage=function(a){console.log(a)};AbstractBrowserApplication.prototype.emitGlobalMessageAndFade=function(a){console.log(a)};AbstractBrowserApplication.prototype.handleGlobalError=function(a){console.error(a)};
AbstractBrowserApplication.prototype.createNewBlankProgramCommand=function(a){var b=this;return this.createAndOpen("",void 0===a?"untitled.flow":a).then(function(a){return b.emitGlobalMessageAndFade(Say($jscomp$templatelit$1,a.getUrl()))})};AbstractBrowserApplication.prototype.canMakePrograms=function(){return!0};AbstractBrowserApplication.prototype.openUrlPromptCommand=function(){var a=this;this.prompt(Say($jscomp$templatelit$2),"").then(function(b){b&&a.openUrlInNewSpaceAndFocus(b)})};
AbstractBrowserApplication.prototype.openManyPrompt=function(){var a=this;return this.prompt(Say($jscomp$templatelit$3),"").then(function(b){if(b)return a.openManyCommand(b)})};AbstractBrowserApplication.prototype.openManyCommand=function(a){var b=this,c=new RegExp(a,"i");return Promise.all(this.getLinks().map(function(a){a.link.match(c)&&b.openUrlInNewSpace(a.link)}))};
AbstractBrowserApplication.prototype.openUrlInNewSpace=function(a){var b=this.getFocusedPanel().getOpenTabByUrl(a);return b?Promise.resolve(b):this.getFocusedPanel().openUrlInNewSpace(a)};AbstractBrowserApplication.prototype.openUrlInNewSpaceAndFocus=function(a){var b=this;return this.openUrlInNewSpace(a).then(function(a){return b.getFocusedPanel().setMountedProgram(a)})};AbstractBrowserApplication.prototype.mountTabByIndexCommand=function(a){return this.getFocusedPanel().mountTabByIndex(a)};
AbstractBrowserApplication.prototype.closeTabByIndexCommand=function(a){return this.getFocusedPanel().closeTabByIndex(a)};AbstractBrowserApplication.prototype.getFolder=function(){return""};AbstractBrowserApplication.prototype.tabDidOpen=function(){};AbstractBrowserApplication.prototype.isAutoSaveEnabled=function(){return"false"!==this.getFromStore(StorageKeys.autoSave)};
AbstractBrowserApplication.prototype.toggleAutoSaveCommand=function(){var a=!this.isAutoSaveEnabled();a?this.removeValue(StorageKeys.autoSave):this.storeValue(StorageKeys.autoSave,"false");this.emitGlobalMessageAndFade(Say($jscomp$templatelit$4,a));return Promise.resolve()};
AbstractBrowserApplication.prototype.saveCompiledCommand=function(){var a=this.getMountedProgram(),b=a.compilesTo(),c=Format.permalink(Format.removeFileExtension(a.getFileName()))+"."+b,a=a.buildProgram();this.downloadFile(a,c,"text/"+b);return Promise.resolve()};AbstractBrowserApplication.prototype.toggleThemeCommand=function(){return this._toggleTheme()};AbstractBrowserApplication.prototype._getThemeName=function(){return this.getFromStore(StorageKeys.theme)};
AbstractBrowserApplication.prototype.getTheme=function(){return Themes[this._getThemeName()]||Themes.glass};AbstractBrowserApplication.prototype._toggleTheme=function(){var a=Util.toggle(this._getThemeName(),Object.keys(Themes));this.emitGlobalMessageAndFade(Say($jscomp$templatelit$5,a));this.storeValue(StorageKeys.theme,a);this.getApp().makeAllDirty();this.renderApp();return Promise.resolve()};
AbstractBrowserApplication.prototype.confirmAndDeleteFile=function(a){var b=this;return this.confirm(Say($jscomp$templatelit$6,a)).then(function(c){return c?b.deleteFileCommand(a):Promise.resolve(!1)})};AbstractBrowserApplication.prototype.promptToRenameFile=function(a,b){var c=this;return this.prompt("Enter new name for file",a).then(function(d){return d&&d!==a?(d=Format.permalink(d))?c.renameFileCommand(a,d,b).then(function(a){c.emitGlobalMessageAndFade("Renamed");return a}):Promise.resolve():Promise.resolve()})};
AbstractBrowserApplication.prototype.getFolderPath=function(){return""};AbstractBrowserApplication.prototype.insertStringCommand=function(a){this.getFakeDom().getFocusedStump().val(a);return Promise.resolve()};
AbstractBrowserApplication.prototype.showTabRenamePromptCommand=function(){var a=this,b=this.getMountedProgram();this.promptToRenameFile(b.getFullPath()).then(function(c){if(!c)return!1;a.openUrlInNewSpaceAndFocus(""+a.getFolderPath()+c).then(function(c){a.getFocusedPanel().closeProgram(b)});a.fetchLinks()});return Promise.resolve()};AbstractBrowserApplication.prototype.fetchLinks=function(){return Promise.resolve(this.getLinks())};AbstractBrowserApplication.prototype.fetchLinksCommand=function(){return this.fetchLinks()};
AbstractBrowserApplication.prototype.toggleHelpCommand=function(){return this.toggleAndRender("helpModal")};AbstractBrowserApplication.prototype.toggleSourceEditorCommand=function(){return this.toggleAndRender("sourceEditorModal")};AbstractBrowserApplication.prototype.toggleLayoutCommand=function(){return this.getMountedProgram().toggleLayout()};AbstractBrowserApplication.prototype.setRefreshUrl=function(a){this.getFakeDom().getHistory().replaceState({},"",a);return this};
AbstractBrowserApplication.prototype.closeMountedProgramCommand=function(){return this.getFocusedPanel().closeProgram(this.getMountedProgram())};AbstractBrowserApplication.prototype.fetchAndReloadFocusedProgramCommand=function(){return this.getFocusedPanel().fetchAndReloadProgram(this.getMountedProgram())};AbstractBrowserApplication.prototype.selectAllCommand=function(){this.getMountedProgram().selectAll();return Promise.resolve()};
AbstractBrowserApplication.prototype.selectBlocksBySelectorCommand=function(a){this.logCommand("app selectBlocksBySelectorCommand");this.getMountedProgram().selectBlocksBySelector(a);return Promise.resolve()};AbstractBrowserApplication.prototype.clearSelectionCommand=function(){this.logCommand("app clearSelectionCommand");this.getMountedProgram().clearSelection();return Promise.resolve()};AbstractBrowserApplication.prototype.deleteSelectionCommand=function(){return this.getMountedProgram().deleteSelection()};
AbstractBrowserApplication.prototype.duplicateSelectionCommand=function(){return this.getMountedProgram().duplicateSelection()};AbstractBrowserApplication.prototype.cancelConfirmCommand=function(){return this._confirmModal._resolveCommand("0")};AbstractBrowserApplication.prototype.acceptConfirmCommand=function(){return this._confirmModal._resolveCommand("1")};AbstractBrowserApplication.prototype.submitPromptCommand=function(){return this._promptModal._resolveCommand()};
AbstractBrowserApplication.prototype.clickElementCommand=function(a){$(a).click();return Promise.resolve()};AbstractBrowserApplication.prototype.showDeleteFileConfirmDialogCommand=function(){var a=this,b=this.getMountedProgram();return this.confirmAndDeleteFile(b.getFullPath()).then(function(c){!1!==c&&a.getFocusedPanel().closeProgram(b)})};AbstractBrowserApplication.prototype.mountPreviousProgramCommand=function(){return this.getFocusedPanel().mountPreviousProgram()};
AbstractBrowserApplication.prototype.mountNextProgramCommand=function(){return this.getFocusedPanel().mountNextProgram()};AbstractBrowserApplication.prototype.closeAllProgramsCommand=function(){return this.getFocusedPanel().closeAllPrograms()};AbstractBrowserApplication.prototype.openFocusedPanelSearchCommand=function(){return this.getFocusedPanel().openSearchCommand()};AbstractBrowserApplication.prototype.universalSearchCommand=function(a){return Promise.resolve()};
AbstractBrowserApplication.prototype.toggleFullScreenCommand=function(){this.getFakeDom().toggleFullScreen();return Promise.resolve()};AbstractBrowserApplication.prototype.toggleFocusedModeCommand=function(){this.toggle("menu");var a=this.getFocusedPanel();a.toggle("programs");a.toggle("search");return this.toggleFullScreenCommand()};AbstractBrowserApplication.prototype.toggleSourceGutterCommand=function(){this.makeAllDirty();return this.getFocusedPanel().toggleAndRender("sourceGutter")};
AbstractBrowserApplication.prototype.getKeyboardShortcuts=function(){this._shortcuts||(this._shortcuts=new KeyboardShortcutNotation(this._getKeyboardShortcuts()));return this._shortcuts};AbstractBrowserApplication.prototype.selectNextCommand=function(){return this.getMountedProgram().selectNext()};AbstractBrowserApplication.prototype.selectPreviousCommand=function(){return this.getMountedProgram().selectPrevious()};AbstractBrowserApplication.prototype._getKeyboardShortcuts=function(){return"mounted showDeleteFileConfirmDialogCommand shift+backspace Delete Program\npanel createNewBlankProgramCommand ctrl+n New Flow Program\npanel toggleHelpCommand ? Help\nmounted closeMountedProgramCommand ctrl+w Close focused program\npanel closeAllProgramsCommand ctrl+shift+w Close all programs\npanel toggleThemeCommand shift+t Toggle Theme\nmounted selectAllCommand command+a Select All\npanel openFocusedPanelSearchCommand command+p\nmounted toggleLayoutCommand shift+l Toggle layout\nmounted mountPreviousProgramCommand shift+left Previous program\nmounted mountNextProgramCommand shift+right Next program\nmounted selectNextCommand shift+down Select next\nmounted selectPreviousCommand shift+up Select previous\npanel toggleSourceGutterCommand shift+u Edit Source\npanel toggleFullScreenCommand shift+f Toggle Full Screen\npanel toggleFocusedModeCommand command+shift+f Toggle Focused Mode\npanel toggleSourceEditorCommand ctrl+u Edit Source\nmounted deleteSelectionCommand backspace Delete Selection\nmounted saveProgramAndNotifyCommand command+s Save Program\nmounted showTabRenamePromptCommand ctrl+shift+r Rename File\npanel toggleAutoSaveCommand shift+s Toggle autosave\nmounted fetchAndReloadFocusedProgramCommand shift+r Re-download and refresh program\nmounted duplicateSelectionCommand command+d Duplicate Selection\nmounted toggleNodePickerCommand shift+p Edit node\nmounted buildProgramCommand shift+b Build program\nmounted saveCompiledCommand command+shift+b\nmounted undoFocusedProgramCommand command+z Undo\nmounted redoFocusedProgramCommand command+shift+z Redo\npanel openManyPrompt command+shift+o Open multiple programs from regex\npanel _runSpeedTestCommand ctrl+shift+m\npanel openUrlPromptCommand shift+o Open program from url\npanel closeModalCommand escape Close any open modal\nmounted cloneProgramCommand ctrl+shift+n Clone program"};
AbstractBrowserApplication.prototype.buildProgramCommand=function(){return this.toggleAndRender("buildProgramModal")};AbstractBrowserApplication.prototype.toggleNodePickerCommand=function(){return this.toggleAndRender("nodePickerModal")};AbstractBrowserApplication.prototype.undoFocusedProgramCommand=function(){return this.getMountedProgram().undoCommand()};AbstractBrowserApplication.prototype.redoFocusedProgramCommand=function(){return this.getMountedProgram().redoCommand()};
...
b,c){var d=b.name.match(/\.([^\.]+)$/);if(!d)return!1;d=d[1].toLowerCase();d.match(/(csv|json|tree|txt|tsv|ssv)/)?(a=new FileReader,a.onload=function(a){a=(new CardParser).parse(a.target.result,d);console.log("Processed "+a.length+" cards");c&&c(a,b.name)},a.onerror=function(a){return console.error("error: ",a)},a.readAsText(b)):console.log("No matching file extension found")},e=function(d,e){for(var f=0;f<d.length;f++){var g=d[f].webkitGetAsEntry();e?c(g,null,function(b){var c=a.getMountedProgram();
c&&(c.concat(a.makeDataBlock(b)),c.autosaveProgram(),a.renderApp())}):g&&c(g,null,b)}};(function(){var b=a.getBodyStump(),c=function(a){a=a.originalEvent;var b=a.dataTransfer.effectAllowed;a.dataTransfer.dropEffect="move"===b||"linkMove"===b?"move":"copy"},d=function(a){a.preventDefault();a.stopPropagation();b.removeClass("dragOver");jqi($jscomp$templatelit$8).remove();b.off(BrowserEvents.dragleave,d)};b.on(BrowserEvents.dragover,function(a){c(a);a.preventDefault();a.stopPropagation();b.hasClass("dragOver")||
(b.append('<div id="dragOverHelp">'+Say($jscomp$templatelit$7)+"</div>"),b.addClass("dragOver"),setTimeout(function(){b.on(BrowserEvents.dragleave,d)},50))});b.on(BrowserEvents.drop,function(a){a.preventDefault();a.stopPropagation();b.removeClass("dragOver");jqi($jscomp$templatelit$9).remove();e(a.originalEvent.dataTransfer.items,a.shiftKey)});b.on(BrowserEvents.dragenter,function(a){a.preventDefault();a.stopPropagation()})})()};AbstractBrowserApplication.prototype.getRenderedBlocks=function(){return this.getMountedProgram().getDescendantBlocks().filter(function(a){return a.isMounted()})};
...
AbstractProgram.prototype.selectPrevious=function(){for(var a=this.getFirstSelectedBlock().getPrevious();!a.getHead().startsWith(">");)a=this.getFirstSelectedBlock().getPrevious();this.clearSelection();a.selectBlock();return Promise.resolve()};
...
AbstractProgram.prototype.toggleLayout=function(){var a=this.toggle("layout",["custom","bin","tree"]);this.getDescendantBlocks().forEach(function(a){return a.makeDirty()});this.getApp().emitGlobalMessageAndFade(Say($jscomp$templatelit$12,a));return this.autosaveAndRender()};AbstractProgram.prototype.getGridSize=function(){return 20};AbstractProgram.prototype.setIsFolder=function(a){this._isFolder=a;return this};AbstractProgram.prototype._getLongestLoadTime=function(){return this.getDescendantBlocks().map(function(a){return a.getTTL()}).sort().reverse()[0]};
...
AbstractProgram.prototype._fixBigBug=function(){var a={"min-height":"","min-width":""},b=this.getApp(),c=this.getStump(),d=c.parent(),e=b.getDocumentStump(),f=b.getHtmlStump(),b=(b=b.getMenuContainer())&&b.getStump();c.css(a);d.css(a);e.width();b&&b.css("width","");f.css({width:"",height:"","min-height":"","min-width":""});a=e.width();e=e.height();b&&b.css("width",a);f.css({"min-height":"100%","min-width":"100%",width:a,height:e});f={"min-height":e-60+"px","min-width":a+"px"};d.css(f);c.css(f)};
...
return!0}})};AbstractProgram.prototype.getAllCards=function(){return _.flatten(this.getDescendantBlocks().map(function(a){return a.isProvider()?a.getOutputBinder().getCards():[]}))};AbstractProgram.prototype.getProgramCardCount=function(){return this.getAllCards().reduce(function(a,b){return a+b.length},0)};
...
AbstractProgram.prototype._getSelectedBlockStumps=function(){return this.getApp().getFakeDom().getStumps(".BlockContainer.ui-selected")};AbstractProgram.prototype.updateSelectedOnMove=function(a,b){var c=this._getSelectedBlockStumps();0!==c.length&&(c.not(a).each(function(){var a=$(this),c=parseFloat(a.css("top")),f=parseFloat(a.css("left"));a.css({transform:"",top:c+b.top+"px",left:f+b.left+"px"})}),a.closest(".ui-selectable").selectable("refresh"))};
AbstractProgram.prototype.makeGroupDraggable=function(a,b){var c=$(a);if(c.hasClass("draggable"))return!0;var d,e=this,f=this.getApp();a={stop:function(a,b){c.removeClass("noTransition");c.attr("data-translate","undefined undefined");a=e._getPinChangeInPixels(b,d);e.updateSelectedOnMove(c,a);d=b;f.getMountedProgram().updateCustomPoint()},handle:".BlockGrabber",drag:function(a,b){c.hasClass("ui-selected")&&(a=e._getPinChangeInPixels(b,d),e._getSelectedBlockStumps().not(c).css("transform","translate("+
...
ListChart.prototype.getBlockHtmlBody=function(){var a=this.getStruct(),b=a.link,c=a.label;return"<ol>"+this.getCardsWithStructQuery().map(function(a){var d=Strip($jscomp$templatelit$14,a.getCardValue(c));return"<li><a "+(b?'href="'+Strip($jscomp$templatelit$15,a.getCardValue(b))+'"':"")+">"+d+"</a></li>"}).join("")+"</ol>"};window.ListChart=ListChart;var MarkdownChart=function(a){return AbstractHeaderlessChartBlock.apply(this,arguments)||this};$jscomp.inherits(MarkdownChart,AbstractHeaderlessChartBlock);
...
AbstractUrlProvider.prototype.fetchCards=function(){var a=this.getStruct(),b=this.getUrl();if(!b)return Promise.resolve([]);b=encodeURI(b);b.match(/\.json/);var c=a.format||this._getFormat(b);return this.getApp().getFakeDom().get(b).then(function(b){a.extract&&(b=b[a.extract]);var d=new CardParser;return"string"===typeof b?d.parse(b,c):d.parseFromObject(b,c)})};window.AbstractUrlProvider=AbstractUrlProvider;var DataBlockCard=function(a){ObjectBackedCard.apply(this,arguments)};
...
typeof g,k=a.type,p='<input data-command="block changePropertyCommand" name="'+b+'" value="'+g+'">';if("boolean"===k)p='<input data-command="block changePropertyCommand" name="'+b+'" '+(!0===g?"checked":"")+' type="checkbox">';else if("int"===k)p='<input data-command="block changePropertyCommand" type="number" name="'+b+'" value="'+g+'">';else if("column"===k)p=f("changePropertyCommand",b,d,g);else if("format"===k)p=f("changePropertyCommand",b,c,g);else if("enum"===k)p=f("changePropertyCommand",b,
Object.keys(a.getChoices()),g);else if("javascript"===k||"content"===k||"object"===h)p='<textarea data-command="block changePropertyCommand" name="'+b+'">'+g+"</textarea>";return[b,p]}),g=a.getPathVector().join(" "),h='<select data-command="block changeParentCommand">\n  <option value=""></option>'+a.getProgram().getDescendantBlocks().map(function(a){return{name:a.getPathName(),value:a.getPathVector().join(" ")}}).map(function(a){return"<option "+(g===a.value?"selected":"")+' value="'+a.value+'">'+
...
PanelContainer.prototype._updateLocationForRestoreOnRefresh=function(){var a=this.getApp(),b=this.getMountedProgram(),c=b?b.getUrl():"/";b?a.storeValue(StorageKeys.mountedProgram,b.getUrl()):a.removeValue(StorageKeys.mountedProgram);a.setRefreshUrl(c).getFakeDom().setWindowTitle(b?(b.hasUnsavedChanges()?"*":"")+(b.getFileName()+" - "+Say($jscomp$templatelit$18)):Say($jscomp$templatelit$19))};
...
CustomConfirmModal.prototype.getHtml=function(){return"<h4>"+this.getTail()+'</h4>\n    <button value="0" data-command="ac _resolveCommand">'+Say($jscomp$templatelit$26)+'</button><button value="1" data-command="ac _resolveCommand">'+Say($jscomp$templatelit$27)+"</button>"};CustomConfirmModal.prototype._resolveCommand=function(a){this.resolve("1"===a);this.getApp().closeModal();return Promise.resolve()};
...
OhayoApp.prototype.componentWillMount=function(){AbstractBrowserApplication.prototype.componentWillMount.call(this);1===this._getVisitCount()&&this.playFirstVisitCommand()};OhayoApp.prototype.playFirstVisitCommand=function(){var a=this;return this.openOhayoProgramCommand("readme.flow faq.flow releasenotes.flow fib.fire").then(function(){return a.openOhayoProgramCommand("ohayo.flow")})};OhayoApp.prototype.saveProgramToDisk=function(a,b){this.storeValue(a.getFullPath(),b.newVersion);return Promise.resolve()};
OhayoApp.prototype.getLinks=function(){return this.getStoreKeys().filter(function(a){return!StorageKeys.isKey(a)}).map(function(a){return{link:a,title:a}})};OhayoApp.prototype.getProgramToOpen=function(){return this.getFromStore(StorageKeys.mountedProgram)};OhayoApp.prototype.doesFileExistSync=function(a){return void 0!==this.getFromStore(a)};OhayoApp.prototype.setRefreshUrl=function(a){return this};OhayoApp.prototype.deleteFileCommand=function(a){this.removeValue(a);return Promise.resolve()};
