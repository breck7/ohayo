...
AbstractProgramChisel.prototype.makePin=function(a){var b=this.getGridSize();return[Math.floor((a.offsetX-0)/b),Math.floor(a.offsetY/b)].join(" ")};AbstractProgramChisel.prototype.chiselDidUpdate=function(){this._fixLargeBug()};
AbstractProgramChisel.prototype._fixLargeBug=function(){var a={"min-height":"","min-width":"",width:"",height:""},b=this.getApp(),c=this.getStump(),d=c.getParent(),e=b.getWillowProgram(),f=e.getHtmlStump(),b=(b=b.getMenuChisel())&&b.getStump();c.setStumpCss(a);d.setStumpCss(a);f.setStumpCss(a);e.forceRepaint();e=e.getDocumentSize();b&&b.setStumpCss(a);f.setStumpCss(a);a=e.width;e=e.height;b&&b.setStumpCss({width:a});f.setStumpCss({"min-height":"100%","min-width":"100%",width:a,height:e});f={"min-height":e-
60+"px","min-width":a+"px"};d.setStumpCss(f);c.setStumpCss(f)};AbstractProgramChisel.prototype.chiselDidMount=function(){this._makeSelectable();this._makeCogsMoveableAndResizableAndEditable();this._fixLargeBug()};
...
XmlParser.prototype.parseTrees=function(a){return this.isNode()?new TreeProgram(a):TreeProgram.fromXml(a)};var HtmlParser=function(a){AbstractTreeCardParser.apply(this,arguments)};$jscomp.inherits(HtmlParser,AbstractTreeCardParser);HtmlParser.prototype.getProbForCardSpecimen=function(a){return a.trimmedStr.match(/^(\<\!doctype html\>|\<html|\<div)/i)?1:0};HtmlParser.prototype.getExample=function(){return"<!doctype html>\n<html>\n <head>bam</head></html>"};HtmlParser.prototype.getFormatName=function(){return"html"};
HtmlParser.prototype.parseTrees=function(a){return this.isNode()?new TreeProgram(a):TreeProgram.fromXml(a)};var SpacedParser=function(a){AbstractCardParser.apply(this,arguments)};$jscomp.inherits(SpacedParser,AbstractCardParser);SpacedParser.prototype.getExample=function(){return"name john\nage 12\n\nname mary\nage 20"};SpacedParser.prototype.getFormatName=function(){return"spaced"};SpacedParser.prototype.getProbForCardSpecimen=function(a){return 10<a.blankLineCount?.95:.05};
...
AbstractAppChisel.prototype.saveCompiledCommand=function(){var a=this.getMountedProgram(),b=a.getDictionary().getTargetExtension(),c=Format.permalink(Format.removeFileExtension(a.getFileName()))+"."+b,a=a.compile();this.getWillowProgram().downloadFile(a,c,"text/"+b);return Promise.resolve()};AbstractAppChisel.prototype.getLanguageBestGuess=function(a){var b=this.getETNs(),b=Object.values(b).map(function(b){return(new b(a)).getGuess()});b.sort(Util.sortByAccessor(function(a){return a.guess}));return b[0].name};
...
AbstractDropDownMenuChisel.prototype.getBray=function(){var a=this.getDropDownBray(),b=this.getAnchorId();return"@div\n style top: 30px; left: "+this.getParent().getStump().findStumpByChild("id "+b).getShadow().getShadowPosition().left+"px;\n class dropdownMenu"+TreeProgram.nest(a,1)};window.AbstractDropDownMenuChisel=AbstractDropDownMenuChisel;var CogToolbarChisel=function(a){return AbstractChisel.apply(this,arguments)||this};$jscomp.inherits(CogToolbarChisel,AbstractChisel);
...
ConsoleChisel.prototype._getMessageBuffer=function(){var a=this.getParent().getParent().getMountedProgram();return a?a.getMessageBuffer():new TreeProgram};ConsoleChisel.prototype.getDependencyTimestamps=function(){var a=this.getParent().getGutterDependencies(),b=this._getMessageBuffer();b.length?a.push(b.nodeAt(-1).getMTime()):a.push(this._getNow());return a};ConsoleChisel.prototype.getBray=function(){var a=this._getConsoleOutput();return"@pre\n class sourcePre\n bern"+TreeProgram.nest(a,2)};
...
window.CodeMirrorCss=CodeMirrorCss;var AbstractCogChisel=function(a){return AbstractChisel.apply(this,arguments)||this};$jscomp.inherits(AbstractCogChisel,AbstractChisel);AbstractCogChisel._mountedChisels=AbstractChisel._mountedChisels;AbstractCogChisel.prototype.getStruct=function(){this._struct||(this._struct=this.getDefinition().computeStruct(this));return this._struct};AbstractCogChisel.prototype._clearCogStruct=function(){delete this._struct};
AbstractCogChisel.prototype.compile=function(){return this.getIndentation()+this.getCompiledLine()};AbstractCogChisel.prototype._getParameterMap=function(a){a=void 0===a?" ":a;var b=this.getDefinition();b._getExtended();var b=b.getParameters(),c={},d=b.length-1,e=this.getWords(1);b.forEach(function(b,g){c[b]=g===d?e.slice(g).join(a):e[g]});return c};
AbstractCogChisel.prototype.getCompiledLine=function(){var a=this.getDefinition()._getExtended(),b=a.findBeam("listDelimiter"),b=this._getParameterMap(b),a=a.findBeam("compiled")||"";return(new TreeProgram(b)).format(a)};AbstractCogChisel.prototype.getTagLine=function(){var a=this.getDefinition().getParameters(),b=[this.getBase()].concat(a),c=b[b.length-1],d=c.endsWith("*");return this.getWords().map(function(a,f){return(a=b[f])?a:d?c:"\ud83d\udca9"}).join(" ")};
...
AbstractCogChisel.prototype.getBray=function(){return"@div\n class CogPage CogChisel "+this.constructor.name+"\n id "+this.getId()+"\n data-onContextMenuCommand chisel _openCogContextMenuCommand\n @div\n  class CogGrabber\n @div "+this.getCogHeaderBern()+"\n  class CogHeader\n @div\n  class CogBody"+TreeProgram.nest(this.getCogBodyBray(),2)+"\n @div\n  class CogFooter"+TreeProgram.nest(this.getCogFooterBray(),2)+"\n @div\n  class CogGrabber"};
AbstractCogChisel.prototype.getCogHeaderBern=function(){return""+this.getBase()};AbstractCogChisel.prototype.makeCogDimension=function(a){a=void 0===a?this.getPin():a;a=a.split(" ").map(function(a){return 20*parseInt(a)});var b={left:a[0],top:a[1]};2<a.length&&(b.width=a[2]);3<a.length&&(b.height=a[3]);return new CogDimension(this,b)};AbstractCogChisel.prototype.getCogBodyBray=function(){return""};
AbstractCogChisel.prototype._getCss=function(){var a="#"+this.getId(),b=this.getTheme(),c=this.isVisible()?"":"display: none",d=this.getCogDimension(),d=d?d.toCss():"";return a+" { "+c+" "+d+" }\n      "+b.hakonToCss(this.getHakon())};AbstractCogChisel.prototype.getDefinition=function(){var a=this.getBase();return this.getDictionary().getDefinitionByName(a)};AbstractCogChisel.prototype.mapTupleNamesToColumnNames=function(a){var b=this.getStruct();return a.map(function(a){return b[a]})};
AbstractCogChisel.prototype.getContextMenuBray=function(){return""};AbstractCogChisel.loadCode=function(){return Promise.resolve()};AbstractCogChisel.prototype.getStructColumns=function(){var a=this.getNode("columns"),b=a?a.toObject():{};return Object.keys(b).map(function(a){var c=b[a]||{};"object"!==typeof c&&(c={});c.name||(c.name=a);return c})};AbstractCogChisel.prototype.getCogClassColumns=function(){return[]};
AbstractCogChisel.prototype.handleCogError=function(a){this._errorCount||(this._errorCount=0);this._errorCount++;this.getApp().goRed(a)};AbstractCogChisel.prototype.getCogErrorCount=function(){return this._errorCount||0};AbstractCogChisel.prototype.isProgram=function(){return!1};AbstractCogChisel.prototype.getLimit=function(){return this.getStruct().limit};AbstractCogChisel.prototype.getChildNodeSuggestions=function(){return[]};AbstractCogChisel.prototype.getId=function(){return"cog"+this._getUid()};
AbstractCogChisel.prototype.getCogDimension=function(){var a=this.getProgram(),b=a.getProgramDimension();return a.getCogDimensionMap(b.width,b.height).get(this)};AbstractCogChisel.prototype.getHeaderHeight=function(){return 30};AbstractCogChisel.prototype.getFooterHeight=function(){return 30};AbstractCogChisel.prototype.getCogBodyDimension=function(){var a=this.getCogDimension();a.height=a.height-this.getHeaderHeight()-this.getFooterHeight();return a};
AbstractCogChisel.prototype.openCogSourceEditorModalCommand=function(){return this.getApp().setTargetNode(this).toggleAndRender("nodeEditorModal")};AbstractCogChisel.prototype.cloneCogCommand=function(){var a=this.getProgram();a.cloneCog(this);return a.autosaveAndRender()};AbstractCogChisel.prototype._changeCogOrderByCommand=function(a){this.toggle("orderBy",[a,"-"+a,""]);this.autosaveCog();this.makeDirty();return this.render()};AbstractCogChisel.prototype.getDependencyTimestamps=function(){return[]};
AbstractCogChisel.prototype.executeLoadData=function(){return Promise.resolve()};AbstractCogChisel.prototype.executeLoadDataAndRender=function(){var a=this;return this.executeLoadData().then(function(){return a.render()})};AbstractCogChisel.prototype.getFirstAncestor=function(){var a=this.getParent();return a instanceof AbstractCogChisel?a.getFirstAncestor():this};
AbstractCogChisel.prototype.changeCogTypeCommand=function(a){var b=this;this.setBase(a);var c=this.duplicate();this.unmountAndDestroy();return c.getDefinition().executeLoadDefinitionCodeOrGetLoadingPromise(this.getApp()).then(function(){return b.getProgram().autosaveAndRender().then(function(){return c.executeLoadDataAndRender()})})};
...
2)+"\n@div CogStruct:\n@pre\n bern"+TreeProgram.nest(JSON.stringify(c,null,2),2)+"\n@div All Cog Tuples:\n@pre\n bern"+TreeProgram.nest(b,2)};window.AbstractCogChisel=AbstractCogChisel;var BinPacker=function(){};BinPacker.prototype.fit=function(a){var b=a.length;this.root={xcc:0,ycc:0,width:0<b?a[0].width:0,height:0<b?a[0].height:0};for(var c=0;c<b;c++){var d=a[c],e=this.findNode(this.root,d.width,d.height);d.fit=e?this.splitNode(e,d.width,d.height):this.growNode(d.width,d.height)}};
...
BlankLine.prototype.isVisible=function(){return!1};window.BlankLine=BlankLine;var CogConstants={pin:"pin",frequency:"frequency"};window.CogConstants=CogConstants;var CogDimension=function(a,b){a=a.getSuggestedSize();this.width=a.width;this.height=a.height;Object.assign(this,b)};CogDimension.prototype.getScaledCss=function(a){a=void 0===a?1:a;return this._toCss({width:this.width*a,height:this.height*a,left:this.left*a,top:this.top*a})};CogDimension.prototype.toCss=function(){return this._toCss(this)};
...
var SubTuple=function(a){return TreeProgram.apply(this,arguments)||this};$jscomp.inherits(SubTuple,TreeProgram);SubTuple.prototype.getParseErrorCount=function(){return 0};SubTuple.prototype.parseNodeType=function(a){return SubTuple};SubTuple.prototype.getTagLine=function(){return"subtuple ".repeat(this.length).trim()};var AbstractTuple=function(a){return TreeProgram.apply(this,arguments)||this};$jscomp.inherits(AbstractTuple,TreeProgram);AbstractTuple.prototype.getTupleName=function(){return this.getWord(1)};
AbstractTuple.prototype.getProbability=function(){var a=this.findBeam(CogConstants.frequency);return a?parseFloat(a):.01};AbstractTuple.prototype.getTagLine=function(){return("tuple "+"word ".repeat(this.length?this.length-1:0)).trim()};
...
window.ColumnRunTimeTuple=ColumnRunTimeTuple;var Definition=function(a){return TreeProgram.apply(this,arguments)||this};$jscomp.inherits(Definition,TreeProgram);Definition.prototype.parseNodeType=function(a){return a.startsWith("&")?this.getTupleClass(a.split(" ")[0].substr(1)):TreeProgram};
...
Definition.prototype.getParameters=function(){var a=this._getExtended().findBeam("parameters");return a?a.split(" "):[]};Definition.prototype.getArity=function(){return this.getParameters().length};Definition.prototype.getDescription=function(){return this.findBeam("description")||""};Definition.prototype.getSvg=function(){return this._getExtended().findBeam("svg")||"table"};Definition.prototype._getExtended=function(){this._extended||(this._extended=this._makeExtended());return this._extended};
...
Definition.prototype.getDefinitionJSClass=function(){if(this._class)return this._class;var a=this._getExtended().findBeam("require").split(" "),b=a[0],c=a[1],d="undefined"!==typeof require,a=d?process:window;d&&!a[b]&&(c=require(c),a[c.name]=c);return this._class=a[b]};Definition.prototype.getFrequency=function(){var a=this.findBeam(CogConstants.frequency);return a?parseFloat(a):0};window.Definition=Definition;var PrefaceNode=function(a){return TreeProgram.apply(this,arguments)||this};
$jscomp.inherits(PrefaceNode,TreeProgram);var DictionaryProgram=function(a){return TreeProgram.apply(this,arguments)||this};$jscomp.inherits(DictionaryProgram,TreeProgram);DictionaryProgram.prototype.parseNodeType=function(a){return a.startsWith("preface")?PrefaceNode:Definition};DictionaryProgram.prototype.getTargetExtension=function(){return this.getNode("preface").findBeam("targetExtension")};DictionaryProgram.prototype.getExtensionName=function(){return this.getNode("preface").findBeam("fileExtension")};
...
DictionaryProgram.prototype.execute=function(a){var b=Util.getFileName(a).replace(".dictionary","Dictionary");a=a.replace(".dictionary","Dictionary.compiled.js");var c=new TreeProgram(this.toString());c.delete("#!");b="const "+b+" = `"+c.toString()+"`\n\nwindow."+b+" = "+b+"\n";require("fs").writeFileSync(a,b,"utf8")};
...
MarkdownChart.prototype.getCogBodyBray=function(){var a=this.getPipishInput(),a=marked(a);return"@div\n bern"+TreeProgram.nest(a,2)};window.MarkdownChart=MarkdownChart;var MiniCog=function(a){return AbstractChartCog.apply(this,arguments)||this};$jscomp.inherits(MiniCog,AbstractChartCog);MiniCog._mountedChisels=AbstractChartCog._mountedChisels;MiniCog.loadCode=AbstractChartCog.loadCode;
...
a.pretty);return"@div\n class TableChisel\n @table\n  @thead\n   @tr\n    title Click to sort."+TreeProgram.nest(e,4)+"\n  @tbody "+TreeProgram.nest(a,2)};window.TableCog=TableCog;var ThreeDChart=function(a){return AbstractHeaderlessChartCog.apply(this,arguments)||this};$jscomp.inherits(ThreeDChart,AbstractHeaderlessChartCog);ThreeDChart._mountedChisels=AbstractHeaderlessChartCog._mountedChisels;ThreeDChart.loadCode=AbstractHeaderlessChartCog.loadCode;ThreeDChart.prototype.getCogBodyBray=function(){return"@div\n class visjs"};
...
TreeOutline.prototype.getCogBodyBray=function(){var a=new TreeProgram(this.getPipishInput()),a=this.getStruct().dots?a.toOutline(function(a){return"o"+a.getLine().split(" ").map(function(a){return"\u00ba"}).join("")}):a.toOutline();return"@pre\n style overflow: scroll; width: 100%; height: 100%; margin: 0; box-sizing: border-box;\n bern"+TreeProgram.nest(a,2)};window.TreeOutline=TreeOutline;var WordCloudChart=function(a){return AbstractHeaderlessChartCog.apply(this,arguments)||this};
...
DataCog.prototype.getCogBodyBray=function(){var a=Format.stripHtml(this.getDataSlang());return"@textarea\n data-onChangeCommand chisel _saveDataCommand\n class CogTextArea savable\n bern"+TreeProgram.nest(a,2)};DataCog.prototype.isVisible=function(){return"false"!==this.findBeam("visible")};DataCog.prototype._saveDataCommand=function(a){this.touchNode("slang").setChildren(a);this.autosaveCog();return this.executeLoadDataAndRender()};DataCog.prototype.getCardClass=function(){return DataCogCard};
DataCog.prototype.fetchCards=function(){return Promise.resolve((new CardParser).parse(this.getDataSlang(),this.getStruct().format))};DataCog.prototype._getFormatted=function(a,b){switch(b){case "tree":return(new TreeProgram(a)).toString();case "json":return(new TreeProgram(a)).toJson();default:return(new TreeProgram(a)).toCsv()}};
...
var ConvertCog=function(a){return AbstractTransformerCog.apply(this,arguments)||this};$jscomp.inherits(ConvertCog,AbstractTransformerCog);ConvertCog._mountedChisels=AbstractTransformerCog._mountedChisels;ConvertCog.loadCode=AbstractTransformerCog.loadCode;ConvertCog.prototype.transformCards=function(){var a=this.getPipishInput();return[{text:(new TreeProgram(a)).toJson()}]};window.ConvertCog=ConvertCog;var DateFilter=function(a){return AbstractTransformerCog.apply(this,arguments)||this};
...
window.ReplacerCog=ReplacerCog;var StatsCog=function(a){return AbstractTransformerCog.apply(this,arguments)||this};$jscomp.inherits(StatsCog,AbstractTransformerCog);StatsCog._mountedChisels=AbstractTransformerCog._mountedChisels;StatsCog.loadCode=AbstractTransformerCog.loadCode;StatsCog.prototype.transformCards=function(){var a=this.getInputBinder(),b=a.getColumnsMap();return a.getColumnNames().map(function(a){var c=b[a];a={Column:a,Type:c.getColumnTypeName()};Object.assign(a,c.getReductions());return a})};
window.StatsCog=StatsCog;var TagsCog=function(a){return AbstractTransformerCog.apply(this,arguments)||this};$jscomp.inherits(TagsCog,AbstractTransformerCog);TagsCog._mountedChisels=AbstractTransformerCog._mountedChisels;TagsCog.loadCode=AbstractTransformerCog.loadCode;TagsCog.prototype.transformCards=function(){var a=this.getPipishInput(),b=this.getApp(),c=b.getLanguageBestGuess(a);return[{text:b.generateProgram(a,c).getProgramTagString()}]};window.TagsCog=TagsCog;
...
'<a href="mailto:$1">$1</a>')}};window.Format=Format;var HakonPropertyNode=function(a){return TreeProgram.apply(this,arguments)||this};$jscomp.inherits(HakonPropertyNode,TreeProgram);HakonPropertyNode.prototype.toCss=function(a){return""+a+this.getBase()+": "+this.getBeam()+";"};var HakonErrorNode=function(a){return TreeProgram.apply(this,arguments)||this};$jscomp.inherits(HakonErrorNode,TreeProgram);HakonErrorNode.prototype.toCss=function(){return""};HakonErrorNode.prototype.getErrorMessage=function(){return"Hakon should not have semicolons."};
...
HakonProgram.prototype.toCss=function(){return this.getTopDownArray().filter(function(a){return a instanceof HakonSelectorNode}).map(function(a){return a.toCss()}).join("")};window.HakonProgram=HakonProgram;function Icons(a,b){var c=SVGS[a];if(!c)return console.error("svg not found for "+a),"";a=c.substr(4);return'<svg width="'+b+'" height="'+b+'" class="SVGIcon" '+a}window.Icons=Icons;var LocalStorageCaddy=function(a){return AbstractCaddy.apply(this,arguments)||this};
$jscomp.inherits(LocalStorageCaddy,AbstractCaddy);window.LocalStorageCaddy=LocalStorageCaddy;var StorageKeys={openPrograms:"__openPrograms",autoSave:"__autoSave",theme:"__theme",visitCount:"__visitCount",newUser:"__newUser",mountedProgram:"__mountedProgram"},_storageKeysmap={};Object.values(StorageKeys).forEach(function(a){_storageKeysmap[a]=!0});StorageKeys.isKey=function(a){return _storageKeysmap[a]};window.StorageKeys=StorageKeys;
