...
SnapNode.prototype.getNodeTypes=function(){return this.getProgram().getNodeTypes()};SnapNode.prototype.getDefaultNodeType=function(a){return this.getProgram().getDefaultNodeType()};SnapNode.prototype.getProgram=function(){return this.getParent().getProgram()};SnapNode.prototype.getDictionary=function(){return this.getProgram().getDictionary()};SnapNode.prototype.getDefinition=function(){var a=this.getBase();return this.getDictionary().getDefinitionByName(a)};SnapNode.prototype.isProgram=function(){return!1};
SnapNode.prototype.compile=function(){return this.getDefinition().isMiddle()?this._compileMiddle():this.getIndentation()+this.getCompiledLine()};SnapNode.prototype._compileMiddle=function(){var a=this.getDefinition(),b=this.getCompiledLine(),c=this.getIndentation(),d=a.getOpenChildrenString(),a=a.getCloseChildrenString(),e=this.getChildrenByNodeType(SnapNode).map(function(a){return a.compile()}).join("\n");return""+c+b+d+"\n"+e+"\n"+c+a};SnapNode.prototype.getParameterErrors=function(){return this.getSnapSlotArray().filter(function(a){return a.getErrorMessage()}).map(function(a){return a.getErrorMessage()})};
SnapNode.prototype.getSnapSlotArray=function(){for(var a=this.getPoint(),b=this.getDefinition().getParameters(),c=b.length,d=b[c-1],d=d&&d.endsWith("*")?d.substr(0,d.length-1):void 0,e=this.getWords(1),f=Math.max(e.length,c),g=[],h=0;h<f;h++)g[h]=new SnapSlot(e[h],h>=c?d:b[h],a.y,h);return g};
...
SnapProgram.prototype.getDictionary=function(){this._dictionary||(this._dictionary=new DictionaryProgram((new TreeProgram(this.getDictionaryString())).getExpanded()));return this._dictionary};SnapProgram.prototype.getProgramTagString=function(){return this.getTopDownArray().map(function(a){return a.getIndentation()+a.getTagLine()}).join("\n")};window.SnapProgram=SnapProgram;var AbstractWordType=function(){},IntSlotType=function(){};IntSlotType.prototype.isValid=function(a){return a.match(/^\-?[0-9]+$/)};
var BooleanSlotType=function(){};BooleanSlotType.prototype.isValid=function(a){return"false"===a||"true"===a};var SnapSlot=function(a,b,c,d){this._word=a;this._type=b;this._line=c;this._index=d+1};SnapSlot.prototype.getType=function(){return this._type};
SnapSlot.prototype.getErrorMessage=function(){var a=this._index;if(void 0===this._word)return'Unfilled "'+this._type+'" slot at line '+this._line+" slot "+a;if(void 0===this._type)return'Extra word "'+this._word+'" at line '+this._line+" slot "+a;var b={int:new IntSlotType,boolean:new BooleanSlotType}[this._type];return b?b.isValid(this._word)?"":"Invalid word at line "+this._line+" slot "+a+'. "'+this._word+'" does not fit in "'+this._type+'" slot.':""};window.SnapSlot=SnapSlot;
