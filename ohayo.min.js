...
AbstractTileChisel.prototype.getTileHeaderBern=function(){return""+this.getBase()};AbstractTileChisel.prototype.makeTileDimension=function(a){a=void 0===a?this.getPin():a;a=a.split(" ").map(function(a){return 20*parseInt(a)});var b={left:a[0],top:a[1]};2<a.length&&(b.width=a[2]);3<a.length&&(b.height=a[3]);return new TileDimension(this,b)};AbstractTileChisel.prototype.getTileBodyBray=function(){return""};
...
AbstractTileChisel.prototype.getStructColumns=function(){var a=this.getNode("columns"),b=a?a.toObject():{};return Object.keys(b).map(function(a){var c=b[a]||{};"object"!==typeof c&&(c={});c.name||(c.name=a);return c})};AbstractTileChisel.prototype.getTileClassColumns=function(){return[]};AbstractTileChisel.prototype.handleTileError=function(a){this._errorCount||(this._errorCount=0);this._errorCount++;this.getApp().goRed(a)};
AbstractTileChisel.prototype.getTileErrorCount=function(){return this._errorCount||0};AbstractTileChisel.prototype.getLimit=function(){return this.getStruct().limit};AbstractTileChisel.prototype.getChildNodeSuggestions=function(){return[]};AbstractTileChisel.prototype.getId=function(){return"tile"+this._getUid()};AbstractTileChisel.prototype.getWall=function(){return this.getApp().getAppWall()};
...
AbstractTileChisel.prototype.getDependencyTimestamps=function(){return[]};AbstractTileChisel.prototype.runAndRender=function(){var a=this;return this.runTile().then(function(){return a.render()})};AbstractTileChisel.prototype.getFirstAncestor=function(){var a=this.getParent();return a instanceof AbstractTileChisel?a.getFirstAncestor():this};AbstractTileChisel.prototype.getTTL=function(){return this._ttl||0};
AbstractTileChisel.prototype.setMonadOrChild=function(a,b){var c=this.getNode(a),d=b.includes("\n")||c&&c.length;if(c)return d?c.setChildren(b):c.setBeam(b);if(this.getDefinition().getMonadName()===a&&!b.includes("\n"))return this.setBeam(b);a=this.touchNode(a);return d?a.setChildren(b):a.setBeam(b)};AbstractTileChisel.prototype.getHakon=function(){return""};AbstractTileChisel.prototype.getTheme=function(){return this.getApp().getTheme()};AbstractTileChisel.prototype.getTileFooterBray=function(){return this.getTileToolbarButtonBray()};
AbstractTileChisel.prototype.getTileToolbarButtonBray=function(){return"@span "+Icons("pencil",16)+"\n class TilePencilButton\n data-onClickCommand chisel toggleToolbarCommand"};AbstractTileChisel.prototype.getSuggestedSize=function(){return this.getDefinition().getSuggestedSize()};AbstractTileChisel.prototype.getPin=function(){return this.findBeam(TileConstants.pin)};AbstractTileChisel.prototype.getStumpForChildren=function(){return this.getStump().getParent()};
AbstractTileChisel.prototype.chiselDidMount=function(){AbstractChisel.prototype.chiselDidMount.call(this);this._tileToolbar&&this._tileToolbar.render()};AbstractTileChisel.prototype.autosaveTile=function(){this._clearTileStruct();return this.getTab().autosaveTab()};
...
BasicTile.prototype.getTileBodyBray=function(){var a=this,b=this.getDefinition(),c=Icons(b.getSvg(),14),d=b.getParameters(),e=d.length-1,d=d.map(function(b,c){var d=c+1;c=(e===c?a.getWords(d).join(" "):a.getWord(d))||"";return" @input\n  placeholder "+b+"\n  value "+c+"\n  name "+d+"\n  data-onChangeCommand chisel changeWordCommand"}).join("\n");return"@div "+c+" "+b.getDescription()+"\n@div\n"+d};window.BasicTile=BasicTile;var BinPacker=function(){};
...
Layout.prototype.getTileDimensionMap=function(a,b,c){var d=a.findBeam(TileConstants.wall+" layout");return(new ({custom:CustomLayout,column:ColumnLayout,tree:TreeLayout,bin:BinLayout}[d]||CustomLayout)(a,b,c)).makeTileDimensionMap()};window.Layout=Layout;var MorphTile=function(a){return AbstractTileChisel.apply(this,arguments)||this};$jscomp.inherits(MorphTile,AbstractTileChisel);MorphTile._mountedChisels=AbstractTileChisel._mountedChisels;MorphTile.loadCode=AbstractTileChisel.loadCode;
MorphTile.prototype.getHakon=function(){this.getTheme();return".MorphTile\n .TileBody\n  display flex\n  flex-flow row wrap\n  overflow scroll\n  a\n   margin 10px\n   height 50px\n   overflow hidden\n   text-align center\n   text-overflow ellipsis\n   font-size 12px\n   width 50px"};
...
var SettingsTile=function(a){return AbstractTileChisel.apply(this,arguments)||this};$jscomp.inherits(SettingsTile,AbstractTileChisel);SettingsTile._mountedChisels=AbstractTileChisel._mountedChisels;SettingsTile.loadCode=AbstractTileChisel.loadCode;SettingsTile.prototype.isVisible=function(){return"true"===this.findBeam("visible")};window.SettingsTile=SettingsTile;var TileConstants={pin:"pin",wall:"@wall"};window.TileConstants=TileConstants;
...
TileProcess.prototype._getProgramCardCount=function(){return this.getAllCards().reduce(function(a,b){return a+b.length},0)};TileProcess.prototype.getApp=function(){return this.getParent().getApp()};TileProcess.prototype.getTab=function(){return this.getParent()};TileProcess.prototype.getTileDimensionMap=function(a,b){return(new Layout).getTileDimensionMap(this,a,b)};TileProcess.prototype.setLayout=function(a){this.touchNode(TileConstants.wall+" layout").setBeam(a);return this};
TileProcess.prototype.toggleLayout=function(){var a=this.touchNode(TileConstants.wall+" layout"),b=a.getBeam()||"custom",b=Util.toggle(b,["custom","bin","tree"]);a.setBeam(b);this.getProcessTiles().forEach(function(a){return a.makeDirty()});return this.getTab().autosaveAndRender()};
TileProcess.prototype.run=function(){var a=this,b=this.getApp(),c=lodash.uniq(this.getTopDownArray().filter(function(a){return a instanceof AbstractTileChisel}).map(function(a){return a.getBase()}));return Promise.all(c.map(function(c){return a._loadTileCode(c,b)})).then(function(){return Promise.all(a.getProcessTiles().map(function(a){return a.runTile()})).then(function(){return a})})};TileProcess.prototype.getTileProcess=function(){return this};TileProcess.prototype.getSelectedTiles=function(){return this.getProcessTiles().filter(function(a){return a.isSelected()})};
TileProcess.prototype.clearSelection=function(){this.getSelectedTiles().forEach(function(a){return a.unselect()})};TileProcess.prototype.deleteSelection=function(){var a=this.getSelectedTiles();if(!a.length)return Promise.resolve();a.forEach(function(a){return a.unmountAndDestroy()});return this.getTab().autosaveAndRender()};TileProcess.prototype.copySelection=function(a){a=this._copySelection(a);if(!a)return Promise.resolve();this.getApp().logMessageBray("@div Items copied");return Promise.resolve(a)};
...
TileProcess.prototype.selectNext=function(){for(var a=this.getFirstSelectedTile().getNext();!a.getBase().startsWith(">");)a=this.getFirstSelectedTile().getNext();this.clearSelection();a.selectTile();return Promise.resolve()};TileProcess.prototype.selectionToString=function(){return this.getSelectedTiles().map(function(a){return a.toString()}).join("\n")};
...
TileProcess.prototype.getOutputBinder=function(){this._outputBinder||(this._outputBinder=new Binder(this));return this._outputBinder};TileProcess.prototype.getProcessTiles=function(){return this.getTopDownArray().filter(function(a){return a instanceof AbstractTileChisel})};
TileProcess.prototype.duplicateSelection=function(){var a=this,b=this.getSelectedTiles().map(function(b){return a.cloneTile(b)}),c=this.getTab().autosaveAndRender();this.clearSelection();b.forEach(function(a){return a.selectTile()});return c};TileProcess.prototype._loadTileCode=function(a,b){this.getParent();var c=b.getTileCache();if(!c[a]){var d=this.getDictionary().getDefinitionByName(a);c[a]=this.loadTileCodeOrGetLoadingPromise(b,d)}return c[a]};
...
TileProcess.prototype.isProcess=function(){return!0};TileProcess.prototype._getLongestRenderTime=function(){return this.getProcessTiles().map(function(a){return a.getNewestTimeToRender()}).sort().reverse()[0]};TileProcess.prototype.cloneTile=function(a){var b=a.duplicate();(a=a.findBeam(TileConstants.pin))&&b.touchNode(TileConstants.pin).setBeam(this.getAvailableSpot(a));return b};
TileProcess.prototype.getAvailableSpot=function(a){a=a.split(" ").map(function(a){return parseInt(a)});a[0]++;a[1]++;return a.join(" ")};TileProcess.prototype.getProcessStats=function(){var a={tiles:this.getProcessTiles().length,url:this.getTab().getFileName()};a.timeToLoad=this._getLongestLoadTime();a.timeToRender=this._getLongestRenderTime();return a};
...
AbstractDropDownMenuChisel.prototype.getBray=function(){var a=this.getDropDownBray(),b=this.getAnchorId();return"@div\n style top: 30px; left: "+this.getParent().getStump().findStumpByChild("id "+b).getShadow().getShadowPosition().left+"px;\n class dropdownMenu"+TreeProgram.nest(a,1)};window.AbstractDropDownMenuChisel=AbstractDropDownMenuChisel;var ConsoleChisel=function(a){return AbstractChisel.apply(this,arguments)||this};$jscomp.inherits(ConsoleChisel,AbstractChisel);
ConsoleChisel._mountedChisels=AbstractChisel._mountedChisels;ConsoleChisel.prototype._getConsoleOutput=function(){var a=this._getMessageBuffer().getChildren().map(function(a){return a.childrenToString()});a.reverse();return a.join("\n")};ConsoleChisel.prototype.getHakon=function(){return".consoleOutput\n height 400px\n overflow scroll"};ConsoleChisel.prototype._getMessageBuffer=function(){var a=this.getApp(),b=a.getMountedTab();return b?b.getMessageBuffer():a.getMessageBuffer()};
ConsoleChisel.prototype.getDependencyTimestamps=function(){var a=this.getParent().getGutterDependencies(),b=this._getMessageBuffer();b.length?a.push(b.nodeAt(-1).getMTime()):a.push(this._getNow());a.push(this.getParent().getParent().getMTime());return a};ConsoleChisel.prototype.getBray=function(){var a=this._getConsoleOutput();return"@div\n class consoleOutput"+TreeProgram.nest(a,1)};window.ConsoleChisel=ConsoleChisel;var GutterChisel=function(a){return AbstractChisel.apply(this,arguments)||this};
$jscomp.inherits(GutterChisel,AbstractChisel);GutterChisel._mountedChisels=AbstractChisel._mountedChisels;GutterChisel.prototype.parseNodeType=function(a){return a.startsWith("console")?ConsoleChisel:TerminalChisel};GutterChisel.prototype.getHakon=function(){var a=this.getTheme(),b=this.getGutterWidth();return AbstractChisel.prototype.getHakon.call(this)+"\n.Gutter\n width "+b+"px\n left 0\n background "+a.backgroundColor+"\n border-color "+a.borderColor+"\n position absolute\n border-right-width 1px\n border-right-style solid\n box-sizing border-box\n top 0\n bottom 0\n padding 20px"};
...
OhayoAppChisel.prototype._createProgramFromFile=function(a,b){var c=Util.getFileExtension(a);if(this.getETNs()[c])return this._createAndOpen(b,a);b=(c=FlowTemplates[c])?c(a,b):">text No visualization templates for "+a;this._createAndOpen(b,a+".flow")};OhayoAppChisel.prototype.registerETN=function(a,b){this.getETNs()[a]=b;return this};OhayoAppChisel.prototype.executeCommandLine=function(a){this.addToCommandLog(a.join(" "));return this.getCommander()[a[0]].apply(this,a.slice(1))};
OhayoAppChisel.prototype.getProgramClass=function(a){return this.getETNs()[a]||FlowProgram};OhayoAppChisel.prototype.getETNs=function(){this._etns||(this._etns={},this.registerETN("flow",FlowProgram),this.registerETN("fire",FireProgram));return this._etns};OhayoAppChisel.prototype.getTargetNode=function(){return this._targetNode};OhayoAppChisel.prototype.setTargetNode=function(a){this._targetNode=a;return this};
...
OhayoAppChisel.prototype.renderApp=function(){this.render(this.getWillowProgram().getBodyStump());return this};OhayoAppChisel.prototype._getAvailablePermalink=function(a){var b=this;a=Format.permalink(a);return Util.getAvailablePermalink(a,function(a){return b.doesFileExistSync(a)})};OhayoAppChisel.prototype._appendTiles=function(a,b){return this.getNodeCursors().map(function(c){return c.append(a,b)})};
OhayoAppChisel.prototype.getNodeCursors=function(){var a=this.getMountedProcess(),b=a.getSelectedTiles();return b.length?b:[a]};OhayoAppChisel.prototype._openOhayoProgram=function(a){var b=(new TreeProgram(DemoTemplates)).getNode(a).childrenToString(),c=this.getFocusedPanel(),d=c.getOpenTabByUrl(a);return d?(c.setMountedTab(d),Promise.resolve()):this._createAndOpen(b,a)};OhayoAppChisel.prototype.saveProgramToDisk=function(a,b){this.storeValue(a.getFileName(),b.newVersion);return Promise.resolve()};
OhayoAppChisel.prototype.doesFileExistSync=function(a){return void 0!==this.getFromStore(a)};OhayoAppChisel.prototype.createFile=function(a,b){a=this._getAvailablePermalink(a);this.storeValue(a,b);return Promise.resolve(a)};OhayoAppChisel.prototype._createAndOpen=function(a,b){var c=this;return this.createFile(b,a).then(function(a){return c.openUrlInNewTabAndFocus(a)})};OhayoAppChisel.prototype.getFocusedPanel=function(){return this.getNode("panel")};OhayoAppChisel.prototype.getMountedTab=function(){return this.getFocusedPanel().getMountedTab()};
...
OhayoAppChisel.prototype.promptToRenameFile=function(a,b){var c=this;return this.getWillowProgram().promptThen("Enter new name for file",b||a).then(function(b){return b&&b!==a?(b=Format.permalink(b))?c.getCommander().renameFileCommand(a,b).then(function(a){c.logMessageBray("@div Renamed");return a}):Promise.resolve():Promise.resolve()})};
OhayoAppChisel.prototype.deleteAllTabsPrompt=function(){var a=this,b=this.getFocusedPanel().getTabs();return this.getWillowProgram().confirmThen("Are you sure you want to delete "+b.length+" open programs?").then(function(c){return c?Promise.all(b.map(function(b){return a.getCommander().deleteFileCommand(b.getFileName())})):Promise.resolve(!1)})};OhayoAppChisel.prototype.getKeyboardShortcuts=function(){this._shortcuts||(this._shortcuts=new DrumsProgram(OhayoAppDrums));return this._shortcuts};
...
OhayoAppChisel.prototype.openExternalLink=function(a){this.getWillowProgram().openUrl(a)};OhayoAppChisel.prototype.getAppWall=function(){return this.getFocusedPanel().getNode("tabs wall")};OhayoAppChisel.prototype.getRenderedTiles=function(){return this.getMountedProcess().getProcessTiles().filter(function(a){return a.isMounted()})};OhayoAppChisel.prototype._createProgramFromPaste=function(a){return this._createAndOpen(a,"untitled.flow")};
OhayoAppChisel.prototype.setMouseEvent=function(a){this._mouseEvent=a;return this};OhayoAppChisel.prototype.getMouseEvent=function(){return this._mouseEvent||this.getWillowProgram().getMockMouseEvent()};OhayoAppChisel.prototype.getCaddies=function(){var a=this;return this.getStoreKeys().filter(function(a){return!StorageKeys.isKey(a)}).map(function(b){return new LocalStorageCaddy(a.getFromStore(b),b)})};OhayoAppChisel.prototype.getStumpString=function(){return this.getWillowProgram().getHtmlStump().toString()};
...
PanelChisel.prototype._getMountedTab=function(){return this._focusedTab};PanelChisel.prototype.getOpenTabByUrl=function(a){return this.getTabs().find(function(b){return b.getUrl()===a})};PanelChisel.prototype.setMountedTab=function(a){if(this._getMountedTab()===a)return this;this._focusedTab=a;this.setBeam(a.getUrl());this._getTabsNode().addWall();this._updateLocationForRestoreOnRefresh();return this};PanelChisel.prototype._getTabsNode=function(){return this.getNode("tabs")};
...
PanelChisel.prototype.closeTab=function(a){if(a.isMounted()){var b=a.getNextOrPrevious(this.getTabs());this._getTabsNode().removeWall();a.unmountAndDestroy();delete this._focusedTab;b&&b!==a&&this.setMountedTab(b)}else a.destroy();this._updateLocationForRestoreOnRefresh();this.getApp().renderApp()};PanelChisel.prototype._updateLocationForRestoreOnRefresh=function(){this.getApp().saveAppState()};
PanelChisel.prototype.closeAllTabs=function(){var a=this._getMountedTab();a&&a.unmount();this.getTabs().forEach(function(a){return a.destroy()});delete this._focusedTab;this._updateLocationForRestoreOnRefresh();this.getApp().renderApp();return Promise.resolve()};PanelChisel.prototype.mountPreviousTab=function(){var a=this.getTabs(),b=this._getMountedTab();if(2>a.length||!b)return this;b=a.indexOf(b);return this.mountTabByIndex(0===b?a.length-1:b-1)};
PanelChisel.prototype.mountNextTab=function(){var a=this.getTabs(),b=this._getMountedTab();if(2>a.length||!b)return this;b=a.indexOf(b);return this.mountTabByIndex(b===a.length-1?0:b+1)};PanelChisel.prototype.getTabs=function(){return this._getTabsNode().getOpenTabs()};window.PanelChisel=PanelChisel;var TabChisel=function(a){return AbstractChisel.apply(this,arguments)||this};$jscomp.inherits(TabChisel,AbstractChisel);TabChisel._mountedChisels=AbstractChisel._mountedChisels;
TabChisel.prototype.getBray=function(a){var b=this.getUrl(),c=this.getParent().getParent().getBeam()===b;return"@a "+b+"\n data-onClickCommand app mountTabByIndexCommand\n collapseNode true\n value "+a+"\n class TabStub "+(c?"mountedTab":"")+"\n @span x\n  collapseNode true\n  data-onClickCommand app closeTabByIndexCommand\n  value "+a+"\n  class closeTabButton"};TabChisel.prototype.getDependencyTimestamps=function(){return[this.getParent().getParent().getMTime()]};
TabChisel.prototype.getContextMenuCommandsBray=function(){return"@a Save Program\n data-onClickCommand app saveTabAndNotifyCommand\n@a Rename program\n data-onClickCommand app showTabRenamePromptCommand\n@a Delete program\n data-onClickCommand app showDeleteFileConfirmDialogCommand\n@a Save compiled '"+this.getDictionary().getTargetExtension()+"' file\n tabindex -1\n data-onClickCommand app saveCompiledCommand"};TabChisel.prototype.getDictionary=function(){return this.getTabProgram().getDictionary()};
TabChisel.prototype.autosaveAndRender=function(){var a=this.autosaveTab();this.getApp().renderApp();return a};TabChisel.prototype.autosaveTab=function(){var a=this,b=this.getTabProcess().childrenToString(),c=this._getTopUndoVersion();if(b===c)return Promise.resolve();this._recordChange(b);var d=this.getApp();return d.isAutoSaveEnabled()?this.forceSaveToDisk().then(function(){a.logMessageBray("@div Saved "+a.getUrl());var b=d.getNode("panel gutter console");b&&b.render()}):Promise.resolve()};
TabChisel.prototype._getDiff=function(){var a=this.getHash(),b=this.getTabProcess().childrenToString(),c=this._getDiskVersion(),c=diff.compareStr(c,b,"\n"),d=new jsSHA("SHA-1","TEXT");d.update(a+JSON.stringify(c));d=d.getHash("HEX");return{oldHash:a,newHash:d,patch:c,newVersion:b}};TabChisel.prototype.getHash=function(){return this._hash||""};TabChisel.prototype.setHash=function(a){this._hash=a};
TabChisel.prototype.redo=function(){var a=this._getUndoStack(),b=this._getRedoStack();if(!b.length)return Promise.resolve();a.push(b.pop());return this._reloadFromUndoTop()};TabChisel.prototype.hasUnsavedChanges=function(){return this.getTabProcess().childrenToString()!==this._getDiskVersion()};TabChisel.prototype.undo=function(){var a=this._getUndoStack(),b=this._getRedoStack();if(1===a.length)return Promise.resolve();b.push(a.pop());return this._reloadFromUndoTop()};
TabChisel.prototype.forceSaveToDisk=function(){var a=this._getDiff();this.setHash(a.newHash);this._setDiskVersion(a.newVersion);return this.getApp().saveProgramToDisk(this,a)};TabChisel.prototype.getUrl=function(){return this.getWord(1)};TabChisel.prototype.getFileName=function(){return Util.getFileName(this.getUrl())};TabChisel.prototype._getDiskVersion=function(){return this._diskVersion};TabChisel.prototype._setDiskVersion=function(a){this._diskVersion=a;return this};
TabChisel.prototype._clearRedoStack=function(){var a=this._getRedoStack();a.splice(0,a.length)};TabChisel.prototype.getGridSize=function(){return 20};TabChisel.prototype.makePin=function(a){var b=this.getGridSize();return[Math.floor((a.offsetX-0)/b),Math.floor(a.offsetY/b)].join(" ")};TabChisel.prototype._getUndoStack=function(){this._undoStack||(this._undoStack=[]);return this._undoStack};TabChisel.prototype._getRedoStack=function(){this._redoStack||(this._redoStack=[]);return this._redoStack};
TabChisel.prototype._getTopUndoVersion=function(){var a=this._getUndoStack();return a[a.length-1]};TabChisel.prototype._getProgramClass=function(){return this.getApp().getProgramClass(Util.getFileExtension(this.getUrl()))};TabChisel.prototype.getTabProcess=function(){return this._tileProcess};TabChisel.prototype.getTabProgram=function(){return this._program};TabChisel.prototype.getTabWall=function(){return this.getParent().getNode("wall")};
...
TabChisel.prototype.autosaveAndReloadWith=function(a){var b=this;this.getTabProcess().setChildren(a);this.autosaveTab();this.getTabWall().unmount();return this._initProcess(a).then(function(){b.getApp().renderApp()})};TabChisel.prototype.reloadFromDisk=function(){var a=this.getApp().getFromStore(this.getUrl());return this.autosaveAndReloadWith(a)};TabChisel.prototype._executeFetchTab=function(){var a=this.getApp().getFromStore(this.getUrl());this._setDiskVersion(a);this._getUndoStack().push(a);return this._initProcess(a)};
window.TabChisel=TabChisel;var TabsChisel=function(a){return AbstractChisel.apply(this,arguments)||this};$jscomp.inherits(TabsChisel,AbstractChisel);TabsChisel._mountedChisels=AbstractChisel._mountedChisels;TabsChisel.prototype.getNodeTypes=function(){return{tab:TabChisel,wall:WallChisel}};TabsChisel.prototype.removeWall=function(){var a=this.getNode("wall");a&&a.unmountAndDestroy()};TabsChisel.prototype.getOpenTabs=function(){return this.getChildrenByNodeType(TabChisel)};
TabsChisel.prototype.addWall=function(){this.removeWall();return this.append("wall")};TabsChisel.prototype.addTab=function(a){return this.has("wall")?this.insert("tab "+a,void 0,-1):this.append("tab "+a)};TabsChisel.prototype.getGutterWidth=function(){return this.getParent().getGutterWidth()};
...
a.activeTabColor+"\n  border-bottom 0"};window.TabsChisel=TabsChisel;var TerminalChisel=function(a){return AbstractChisel.apply(this,arguments)||this};$jscomp.inherits(TerminalChisel,AbstractChisel);TerminalChisel._mountedChisels=AbstractChisel._mountedChisels;TerminalChisel.prototype.getHakon=function(){return".sourceTextarea\n height "+this._getHeight()+"px"};TerminalChisel.prototype.getCommander=function(){return new TerminalCommander(this)};
TerminalChisel.prototype._getProgramSource=function(){var a=this._getTab();return a?a.getTabProcess().childrenToString():""};TerminalChisel.prototype._getProgram=function(){var a=this._getTab();return a&&a.getTabProgram()};TerminalChisel.prototype._getTab=function(){return this.getApp().getMountedTab()};TerminalChisel.prototype.getBray=function(){var a=this._getProgramSource()||"";return"@div\n style font-size: 14px;\n @textarea\n  class sourceTextarea\n  bern"+TreeProgram.nest(a,3)};
TerminalChisel.prototype._getHeight=function(){return 600};TerminalChisel.prototype._getTextarea=function(){return this.getStump().getNode("@textarea").getShadow().getShadowElement()};TerminalChisel.prototype._makeProgram=function(a){var b=new TreeProgram(this._getCode()),c=this._getProgram().constructor;a=b.getTopDownArray()[a];return new c(a.toString())};TerminalChisel.prototype._updateConsole=function(){this.getParent().getChildren()[1].render()};
TerminalChisel.prototype.getDependencyTimestamps=function(){var a=this.getParent().getGutterDependencies(),b=this._getTab();(b=b&&b.getTabProcess())&&this._getProgramSource()!==this._getCode()&&a.push(b.getTreeMTime());a.push(this.getParent().getParent().getMTime());return a};TerminalChisel.prototype.chiselDidMount=function(){this._loadCodeMirror();AbstractChisel.prototype.chiselDidMount.call(this)};TerminalChisel.prototype.updateHtml=function(){};
TerminalChisel.prototype.chiselDidUpdate=function(){var a=this._getCodeMirror();a&&a.setValue(this._getProgramSource());AbstractChisel.prototype.chiselDidUpdate.call(this)};TerminalChisel.prototype._getCode=function(){return this.isNodeJs()?"":this._getCodeMirror().getValue()};TerminalChisel.prototype._getCodeMirror=function(){return this._codeMirror};TerminalChisel.prototype.hasChanges=function(){var a=this._getProgram();return a&&this._getCode()!==a.childrenToString()};
TerminalChisel.prototype.hasFocus=function(){return this._codeMirror&&this._codeMirror.hasFocus()};TerminalChisel.prototype._makeFullProgram=function(){var a=this._getCode();return new (this._getProgram().constructor)(a,void 0,this.getApp())};
...
TerminalChisel.prototype._loadCodeMirror=function(){var a=this;if(!this.isNodeJs()){var b=this._getTextarea(),c={lineNumbers:!0,tabSize:1,indentUnit:1,extraKeys:{"Ctrl-Space":"autocomplete"},hintOptions:{hint:this._getAutoCompleteFn()}},d=CodeMirror.fromTextArea(b,c);d.setSize(void 0,this._getHeight());d.on("gutterClick",function(b,c,d,h){a.getCommander().executeLineCommand(c)});d.on("blur",function(){a.getCommander().saveChangesCommand()});d.addKeyMap({"Cmd-Enter":function(){var b=d.listSelections()[0].head.line;
a.getCommander().executeLineCommand(b)},"Shift-Cmd-Enter":function(){var b=d.listSelections()[0].head.line;a.getCommander().compileLineCommand(b)},"Cmd-\\":function(){a.getApp().getCommander().clearTabMessagesCommand()},"Cmd-S":function(){a.getCommander().saveChangesCommand();a._updateConsole()}});this._codeMirror=d}};window.TerminalChisel=TerminalChisel;var ThemeChisel=function(a){return AbstractChisel.apply(this,arguments)||this};$jscomp.inherits(ThemeChisel,AbstractChisel);
ThemeChisel._mountedChisels=AbstractChisel._mountedChisels;ThemeChisel.prototype.getBray=function(){var a=this.getTheme();return"@style "+CodeMirrorCss+" .CodeMirror{background: transparent; color: "+a.bodyColor+";} .CodeMirror-gutters { background: transparent;}"};
...
WallChisel.prototype.getHakon=function(){var a=this.getTheme();return".WallChisel\n background "+a.wallBackground+"\n display block\n position relative\n\n.ui-selectable-helper\n position absolute\n z-index 100\n border-radius 2px\n background "+a.selectionBackground+"\n\n.ui-selecting,.ui-selected,.StaySelected\n outline 3px solid "+a.selectedOutline};WallChisel.prototype.getCommander=function(){return new WallCommander(this)};
WallChisel.prototype.selectTilesByShadowClass=function(a){a=void 0===a?"ui-selected":a;this.getApp().getWillowProgram().findStumpsByShadowClass(a).forEach(function(a){return a.getStumpChisel().selectTile()})};WallChisel.prototype._getPinChangeInPixels=function(a,b){return{left:a.offset.left-b.left,top:a.offset.top-b.top}};
WallChisel.prototype.getWallDimension=function(){var a=this.getApp().getWillowProgram().getBodyStump().getShadow();return{width:a.getShadowWidth()-this.getParent().getGutterWidth(),height:a.getShadowHeight()}};WallChisel.prototype._updateCustomPointWithWidthAndHeight=function(){return this._updateCustomLayout(!0)};
WallChisel.prototype._updateCustomLayout=function(a){a=void 0===a?!0:a;var b=this,c=this.getApp();c.getWillowProgram().findStumpsWithClass("TileChisel").forEach(function(c){return b._updateTileLayout(c,a)});c.getMountedProcess().setLayout("custom");c.getMountedTab().autosaveTab();c.renderApp()};
WallChisel.prototype._updateTileLayout=function(a,b){var c=a.getShadow(),d=a.getStumpChisel();if(d.isVisible()){var e=c.getShadowOffset(),f=this.getGridSize();a=a.getParent().getShadow().getShadowOffset();c=[Math.floor((e.left-a.left)/f),Math.floor((e.top-a.top)/f),Math.floor(c.getShadowWidth()/f),Math.floor(c.getShadowHeight()/f)];b=(b?c:c.slice(0,2)).join(" ");d.findBeam(TileConstants.pin)!==b&&(d.delete(TileConstants.pin),d.prepend(TileConstants.pin+" "+b))}};WallChisel.prototype.getGridSize=function(){return 20};
WallChisel.prototype.chiselDidUpdate=function(){this._fixLargeBug()};
...
"px","min-width":a+"px"};d.setStumpCss(f);c.setStumpCss(f)};WallChisel.prototype.chiselDidMount=function(){this._makeSelectable();this._makeTilesMoveableAndResizableAndEditable();this._fixLargeBug()};
WallChisel.prototype._makeTilesMoveableAndResizableAndEditable=function(){var a=this.getApp().getWillowProgram(),b=this,c=this.getGridSize();this.getStump().getShadow().onShadowEvent(WillowShadowEvents.mouseover,".TileChisel",function(d){d=a.getStumpFromElement(this);var e=d.getShadow();if(e.isShadowResizable())return!0;b._makeGroupDraggable(d,[c,c]);e.makeResizable({handles:"se",grid:c,resize:function(a){a.stopPropagation();a.preventDefault();return!1},stop:function(){return b._updateCustomPointWithWidthAndHeight()}})})};
WallChisel.prototype.getBray=function(){return"@div\n class WallChisel\n data-onContextMenuCommand chisel openWallContextMenuCommand\n data-onDblClickCommand app insertMorphTileCommand"};WallChisel.prototype._getSelectedTileStumps=function(){return this.getApp().getWillowProgram().findStumpsWithClass("ui-selected")};
WallChisel.prototype._updateSelectedOnMove=function(a,b){var c=this._getSelectedTileStumps();c.length&&c.filter(function(b){return b!==a}).forEach(function(a){var c=parseFloat(a.getStumpCss("top")),d=parseFloat(a.getStumpCss("left"));a.setStumpCss({transform:"",top:c+b.top+"px",left:d+b.left+"px"})})};
...
Column.prototype.getQuins=function(){var a=this.getReductions().deciles;return[20,40,60,80,100].map(function(b){return{value:a[b],percent:b/100}})};Column.prototype.getColumnTypeName=function(){return this.getColumnTypeObj().getColTypeName()};
...
2)),d=parseInt(a.substr(2,2)),e=parseInt(a.substr(4,2)),f=parseInt(a.substr(6,2)),g=parseInt(a.substr(0,4)),h=parseInt(a.substr(4,4)),e=13>e,l=32>f,f=13>f,g=1E3<g&&2100>g;return c=13>c&&32>d&&1E3<h&&2100>h?b(a,"MMDDYYYY"):g&&e&&l?b(a,"YYYYMMDD"):g&&f?b(a,"YYYYDDMM"):b(a,"DDMMYYYY")}return"string"===typeof a&&a.match(/^[0-9]{2}\/[0-9]{4}$/)?b(a,"MM/YYYY"):!a.match||a.match(/[^0-9]/)||(d=parseFloat(a),isNaN(d))?c:10===a.length?b(1E3*d):b(d)}};window.Metrics=Metrics;
...
AppCommander.prototype.toggleShadowByIdCommand=function(a){this.getTarget().getWillowProgram().findStumpByChild("id "+a).getShadow().toggleShadow();return Promise.resolve()};AppCommander.prototype.toggleAndRenderNewDropDownCommand=function(){this.getTarget().getNode("menu").toggleAndRender("newDropDownMenu");return Promise.resolve()};
...
AppCommander.prototype.insertMorphTileCommand=function(){var a=this.getTarget(),b=a.getMountedTab(),c=a.getMouseEvent();a.getNodeCursors().forEach(function(a){a.append(">morph",TileConstants.pin+" "+b.makePin(c))});return b.autosaveAndRender()};AppCommander.prototype.appendTileCommand=function(a,b){var c=this.getTarget();c._appendTiles(a,b).forEach(function(a){return a.runTile()});return c.getMountedTab().autosaveAndRender()};
AppCommander.prototype.deleteAllCardsInTargetTileCommand=function(){var a=this.getTarget(),b=a.getTargetNode().getInputBinder();return Promise.all(b.getCards().map(function(a){return a.destroyCard()})).then(function(){a.renderApp()})};AppCommander.prototype.openOhayoProgramCommand=function(a){var b=this.getTarget();return Promise.all(a.split(" ").map(function(a){return b._openOhayoProgram(a)}))};AppCommander.prototype.deleteFileCommand=function(a){this.getTarget().removeValue(a);return Promise.resolve()};
AppCommander.prototype.renameFileCommand=function(a,b){var c=this.getTarget();c.storeValue(b,c.getFromStore(a)||"");c.removeValue(a);return Promise.resolve(b)};AppCommander.prototype.createNewBlankProgramCommand=function(a){a=void 0===a?"untitled.flow":a;return this.getTarget()._createAndOpen("",a).then(function(a){return a.logMessageBray("@div Created '"+a.getUrl()+"'")})};
...
AppCommander.prototype.openUrlPromptCommand=function(a){var b=this.getTarget();return b.getWillowProgram().promptThen("Enter a url to open",a).then(function(a){if(a)return b.openUrlInNewTabAndFocus(a)})};AppCommander.prototype.openManyCommand=function(a){var b=this.getTarget(),c=new RegExp(a,"i");a=b.getCaddies().filter(function(a){return a.getCaddyLink().match(c)});return Promise.all(a.map(function(a){return b._openUrlInNewTab(a.getCaddyLink())}))};AppCommander.prototype.openUrlInNewTabCommand=function(a){return this.getTarget()._openUrlInNewTab(a)};
AppCommander.prototype.mountTabByIndexCommand=function(a){this.getTarget().getFocusedPanel().mountTabByIndex(a);return Promise.resolve()};AppCommander.prototype.closeTabByIndexCommand=function(a){this.getTarget().getFocusedPanel().closeTabByIndex(a);return Promise.resolve()};
...
AppCommander.prototype.saveCompiledCommand=function(){var a=this.getTarget(),b=a.getMountedTab(),c=b.getDictionary().getTargetExtension(),d=Format.permalink(Util.removeFileExtension(b.getFileName()))+"."+c,b=b.compile();a.getWillowProgram().downloadFile(b,d,"text/"+c);return Promise.resolve()};AppCommander.prototype.executeProgramCommand=function(){var a=this.getTarget().getMountedTab();return a.getTabProgram().execute().then(function(b){return a.logMessageText(b.join("\n"))})};
...
AppCommander.prototype.toggleHelpCommand=function(){return this.getTarget().toggleAndRender("helpModal")};AppCommander.prototype.toggleLayoutCommand=function(){var a=this.getTarget();return a.getMountedProcess().toggleLayout().then(function(){a.getMountedTab().logMessageBray("@div Layout changed.")})};AppCommander.prototype.closeMountedProgramCommand=function(){var a=this.getTarget();a.getFocusedPanel().closeTab(a.getMountedTab());return Promise.resolve()};
AppCommander.prototype.fetchAndReloadFocusedTabCommand=function(){return this.getTarget().getMountedTab().reloadFromDisk()};AppCommander.prototype.selectAllCommand=function(){this.getTarget().getMountedProcess().selectAll();return Promise.resolve()};AppCommander.prototype.selectTilesByShadowClassCommand=function(a){var b=this.getTarget();b.addToCommandLog("app selectTilesByShadowClassCommand");b.getMountedTab().getTabWall().selectTilesByShadowClass(a);return Promise.resolve()};
...
AppCommander.prototype.showDeleteFileConfirmDialogCommand=function(){var a=this,b=this.getTarget(),c=b.getMountedTab().getFileName();return b.getWillowProgram().confirmThen("Are you sure you want to delete "+c+"?").then(function(b){return b?a.deleteFocusedTabCommand():Promise.resolve()})};AppCommander.prototype.deleteFocusedTabCommand=function(){var a=this.getTarget(),b=a.getMountedTab(),c=b.getFileName();return this.deleteFileCommand(c).then(function(){a.getFocusedPanel().closeTab(b)})};
AppCommander.prototype.mountPreviousTabCommand=function(){this.getTarget().getFocusedPanel().mountPreviousTab();return Promise.resolve()};AppCommander.prototype.mountNextTabCommand=function(){this.getTarget().getFocusedPanel().mountNextTab();return Promise.resolve()};AppCommander.prototype.closeAllTabsCommand=function(){return this.getTarget().getFocusedPanel().closeAllTabs()};AppCommander.prototype.toggleFullScreenCommand=function(){this.getTarget().getWillowProgram().toggleFullScreen();return Promise.resolve()};
AppCommander.prototype.toggleFocusedModeCommand=function(){var a=this.getTarget();a.toggle("menu");a.getFocusedPanel();return this.toggleFullScreenCommand()};AppCommander.prototype.toggleGutterCommand=function(){var a=this.getTarget();a.makeAllDirty();var b=a.getFocusedPanel(),c=b.getNode("gutter");c?c.unmountAndDestroy():(b=b.touchNode("gutter"),b.insert("terminal"),b.insert("console"));a.renderApp();return Promise.resolve()};AppCommander.prototype.selectNextCommand=function(){return this.getTarget().getMountedProcess().selectNext()};
...
AppCommander.prototype.saveTabAndNotifyCommand=function(){var a=this.getTarget(),b=a.getMountedTab();return b.forceSaveToDisk().then(function(){b.logMessageBray("@div Saved "+b.getUrl());a.renderApp()}).catch(function(a){console.error(a)})};AppCommander.prototype.cloneTabCommand=function(){var a=this.getTarget(),b=a.getMountedTab();return a._createAndOpen(b.getTabProcess().childrenToString(),b.getFileName())};
...
AppCommander.prototype.runSpeedTestCommand=function(){var a=this,b=this.getTarget(),c=b.getCaddies().map(function(a){return a.getCaddyLink()}),d=Date.now(),e=Util.pLimit(7),f=b.getFocusedPanel(),c=c.map(function(a){return e(function(){return b._openUrlInNewTab(a).then(function(a){var b=f.getMountedTab();f.setMountedTab(a);b&&f.closeTab(b);return a.getTabProcess().getProcessStats()})})});return Promise.all(c).then(function(c){f.getMountedTab()&&a.closeMountedProgramCommand();c=new TreeProgram(c);var e=
Date.now()-d,e="Program Load Times "+moment().format("MM/DD/YYYY")+" version "+b.getVersion()+". Run time: "+e;return b._createAndOpen(SpeedTestTemplate(e,c.toCsv()),"program-load-times")})};window.AppCommander=AppCommander;var ChiselCommander=function(a){AbstractCommander.apply(this,arguments)};$jscomp.inherits(ChiselCommander,AbstractCommander);ChiselCommander.prototype.stopPropagationCommand=function(){};ChiselCommander.prototype.clearCommand=function(){delete this.getTarget()._messageBuffer;return Promise.resolve()};
ChiselCommander.prototype.unmountAndDestroyCommand=function(){return this.getTarget().unmountAndDestroy()};window.ChiselCommander=ChiselCommander;var TabCommander=function(a){AbstractCommander.apply(this,arguments)};$jscomp.inherits(TabCommander,AbstractCommander);window.TabCommander=TabCommander;var TerminalCommander=function(a){AbstractCommander.apply(this,arguments)};$jscomp.inherits(TerminalCommander,AbstractCommander);
TerminalCommander.prototype.saveChangesCommand=function(){var a=this.getTarget();if(a.hasChanges())return a._getTab().autosaveAndReloadWith(a._getCode())};TerminalCommander.prototype.executeLineCommand=function(a){var b=this.getTarget();return b._makeProgram(a).execute(b.getApp()).then(function(a){b._getTab().logMessageText(a.join("\n"));b._updateConsole()})};
TerminalCommander.prototype.compileLineCommand=function(a){var b=this.getTarget();a=b._makeProgram(a).compile();b._getTab().logMessageText(a);b._updateConsole()};window.TerminalCommander=TerminalCommander;var TileCommander=function(a){AbstractCommander.apply(this,arguments)};$jscomp.inherits(TileCommander,AbstractCommander);TileCommander.prototype.cloneTileCommand=function(){var a=this.getTarget(),b=a.getTileProcess();b.cloneTile(a);return b.getTab().autosaveAndRender()};
TileCommander.prototype.updateSlangCommand=function(a){var b=this.getTarget();a=Format.stripHtml(a.replace(/\<br\>/g,"\n").replace(/\<div\>/g,"\n"));b.setMonadOrChild("slang",a);b.autosaveTile();return b.runAndRender().then(function(){b.getApp().renderApp()})};TileCommander.prototype.changeTileOrderByCommand=function(a){var b=this.getTarget();b.toggle("orderBy",[a,"-"+a,""]);b.autosaveTile();b.makeDirty();b.render();return Promise.resolve()};
...
TileCommander.prototype.destroyTileCommand=function(){var a=this.getTarget();a.unmountAndDestroy();return a.getTileProcess().getTab().autosaveAndRender()};TileCommander.prototype.getNewDataCommand=function(){};TileCommander.prototype.changeDetailCommand=function(a,b){var c=this.getTarget();c.setMonadOrChild(b,a.toString());c._clearTileStruct();c.getApp().renderApp();return c.autosaveTile()};TileCommander.prototype.changeWordCommand=function(a,b){var c=this.getTarget();c.setWord(b,a);c.render();return c.autosaveTile()};
TileCommander.prototype.copyTileCommand=function(){var a=this.getTarget();a.getApp().getWillowProgram().copyTextToClipboard(a.getFirstAncestor().toString());return Promise.resolve()};TileCommander.prototype.inspectTileCommand=function(){var a=this.getTarget(),b=a.getInspection();a.getTab().logMessageBray(b);a.getApp().renderApp();return Promise.resolve()};TileCommander.prototype.toggleToolbarCommand=function(){this.getTarget().toggleToolbar();return Promise.resolve()};
TileCommander.prototype.createCardsFromTNCommand=function(a){return this.getTarget().createCards((new CardParser).parse(a,"tree"))};TileCommander.prototype.copyDataCommand=function(a){var b=this.getTarget();b.getApp().getWillowProgram().copyTextToClipboard(b.getOutputBinder().toDelimited(a));return Promise.resolve()};
TileCommander.prototype.exportTileDataCommand=function(){var a=this.getTarget();return a.getApp().getWillowProgram().downloadFile(a.getOutputBinder().toDelimited(","),a.getBase()+".csv","text/csv")};window.TileCommander=TileCommander;var WallCommander=function(a){AbstractCommander.apply(this,arguments)};$jscomp.inherits(WallCommander,AbstractCommander);WallCommander.prototype.openWallContextMenuCommand=function(){return this.getTarget().getApp().toggleAndRender("tabContextMenu")};
window.WallCommander=WallCommander;var AbstractContextMenuChisel=function(a){return AbstractChisel.apply(this,arguments)||this};$jscomp.inherits(AbstractContextMenuChisel,AbstractChisel);AbstractContextMenuChisel._mountedChisels=AbstractChisel._mountedChisels;
...
Definition.prototype.getMonadName=function(){return this.getDetails().filter(function(a){return a.isMonad()}).map(function(a){return a.getDetailName()}).join("")};Definition.prototype.getParameters=function(){var a=this.findBeam(DictionaryConstants.parameters);return a?a.split(" "):[]};Definition.prototype.getArity=function(){return this.getParameters().length};Definition.prototype.getDescription=function(){return this.findBeam(DictionaryConstants.description)||""};
...
var DictionaryConstants={preface:"@preface",frequency:"@frequency",targetExtension:"@targetExtension",fileExtension:"@fileExtension",openChildren:"@openChildren",closeChildren:"@closeChildren",childNodeTypes:"@childNodeTypes",parameters:"@parameters",description:"@description",svg:"@svg",tileSize:"@tileSize",compiled:"@compiled",listDelimiter:"@listDelimiter",tileClass:"@tileClass",primitives:"@primitives",script:"@script",cssScript:"@cssScript",monad:"@monad",const:"@const",templateString:"@templateString",
default:"@default",options:"@options",auto:"@auto"};window.DictionaryConstants=DictionaryConstants;var PrefaceNode=function(a){return TreeProgram.apply(this,arguments)||this};$jscomp.inherits(PrefaceNode,TreeProgram);var DictionaryProgram=function(a){return TreeProgram.apply(this,arguments)||this};$jscomp.inherits(DictionaryProgram,TreeProgram);DictionaryProgram.prototype.parseNodeType=function(a){return a.startsWith(DictionaryConstants.preface)?PrefaceNode:Definition};
DictionaryProgram.prototype.getTargetExtension=function(){return this.getNode(DictionaryConstants.preface).findBeam(DictionaryConstants.targetExtension)};DictionaryProgram.prototype.getExtensionName=function(){return this.getNode(DictionaryConstants.preface).findBeam(DictionaryConstants.fileExtension)};DictionaryProgram.prototype.getTopNodeTypes=function(){var a=this._getDefinitions();a.sort(Util.sortByAccessor(function(a){return a.getFrequency()}));a.reverse();return a.map(function(a){return a.getBase()})};
DictionaryProgram.prototype.getRunTimeNodeTypes=function(){this._getDefinitionMap();return this._runTimeNodeTypes};DictionaryProgram.prototype.getDocs=function(){return this.toString()};DictionaryProgram.prototype._getDefinitionMap=function(){if(this._definitionMap)return this._definitionMap;var a={},b={};this.getChildrenByNodeType(Definition).forEach(function(c){var d=c.getBase();a[d]=c;b[d]=SnapNode});this._definitionMap=a;this._runTimeNodeTypes=b;return this._definitionMap};
DictionaryProgram.prototype._getDefinitions=function(){return Object.values(this._getDefinitionMap())};DictionaryProgram.prototype.getDefaultDefinition=function(){return this.getChildrenByNodeType(Definition)[0]};DictionaryProgram.prototype.isDefined=function(a){return this._getDefinitionMap()[a.toLowerCase()]};DictionaryProgram.prototype.getDefinitionByName=function(a){return this._getDefinitionMap()[a.toLowerCase()]||this.getDefaultDefinition()};DictionaryProgram.prototype.getSnapNodeNames=function(){return Object.keys(this._getDefinitionMap())};
DictionaryProgram.prototype.execute=function(a){return Util.compileProgramToJavascriptFile(a)};window.DictionaryProgram=DictionaryProgram;var MockDictionary=">tile\n @tileClass AbstractFlowTile /aientist/client/flow/AbstractFlowTile.js\n @tileSize 200 100\n title string Default title\n  @frequency .20\n  @description About this detail\n orderBy orderByExpression\n  @frequency .5\n>subtile >tile\n @tileSize 200 100\n limit int 100\n  @frequency .10\n pretty boolean true\n  @frequency .20\n range prob .5\n  @frequency .20\n badHtml alphanumeric\n constOverwrite title Can't touch this\n  @frequency .20\n  @const\n badText title\n birthday column\n  @auto isTemporal=true\n column column\n  @auto\n value column\n  @auto isString=false\n size enum\n  @options optionA optionB\n region enum region\n  @options\n   country Country\n   continent Continent\n url url\n  @templateString\n message string\n  @monad\n caption string\n  @description Some caption.\n>subsubtile >subtile\n>provider >tile\n columns columnsObject\n  @frequency .5\n>data >provider\n slang slang\n  @frequency .9\n  @description The actual data.\n format format\n  @frequency .4\n  @description CSV, TSV, JSON, etc.\n @tileClass DataTile /aientist/client/flow/providers/DataTile.js\n @tileSize 100 100\n>didyoumean >tile";
window.MockDictionary=MockDictionary;var SnapAnnex=function(a){return TreeProgram.apply(this,arguments)||this};$jscomp.inherits(SnapAnnex,TreeProgram);SnapAnnex.prototype.getDetail=function(){var a=this.getBase();return this.getSnapNodeDefinition().getDetailByName(a)};SnapAnnex.prototype.getSnapNodeDefinition=function(){return this.getParent().getDefinition()};window.SnapAnnex=SnapAnnex;var SnapNode=function(a){return TreeProgram.apply(this,arguments)||this};$jscomp.inherits(SnapNode,TreeProgram);
SnapNode.prototype.getNodeTypes=function(){return this.getProgram().getNodeTypes()};SnapNode.prototype.getDefaultNodeType=function(a){return this.getProgram().getDefaultNodeType()};SnapNode.prototype.getParameterErrorCount=function(){return 0};SnapNode.prototype.getProgram=function(){return this.getParent().getProgram()};SnapNode.prototype.getDictionary=function(){return this.getProgram().getDictionary()};SnapNode.prototype.getDefinition=function(){var a=this.getBase();return this.getDictionary().getDefinitionByName(a)};
SnapNode.prototype.isProgram=function(){return!1};SnapNode.prototype.compile=function(){return this.getDefinition().isMiddle()?this._compileMiddle():this.getIndentation()+this.getCompiledLine()};SnapNode.prototype._compileMiddle=function(){var a=this.getDefinition(),b=this.getCompiledLine(),c=this.getIndentation(),d=a.getOpenChildrenString(),a=a.getCloseChildrenString(),e=this.getChildrenByNodeType(SnapNode).map(function(a){return a.compile()}).join("\n");return""+c+b+d+"\n"+e+"\n"+c+a};
SnapNode.prototype._getParameterMap=function(a){a=void 0===a?" ":a;var b=this.getDefinition().getParameters(),c={},d=b.length-1,e=this.getWords(1);b.forEach(function(b,g){c[b]=g===d?e.slice(g).join(a):e[g]});return c};SnapNode.prototype.getCompiledLine=function(){var a=this.getDefinition(),b=a.findBeam(DictionaryConstants.listDelimiter),b=this._getParameterMap(b),a=a.findBeam(DictionaryConstants.compiled)||"";return(new TreeProgram(b)).format(a)};
SnapNode.prototype.getTagLine=function(){var a=this.getDefinition().getParameters(),b=[this.getBase()].concat(a),c=b[b.length-1],d=c.endsWith("*");return this.getWords().map(function(a,f){return(a=b[f])?a:d?c:"\ud83d\udca9"}).join(" ")};window.SnapNode=SnapNode;var UnknownSnapNode=function(a){return TreeProgram.apply(this,arguments)||this};$jscomp.inherits(UnknownSnapNode,TreeProgram);UnknownSnapNode.prototype.getTagLine=function(){return"unknownType ".repeat(this.length).trim()};
var SnapProgram=function(a){return TreeProgram.apply(this,arguments)||this};$jscomp.inherits(SnapProgram,TreeProgram);SnapProgram.prototype.getNodeTypes=function(){return this.getDictionary().getRunTimeNodeTypes()};SnapProgram.prototype.getDefaultNodeType=function(a){return UnknownSnapNode};SnapProgram.prototype.getTypeErrorCount=function(){return this.getTopDownArray().filter(function(a){return a instanceof UnknownSnapNode}).length};
SnapProgram.prototype.getErrorCount=function(){var a=this.getDictionary();return{errorCount:this.getTypeErrorCount(),name:a.getExtensionName()}};SnapProgram.prototype.isProgram=function(){return!0};SnapProgram.prototype.getProgram=function(){return this};SnapProgram.prototype.getSnapNodes=function(){return this.getTopDownArray().filter(function(a){return a instanceof SnapNode})};SnapProgram.prototype.run=function(){return Promise.resolve()};
SnapProgram.prototype.getAutocompleteWords=function(a){var b=this.getDictionary().getSnapNodeNames().join("\n")+"\n"+this.childrenToString();return Util.getUniqueWordsArray(b).filter(function(b){return b.word.includes(a)&&b.word!==a}).map(function(a){return a.word})};SnapProgram.prototype.compileFile=function(a){this.delete("#!");var b=this.getDictionary();a=a.replace("."+b.getExtensionName(),"."+b.getTargetExtension());require("fs").writeFileSync(a,this.compile(),"utf8")};
SnapProgram.prototype.getDictionary=function(){this._dictionary||(this._dictionary=new DictionaryProgram((new TreeProgram(this.getDictionaryString())).getExpanded()));return this._dictionary};SnapProgram.prototype.getProgramTagString=function(){return this.getTopDownArray().map(function(a){return a.getIndentation()+a.getTagLine()}).join("\n")};window.SnapProgram=SnapProgram;var SubDetail=function(a){return TreeProgram.apply(this,arguments)||this};$jscomp.inherits(SubDetail,TreeProgram);
SubDetail.prototype.getDefaultNodeType=function(){return SubDetail};SubDetail.prototype.getParseErrorCount=function(){return 0};SubDetail.prototype.getTagLine=function(){return"subdetail ".repeat(this.length).trim()};var AbstractDetail=function(a){return TreeProgram.apply(this,arguments)||this};$jscomp.inherits(AbstractDetail,TreeProgram);AbstractDetail.prototype.getDefaultNodeType=function(){return SubDetail};AbstractDetail.prototype.getDetailName=function(){return this.getBase()};
AbstractDetail.prototype.isMonad=function(){return this.has(DictionaryConstants.monad)};AbstractDetail.prototype.getDetailFrequency=function(){var a=this.findBeam(DictionaryConstants.frequency);return a?parseFloat(a):.01};AbstractDetail.prototype.getTagLine=function(){return("detail "+"word ".repeat(this.length?this.length-1:0)).trim()};
AbstractDetail.prototype.getOptions=function(){var a=this.getNode(DictionaryConstants.options),b={};a.length?a.getChildren().forEach(function(a){b[a.getBase()]=a.getBeam()}):a.getBeam().split(" ").forEach(function(a){b[a]=a});return b};AbstractDetail.prototype.getAuto=function(){return this.getNode(DictionaryConstants.auto)};AbstractDetail.prototype.getDetailTypeName=function(){return this.getWord(1)};AbstractDetail.prototype.isTemplateString=function(){return this.has(DictionaryConstants.templateString)};
...
ColumnRunTimeDetail.prototype._parseValue=function(a,b){var c=b.getInputBinder(),d=c.getColumnsMap(),e=this.getAuto();if(d[a])return a;if(e){if(e.getBeam())return this._getAutoColumn(b,e.getBeam());a=c.getColumnsByImportance();if(a=a.length&&a[0].getColumnName())return a}};ColumnRunTimeDetail.prototype.toFormBray=function(a,b){b=b.getInputBinder().getColumnNames();return this._getTileCommandDropdownBray(b,a)};
ColumnRunTimeDetail.prototype._getAutoColumn=function(a,b){a=a.getInputBinder();b=b.split(",");var c=b.filter(function(a){return a.includes("=")}).map(function(a){return a.split("=")}),d=function(a){return c.every(function(b){return void 0!==a[b[0]]&&a[b[0]]().toString()===b[1]})};a=a.getColumnsArray().filter(function(a){return d(a)});var e=b.find(function(a){return!a.includes("=")});b=a;e&&(b=lodash.sortBy(b,function(a){return a[e]()}).reverse());if(b.length)return b[0].getColumnName()};
window.ColumnRunTimeDetail=ColumnRunTimeDetail;var EnumDetail=function(a){return AbstractDetail.apply(this,arguments)||this};$jscomp.inherits(EnumDetail,AbstractDetail);EnumDetail.prototype._parseValue=function(a){return this.getOptions()[a]?a:void 0};EnumDetail.prototype.toFormBray=function(a){var b=Object.keys(this.getOptions());return this._getTileCommandDropdownBray(b,a)};window.EnumDetail=EnumDetail;var FormatDetail=function(a){return AbstractDetail.apply(this,arguments)||this};
$jscomp.inherits(FormatDetail,AbstractDetail);FormatDetail.prototype.toFormBray=function(a){var b=(new CardParser).getEncodingNames();return this._getTileCommandDropdownBray(b,a)};window.FormatDetail=FormatDetail;var IntDetail=function(a){return AbstractDetail.apply(this,arguments)||this};$jscomp.inherits(IntDetail,AbstractDetail);IntDetail.prototype._parseValue=function(a){return parseInt(a)};
...
ThreeDChart.prototype._treeTo3D=function(a){var b={},c=new TreeProgram(a.getProgramTagString()),d=Util.makeSemiRandomFn(),e=[];a.getTopDownArray().forEach(function(f,g){var h=f.getPoint(a);g=f.getPathVector(a);var l=c.nodeAt(g);f.getWords().forEach(function(a,c){var f=l.getWord(c);b[f]||(b[f]=d());c=h.x+c;e.push({x:c,y:-h.y,z:0,line:f+" | "+a+" | x "+c+" y "+h.y+" z 0",style:b[f]})})});return e};window.ThreeDChart=ThreeDChart;
...
DataTile.prototype.createCards=function(a){var b=this.getStruct().format,c=this.getDataSlang(),c=(new CardParser).parse(c,b);a=lodash.concat(c,a);b=this._getFormatted(a,b);return this.getCommander().updateSlangCommand(b)};DataTile.prototype.updateCards=function(a){return this.autosaveTile()};
DataTile.prototype.deleteCards=function(a){var b=this.getOutputBinder().getCards();lodash.remove(b,function(b){return a.indexOf(b)});b=this._getFormatted(b.map(function(a){return a.getCardSource()}),this.getStruct().format);return this.getCommander().updateSlangCommand(b)};window.DataTile=DataTile;var OhayoProgramCard=function(a){ObjectBackedCard.apply(this,arguments)};$jscomp.inherits(OhayoProgramCard,ObjectBackedCard);OhayoProgramCard._uniqueId=ObjectBackedCard._uniqueId;
OhayoProgramCard.prototype.destroyCard=function(){return this.getCardApp().deleteFileCommand(this.getCardValue("link"))};OhayoProgramCard.prototype.updateCard=function(){};var ProgramsTile=function(a){return AbstractProviderTile.apply(this,arguments)||this};$jscomp.inherits(ProgramsTile,AbstractProviderTile);ProgramsTile._mountedChisels=AbstractProviderTile._mountedChisels;ProgramsTile.loadCode=AbstractProviderTile.loadCode;ProgramsTile.prototype.getCardClass=function(){return OhayoProgramCard};
ProgramsTile.prototype.fetchCards=function(){return Promise.resolve(this.getApp().getCaddies().map(function(a){return a.toCaddyObject()}))};window.ProgramsTile=ProgramsTile;var QueryTile=function(a){return AbstractUrlProvider.apply(this,arguments)||this};$jscomp.inherits(QueryTile,AbstractUrlProvider);QueryTile._mountedChisels=AbstractUrlProvider._mountedChisels;QueryTile.loadCode=AbstractUrlProvider.loadCode;QueryTile.prototype.getUrl=function(){return"/sql?q="+this.getStruct().query};
QueryTile.prototype.getTileBodyBray=function(){return"@textarea\n data-onChangeCommand chisel changeDetailCommand\n name query\n class TileTextArea\n bern"+TreeProgram.nest(Format.stripHtml(this.getStruct().query))};window.QueryTile=QueryTile;var RedditTile=function(a){return AbstractUrlProvider.apply(this,arguments)||this};$jscomp.inherits(RedditTile,AbstractUrlProvider);RedditTile._mountedChisels=AbstractUrlProvider._mountedChisels;RedditTile.loadCode=AbstractUrlProvider.loadCode;
RedditTile.prototype.getUrl=function(){var a=this.getStruct();return"https://www.reddit.com/"+((a.subreddit?"/r/"+a.subreddit+"/top/.json?sort=top&t=all":"")||a.get)};RedditTile.prototype.fetchCards=function(){return AbstractUrlProvider.prototype.fetchCards.call(this).then(function(a){return a.length?a[0].data.children.map(function(a){return a.data}):[]})};window.RedditTile=RedditTile;var TextTile=function(a){return AbstractProviderTile.apply(this,arguments)||this};$jscomp.inherits(TextTile,AbstractProviderTile);
TextTile._mountedChisels=AbstractProviderTile._mountedChisels;TextTile.loadCode=AbstractProviderTile.loadCode;TextTile.prototype.fetchCards=function(){return Promise.resolve([{text:this.getStruct().slang}])};TextTile.prototype.isVisible=function(){return!0};window.TextTile=TextTile;var TopTile=function(a){return AbstractUrlProvider.apply(this,arguments)||this};$jscomp.inherits(TopTile,AbstractUrlProvider);TopTile._mountedChisels=AbstractUrlProvider._mountedChisels;TopTile.loadCode=AbstractUrlProvider.loadCode;
TopTile.prototype.getUrl=function(){this.getStruct();return"/samples/presidents.csv"};window.TopTile=TopTile;var AbstractExtendTile=function(a){return AbstractTransformerTile.apply(this,arguments)||this};$jscomp.inherits(AbstractExtendTile,AbstractTransformerTile);AbstractExtendTile._mountedChisels=AbstractTransformerTile._mountedChisels;AbstractExtendTile.loadCode=AbstractTransformerTile.loadCode;AbstractExtendTile.prototype.getTileClassColumns=function(){return this.getStructColumns().filter(function(a){return!!a.source})};
...
AbstractExtendTile.prototype.transformCards=function(){var a=this,b=this.getTileClassColumns(),c=this.getInputBinder().getColumnsMap();return this.getInputBinder().getCards().map(function(d){var e=d.getCardSourceAsObject(),f={};Object.assign(f,e);b.forEach(function(b){var d=e[b.source],g=c[b.source].getColumnTypeName();f[b.name]=a._convertValueToNumeric(d,b.type,g)});return f})};window.AbstractExtendTile=AbstractExtendTile;
...
var ExtendDate=function(a){return AbstractExtendTile.apply(this,arguments)||this};$jscomp.inherits(ExtendDate,AbstractExtendTile);ExtendDate._mountedChisels=AbstractExtendTile._mountedChisels;ExtendDate.loadCode=AbstractExtendTile.loadCode;ExtendDate.prototype.getTileClassColumns=function(){var a=this.getStruct().column;return a?["day","month","year"].map(function(b){return{source:a,name:b,type:b}}):[]};window.ExtendDate=ExtendDate;
var ExtractTile=function(a){return AbstractTransformerTile.apply(this,arguments)||this};$jscomp.inherits(ExtractTile,AbstractTransformerTile);ExtractTile._mountedChisels=AbstractTransformerTile._mountedChisels;ExtractTile.loadCode=AbstractTransformerTile.loadCode;ExtractTile.prototype.transformCards=function(){var a=this.getInputBinder().getFirstCard().getFirstCell(),b={};ExtractTile._extractTablesFromObject(b,a);a=Object.keys(b);return b[a[0]]};
ExtractTile._getColumnNamesFromObj=function(a){a=Object.keys(a);a.sort();return a};ExtractTile._extractTablesFromObject=function(a,b){var c=this;if(!(b instanceof Array)){var d=this._getColumnNamesFromObj(b).join(" ");a[d]||(a[d]=0);a[d]++}Object.keys(b).forEach(function(d){d=b[d];"object"===typeof d&&c._extractTablesFromObject(a,d)})};window.ExtractTile=ExtractTile;var FilterTile=function(a){return AbstractTransformerTile.apply(this,arguments)||this};$jscomp.inherits(FilterTile,AbstractTransformerTile);
FilterTile._mountedChisels=AbstractTransformerTile._mountedChisels;FilterTile.loadCode=AbstractTransformerTile.loadCode;FilterTile.prototype.transformCards=function(){var a=this.getStruct().filter,b=this.getInputBinder().getCards();if(!a)return b;var c=this._generateSearchFn(a);return b.filter(function(a){return c(a.cardToString())})};FilterTile.prototype.getTileClassColumns=function(){return this.getInputBinder().getColumnsArrayOfObjects()};
FilterTile.prototype.getTileBodyBray=function(){return"@textarea "+(this.getStruct().filter||"")+"\n placeholder Enter a string to filter by.\n name filter\n data-onChangeCommand chisel changeDetailCommand\n class TileTextArea"};
...
var ParseTile=function(a){return AbstractTransformerTile.apply(this,arguments)||this};$jscomp.inherits(ParseTile,AbstractTransformerTile);ParseTile._mountedChisels=AbstractTransformerTile._mountedChisels;ParseTile.loadCode=AbstractTransformerTile.loadCode;ParseTile.prototype.transformCards=function(){var a=this.getStruct(),b=this.getInputBinder().getCardSources(),c=a.format,d=a.column,e=new CardParser;return lodash.flatten(b.map(function(a){return e.parse(a[d],c)}))};window.ParseTile=ParseTile;
var ReplacerTile=function(a){return AbstractTransformerTile.apply(this,arguments)||this};$jscomp.inherits(ReplacerTile,AbstractTransformerTile);ReplacerTile._mountedChisels=AbstractTransformerTile._mountedChisels;ReplacerTile.loadCode=AbstractTransformerTile.loadCode;ReplacerTile.prototype.transformCards=function(){var a=this.getPipishInput(),b=this.getStruct(),c=(new TreeProgram(b.map.trim())).toObject(),d=a;Object.keys(c).forEach(function(a){d=d.replace(new RegExp(a,"g"),c[a])});return[{text:d}]};
window.ReplacerTile=ReplacerTile;var StatsTile=function(a){return AbstractTransformerTile.apply(this,arguments)||this};$jscomp.inherits(StatsTile,AbstractTransformerTile);StatsTile._mountedChisels=AbstractTransformerTile._mountedChisels;StatsTile.loadCode=AbstractTransformerTile.loadCode;
StatsTile.prototype.transformCards=function(){var a=this.getInputBinder(),b=a.getColumnsMap();return a.getColumnNames().map(function(a){var c=b[a];a={Column:a,Type:c.getColumnTypeName()};Object.assign(a,c.getReductions());return a})};window.StatsTile=StatsTile;var TagsTile=function(a){return AbstractTransformerTile.apply(this,arguments)||this};$jscomp.inherits(TagsTile,AbstractTransformerTile);TagsTile._mountedChisels=AbstractTransformerTile._mountedChisels;TagsTile.loadCode=AbstractTransformerTile.loadCode;
TagsTile.prototype.transformCards=function(){var a=this.getPipishInput(),b=this.getApp(),c=b.getLanguageBestGuess(a);return[{text:b.generateProgram(a,c).getProgramTagString()}]};window.TagsTile=TagsTile;var WordCount=function(a){return AbstractTransformerTile.apply(this,arguments)||this};$jscomp.inherits(WordCount,AbstractTransformerTile);WordCount._mountedChisels=AbstractTransformerTile._mountedChisels;WordCount.loadCode=AbstractTransformerTile.loadCode;WordCount.prototype.transformCards=function(){return this._getWords(this.getPipishInput())};
...
window.SVGS=SVGS;var LocalStorageCaddy=function(a){return AbstractCaddy.apply(this,arguments)||this};$jscomp.inherits(LocalStorageCaddy,AbstractCaddy);window.LocalStorageCaddy=LocalStorageCaddy;var StorageKeys={autoSave:"__autoSave",appState:"__appState",visitCount:"__visitCount",newUser:"__newUser"},_storageKeysmap={};Object.values(StorageKeys).forEach(function(a){_storageKeysmap[a]=!0});StorageKeys.isKey=function(a){return _storageKeysmap[a]};window.StorageKeys=StorageKeys;
var MashProgram=function(a){return TreeProgram.apply(this,arguments)||this};$jscomp.inherits(MashProgram,TreeProgram);MashProgram.prototype.parseNodeType=function(a){return MashCommandNode};var MashArgNode=function(a){return TreeProgram.apply(this,arguments)||this};$jscomp.inherits(MashArgNode,TreeProgram);var MashCommandNode=function(a){return MashProgram.apply(this,arguments)||this};$jscomp.inherits(MashCommandNode,MashProgram);
MashCommandNode.prototype.getNodeTypeByBase=function(a){return{"%%":MashArgNode}[a]||MashCommandNode};MashCommandNode.prototype.parseNodeType=function(a){};MashCommandNode.prototype._getArgs=function(){var a=this.getChildrenByNodeType(MashArgNode).map(function(a){return a.childrenToString()});a.length&&a.unshift(this.getWord(0));return a.length?a:this.getWords(0)};
MashCommandNode.prototype.execute=function(a){var b=this;this.getPoint();return a.app.executeCommandLine(this._getArgs()).then(function(){return MashProgram.prototype.execute.call(b,a)})};window.MashProgram=MashProgram;var AbstractModalChisel=function(a){return AbstractChisel.apply(this,arguments)||this};$jscomp.inherits(AbstractModalChisel,AbstractChisel);AbstractModalChisel._mountedChisels=AbstractChisel._mountedChisels;
...
AbstractWillowProgram.prototype.confirmThen=function(a){return Promise.resolve(!0)};AbstractWillowProgram.prototype.promptThen=function(a,b){return Promise.resolve(b)};AbstractWillowProgram.prototype.setLoadedDroppedFileHandler=function(a,b){};AbstractWillowProgram.prototype.getWindowSize=function(){return{width:1111,height:1111}};AbstractWillowProgram.prototype.getDocumentSize=function(){return this.getWindowSize()};
...
AbstractWillowShadow.prototype.getShadowValue=function(){return""};AbstractWillowShadow.prototype.removeShadow=function(){return this};AbstractWillowShadow.prototype.makeResizable=function(){return this};AbstractWillowShadow.prototype.makeDraggable=function(){return this};AbstractWillowShadow.prototype.makeSelectable=function(){return this};AbstractWillowShadow.prototype.isShadowChecked=function(){return!1};AbstractWillowShadow.prototype.getShadowHtml=function(){return""};
AbstractWillowShadow.prototype.getShadowOffset=function(){return{left:111,top:111}};AbstractWillowShadow.prototype.getShadowWidth=function(){return 111};AbstractWillowShadow.prototype.getShadowHeight=function(){return 111};AbstractWillowShadow.prototype.isShadowResizable=function(){return!1};AbstractWillowShadow.prototype.toggleShadow=function(){};AbstractWillowShadow.prototype.addClassToShadow=function(){};AbstractWillowShadow.prototype.removeClassFromShadow=function(){};
AbstractWillowShadow.prototype.setShadowHtml=function(a){return this};AbstractWillowShadow.prototype.onShadowEvent=function(){return this};AbstractWillowShadow.prototype.offShadowEvent=function(){return this};AbstractWillowShadow.prototype.triggerShadowEvent=function(a){return this};AbstractWillowShadow.prototype.getShadowPosition=function(){return{left:111,top:111}};AbstractWillowShadow.prototype.getShadowOuterHeight=function(){return 11};AbstractWillowShadow.prototype.getShadowOuterWidth=function(){return 11};
AbstractWillowShadow.prototype.getShadowCss=function(){return""};AbstractWillowShadow.prototype.setShadowCss=function(){return this};AbstractWillowShadow.prototype.insertHtmlNode=function(){};AbstractWillowShadow.prototype.getShadowElement=function(){};window.AbstractWillowShadow=AbstractWillowShadow;window.lodash||(window.lodash=_);window.console||(window.console={log:function(){},time:function(){},error:function(){},debug:function(){}});Object.values||(Object.values=function(a){return Object.keys(a).map(function(b){return a[b]})});
