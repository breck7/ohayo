var $jscomp$templatelit$27=["Delete row"];$jscomp$templatelit$27.raw=["Delete row"];var $jscomp$templatelit$26=["Ok"];$jscomp$templatelit$26.raw=["Ok"];var $jscomp$templatelit$25=["Cancel"];$jscomp$templatelit$25.raw=["Cancel"];var $jscomp$templatelit$24=["Adding..."];$jscomp$templatelit$24.raw=["Adding..."];var $jscomp$templatelit$23=["Keyboard Shortcuts"];$jscomp$templatelit$23.raw=["Keyboard Shortcuts"];var $jscomp$templatelit$22=["ohayo"];$jscomp$templatelit$22.raw=["ohayo"];
...
var $jscomp$templatelit$9=["dragOverHelp"];$jscomp$templatelit$9.raw=["dragOverHelp"];var $jscomp$templatelit$8=["dragOverHelp"];$jscomp$templatelit$8.raw=["dragOverHelp"];var $jscomp$templatelit$7=["Drop to create a new program. Hold shift key to insert rows into current program."];$jscomp$templatelit$7.raw=["Drop to create a new program. Hold shift key to insert rows into current program."];var $jscomp$templatelit$6=["Are you sure you want to delete ","?"];
...
AC.prototype.render=function(a,b){var c=this.isMounted();c?this._update():this._mount(a,b);this.isMounted()&&this._renderChildren();c?this.componentDidUpdate():this.componentDidMount();return this};window.AC=AC;var AbstractRow=function(a,b){this._puid=this._getUniqueId();this._sourceObject=a?a:{};this._plane=b};AbstractRow.prototype._getUniqueId=function(){void 0===AbstractRow._uniqueId&&(AbstractRow._uniqueId=0);AbstractRow._uniqueId++;return AbstractRow._uniqueId};
AbstractRow.prototype.destroy=function(){};AbstractRow.prototype._getRowPlane=function(){return this._plane};AbstractRow.prototype.getRowApp=function(){return this.getRowBlock().getApp()};AbstractRow.prototype.getRowBlock=function(){return this._getRowPlane().getPlaneBlock()};AbstractRow.prototype.destroyRowCommand=function(){return Promise.resolve()};AbstractRow.prototype.getRowSourceAsObject=function(){return this.getRowSource()};
AbstractRow.prototype.getAsArray=function(a){var b=this.getRowNumeric();return a.map(function(a){return b[a]})};AbstractRow.prototype.getRowSource=function(){return this._sourceObject};AbstractRow.prototype._parseNumeric=function(){var a=this,b=this._getRowPlane().getColumnsMap(),c={};Object.keys(b).forEach(function(d){var e=b[d],f=a.getRowValue(d);void 0===f&&(f="");c[d]=""===f?"":e.getType().fromStringToNumeric(f)});return c};
AbstractRow.prototype.getRowNumeric=function(){this._numeric||(this._numeric=this._parseNumeric());return this._numeric};AbstractRow.prototype.getRowKeys=function(){return Object.keys(this.getRowSource())};AbstractRow.prototype.getRowValue=function(a){a=this.getRowSource()[a];return null===a?"":a};AbstractRow.prototype.setRowValue=function(a,b){this.getRowSource()[a]=b;return this};
AbstractRow.prototype.reloadFromStr=function(a){var b=this.getRowSource();Object.keys(b).forEach(function(a){return delete b[a]});var c=JSON.parse(a);Object.keys(c).forEach(function(a){return b[a]=c[a]})};AbstractRow.prototype.deleteFromRow=function(a){delete this.getRowSource()[a];return this};AbstractRow.prototype.getPuid=function(){return this._puid};AbstractRow.prototype.renameRow=function(a,b){var c=this.getRowSource();c[b]=c[a];delete c[a];return this};
AbstractRow.prototype.rowToString=function(){return JSON.stringify(this.getRowSource(),null,2)};window.AbstractRow=AbstractRow;var BrayContentNode=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(BrayContentNode,TreeNotation);BrayContentNode.prototype._toHtml=function(){return this.getTailWithChildren()};var BrayAttributeNode=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(BrayAttributeNode,TreeNotation);
BrayAttributeNode.prototype._toHtml=function(){return""};BrayAttributeNode.prototype.getAttribute=function(){return" "+this.getHead()+'="'+this.getTail()+'"'};var Bray=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(Bray,TreeNotation);Bray.prototype.getTag=function(){return this.getWord(1)};Bray.prototype.parseNodeType=function(a){return a.startsWith("@")?Bray:a.startsWith("content")?BrayContentNode:BrayAttributeNode};Bray.prototype.getId=function(){return this.getWord(2)};
Bray.prototype.getClasses=function(){return this.getWords(3).join(" ")};Bray.prototype.getChildInstances=function(a){return this.getChildren().filter(function(b){return b instanceof a})};
...
AbstractBrowserApplication.prototype.getHtml=function(){return""};AbstractBrowserApplication.prototype.renderApp=function(){this.render(this.getBodyStump());return this};AbstractBrowserApplication.prototype.downloadJavascriptCommand=function(){var a=this.getMountedProgram(),b=a.toJavascript();return this.downloadFile(b,a.getFileName()+".js","text/javascript")};
AbstractBrowserApplication.prototype.downloadFile=function(a,b,c){var d=this.getFakeDom(),e=d.createElement("a");e.setAttribute("href","data:"+c+","+d.encodeURIComponent(a));e.setAttribute("download",b);e.click()};AbstractBrowserApplication.prototype.appendBlockCommand=function(a,b){this._appendBlocks(a,b);return this.getMountedProgram().autosaveAndRender()};AbstractBrowserApplication.prototype._getAvailablePermalink=function(a){var b=this;return Util.getAvailablePermalink(a,function(a){return b.doesFileExistSync(a)})};
...
AbstractBrowserApplication.prototype.openUrlPromptCommand=function(){var a=this;this.prompt(Say($jscomp$templatelit$2),"").then(function(b){b&&a.openUrlInNewSpaceAndFocus(b)})};AbstractBrowserApplication.prototype.openManyCommand=function(){var a=this;this.prompt(Say($jscomp$templatelit$3),"").then(function(b){if(b){var c=new RegExp(b,"i");a.getLinks().forEach(function(b){b.link.match(c)&&a.openUrlInNewSpace(b.link)})}})};
...
ListChart.prototype.getBlockHtmlBody=function(){var a=this.getStruct(),b=a.link,c=a.label;return"<ol>"+this.getRowsWithStructQuery().map(function(a){var d=Strip($jscomp$templatelit$14,a.getRowValue(c));return"<li><a "+(b?'href="'+Strip($jscomp$templatelit$15,a.getRowValue(b))+'"':"")+">"+d+"</a></li>"}).join("")+"</ol>"};window.ListChart=ListChart;var MarkdownChart=function(a){return AbstractHeaderlessChartBlock.apply(this,arguments)||this};$jscomp.inherits(MarkdownChart,AbstractHeaderlessChartBlock);
...
TableBlock.prototype._getTrHtml=function(a,b){var c="";this.getRowsWithStructQuery().forEach(function(b,e){var d=b.getPuid();b.getRowNumeric();var g=a.map(function(a){var c=a.getColumnName(),c=b.getRowValue(c),d="";void 0!==c&&(c=Format.stripHtml(c),d=a.isLink()?'<a href="'+c+'">'+c+"</a>":c);return"<td>"+d+"</td>"}).join("");c+='<tr data-contextmenucommand="ac openRowEditorByPuidCommand" value="'+d+'"><td>'+(e+1)+"</td>"+g+"</tr>\n"});return c};TableBlock.prototype.getContextMenuHtml=function(){return'<a data-command="app deleteAllRowsInTargetBlockCommand">Delete all rows</a>'};
...
ProgramsBlock.prototype.fetchRows=function(){return this.getApp().fetchLinks()};window.ProgramsBlock=ProgramsBlock;var QueryBlock=function(a){return AbstractUrlProvider.apply(this,arguments)||this};$jscomp.inherits(QueryBlock,AbstractUrlProvider);QueryBlock._mountedComponents=AbstractUrlProvider._mountedComponents;QueryBlock.loadCode=AbstractUrlProvider.loadCode;QueryBlock.prototype.getUrl=function(){return"/sql?q="+this.getStruct().query};
...
FireProgram.prototype.compilesTo=function(){return"js"};FireProgram.prototype.buildProgram=function(){return this.getChildrenByNodeType(AbstractBlock).map(function(a){return a.toJavascript()}).join("\n")};FireProgram.prototype.getContextMenuCommands=function(){return'<a tabindex="-1" data-command="app downloadJavascriptCommand">Export Javascript</a>'};
FireProgram.prototype.getTopNodeTypes=function(){var a=(new TreeNotation(FireBlocks)).getChildren().slice(0);a.sort(Util.sortByAccessor(function(a){return a.findTail("inserts")||1}));a.reverse();return a.slice(0,20).map(function(a){return a.getHead()})};FireProgram.getParser=function(a){this._parser||(this._parser=new ParserETN(FireBlocks,"fire",a));return this._parser};window.FireProgram=FireProgram;var FlowProgram=function(a){return AbstractProgram.apply(this,arguments)||this};
$jscomp.inherits(FlowProgram,AbstractProgram);FlowProgram._mountedComponents=AbstractProgram._mountedComponents;FlowProgram.prototype.getParser=function(){return FlowProgram.getParser(this.getApp())};FlowProgram.prototype.getContextMenuCommands=function(){return""};FlowProgram.prototype.getTopNodeTypes=function(){return">text >data >table >presidents >url >filter >group >kpi >reddit >h2".split(" ")};FlowProgram.prototype.compilesTo=function(){return"html"};
FlowProgram.prototype.buildProgram=function(){return this.getDescendantBlocks().filter(function(a){return!(a instanceof ParserETN.BlockPropertyNode)}).map(function(a){return a.getBlockHtmlBody()}).join("\n")};FlowProgram.prototype.getCatchAllBlockClass=function(a,b,c,d){a=a.getDidYouMeanBlock().getJSClass(d);return c.startsWith(">")?a:ParserETN.BlockPropertyNode};FlowProgram.clearParser=function(){delete this._parser};
