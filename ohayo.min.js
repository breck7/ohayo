...
$jscomp.polyfill("String.prototype.endsWith",function(a){return a?a:function(a,c){var b=$jscomp.checkStringArgs(this,a,"endsWith");a+="";void 0===c&&(c=b.length);c=Math.max(0,Math.min(c|0,b.length));for(var e=a.length;0<e&&0<c;)if(b[--c]!=a[--e])return!1;return 0>=e}},"es6","es3");var AbstractCard=function(a,b){a=void 0===a?{}:a;this._puid=this._getUniqueId();this._sourceObject=a;this._binder=b};
...
window.FireGrammar=FireGrammar;var FireProgram=function(a){return TreeProgram.apply(this,arguments)||this};$jscomp.inherits(FireProgram,TreeProgram);FireProgram.prototype.getGrammarString=function(){return FireGrammar};
...
whiteColors.bodyBackground="white";whiteColors.foregroundColor="black";whiteColors.tileBackgroundColor="transparent";Themes.white=new Theme(whiteColors);Themes.glass=new Theme(glassColors);glassColors.tileBackgroundColor="transparent";Themes.clearGlass=new Theme(glassColors);window.Themes=Themes;var AbstractTileSettingNode=function(a){return TreeProgram.TerminalNode.apply(this,arguments)||this};$jscomp.inherits(AbstractTileSettingNode,TreeProgram.TerminalNode);
...
$jscomp.inherits(TileErrorNode,TreeProgram);TileErrorNode.prototype.getErrors=function(){return["Unknown type"]};window.TileErrorNode=TileErrorNode;var TileGrammar=function(){};TileGrammar._initTileClassCache=function(a){if(!a._cache_tileClass){var b=(a.findBeam(TileConstants.ohayoTileClass)||"AbstractTileChisel /aientist/client/tiles/AbstractTileChisel.js").split(" "),c=b[0],d=b[1],e="undefined"!==typeof require;b=e?process:window;e&&!b[c]&&(d=require(d),b[d.name]=d);a._cache_tileClass=b[c]}};
TileGrammar.getDefinitionTileClass=function(a){this._initTileClassCache(a);return a._cache_tileClass};window.TileGrammar=TileGrammar;var TileGrammarStressTest="mock\n @catchAllKeyword error\n @keywords\n  >tile\nerror\n @parseClass ErrorNode\nsetting\n @ohayoTileClass TileSettingTerminalNode /aientist/client/tiles/TileSettingTerminalNode.js\nntsetting\n @ohayoTileClass TileSettingNonTerminalNode /aientist/client/tiles/TileSettingNonTerminalNode.js\ntitle setting\n @frequency 0.2\n @parameters any*\n @description About this setting\norderBy setting\n @parameters any*\nlimit setting\n @parameters int\npretty setting\n @parameters boolean\nrange setting\n @parameters any\nflatIndent\n @compiledIndentCharacter \ndashIndent\n @compiledIndentCharacter -\ncolumn setting\n @parameters any\nbirthday column\nvalue column\nsize setting\n @parameters any\nmessage setting\n @parameters any\ncaption setting\n @description Some caption.\ncolumns setting\nslang ntsetting\n @frequency .9\n @description The actual data.\nformat setting\n @frequency .4\n @description CSV, TSV, JSON, etc.\n>tile\n @ohayoTileClass AbstractFlowTile /aientist/client/flow/AbstractFlowTile.js\n @ohayoTileSize 200 100\n @keywords\n  title\n  limit\n  >tile\n>subtile >tile\n @ohayoTileSize 200 100\n @keywords\n  limit\n  pretty\n  range\n  birthday\n  value\n  message\n  size\n  region\n  message\n  caption\n @defaults\n  limit 100\n  pretty true\n @constants\n  constOverwrite title Can't touch this\n  improvs\n   birthday isTemporal=true\n   column\n   value isString=false\n>subsubtile >subtile\n>provider >tile\n @keywords\n  columns\n>data >provider\n @keywords\n  slang\n  format\n @ohayoTileClass DataTile /aientist/client/flow/providers/DataTile.js\n @ohayoTileSize 100 100\n>didyoumean >tile";
window.TileGrammarStressTest=TileGrammarStressTest;var TileSettingNonTerminalNode=function(a){return AbstractTileSettingNode.apply(this,arguments)||this};$jscomp.inherits(TileSettingNonTerminalNode,AbstractTileSettingNode);TileSettingNonTerminalNode.loadCode=AbstractTileSettingNode.loadCode;TileSettingNonTerminalNode.prototype.getSettingValue=function(){return this.childrenToString()};TileSettingNonTerminalNode.prototype.getCatchAllNodeClass=function(){return TreeProgram};
...
TileSettingTerminalNode.prototype.getSettingValue=function(){return this.getBeam()};TileSettingTerminalNode.prototype.toFormBray=function(a){return"@input\n data-onChangeCommand tile changeTileSettingAndRenderCommand\n name "+this.getKeyword()+"\n value "+a};window.TileSettingTerminalNode=TileSettingTerminalNode;var TileWallNode=function(a){return TreeProgram.apply(this,arguments)||this};$jscomp.inherits(TileWallNode,TreeProgram);TileWallNode.prototype.getWordTypeLine=function(){return"wall ".repeat(this.getWords().length).trim()};
...
var TurtleFunctionCallNode=function(a){return TreeProgram.TerminalNode.apply(this,arguments)||this};$jscomp.inherits(TurtleFunctionCallNode,TreeProgram.TerminalNode);TurtleFunctionCallNode.prototype.getCompiledLine=function(){return this.getLine()};window.TurtleFunctionCallNode=TurtleFunctionCallNode;var TurtleGrammar="turtle\n @targetExtension logo\n @keywords\n  term\n  nt\n @catchAllKeyword functionCall\nfunctionCall\n @parseClass /aientist/client/turtle/TurtleFunctionCallNode.js\nterm\n @ohayoTileSize 100 100\n @ohayoTileClass BasicTile /aientist/client/tiles/BasicTile.js\nnt\n @ohayoTileSize 100 100\n @ohayoTileClass BasicTile /aientist/client/tiles/BasicTile.js\n @keywords\n  term\n  nt\nto nt\n @parameters identifier\n @compiled to {identifier}\n @closeChildren end\nrepeat nt\n @parameters int\n @compiled repeat {int}\n @openChildren  [\n @closeChildren ]\nclear term\n @compiled clearscreen\nfd term\n @parameters int\n @compiled fd {int}\nrt term\n @parameters int\n @compiled rt {int}";
window.TurtleGrammar=TurtleGrammar;var TurtleProgram=function(a){return TreeProgram.apply(this,arguments)||this};$jscomp.inherits(TurtleProgram,TreeProgram);TurtleProgram.prototype.getGrammarString=function(){return TurtleGrammar};window.TurtleProgram=TurtleProgram;
...
window.LocalStorageFolder=LocalStorageFolder;var RustyProgram=function(a){return TreeProgram.apply(this,arguments)||this};$jscomp.inherits(RustyProgram,TreeProgram);RustyProgram.prototype.getGrammarString=function(){return RustyGrammar};RustyProgram.prototype.executeCommand=function(a){var b=require("child_process").exec;return new Promise(function(c,d){b(a,{},function(a,b,g){if(a)return d(a);c(b)})})};
