...
TileProcess.prototype.getFirstSelectedTile=function(){return this.getSelectedTiles()[0]};TileProcess.prototype.selectNext=function(){for(var a=this.getFirstSelectedTile().getNext();!a.getBase().startsWith(">");)a=this.getFirstSelectedTile().getNext();this.clearSelection();a.selectTile();return Promise.resolve()};TileProcess.prototype.selectionToString=function(){return this.getSelectedTiles().map(function(a){return a.toString()}).join("\n")};
...
AppCommander.prototype.toggleGutterCommand=function(){var a=this.getTarget();a.makeAllDirty();var b=a.getFocusedPanel(),c=b.getNode("gutter");c?c.unmountAndDestroy():(b=b.touchNode("gutter"),b.insert("terminal"),b.insert("console"));a.renderApp();return Promise.resolve()};AppCommander.prototype.selectNextCommand=function(){return this.getTarget().getMountedProcess().selectNext()};AppCommander.prototype.selectPreviousCommand=function(){return this.getTarget().getMountedProcess().selectPrevious()};
AppCommander.prototype.createNewFlowVisProgramCommand=function(){var a=this.getTarget(),b=a.getMountedTab(),c=a.getMountedProcess().childrenToString();return a._createAndOpen(FlowCodeEditorTemplate(c,"fire"),b.getFileName()+".editor.flow").then(function(a){return a.logMessageBray("@div Created '"+a.getUrl()+"'")})};
...
ChiselCommander.prototype.clearCommand=function(){delete this.getTarget()._messageBuffer;return Promise.resolve()};ChiselCommander.prototype.unmountAndDestroyCommand=function(){this.getTarget().unmountAndDestroy();return Promise.resolve()};window.ChiselCommander=ChiselCommander;var TerminalCommander=function(a){AbstractCommander.apply(this,arguments)};$jscomp.inherits(TerminalCommander,AbstractCommander);TerminalCommander.prototype.saveChangesCommand=function(){var a=this.getTarget();if(a.hasChanges())return a._getTab().autosaveAndReloadWith(a._getCode())};
