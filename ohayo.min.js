...
Bray.prototype._toHtml=function(a){var b=this.getTag(),c=this.getChildren().map(function(b){return b._toHtml(a+1)}).join(""),d=this.getChildInstances(BrayAttributeNode).map(function(a){return a.getAttribute()}).join(""),e=this.getId(),f=this.getClasses(),e=e?' id="'+e+'"':"",f=f?' classes="'+f+'"':"";return" ".repeat(a)+"<"+b+e+f+d+">"+c+"</"+b+">\n"};window.Bray=Bray;var Column=function(a,b){this._obj=a;this._plane=b};Column.prototype.getColumnName=function(){return this._obj.name};
...
e&&(a.date=.98);var b=0,d=null,f;for(f in a)a[f]>b&&(b=a[f],d=f);"number"===d&&"string"===typeof c&&c.match(",")&&(d="numberString");"date"===d&&"string"===typeof c&&ColumnTypes.day.is(c)&&(d="day");return ColumnTypes[d]};window.Column=Column;var ColumnSpecimen=function(){};window.ColumnSpecimen=ColumnSpecimen;moment.createFromInputFallback=function(a){a._d=new Date(a._i)};var AbstractColType=function(){};AbstractColType.prototype.toDisplayString=function(a){return a};
AbstractColType.prototype.fromStringToNumeric=function(a){return a};AbstractColType.prototype.getDefaultFormat=function(){};AbstractColType.prototype.isTemporal=function(){return!1};AbstractColType.prototype.isString=function(){return!1};AbstractColType.prototype.isInt=function(){return!1};AbstractColType.prototype._setName=function(a){this._name=a;return this};AbstractColType.prototype.getColumnTypeName=function(){return this._name};AbstractColType.prototype.isNumericMS=function(){return!1};
AbstractColType.prototype.isInvalidValue=function(a){return void 0===a||""===a?!0:!1};var AbstractNumeric=function(a){AbstractColType.apply(this,arguments)};$jscomp.inherits(AbstractNumeric,AbstractColType);AbstractNumeric.prototype.fromStringToNumeric=function(a){return parseFloat(a)};AbstractNumeric.prototype.isInvalidValue=function(a){return AbstractColType.prototype.isInvalidValue.call(this,a)||isNaN(a)};var AbstractTemporal=function(a){AbstractColType.apply(this,arguments)};
$jscomp.inherits(AbstractTemporal,AbstractColType);AbstractTemporal.prototype.fromStringToMoment=function(a){return moment(parseInt(a))};AbstractTemporal.prototype.isTemporal=function(){return!0};var AbstractCurrency=function(a){AbstractColType.apply(this,arguments)};$jscomp.inherits(AbstractCurrency,AbstractColType);var DateCol=function(a){AbstractTemporal.apply(this,arguments)};$jscomp.inherits(DateCol,AbstractTemporal);
...
var CompileTimeError=function(a){var b=Error.apply(this,arguments);this.message=b.message;"stack"in b&&(this.stack=b.stack)};$jscomp.inherits(CompileTimeError,Error);var AbstractProgramError=function(a){var b=Error.apply(this,arguments);this.message=b.message;"stack"in b&&(this.stack=b.stack)};$jscomp.inherits(AbstractProgramError,Error);var AbstractTabError=function(a){var b=Error.apply(this,arguments);this.message=b.message;"stack"in b&&(this.stack=b.stack)};$jscomp.inherits(AbstractTabError,Error);
var ProgramFetchError=function(a){AbstractProgramError.apply(this,arguments)};$jscomp.inherits(ProgramFetchError,AbstractProgramError);var TabSaveError=function(a){AbstractTabError.apply(this,arguments)};$jscomp.inherits(TabSaveError,AbstractTabError);var AbstractChildBlockError=function(a){var b=Error.apply(this,arguments);this.message=b.message;"stack"in b&&(this.stack=b.stack)};$jscomp.inherits(AbstractChildBlockError,Error);
var BlockFetchDataError=function(a){AbstractChildBlockError.apply(this,arguments)};$jscomp.inherits(BlockFetchDataError,AbstractChildBlockError);var AbstractRowError=function(a){var b=Error.apply(this,arguments);this.message=b.message;"stack"in b&&(this.stack=b.stack)};$jscomp.inherits(AbstractRowError,Error);var ProgramLoadError=function(a){var b=Error.apply(this,arguments);this.message=b.message;"stack"in b&&(this.stack=b.stack)};$jscomp.inherits(ProgramLoadError,Error);
...
b){return a.length?a.toLowerCase().replace(b,"").replace(/ /g,"-"):""},permalink:function(a){return Format._permalink(a,/[^a-z0-9- _]/gi)},permalinkAllowPeriods:function(a){return Format._permalink(a,/[^a-z0-9- _\.]/gi)},roundTo:function(a,b){return parseFloat(a.toFixed(b))},roundToWhole:function(a){return Format.roundTo(a,0)},roundToTenths:function(a){return Format.roundTo(a,1)},roundToHundredths:function(a){return Format.roundTo(a,2)},roundToThousandths:function(a){return Format.roundTo(a,3)},roundToTenThousandths:function(a){return Format.roundTo(a,
4)},linkify:function(a){a=a.replace(/(\b(https?|ftp):\/\/[-A-Z0-9+&@#\/%?=~_|!:,.;]*[-A-Z0-9+&@#\/%=~_|])/gim,'<a href="$1" target="_blank">$1</a>');a=a.replace(/(^|[^\/])(www\.[\S]+(\b|$))/gim,'$1<a href="http://$2" target="_blank">$2</a>');return a=a.replace(/(([a-zA-Z0-9\-\_\.])+@[a-zA-Z\_]+?(\.[a-zA-Z]{2,6})+)/gim,'<a href="mailto:$1">$1</a>')}};window.Format=Format;moment.createFromInputFallback=function(a){a._d=new Date(a._i)};
...
ParserBlock.prototype.getJSClass=function(a){if(this._class)return this._class;a=a.getFakeDom().getWindowNamespace();var b=this._getExtended().findTail("require").split(" "),c=b[0],b=b[1];"undefined"!==typeof require&&(b=require(b),a[b.name]=b);this._class=a[c];if(!this._class)debugger;return this._class};var ParserETN=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(ParserETN,TreeNotation);ParserETN.prototype.parseNodeType=function(a){return ParserBlock};
ParserETN.prototype.getContextMenuCommands=function(){return""};ParserETN.prototype.dynamicGetJsClass=function(a,b,c){var d=b.split(" ")[0];return(d=(d=this.getParserBlockMap()[d])&&d.getJSClass(c))?d:this.getCatchAllBlockClass(a,b,c)};ParserETN.prototype.getCatchAllBlockClass=function(a,b,c){return TreeNotation};ParserETN.prototype.getDocs=function(){return this.toString()};
...
ParserETN.prototype.buildProgram=function(a){};ParserETN.prototype.loadBlockCode=function(a){this._loadedBlocks||(this._loadedBlocks={});this._loadedBlocks[a]||(this._loadedBlocks[a]=this.getParserBlockByName(a).executeLoadBlockOrGetLoadingPromise(this.getParent()));return this._loadedBlocks[a]};var DumbFlowNode=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(DumbFlowNode,TreeNotation);var FlowParserETN=function(a){return ParserETN.apply(this,arguments)||this};
$jscomp.inherits(FlowParserETN,ParserETN);FlowParserETN.prototype.getCatchAllBlockClass=function(a,b,c){a=this.getDidYouMeanBlock().getJSClass(c);return b.startsWith(">")?a:b.trim().length?TreeNotation:DumbFlowNode};FlowParserETN.prototype.getTopNodeTypes=function(){return">text >data >table >presidents >url >filter >group >kpi >reddit >h2".split(" ")};var DumbFireNode=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(DumbFireNode,TreeNotation);
DumbFireNode.prototype.toJavascript=function(){return""};var FireParserETN=function(a){return ParserETN.apply(this,arguments)||this};$jscomp.inherits(FireParserETN,ParserETN);FireParserETN.prototype.getCatchAllBlockClass=function(a,b,c){return b.startsWith("pin")||b.startsWith("etn")||b.startsWith("layout")||!b.trim().length?DumbFireNode:this.getDidYouMeanBlock().getJSClass(c)};FireParserETN.prototype.buildProgram=function(a){return a.getChildren().map(function(a){return a.toJavascript()}).join("\n")};
FireParserETN.prototype.getContextMenuCommands=function(){return'<a tabindex="-1" data-command="app downloadJavascriptCommand">Export Javascript</a>'};FireParserETN.prototype.getTopNodeTypes=function(){var a=this.getChildren().slice(0);a.sort(Util.sortByAccessor(function(a){return a.getInsertCount()}));a.reverse();return a.slice(0,20).map(function(a){return a.getHead()})};ParserETN.FireParser=FireParserETN;ParserETN.FlowParser=FlowParserETN;window.ParserETN=ParserETN;
var PivotTable=function(a,b,c){this._rows=a;var d={};b.forEach(function(a){return d[a.name]=a});c.forEach(function(a){return d[a.name]=a});this._columns=d};PivotTable.prototype._getGroups=function(a,b){var c=new Map;a.forEach(function(a){var d=b.map(function(b){return a[b].toString().replace(/ /g,"")}).join(" ");d&&(c.has(d)||c.set(d,[]),c.get(d).push(a))});return c};
...
var Util={_getColumnNamesFromObj:function(a){a=Object.keys(a);a.sort();return a},getFileExtension:function(a){return(a=(void 0===a?"":a).match(/\.([^\.]+)$/))&&a[1]||""},removeFileExtension:function(a){return(void 0===a?"":a).replace(/\.[^\.]$/,"")},extractTables:function(a,b){if(!(b instanceof Array)){var c=Util._getColumnNamesFromObj(b).join(" ");a[c]||(a[c]=0);a[c]++}Object.keys(b).forEach(function(c){c=b[c];"object"===typeof c&&Util.extractTables(a,c)})},parseCookie:function(a){var b={};(void 0===
a?"":a).split(/[;,] */).forEach(function(a){var c=a.indexOf("="),e=a.substr(0,c).trim();a=a.substr(++c,a.length).trim();'"'===a[0]&&(a=a.slice(1,-1));if(void 0===b[e])try{b[e]=decodeURIComponent(a)}catch(f){b[e]=a}});return b},pLimit:function(a){var b=[],c=0;return function(d){return new Promise(function(e,f){var g=function(){c++;d().then(function(a){e(a);c--;b.length&&b.shift()()},function(a){f(a);c--;b.length&&b.shift()()})};c<a?g():b.push(g)})}},moveArray:function(a,b,c){return a.splice(c,0,a.splice(b,
1)[0])},dynamicSort:function(a){var b=1;"-"===a[0]&&(b=-1,a=a.substr(1));return function(c,d){c=c[a];d=d[a];var e=c<d?-1:c>d?1:0;void 0===c&&void 0!==d?e=-1:void 0===d&&void 0!==c&&(e=1);return e*b}},sortByAccessor:function(a){return function(b,c){b=a(b);c=a(c);var d=b<c?-1:b>c?1:0;void 0===b&&void 0!==c?d=-1:void 0===c&&void 0!==b&&(d=1);return d}},isExternalLink:function(a,b){if(a&&"/"===a.substr(0,1)||!a.includes(":"))return!1;a=new miuri(a);return a.hostname()&&b!==a.hostname()},toggle:function(a,
b){a=b.indexOf(a);return-1===a||a+1===b.length?b[0]:b[a+1]},getDiskPath:function(a){return a?a.replace("file://",""):""},sortByFast:function(a,b){var c=[],d=b.split(/ /g).map(function(a,b){return"-"===a.substr(0,1)?(c[b]=!0,a.substr(1)):a}),e=function(a,b,h){var f=d[h];if(!f)return 0;var g=a.getRowNumeric()[f],f=b.getRowNumeric()[f];return g===f?e(a,b,h+1):g>f?c[h]?-1:1:c[h]?1:-1};a.sort(function(a,b){return e(a,b,0)})},joinArraysOn:function(a,b,c){var d={},e=0;c||(c=b.map(function(a){return Object.keys(a[0])}));
b.forEach(function(b,g){var f=c[g];b.forEach(function(b){var c=a?b[a]:e++;d[c]||(d[c]={});var g=d[c];f.forEach(function(a){return g[a]=b[a]})})});return Object.values(d)}};window.Util=Util;var Version="7.0.2";"undefined"!==typeof exports&&(module.exports=Version);var UnitTestSection=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(UnitTestSection,TreeNotation);var Wall=function(a){return TreeNotation.apply(this,arguments)||this};$jscomp.inherits(Wall,TreeNotation);
Wall.prototype.parseNodeType=function(a){return UnitTestSection};Wall.prototype.getSectionsToRun=function(){var a=this.getChildren().filter(function(a){return a.getLine().startsWith("+")});return a.length?a:this.getChildren().filter(function(a){return!a.getLine().startsWith("!")})};Wall.prototype.execute=function(a){this.getSectionsToRun().map(function(b){Tape(b.getHead(),function(c){var d=a(b);c.equal(d.actual,d.expected,d.message);c.end()})})};window.Wall=Wall;
var AbstractApp=function(a){return AC.apply(this,arguments)||this};$jscomp.inherits(AbstractApp,AC);AbstractApp._mountedComponents=AC._mountedComponents;AbstractApp.prototype.getSessionId=function(){this._sessionId||(this._sessionId=Format.randomString(16));return this._sessionId};AbstractApp.prototype.normalizePath=function(a){return a};AbstractApp.prototype.getTargetNode=function(){return this._targetNode};AbstractApp.prototype.setTargetNode=function(a){this._targetNode=a;return this};
AbstractApp.prototype.getFakeDom=function(){this._fakeDom||(this._fakeDom="undefined"===typeof $?new FakeDom("http://localhost:8000/"):new JQueryDom(""));return this._fakeDom};AbstractApp.prototype.appendScript=function(){return Promise.resolve()};AbstractApp.prototype.getParsers=function(){this._parsers||(this._parsers=this._makeParsers());return this._parsers};AbstractApp.prototype.getParsersArray=function(){return Object.values(this.getParsers())};
AbstractApp.prototype.getFlowBlocks=function(){var a=this.constructor.name.toLowerCase(),b=new TreeNotation(FlowParser);b.getChildren().forEach(function(b){var c=b.findTail("platform");c&&!c.includes(a)&&b.destroy()});return b.toString()};AbstractApp.prototype._isSupportedEtn=function(a){var b=this.getParsers();return a&&b[a]?!0:!1};AbstractApp.prototype._getDefaultEtn=function(){return"flow"};
AbstractApp.prototype.getDetectedEtnKey=function(a){a=(new TreeNotation(a)).findTail("etn");return this._isSupportedEtn(a)?a:this._getDefaultEtn()};AbstractApp.prototype._makeParsers=function(){return{flow:new ParserETN.FlowParser(this.getFlowBlocks(),"flow",this),fire:new ParserETN.FireParser(FireParser,"fire",this)}};AbstractApp.prototype.getRootPath=function(){return""};AbstractApp.prototype.getVersion=function(){return Version};window.AbstractApp=AbstractApp;
var AbstractBlock=function(a){return AC.apply(this,arguments)||this};$jscomp.inherits(AbstractBlock,AC);AbstractBlock._mountedComponents=AC._mountedComponents;AbstractBlock.prototype.parseNodeType=function(a){return this.getParser().dynamicGetJsClass(this,a,this.getApp())};AbstractBlock.prototype.getParser=function(){var a=this._getEtnKey();return this.getTab().getPanel().getApp().getParsers()[a]};AbstractBlock.prototype._getEtnKey=function(){return this._etnKey||this.getParent()._getEtnKey()};
AbstractBlock.prototype.toJavascript=function(){return""};AbstractBlock.prototype.getTab=function(){return this.isTab()?this:this.getParent().getTab()};AbstractBlock.prototype.isTab=function(){return!0};AbstractBlock.prototype.getRowClass=function(){return ObjectBackedRow};AbstractBlock.prototype.getStructColumns=function(){return[]};AbstractBlock.prototype.getBlockClassColumns=function(){return[]};AbstractBlock.prototype.getChildBlocks=function(){return this.getChildrenByNodeType(AbstractBlock)};
AbstractBlock.prototype.getChildNonBlocks=function(){return this.getChildren().filter(function(a){return!a.getHead().startsWith(">")})};AbstractBlock.prototype.getDescendantBlocks=function(){var a=[];this.getChildBlocks().forEach(function(b){return b._getDescendantBlocks(a)});return a};AbstractBlock.prototype._getDescendantBlocks=function(a){a.push(this);this.getChildBlocks().forEach(function(b){return b._getDescendantBlocks(a)})};AbstractBlock.prototype.getHierarchyWithNonTerminals=function(){return{children:this.getChildBlocks().map(function(a){return a._getHierarchyWithNonTerminals()})}};
AbstractBlock.prototype._getHierarchyWithNonTerminals=function(){var a=this.getChildBlocks().map(function(a){return a._getHierarchyWithNonTerminals()});a.unshift({block:this});return{children:a}};AbstractBlock.prototype.getTTL=function(){return this._ttl||0};AbstractBlock.prototype.getHierarchy=function(){return{block:this,children:this.getChildBlocks().map(function(a){return a.getHierarchy()})}};
AbstractBlock.prototype.getInputPlane=function(){var a=this.getParent();return a.isProvider()?a.getOutputPlane():a.getInputPlane()};AbstractBlock.prototype.getOutputPlane=function(){return this.isProvider()?(this._outputPlane||(this._outputPlane=new Plane(this,[])),this._outputPlane):this.getInputPlane()};window.AbstractBlock=AbstractBlock;var AbstractChildBlock=function(a){return AbstractBlock.apply(this,arguments)||this};$jscomp.inherits(AbstractChildBlock,AbstractBlock);
AbstractChildBlock._mountedComponents=AbstractBlock._mountedComponents;AbstractChildBlock.prototype.getStruct=function(){this._blockStruct||(this._blockStruct=this.getBlock().computeStruct(this));return this._blockStruct};AbstractChildBlock.prototype._getInnerHtml=function(){return{html:'<div class="BlockPage" data-contextmenucommand="ac _openBlockContextMenuCommand">\n        '+this.getBlockHtmlPage()+"\n      </div>",css:this._getCssContent()}};AbstractChildBlock.prototype.isVisible=function(){return this.getStruct().visible};
AbstractChildBlock.prototype.selectBlock=function(){this._selected=!0;this.isMounted()&&this.getStump().addClass("ui-selected")};AbstractChildBlock.prototype.unselect=function(){delete this._selected;this.isMounted()&&this.getStump().removeClass("ui-selected")};AbstractChildBlock.prototype.isSelected=function(){return this._selected};
AbstractChildBlock.prototype.getBlockHtmlPage=function(){return'<div class="BlockHeader">'+this.getBlockHtmlHeader()+'</div>\n  <div class="BlockBody">'+this.getBlockHtmlBody()+'</div>\n  <div class="BlockFooter">'+this.getBlockHtmlFooter()+"</div>"};AbstractChildBlock.prototype.getBlockHtmlHeader=function(){return""+this.getHead()};AbstractChildBlock.prototype.openRowEditorByIndexCommand=function(a){return this._openRowEditor(this.getInputPlane().getRows()[a])};
AbstractChildBlock.prototype.makeBlockDimension=function(a){a=void 0===a?this.getPin():a;a=a.split(" ").map(function(a){return 20*parseInt(a)});var b={left:a[0],top:a[1]};2<a.length&&(b.width=a[2]);3<a.length&&(b.height=a[3]);return new BlockDimension(this,b)};AbstractChildBlock.prototype.openRowEditorByPuidCommand=function(a){return this._openRowEditor(this._getRowByPuid(a))};AbstractChildBlock.prototype._openRowEditor=function(a){var b=this.getApp();b.setTargetNode(a);return b.toggleAndRender("rowEditorModal")};
AbstractChildBlock.prototype._getRowByPuid=function(a){a=parseInt(a);return this.getInputPlane().getRows().find(function(b){return b.getPuid()===a})};AbstractChildBlock.prototype.getBlockHtmlBody=function(){return""};AbstractChildBlock.prototype.openSingleInsertModalCommand=function(){var a=this.getApp();a.setTargetNode(this);return a.toggleAndRender("singleInsertModal")};AbstractChildBlock.prototype.openBulkInsertModalCommand=function(){return this.getApp().setTargetNode(this).toggleAndRender("bulkInsertModal")};
AbstractChildBlock.prototype.getPanel=function(){return this.getTab().getPanel()};AbstractChildBlock.prototype._getCssContent=function(){var a="#"+this.getId(),b=this.getStyles(),c=this.getTheme(),d=this.isVisible()?"":"display: none",e=this.getBlockDimension(),e=e?e.toCss():"",f=Object.keys(b).map(function(d){return a+" "+d+" {"+c.objToCss(b[d])+"}"}).join("");return a+" { "+d+" "+e+" }\n      "+f+"\n      "+c.hakonToCss(this.getHakon())};AbstractChildBlock.prototype.isProvider=function(){return!1};
AbstractChildBlock.prototype.getBlock=function(){return this.getParser().getParserBlockByName(this.getHead())};AbstractChildBlock.prototype.mapPropertiesToColumnNames=function(a){var b=this.getStruct();return a.map(function(a){return b[a]})};AbstractChildBlock.prototype.getRequiredTable=function(a){a=this.mapPropertiesToColumnNames(a);var b=this.getOutputPlane();return a.map(function(a){return b.getPlaneColumnByName(a)}).some(function(a){return!a})?[]:this.getRowsAsCsvArray(a)};
AbstractChildBlock.prototype.getRowsWithStructQuery=function(){if(this.isTab())return this.getRows();var a=this.getLimit(),b=this.getStruct().orderBy;return this.getOutputPlane().getSortedRowsWithLimit(b,a)};AbstractChildBlock.prototype.getRowsAsCsvArray=function(a){var b=this.getRowsWithStructQuery().map(function(b){return b.getAsArray(a)});b.unshift(a);return b};AbstractChildBlock.prototype.getContextMenuHtml=function(){return""};
AbstractChildBlock.prototype.getRequiredTableWithDates=function(a){var b=this.getOutputPlane(),c=this.mapPropertiesToColumnNames(a).map(function(a){return b.getPlaneColumnByName(a)}),d=this.getRequiredTable(a);if(!d.length)return d;a=c.map(function(a,b){return a.isNumericMS()?b:-1}).filter(function(a){return-1<a});if(!a.length)return d;for(var c=d.length,e={i:1};e.i<c;e={i:e.i},e.i++)a.forEach(function(a){return function(b){d[a.i][b]=new Date(d[a.i][b])}}(e));return d};
AbstractChildBlock.loadCode=function(){return Promise.resolve()};AbstractChildBlock.prototype.createRowsFromTNCommand=function(a){return this.createRows((new RowParser).parse(a,"tree"))};AbstractChildBlock.prototype.createRows=function(a){return Promise.resolve()};AbstractChildBlock.prototype.fetchRows=function(){return Promise.resolve([])};
AbstractChildBlock.prototype.getStructColumns=function(){var a=this.getNode("columns"),b=a?a.toObject():{};return Object.keys(b).map(function(a){var c=b[a]||{};"object"!==typeof c&&(c={});c.name||(c.name=a);return c})};AbstractChildBlock.prototype.getBlockClassColumns=function(){return[]};
AbstractChildBlock.prototype.executeLoadNewPlane=function(){var a=this,b=this._getNow();this._timeLastLoadStarted=b;var c=this.fetchRows();if(!(c instanceof Promise))debugger;return c.then(function(c){if(a._timeLastLoadStarted!==b)return Promise.resolve();a._outputPlane=new Plane(a,c);a._ttl=a._getNow()-b;return Promise.all(a.getChildBlocks().map(function(a){return a.executeLoadNewPlane()})).then(function(b){return a})}).catch(function(b){a.handleBlockError(b)})};
AbstractChildBlock.prototype.handleBlockError=function(a){this._errorCount||(this._errorCount=0);this._errorCount++;this.getApp().goRed(a)};AbstractChildBlock.prototype.getErrorCount=function(){return this._errorCount||0};AbstractChildBlock.prototype.isTab=function(){return!1};AbstractChildBlock.prototype.getLimit=function(){return this.getStruct().limit};AbstractChildBlock.prototype.getChildNodeSuggestions=function(){return[">filter",">group",">table"]};
AbstractChildBlock.prototype.getId=function(){return"block"+this._getUid()};AbstractChildBlock.prototype.getAttributes=function(){return' id="'+this.getId()+'" '};AbstractChildBlock.prototype.getClasses=function(){return"AC BlockContainer "+this.constructor.name};AbstractChildBlock.prototype.getStyles=function(){this._styles||(this._styles={});return this._styles};
AbstractChildBlock.prototype.getBlockDimension=function(){var a=this.getTab(),b=a.getTabDimension();return a.getBlockDimensionMap(b.width,b.height).get(this)};AbstractChildBlock.prototype.getHeaderHeight=function(){return 30};AbstractChildBlock.prototype.getFooterHeight=function(){return 30};AbstractChildBlock.prototype.getBlockBodyDimension=function(){var a=this.getBlockDimension();a.height=a.height-this.getHeaderHeight()-this.getFooterHeight();return a};
AbstractChildBlock.prototype.openBlockSourceEditorModalCommand=function(){return this.getApp().setTargetNode(this).toggleAndRender("nodeEditorModal")};AbstractChildBlock.prototype.cloneBlockCommand=function(){var a=this.getTab();a.cloneBlock(this);return a.autosaveAndRender()};AbstractChildBlock.prototype._changeBlockOrderByCommand=function(a){this.toggle("orderBy",[a,"-"+a,""]);this.autosaveBlock();this.makeDirty();return this.render()};
AbstractChildBlock.prototype.shouldComponentUpdate=function(){return AbstractBlock.prototype.shouldComponentUpdate.call(this)||this._isDataExpired()};AbstractChildBlock.prototype._isDataExpired=function(){var a=this.getRTime();return this.getOutputPlane().getCTime()>a||this.getInputPlane().getCTime()>a};AbstractChildBlock.prototype.getFirstAncestor=function(){var a=this.getParent();return a instanceof AbstractChildBlock?a.getFirstAncestor():this};
AbstractChildBlock.prototype.executeLoadNewPlaneAndRender=function(){var a=this;return this.executeLoadNewPlane().then(function(){return a.render()})};AbstractChildBlock.prototype.changeTypeCommand=function(a){var b=this;this.setHead(a);var c=this.duplicate();this.unmountAndDestroy();return c.getBlock().executeLoadBlockOrGetLoadingPromise(this.getApp()).then(function(){return b.getTab().autosaveAndRender().then(function(){return c.executeLoadNewPlaneAndRender()})})};
AbstractChildBlock.prototype.changeParentCommand=function(a){var b=this.getTab(),b=(a=a?a.split(" ").map(function(a){return parseInt(a)}):"")?this.getApp().nodeAt(a):b;this.copyTo(b);this.unmountAndDestroy();return this.getTab().autosaveAndRender()};AbstractChildBlock.prototype._openBlockContextMenuCommand=function(){return this.getApp().setTargetNode(this).toggleAndRender("blockContextMenu")};AbstractChildBlock.prototype.destroyBlockCommand=function(){this.unmountAndDestroy();return this.getTab().autosaveAndRender()};
AbstractChildBlock.prototype.getNewDataCommand=function(){};AbstractChildBlock.prototype.changePropertyCommand=function(a,b){this.touchNode(b).setTail(a);this.render();return this.autosaveBlock()};AbstractChildBlock.prototype.changeMonadCommand=function(a){this.setTail(a);this.render();return this.autosaveBlock()};AbstractChildBlock.prototype.insertSuggestionCommand=function(a){var b=this;this.append(a);this.autosaveBlock();return this.getTab().executeLoadTabCode().then(function(){return b.render()})};
AbstractChildBlock.prototype.copyBlockCommand=function(){this.getApp().getFakeDom().copyTextToClipboard(this.getFirstAncestor().toString());return Promise.resolve()};AbstractChildBlock.prototype.copyDataCommand=function(a){this.getApp().getFakeDom().copyTextToClipboard(this.getOutputPlane().toDelimited(a));return Promise.resolve()};AbstractChildBlock.prototype._exportDataCommand=function(){this.getApp().downloadFile(this.getOutputPlane().toDelimited(","),this.getHead()+".csv","text/csv")};
AbstractChildBlock.prototype.getHakon=function(){return""};AbstractChildBlock.prototype.getTheme=function(){return this.getApp().getTheme()};AbstractChildBlock.prototype.getBlockHtmlFooter=function(){return this.getBlockToolbarButton()};AbstractChildBlock.prototype.getBlockToolbarButton=function(){return MakeSVG("pencil",16,'data-command="ac toggleToolbarCommand"',"BlockPencilButton")};AbstractChildBlock.prototype.openBlockInspectorCommand=function(){return this.getApp().setTargetNode(this).toggleAndRender("blockInspectorModal")};
AbstractChildBlock.prototype.getSuggestedSize=function(){return this.getBlock().getSuggestedSize()};AbstractChildBlock.prototype.getPin=function(){return this.findTail("pin")};AbstractChildBlock.prototype.getStumpForChildren=function(){return this.getStump().parent()};AbstractChildBlock.prototype.componentDidMount=function(){AbstractBlock.prototype.componentDidMount.call(this);this._blockToolbar&&this._blockToolbar.render()};
AbstractChildBlock.prototype.autosaveBlock=function(){this._clearBlockStruct();return this.getTab().autosaveTab()};AbstractChildBlock.prototype._clearBlockStruct=function(){delete this._blockStruct};AbstractChildBlock.prototype.toggleToolbarCommand=function(){this._blockToolbar=this._blockToolbar?this._blockToolbar.unmount():(new BlockToolbarContainer("",void 0,this)).render(this.getStump());return Promise.resolve()};window.AbstractChildBlock=AbstractChildBlock;
var AbstractTab=function(a){return AbstractBlock.apply(this,arguments)||this};$jscomp.inherits(AbstractTab,AbstractBlock);AbstractTab._mountedComponents=AbstractBlock._mountedComponents;AbstractTab.prototype.isProvider=function(){return!0};AbstractTab.prototype._getEtnKey=function(){return this._etnKey||"flow"};AbstractTab.prototype.isTab=function(){return!0};AbstractTab.prototype.getPanel=function(){return this.getParent()};AbstractTab.prototype.buildProgram=function(){return this.getParser().buildProgram(this)};
AbstractTab.prototype.executeLoadTabCode=function(){var a=this.getParser(),b=_.uniq(this.getDescendantBlocks().map(function(a){return a.getHead()}));return Promise.all(b.map(function(b){return a.loadBlockCode(b)}))};AbstractTab.prototype.executeLoadTabCodeAndData=function(){var a=this;return this.executeLoadTabCode().then(function(){return Promise.all(a.getChildBlocks().map(function(a){return a.executeLoadNewPlane()}))})};window.AbstractTab=AbstractTab;
var AbstractBrowserApplication=function(a){return AbstractApp.apply(this,arguments)||this};$jscomp.inherits(AbstractBrowserApplication,AbstractApp);AbstractBrowserApplication._mountedComponents=AbstractApp._mountedComponents;
AbstractBrowserApplication.prototype.componentWillMount=function(){var a=this;this._startVisitCounter();var b=this.getFromStore(StorageKeys.openTabs),b=(b=b?b.replace("!",""):"")?b.split(" "):[],b=_.uniq(b),c=this.getTabToOpen();c&&-1===b.indexOf(c)&&b.push(c);b=b.map(function(a){return a===c?"!"+a:a});b=b.slice(0,30);this.concat("theme\nmenu\npanel\n tabs "+b+"\n search");b.forEach(function(b){return b.startsWith("!")?a.openUrlInNewProgramTabAndFocus(b.substr(1)):a.openUrlInNewProgramTab(b)});this._setContainerHandlers();
this._makeProgramLinksOpenImmediately();this._makeWindowDroppable(this);this._makeWindowPastable(this);this._makeDocumentCopyableAndCuttable();this._bindKeyboardShortcuts();this._setErrorHandlers()};AbstractBrowserApplication.prototype._startVisitCounter=function(){var a=this._getVisitCount();a++;this.storeValue(StorageKeys.visitCount,a)};AbstractBrowserApplication.prototype._getVisitCount=function(){var a=this.getFromStore(StorageKeys.visitCount);return a?parseInt(a):0};
AbstractBrowserApplication.prototype.getTabToOpen=function(){var a=this.getWindowPathName();return 1<a.length&&!a.match(/\.html$/)?a:void 0};
AbstractBrowserApplication.prototype.getNodeTypes=function(){return{theme:ThemeContainer,menu:MenuContainer,panel:PanelContainer,nodePickerModal:NodePickerModal,sourceEditorModal:SourceEditorModal,programTabContextMenu:ProgramTabContextMenu,blockContextMenu:BlockContextMenu,blockInspectorModal:BlockInspectorModal,rowEditorModal:RowEditorModal,singleInsertModal:SingleInsertModal,bulkInsertModal:BulkInsertModal,promptModal:CustomPromptModal,confirmModal:CustomConfirmModal,nodeEditorModal:NodeEditorModal,
...
AbstractBrowserApplication.prototype.renderApp=function(){this.render(this.getBodyStump());return this};AbstractBrowserApplication.prototype.downloadJavascriptCommand=function(){var a=this.getMountedTab(),b=a.toJavascript();return this.downloadFile(b,a.getFileName()+".js","text/javascript")};AbstractBrowserApplication.prototype.downloadFile=function(a,b,c){var d=this.getFakeDom(),e=d.createElement("a");e.setAttribute("href","data:"+c+","+d.encodeURIComponent(a));e.setAttribute("download",b);e.click()};
AbstractBrowserApplication.prototype.appendBlockCommand=function(a,b){this._appendBlocks(a,b);return this.getMountedTab().autosaveAndRender()};AbstractBrowserApplication.prototype._getAvailablePermalink=function(a){for(var b=2,c="",d=""+a+c;this.doesFileExistSync(d);)d=""+a+c,c="-"+b,b++;return d};AbstractBrowserApplication.prototype._appendBlocks=function(a,b){return this.getNodeCursors().map(function(c){c=c.append(a,b);c.executeLoadNewPlane();return c})};
AbstractBrowserApplication.prototype.isPaid=function(){return!!Util.parseCookie(this.getWindowCookie()).paidToken};AbstractBrowserApplication.prototype.appendBlockAndSelectCommand=function(a,b){var c=this._appendBlocks(a,b);a=this.getMountedTab();a.clearSelection();return a.autosaveAndRender().then(function(){c.forEach(function(a){return a.selectBlock()})})};
AbstractBrowserApplication.prototype.insertMorphBlockCommand=function(){var a=this.getMountedTab(),b=this.getDblClickEvent();this.getNodeCursors().forEach(function(c){c.append(">morph","pin "+a.makePin(b))});return a.autosaveAndRender()};AbstractBrowserApplication.prototype.getNodeCursors=function(){var a=this.getMountedTab().getSelectedBlocks();return a.length?a:[this.getMountedTab()]};
...
AbstractBrowserApplication.prototype.getWindowElement=function(){return this.getFakeDom().getWindowElement()};AbstractBrowserApplication.prototype.openOhayoProgram=function(a){var b=(new TreeNotation(DemoPrograms)).getNode(a).getTailWithChildren(),c=this.getFocusedPanel(),d=c.getOpenTabByUrl(a);return d?c.setMountedTab(d):this.createAndOpen(b,a)};AbstractBrowserApplication.prototype.setWindowLocation=function(a){this.getDocumentElement().location=a;return this};
AbstractBrowserApplication.prototype.getWindowPathName=function(){return this.getDocumentElement().location.pathname||""};AbstractBrowserApplication.prototype.makeDataBlock=function(a){var b=(new RowParser).inferEncoding(a),b=new TreeNotation(">data\n format "+b+"\n content");b.getNode(">data content").setTailWithChildren(a);return b.toString()};AbstractBrowserApplication.prototype.onTabsChange=function(){};AbstractBrowserApplication.prototype.getFocusedPanel=function(){return this.getNode("panel")};
AbstractBrowserApplication.prototype.getMountedTab=function(){return this.getFocusedPanel().getMountedTab()};AbstractBrowserApplication.prototype.getMenuContainer=function(){return this.getNode("menu")};AbstractBrowserApplication.prototype.getHtmlStump=function(){return this.getFakeDom().getHtmlStump()};AbstractBrowserApplication.prototype.emitGlobalMessage=function(a){console.log(a)};AbstractBrowserApplication.prototype.emitGlobalMessageAndFade=function(a){console.log(a)};
AbstractBrowserApplication.prototype.handleGlobalError=function(a){console.error(a)};AbstractBrowserApplication.prototype.createNewBlankProgramCommand=function(){var a=this;return this.createAndOpen("","untitled").then(function(b){return a.emitGlobalMessageAndFade(Say($jscomp$templatelit$1,b.getUrl()))})};AbstractBrowserApplication.prototype.canMakePrograms=function(){return!0};
AbstractBrowserApplication.prototype.openUrlPromptCommand=function(){var a=this;this.prompt(Say($jscomp$templatelit$2),"").then(function(b){b&&a.openUrlInNewProgramTab(b)})};AbstractBrowserApplication.prototype.openUrlInNewProgramTab=function(a){return this.getFocusedPanel().openUrlInNewProgramTab(a)};AbstractBrowserApplication.prototype.openUrlInNewProgramTabAndFocus=function(a){var b=this,c=this.getFocusedPanel(),d=c.getOpenTabByUrl(a);return d?c.setMountedTab(d):this.openUrlInNewProgramTab(a).then(function(a){return b.getFocusedPanel().setMountedTab(a)})};
...
AbstractBrowserApplication.prototype.toggleLayoutCommand=function(){return this.getMountedTab().toggleLayout()};AbstractBrowserApplication.prototype.toggleEtnCommand=function(){return this.getMountedTab().toggleEtn()};AbstractBrowserApplication.prototype.setRefreshUrl=function(a){this.getFakeDom().getHistory().replaceState({},"",a);return this};AbstractBrowserApplication.prototype.closeMountedTabCommand=function(){return this.getFocusedPanel().closeTab(this.getMountedTab())};
AbstractBrowserApplication.prototype.fetchAndReloadFocusedTabCommand=function(){return this.getFocusedPanel().fetchAndReloadTab(this.getMountedTab())};AbstractBrowserApplication.prototype.selectAllCommand=function(){this.getMountedTab().selectAll();return Promise.resolve()};AbstractBrowserApplication.prototype.selectBlocksBySelectorCommand=function(a){this.logCommand("app selectBlocksBySelectorCommand");this.getMountedTab().selectBlocksBySelector(a);return Promise.resolve()};
AbstractBrowserApplication.prototype.clearSelectionCommand=function(){this.logCommand("app clearSelectionCommand");this.getMountedTab().clearSelection();return Promise.resolve()};AbstractBrowserApplication.prototype.deleteSelectionCommand=function(){return this.getMountedTab().deleteSelection()};AbstractBrowserApplication.prototype.duplicateSelectionCommand=function(){return this.getMountedTab().duplicateSelection()};AbstractBrowserApplication.prototype.cancelConfirmCommand=function(){return this._confirmModal._resolveCommand("0")};
AbstractBrowserApplication.prototype.acceptConfirmCommand=function(){return this._confirmModal._resolveCommand("1")};AbstractBrowserApplication.prototype.submitPromptCommand=function(){return this._promptModal._resolveCommand()};AbstractBrowserApplication.prototype.clickElementCommand=function(a){$(a).click();return Promise.resolve()};
AbstractBrowserApplication.prototype.showDeleteFileConfirmDialogCommand=function(){var a=this,b=this.getMountedTab();return this.confirmAndDeleteFile(b.getFullPath()).then(function(c){!1!==c&&a.getFocusedPanel().closeTab(b)})};AbstractBrowserApplication.prototype.mountPreviousTabCommand=function(){return this.getFocusedPanel().mountPreviousTab()};AbstractBrowserApplication.prototype.mountNextTabCommand=function(){return this.getFocusedPanel().mountNextTab()};
AbstractBrowserApplication.prototype.closeAllTabsCommand=function(){return this.getFocusedPanel().closeAllTabs()};AbstractBrowserApplication.prototype.openFocusedPanelSearchCommand=function(){return this.getFocusedPanel().openSearchCommand()};AbstractBrowserApplication.prototype.universalSearchCommand=function(a){return Promise.resolve()};AbstractBrowserApplication.prototype.toggleFullScreenCommand=function(){this.getFakeDom().toggleFullScreen();return Promise.resolve()};
AbstractBrowserApplication.prototype.toggleFocusedModeCommand=function(){this.toggle("menu");var a=this.getFocusedPanel();a.toggle("tabs");a.toggle("search");return this.toggleFullScreenCommand()};AbstractBrowserApplication.prototype.toggleSourceGutterCommand=function(){this.makeAllDirty();return this.getFocusedPanel().toggleAndRender("sourceGutter")};
AbstractBrowserApplication.prototype.getKeyboardShortcuts=function(){this._shortcuts||(this._shortcuts=new KeyboardShortcutNotation(this._getKeyboardShortcuts()));return this._shortcuts};AbstractBrowserApplication.prototype.selectNextCommand=function(){return this.getMountedTab().selectNext()};AbstractBrowserApplication.prototype.selectPreviousCommand=function(){return this.getMountedTab().selectPrevious()};AbstractBrowserApplication.prototype._getKeyboardShortcuts=function(){return"mounted showDeleteFileConfirmDialogCommand shift+backspace Delete Program\npanel createNewBlankProgramCommand ctrl+n New Program\npanel toggleHelpCommand ? Help\nmounted closeMountedTabCommand ctrl+w Close focused tab\npanel closeAllTabsCommand ctrl+shift+w Close all tabs\npanel toggleThemeCommand shift+t Toggle Theme\nmounted selectAllCommand command+a Select All\nmounted openHtmlCommand ctrl+h\npanel openFocusedPanelSearchCommand command+p\nmounted toggleLayoutCommand shift+l Toggle layout\nmounted toggleEtnCommand shift+e Toggle Etn\nmounted mountPreviousTabCommand shift+left Previous tab\nmounted mountNextTabCommand shift+right Next tab\nmounted selectNextCommand shift+down Select next\nmounted selectPreviousCommand shift+up Select previous\npanel toggleSourceGutterCommand shift+u Edit Source\npanel toggleFullScreenCommand shift+f Toggle Full Screen\npanel toggleFocusedModeCommand command+shift+f Toggle Focused Mode\npanel toggleSourceEditorCommand ctrl+u Edit Source\nmounted deleteSelectionCommand backspace Delete Selection\nmounted saveProgramAndNotifyCommand command+s Save Program\nmounted showTabRenamePromptCommand ctrl+shift+r Rename File\npanel toggleAutoSaveCommand shift+s Toggle autosave\nmounted fetchAndReloadFocusedTabCommand shift+r Re-download and refresh tab\nmounted duplicateSelectionCommand command+d Duplicate Selection\nmounted toggleNodePickerCommand shift+p Edit node\nmounted undoFocusedTabCommand command+z Undo\nmounted redoFocusedTabCommand command+shift+z Redo\npanel openAllLinksCommand command+shift+o Open All Links\npanel _runSpeedTestCommand ctrl+shift+m\npanel openUrlPromptCommand shift+o Open url\npanel closeModalCommand escape Close any open modal\nmounted cloneProgramCommand ctrl+shift+n Clone program\nmounted toggleBuildProgramModal shift+b Build program"};
AbstractBrowserApplication.prototype.openAllLinksCommand=function(){var a=this;this.getLinks().forEach(function(b){a.openUrlInNewProgramTab(b.link)});return Promise.resolve()};AbstractBrowserApplication.prototype.toggleBuildProgramModal=function(){return this.toggleAndRender("buildProgramModal")};AbstractBrowserApplication.prototype.undoFocusedTabCommand=function(){return this.getMountedTab().undoCommand()};AbstractBrowserApplication.prototype.redoFocusedTabCommand=function(){return this.getMountedTab().redoCommand()};
...
AbstractBrowserApplication.prototype._runSpeedTestCommand=function(){var a=this,b=this.getLinks().map(function(a){return a.link}),c=Date.now(),d=Util.pLimit(7),e=this.getFocusedPanel(),b=b.map(function(b){return d(function(){return a.openUrlInNewProgramTab(b).then(function(a){var b=e.getMountedTab();e.setMountedTab(a);b&&e.closeTab(b);return a.getTabStats()})})});return Promise.all(b).then(function(b){e.closeTab(e.getMountedTab());b=new TreeNotation(b);var d=Date.now()-c,d="Program Load Times "+moment().format("MM/DD/YYYY")+
" version "+a.getVersion()+". Run time: "+d;return a.createAndOpen(SpeedTestTemplate(d,b.toCsv()),"program-load-times")})};AbstractBrowserApplication.prototype.executeCommandOnFirstSelectedBlock=function(a,b,c){return this.getMountedTab().getFirstSelectedBlock()[a](b,c)};
...
TreeLayout.prototype.makeBlockDimensionMap=function(){var a=d3.hierarchy(this.getHierarchy()),b=d3.tree().size([.8*this.getContainerWidth(),.8*this.getContainerHeight()]),c=new Map;b(a).descendants().forEach(function(a){var b=a.data.block;b.isTab()||(a=new BlockDimension(b,{width:80,height:80,left:a.x,top:a.y}),c.set(b,a))});return c};var ColumnLayout=function(a){AbstractLayoutStrategy.apply(this,arguments)};$jscomp.inherits(ColumnLayout,AbstractLayoutStrategy);
...
var ProgramTab=function(a){return AbstractTab.apply(this,arguments)||this};$jscomp.inherits(ProgramTab,AbstractTab);ProgramTab._mountedComponents=AbstractTab._mountedComponents;ProgramTab.prototype.getBlockDimensionMap=function(a,b){return(new (this._getLayoutStrategyClass())(this,a,b)).makeBlockDimensionMap()};ProgramTab.prototype._getLayoutStrategyClass=function(){return LayoutStrategies[this.findTail("layout")]||LayoutStrategies.custom};
ProgramTab.prototype.getTabDimension=function(){var a=this.getApp().getBodyStump();return{width:a.width()-this.getParent().getGutterWidth(),height:a.height()}};ProgramTab.prototype.getSelectedBlocks=function(){return this.getDescendantBlocks().filter(function(a){return a.isSelected()})};ProgramTab.prototype.clearSelection=function(){this.getSelectedBlocks().forEach(function(a){return a.unselect()})};ProgramTab.prototype.selectAll=function(){this.getDescendantBlocks().forEach(function(a){return a.selectBlock()})};
ProgramTab.prototype.getFirstSelectedBlock=function(){return this.getSelectedBlocks()[0]};ProgramTab.prototype.selectNext=function(){for(var a=this.getFirstSelectedBlock().getNext();!a.getHead().startsWith(">");)a=this.getFirstSelectedBlock().getNext();this.clearSelection();a.selectBlock();return Promise.resolve()};ProgramTab.prototype.copySelection=function(a){a=this._copySelection(a);if(!a)return Promise.resolve();this.getApp().emitGlobalMessageAndFade(Say($jscomp$templatelit$9));return Promise.resolve(a)};
ProgramTab.prototype._copySelection=function(a){var b=this.getApp().getFakeDom();if(b.someInputHasFocus())return"";var c=this.selectionToString();if(!c)return"";b.setCopyData(a,c);return c};ProgramTab.prototype.selectionToString=function(){return this.getSelectedBlocks().map(function(a){return a.toString()}).join("\n")};ProgramTab.prototype.selectBlocksBySelector=function(a){$(void 0===a?".ui-selected":a).each(function(){$(this).data("container").selectBlock()})};
ProgramTab.prototype._getPinChangeInPixels=function(a,b){return{left:a.offset.left-b.left,top:a.offset.top-b.top}};ProgramTab.prototype.cutSelection=function(a){a=this._copySelection(a);if(!a)return Promise.resolve();this.deleteSelection();this.getApp().emitGlobalMessageAndFade(Say($jscomp$templatelit$10));return Promise.resolve(a)};
ProgramTab.prototype.deleteSelection=function(){var a=this.getSelectedBlocks();if(!a.length)return Promise.resolve();a.forEach(function(a){return a.unmountAndDestroy()});return this.autosaveAndRender()};ProgramTab.prototype.duplicateSelection=function(){var a=this,b=this.getSelectedBlocks().map(function(b){return a.cloneBlock(b)}),c=this.autosaveAndRender();this.clearSelection();b.forEach(function(a){return a.selectBlock()});return c};
ProgramTab.prototype.selectPrevious=function(){for(var a=this.getFirstSelectedBlock().getPrevious();!a.getHead().startsWith(">");)a=this.getFirstSelectedBlock().getPrevious();this.clearSelection();a.selectBlock();return Promise.resolve()};ProgramTab.prototype.appendFromPaste=function(a){var b=this,c=this.concat(a);a=this.autosaveAndRender();this.clearSelection();return a.then(function(){return b.executeLoadTabCodeAndData().then(function(){c.forEach(function(a){return a.selectBlock()})})})};
ProgramTab.prototype.getDiskFolder=function(){var a=(this.isFolder()?this.getUrl():this.getFolder())||"/";return require("path").normalize(a.replace("file://",""))};ProgramTab.prototype.getFolder=function(){var a=this.getUrl().split("/");a.pop();return a.join("/")};ProgramTab.prototype.setLayout=function(a){this.touchNode("layout").setTail(a);return this};ProgramTab.prototype.cloneBlock=function(a){var b=a.duplicate();(a=a.findTail("pin"))&&b.touchNode("pin").setTail(this.getAvailableSpot(a));return b};
ProgramTab.prototype.updateCustomPoint=function(){return this._updateCustomLayout()};ProgramTab.prototype.updateCustomPointWithWidthAndHeight=function(){return this._updateCustomLayout(!0)};ProgramTab.prototype._updateCustomLayout=function(a){a=void 0===a?!1:a;var b=this;$(".BlockContainer").each(function(){b._updateBlockLayout($(this),a)});this.setLayout("custom");this.autosaveTab();this.getApp().renderApp()};
ProgramTab.prototype._updateBlockLayout=function(a,b){var c=a.data("container"),d=a.offset(),e=this.getGridSize(),f=a.parent().offset();a=[Math.floor((d.left-f.left)/e),Math.floor((d.top-f.top)/e),Math.floor(a.width()/e),Math.floor(a.height()/e)];b=b?a:a.slice(0,2);c.delete("pin");c.prepend("pin "+b.join(" "))};ProgramTab.prototype.getAvailableSpot=function(a){a=a.split(" ").map(function(a){return parseInt(a)});a[0]++;a[1]++;return a.join(" ")};
ProgramTab.prototype.toggleLayout=function(){var a=this.toggle("layout",["custom","bin","tree"]);this.getDescendantBlocks().forEach(function(a){return a.makeDirty()});this.getApp().emitGlobalMessageAndFade(Say($jscomp$templatelit$11,a));return this.autosaveAndRender()};ProgramTab.prototype.getGridSize=function(){return 20};ProgramTab.prototype.setIsFolder=function(a){this._isFolder=a;return this};ProgramTab.prototype._getLongestLoadTime=function(){return this.getDescendantBlocks().map(function(a){return a.getTTL()}).sort().reverse()[0]};
ProgramTab.prototype._getLongestRenderTime=function(){return this.getDescendantBlocks().map(function(a){return a.getNewestTimeToRender()}).sort().reverse()[0]};ProgramTab.prototype.isFolder=function(){return!0===this._isFolder};ProgramTab.prototype.getFullPath=function(){return this.getApp().normalizePath(this.getFileName())};ProgramTab.prototype.handleTabError=function(a){console.error(a)};ProgramTab.prototype.isReadOnly=function(){return!0===this._readOnly};
ProgramTab.prototype.setAuthor=function(a){this._author=a;return this};ProgramTab.prototype.getAuthor=function(){return this._author||""};ProgramTab.prototype.setReadOnly=function(a){this._readOnly=a;return this};ProgramTab.prototype.autosaveAndRender=function(){var a=this.autosaveTab();this.getApp().renderApp();return a};
ProgramTab.prototype.autosaveTab=function(){var a=this.childrenToString(),b=this._getTopUndoVersion();if(a===b)return Promise.resolve();this._recordChange(a);return this.getApp().isAutoSaveEnabled()?this.forceSaveToDisk():Promise.resolve()};ProgramTab.prototype._clearRedoStack=function(){var a=this._getRedoStack();a.splice(0,a.length)};ProgramTab.prototype._recordChange=function(a){this._clearRedoStack();this._getUndoStack().push(a)};
ProgramTab.prototype.forceSaveToDisk=function(){var a=this._getDiff();this.setHash(a.newHash);this._setDiskVersion(a.newVersion);return this.getApp().saveTabToDisk(this,a).catch(function(a){throw new TabSaveError(a);})};ProgramTab.prototype._getDiskVersion=function(){return this._diskVersion};ProgramTab.prototype._setDiskVersion=function(a){this._diskVersion=a;return this};ProgramTab.prototype._getUndoStack=function(){this._undoStack||(this._undoStack=[]);return this._undoStack};
ProgramTab.prototype._getRedoStack=function(){this._redoStack||(this._redoStack=[]);return this._redoStack};ProgramTab.prototype._getTopUndoVersion=function(){var a=this._getUndoStack();return a[a.length-1]};ProgramTab.prototype.undoCommand=function(){var a=this._getUndoStack(),b=this._getRedoStack();if(1===a.length)return Promise.resolve();b.push(a.pop());return this._reloadFromUndoTop()};
ProgramTab.prototype._reloadFromUndoTop=function(){this.unmount();this.setChildren(this._getTopUndoVersion());return this._reloadTab()};ProgramTab.prototype.autosaveAndReloadWith=function(a){this.unmount();this.setChildren(a);this.autosaveTab();return this._reloadTab()};ProgramTab.prototype._reloadTab=function(){var a=this;return this.executeLoadTabCodeAndData().then(function(){a.getParent().setMountedTab(a);a.getApp().renderApp()})};
ProgramTab.prototype.redoCommand=function(){var a=this._getUndoStack(),b=this._getRedoStack();if(!b.length)return Promise.resolve();a.push(b.pop());return this._reloadFromUndoTop()};ProgramTab.prototype.setHostedProgramId=function(a){this._id=a};ProgramTab.prototype.getHostedProgramId=function(){return this._id||0};ProgramTab.prototype.hasUnsavedChanges=function(){return this.childrenToString()!==this._getDiskVersion()};ProgramTab.prototype.getHash=function(){return this._hash||""};
ProgramTab.prototype.setHash=function(a){this._hash=a};ProgramTab.prototype._getDiff=function(){var a=this.getHash(),b=this.childrenToString(),c=this._getDiskVersion(),c=diff.compareStr(c,b,"\n"),d=new jsSHA("SHA-1","TEXT");d.update(a+JSON.stringify(c));d=d.getHash("HEX");return{oldHash:a,newHash:d,patch:c,newVersion:b}};ProgramTab.prototype._setEtnFromStr=function(a){this._etnKey=this.getApp().getDetectedEtnKey(a)};
ProgramTab.prototype.setEtnAndChildrenAndDiskAndUndoStack=function(a){this._setEtnFromStr(a);this.setChildren(a);this._setDiskVersion(a);this._getUndoStack().push(a);return this};ProgramTab.prototype.toggleEtn=function(){this._etnKey="flow"===this._getEtnKey()?"fire":"flow";var a=this.getPanel();a.log(this._etnKey);return a.fetchAndReloadTab(this)};ProgramTab.prototype.getFileName=function(){return this.getUrl().split("/").pop()};ProgramTab.prototype.setPrivate=function(a){this._private=a;return this};
ProgramTab.prototype.getUrl=function(){return this.getTail()};ProgramTab.prototype.setParentId=function(a){this._parentId=a};ProgramTab.prototype.setApiKey=function(a){this._apiKey=a};ProgramTab.prototype.setComments=function(a){this._comments=a};ProgramTab.prototype.getComments=function(){return this._comments||[]};ProgramTab.prototype.isPrivate=function(){return this._private||0};ProgramTab.prototype.setListed=function(a){this._listed=a;return this};
ProgramTab.prototype.isListed=function(){return this._listed||0};ProgramTab.prototype.getParentId=function(){return this._parentId||0};ProgramTab.prototype.getMTime=function(){return this._mtime||0};ProgramTab.prototype.setMTime=function(a){this._mtime=a};ProgramTab.prototype.getCTime=function(){return this._ctime||0};ProgramTab.prototype.setCTime=function(a){this._ctime=a};ProgramTab.prototype.getApiKey=function(){return this._apiKey||""};ProgramTab.prototype.getHtml=function(){return""};
ProgramTab.prototype.getHakon=function(){var a=this.getTheme();return".ProgramTab\n left "+this.getParent().getGutterWidth()+"px\n background "+a.surfaceBackground+"\n position relative\n right 0\n bottom 0\n\n.ui-selectable-helper\n position absolute\n z-index 100\n border-radius 2px\n background "+a.selectionBackground+"\n\n.ui-selecting,.ui-selected,.StaySelected\n outline 3px solid "+a.selectedOutline};
ProgramTab.prototype._clearWideProgramMins=function(){var a={"min-height":"","min-width":""},b=this.getStump();b.css(a);b.parent().css(a);this._forceRepaint()};ProgramTab.prototype._forceRepaint=function(){this.getApp().getDocumentStump().width()};ProgramTab.prototype.makePin=function(a){var b=this.getGridSize();return[Math.floor((a.offsetX-0)/b),Math.floor(a.offsetY/b)].join(" ")};ProgramTab.prototype.componentDidUpdate=function(){this._clearWideProgramMins();this._fixWideProgramBugs()};
ProgramTab.prototype._fixWideProgramBugs=function(){var a=this.getApp(),b=a.getMenuContainer(),b=b&&b.getStump(),c=a.getHtmlStump();b&&b.css("width","");c.css({width:"",height:"","min-height":"","min-width":""});var a=a.getDocumentStump(),d=a.width(),e=a.height();b&&b.css("width",d);c.css({"min-height":"100%","min-width":"100%",width:d,height:e});b=this.getStump();c=b.parent();a={"min-height":a.height()-60+"px","min-width":a.width()+"px"};c.css(a);b.css(a)};
ProgramTab.prototype.componentDidMount=function(){this._makeSelectable();this._makeBlocksMoveableAndResizableAndEditable();this.componentDidUpdate()};
ProgramTab.prototype._makeSelectable=function(){var a=this.getApp(),b=this.getStump();b.on(BrowserEvents.click,function(b){b.target===this&&a.getFakeDom().someInputHasFocus()&&$(":focus").first().trigger("blur")});b.selectable({cancel:".BlockContainer",distance:10,filter:".BlockContainer",start:function(b){b.shiftKey?$(".ui-selected").addClass("StaySelected"):a.clearSelectionCommand()},stop:function(){$(".StaySelected").addClass("ui-selected").removeClass("StaySelected");a.selectBlocksBySelectorCommand();
return!0}})};ProgramTab.prototype.getAllRows=function(){return _.flatten(this.getDescendantBlocks().map(function(a){return a.isProvider()?a.getOutputPlane().getRows():[]}))};ProgramTab.prototype.getProgramRowCount=function(){return this.getAllRows().reduce(function(a,b){return a+b.length},0)};
ProgramTab.prototype.getTabStats=function(){var a=this.getDescendantBlocks(),b=a.map(function(a){return a.getErrorCount()}).reduce(function(a,b){return a+b},0);return{blocks:a.length,rows:this.getProgramRowCount(),url:this.getFileName(),timeToLoad:this._getLongestLoadTime(),timeToRender:this._getLongestRenderTime(),errorCount:b}};ProgramTab.prototype.shouldComponentMount=function(){return AbstractTab.prototype.shouldComponentMount.call(this)&&this.getParent().getMountedTab()===this};
ProgramTab.prototype._makeBlocksMoveableAndResizableAndEditable=function(){var a=this.getApp(),b=this,c=this.getGridSize();this.getStump().on(BrowserEvents.mouseover,".BlockContainer",function(d){var e=$(this);if(0<e.find(".ui-resizable-handle").length)return!0;b.makeGroupDraggable(e,[c,c]);e.resizable({handles:"se",grid:c,create:function(a,b){e.find(".ui-resizable-handle").attr("title","Drag to resize")},stop:function(){return a.getMountedTab().updateCustomPointWithWidthAndHeight()}})})};
ProgramTab.prototype.getAttributes=function(){return'data-contextmenucommand="ac _openProgramTabContextMenuCommand" data-dblclickcommand="app insertMorphBlockCommand"'};ProgramTab.prototype._openProgramTabContextMenuCommand=function(){return this.getApp().toggleAndRender("programTabContextMenu")};ProgramTab.prototype._getSelectedBlockStumps=function(){return this.getApp().getFakeDom().getStumps(".BlockContainer.ui-selected")};
ProgramTab.prototype.updateSelectedOnMove=function(a,b){var c=this._getSelectedBlockStumps();0!==c.length&&(c.not(a).each(function(){var a=$(this),c=parseFloat(a.css("top")),f=parseFloat(a.css("left"));a.css({transform:"",top:c+b.top+"px",left:f+b.left+"px"})}),a.closest(".ui-selectable").selectable("refresh"))};
ProgramTab.prototype.makeGroupDraggable=function(a,b){var c=$(a);if(c.hasClass("draggable"))return!0;var d,e=this,f=this.getApp();a={stop:function(a,b){c.removeClass("noTransition");c.attr("data-translate","undefined undefined");a=e._getPinChangeInPixels(b,d);e.updateSelectedOnMove(c,a);d=b;f.getMountedTab().updateCustomPoint()},handle:".BlockFooter",drag:function(a,b){c.hasClass("ui-selected")&&(a=e._getPinChangeInPixels(b,d),e._getSelectedBlockStumps().not(c).css("transform","translate("+a.left+
"px, "+a.top+"px)"))},start:function(a,b){d=b.offset;c.addClass("noTransition");if(a=c.attr("data-translate"))parseInt(a.split(" ")[0]),parseInt(a.split(" ")[1])}};b&&(a.grid=b);c.draggable(a).addClass("draggable")};window.ProgramTab=ProgramTab;var SearchContainer=function(a){return AC.apply(this,arguments)||this};$jscomp.inherits(SearchContainer,AC);SearchContainer._mountedComponents=AC._mountedComponents;
...
SearchContainer.prototype._scanLinks=function(a){if(a)return this.getApp().getLinks().find(function(b){return a!==b.title?!1:!0})};SearchContainer.prototype.tryOpenByNameCommand=function(a,b){var c=this.getApp();(a=a&&this._scanLinks(a.split(" ").pop()))?(c.openUrlInNewProgramTabAndFocus(a.link),this._getInputElement().typeahead("val","").blur()):b&&c.universalSearchCommand(b)};
...
var StorageKeys={openTabs:"__openTabs",autoSave:"__autoSave",theme:"__theme",visitCount:"__visitCount",newUser:"__newUser"},_storageKeysmap={};Object.values(StorageKeys).forEach(function(a){_storageKeysmap[a]=!0});StorageKeys.isKey=function(a){return _storageKeysmap[a]};window.StorageKeys=StorageKeys;
var Theme=function(a){var b=a=void 0===a?{}:a,c=void 0===b.backgroundColor?"rgb(255,255,255)":b.backgroundColor,d=void 0===b.foregroundColor?"black":b.foregroundColor,e=void 0===b.fn?"lighten":b.fn,b=void 0===b.selectionColor?"rgb(42, 89, 178)":b.selectionColor;this.blockBackgroundColor=this.contextMenuBackground=this.surfaceBackground=this.bodyBackground=this.tabsBackground=this.tabBackground=this.menuBackground=this.backgroundColor=c;this.foregroundColor=this.menuContainerColor=d;this.lineColor=
...
TableBlock.prototype.getBlockHtmlBody=function(){var a=this.getStruct(),b=this.getInputPlane(),b="importance"===a.columnOrder?b.getColumnsByImportance():b.getColumnsArray();if(a.visible)var c=a.visible.split(" "),b=b.filter(function(a){return c.includes(a.getColumnName())});else if(a.hidden)var d=a.hidden.split(" "),b=b.filter(function(a){return!d.includes(a.getColumnName())});var b=b.slice(0,50),e=b.map(function(a){return a.getColumnName()}),e=this._getHeaderHtml(e,a.orderBy),a=this._getTrHtml(b,
a.pretty);return'<div class="TableContainer">\n<table>\n  <thead>\n    <tr title="'+Say($jscomp$templatelit$15)+'">'+e+"</tr>\n  </thead>\n  <tbody>"+a+"</tbody>\n  </table>\n</div>"};window.TableBlock=TableBlock;var WordCloudChart=function(a){return AbstractHeaderlessChartBlock.apply(this,arguments)||this};$jscomp.inherits(WordCloudChart,AbstractHeaderlessChartBlock);WordCloudChart._mountedComponents=AbstractHeaderlessChartBlock._mountedComponents;WordCloudChart.loadCode=AbstractHeaderlessChartBlock.loadCode;
WordCloudChart.prototype.getBlockHtmlBody=function(){return'<div class="wordCloud" style="width: 100%; height: 100%;"></div>'};WordCloudChart.prototype._getWords=function(){return this.getRequiredTable(["name","count"])};
...
MorphBlock.prototype.getBlockHtmlBody=function(){var a=this.getParser(),b=a.getTopNodeTypes();this.getApp();return b.map(function(b){return a.getParserBlockByName(b)}).map(function(a){var b=MakeSVG(a.getSvg(),24);return'<a tabindex="-1" value="'+a.getHead()+'" data-command="ac changeTypeCommand">'+b+"<br>"+a.getHead()+"</a>"}).join("<br>")};MorphBlock.prototype.getBlockHtmlHeader=function(){return""};window.MorphBlock=MorphBlock;
var FireBlock=function(a){return AbstractChildBlock.apply(this,arguments)||this};$jscomp.inherits(FireBlock,AbstractChildBlock);FireBlock._mountedComponents=AbstractChildBlock._mountedComponents;FireBlock.loadCode=AbstractChildBlock.loadCode;FireBlock.prototype.getHakon=function(){return".FireBlock\n text-align center\n input\n  border 0\n  font-size 14px"};
FireBlock.prototype.getBlockHtmlPage=function(){var a=this.getBlock(),b=MakeSVG(a.getSvg(),24),a=a.getPattern(),c=this.getTail()||"";return'<div class="BlockBody HeaderLess">\n\t\t'+b+"\n\t\t<br>\n\t\t"+('\n\t\t\t<input placeholder="'+a+'" value="'+c+'" data-command="ac changeMonadCommand" / >')+'\n\t\t</div>\n<div class="BlockFooter">'+this.getBlockHtmlFooter()+"</div>"};
FireBlock.prototype.toJavascript=function(a){a=void 0===a?0:a;var b=this.getBlock(),c=b._getExtended(),d=c.findTail("toJS"),b=b.getPattern().split(" "),e=this.getTail().split(" "),f={},g=b.length-1,h=c.findTail("joinBy")||" ";b.forEach(function(a,b){f[a]=b===g?e.slice(b).join(h):e[b]});var d=(new TreeNotation(f)).format(d),c=c.getNode("hasBlock"),k=" ".repeat(a);return c?k+d+" {\n"+this.getChildren().map(function(b){return k+b.toJavascript(a+2)}).join("\n")+"\n"+k+"}\n":k+d};window.FireBlock=FireBlock;
...
StoreBlock._mountedComponents=DataBlock._mountedComponents;StoreBlock.loadCode=DataBlock.loadCode;StoreBlock.prototype._getData=function(){return this.getApp().getStore().get(this._getKey())||""};StoreBlock.prototype._getKey=function(){return this.getStruct().key||this.getTab().getUrl()};StoreBlock.prototype._saveDataCommand=function(a){this.getApp().getStore().set(this._getKey(),a)};window.StoreBlock=StoreBlock;var TopBlock=function(a){return AbstractUrlProvider.apply(this,arguments)||this};
...
JoinBlock.prototype.transformRows=function(){var a=this.getStruct().on,b=this.getParent();this.getOutputPlane();if(!b)return[];var c=b.getParent();if(!c)return b.getOutputRowSources();c=[b,c];b=c.map(function(a){return a.getOutputPlane().getRowSources()});if(!a)return _.flatten(b);c=c.map(function(a){return a.getOutputPlane().getColumnNames()});return Util.joinArraysOn(a,b,c)};window.JoinBlock=JoinBlock;var ParseBlock=function(a){return AbstractTransformerBlock.apply(this,arguments)||this};
$jscomp.inherits(ParseBlock,AbstractTransformerBlock);ParseBlock._mountedComponents=AbstractTransformerBlock._mountedComponents;ParseBlock.loadCode=AbstractTransformerBlock.loadCode;ParseBlock.prototype.transformRows=function(){var a=this.getStruct(),b=this.getInputPlane().getRowSources(),c=a.format,d=a.column,e=new RowParser;return _.flatten(b.map(function(a){return e.parse(a[d],c)}))};window.ParseBlock=ParseBlock;var WordCount=function(a){return AbstractTransformerBlock.apply(this,arguments)||this};
$jscomp.inherits(WordCount,AbstractTransformerBlock);WordCount._mountedComponents=AbstractTransformerBlock._mountedComponents;WordCount.loadCode=AbstractTransformerBlock.loadCode;WordCount.prototype.transformRows=function(){var a=this.getStruct().field,b=this.getInputPlane().getRowSources().map(function(b){return a?b[a]:b}).join(" ");return this._getWords(b)};
...
MenuContainer._mountedComponents=AbstractMenuContainer._mountedComponents;window.MenuContainer=MenuContainer;var PanelContainer=function(a){return AC.apply(this,arguments)||this};$jscomp.inherits(PanelContainer,AC);PanelContainer._mountedComponents=AC._mountedComponents;PanelContainer.prototype.getNodeTypes=function(){return{tabs:TabsContainer,search:SearchContainer,sourceGutter:SourceGutter,commentsGutter:CommentsGutter,historyGutter:HistoryGutter,tab:ProgramTab}};
PanelContainer.prototype.parseNodeType=function(a){return this.getNodeTypes()[a.split(" ")[0]]};PanelContainer.prototype.getHtml=function(){return""};PanelContainer.prototype.getHakon=function(){var a=this.getParent().getMenuContainer()?"30":"0";this.getTheme();return".PanelContainer\n left 0\n position relative\n right 0\n bottom 0\n height calc(100% - "+a+"px)"};
PanelContainer.prototype.getGutterWidth=function(){return 0<this.getChildren().filter(function(a){return a.getHead().includes("Gutter")}).length?400:0};PanelContainer.prototype.log=function(a){console.log(a)};PanelContainer.prototype.openSearchCommand=function(){var a=this.getNode("search");a&&a.focusInputCommand();return Promise.resolve()};PanelContainer.prototype.mountTabByIndex=function(a){return this.setMountedTab(this.getTabs()[a])};PanelContainer.prototype.getMountedTab=function(){return this._mountedTab};
PanelContainer.prototype.fetchAndReloadTab=function(a){var b=this;a.unmount();return this._executeFetchTab(a).then(function(){b.getApp().renderApp()})};PanelContainer.prototype._executeFetchTab=function(a){var b=this.getApp();this._updateTabsContainer();return b.fetchTab(a).then(function(){return a.executeLoadTabCodeAndData()}).then(function(){b.tabDidOpen(a);b.renderApp();return a})};PanelContainer.prototype.getOpenTabByUrl=function(a){return this.getTabs().find(function(b){return b.getUrl()===a})};
PanelContainer.prototype.setMountedTab=function(a){var b=this.getMountedTab();if(b===a)return Promise.resolve(a);b&&b.unmount();this._mountedTab=a;this._updateTabsContainer();this.getApp().renderApp();return Promise.resolve(a)};PanelContainer.prototype.openUrlInNewProgramTab=function(a){return this._executeFetchTab(this.append("tab "+a))};PanelContainer.prototype.closeTabByIndex=function(a){return this.closeTab(this.getTabs()[a])};
PanelContainer.prototype.closeTab=function(a){if(a.isMounted()){var b=a.getNextOrPrevious(this.getTabs());a.unmountAndDestroy();if(b&&b!==a)return this.setMountedTab(b);delete this._mountedTab}else a.destroy();this._updateTabsContainer();this.getApp().renderApp();return Promise.resolve()};PanelContainer.prototype.getOpenTabsString=function(){var a=this.getMountedTab();return this.getTabs().map(function(b){return""+(b===a?"!":"")+b.getUrl()}).join(" ")};
PanelContainer.prototype._updateTabsContainer=function(){var a=this.getOpenTabsString();this.touchNode("tabs").setTail(a);this._openTabs!==a&&(this.getApp().storeValue(StorageKeys.openTabs,a),this._openTabs=a,this._updateLocationForRestoreOnRefresh())};
PanelContainer.prototype._updateLocationForRestoreOnRefresh=function(){var a=this.getApp(),b=this.getMountedTab(),c=b?b.getUrl():"/";a.setRefreshUrl(c).getFakeDom().setWindowTitle(b?(b.hasUnsavedChanges()?"*":"")+(b.getFileName()+" - "+Say($jscomp$templatelit$17)):Say($jscomp$templatelit$18))};
PanelContainer.prototype.closeAllTabs=function(){var a=this.getMountedTab();a&&a.unmount();this.getTabs().forEach(function(a){return a.destroy()});delete this._mountedTab;this._updateTabsContainer();this.getApp().renderApp();return Promise.resolve()};PanelContainer.prototype.mountPreviousTab=function(){var a=this.getTabs(),b=this.getMountedTab();if(2>a.length||!b)return Promise.resolve();b=a.indexOf(b);return this.mountTabByIndex(0===b?a.length-1:b-1)};
PanelContainer.prototype.mountNextTab=function(){var a=this.getTabs(),b=this.getMountedTab();if(2>a.length||!b)return Promise.resolve();b=a.indexOf(b);return this.mountTabByIndex(b===a.length-1?0:b+1)};PanelContainer.prototype.getTabs=function(){return this.findNodes("tab")};window.PanelContainer=PanelContainer;var TabsContainer=function(a){return AC.apply(this,arguments)||this};$jscomp.inherits(TabsContainer,AC);TabsContainer._mountedComponents=AC._mountedComponents;
TabsContainer.prototype.shouldComponentUpdate=function(){var a=this.getParent().getGutterWidth();return this._gutterWidth!==a?(this._gutterWidth=a,!0):AC.prototype.shouldComponentUpdate.call(this)};
TabsContainer.prototype.getHakon=function(){var a=this.getTheme(),b=this._getTabs().length;return".TabsContainer\n height 30px\n box-sizing border-box\n left "+this.getParent().getGutterWidth()+"px\n right 0\n position relative\n white-space nowrap\n overflow-y hidden\n overflow-x "+(10<b?"scroll":"auto")+"\n border-bottom "+(b?"1px solid "+a.borderColor:"0")+"\n background "+a.tabsBackground+"\n a\n  span\n   position absolute\n   top 10px\n   right 5px\n   display block\n   font-size 12px\n   line-height 10px\n   text-align center\n   opacity .25\n   &:hover\n    opacity 1\n  background "+
a.tabBackground+"\n  height 30px\n  display inline-block\n  box-sizing border-box\n  position relative\n  font-size 14px\n  padding 0 20px\n  color "+a.foregroundColor+"\n  line-height 30px\n  border-right 1px solid "+a.borderColor+"\n  border-bottom 1px solid "+a.borderColor+"\n  &.mountedTab\n   background "+a.surfaceBackground+"\n   border-bottom 0"};TabsContainer.prototype._getTabs=function(){var a=this.getTail();return a?a.split(" "):[]};
TabsContainer.prototype.getHtml=function(){return this._getTabs().map(function(a,b){return'<a data-command="app mountTabByIndexCommand" value="'+b+'" class="'+(a.startsWith("!")?"mountedTab":"")+'">'+a.replace("!","")+'<span data-command="app closeTabByIndexCommand" value="'+b+'" class="closeTabButton">x</span></a>'}).join("")};window.TabsContainer=TabsContainer;var ThemeContainer=function(a){return AC.apply(this,arguments)||this};$jscomp.inherits(ThemeContainer,AC);
ThemeContainer._mountedComponents=AC._mountedComponents;ThemeContainer.prototype.getHtml=function(){return""};
...
BlockContextMenu.prototype.getHtml=function(){return'<a data-command="app fetchAndReloadFocusedTabCommand">Reload</a>\n<a tabindex="-1" data-command="context copyBlockCommand">Copy block with inputs</a>\n<a data-command="context copyDataCommand" value="\t">Copy data as tsv</a>\n<a data-command="context _exportDataCommand">Export data to csv file</a>\n'+this.getApp().getTargetNode().getContextMenuHtml()};window.BlockContextMenu=BlockContextMenu;
var ProgramTabContextMenu=function(a){return AbstractContextMenu.apply(this,arguments)||this};$jscomp.inherits(ProgramTabContextMenu,AbstractContextMenu);ProgramTabContextMenu._mountedComponents=AbstractContextMenu._mountedComponents;ProgramTabContextMenu.prototype.getHtml=function(){return this.getApp().getMountedTab().getParser().getContextMenuCommands()};window.ProgramTabContextMenu=ProgramTabContextMenu;var AbstractGutter=function(a){return AbstractModal.apply(this,arguments)||this};
$jscomp.inherits(AbstractGutter,AbstractModal);AbstractGutter._mountedComponents=AbstractModal._mountedComponents;AbstractGutter.prototype.getHakon=function(){var a=this.getTheme(),b=this.getParent().getGutterWidth();return AbstractModal.prototype.getHakon.call(this)+"\n.AbstractGutter\n width "+b+"px\n left 0\n background "+a.backgroundColor+"\n border-color "+a.borderColor+"\n position absolute\n border-right-width 1px\n border-right-style solid\n box-sizing border-box\n top 0\n bottom 0\n padding 20px\n .GutterHeader\n  height 30px\n  padding 5px\n  box-sizing border-box\n  line-height 30px\n  font-size 16px\n .GutterBody\n  width 100%\n  overflow scroll\n  bottom 0\n  height calc(100% - 30px)\n .GutterClose\n  position absolute\n  top 0\n  line-height 30px\n  height 30px\n  right 10px\n  cursor pointer"};
...
CommentsGutter.prototype._postCommentCommand=function(){var a=this.getApp(),b=a.getApi(),c=this.getStump().find("textarea").val(),d=a.getMountedTab();b.commentCreate(d.getHostedProgramId(),c).then(function(){a.emitGlobalMessageAndFade("Comment posted");b.programGet(d.getAuthor(),d.getFileName()).then(function(b){d.setComments(b.comments);a.renderApp()})})};CommentsGutter.prototype.getGutterTitle=function(){return"Comments"};
...
$jscomp.inherits(SourceGutter,AbstractGutter);SourceGutter._mountedComponents=AbstractGutter._mountedComponents;SourceGutter.prototype.hasChanges=function(){var a=this._getTab();return a&&this._getTextarea().val()!==a.childrenToString()};SourceGutter.prototype._getTextarea=function(){return this.getStump().find("textarea")};SourceGutter.prototype._getTab=function(){return this.getParent().getMountedTab()};SourceGutter.prototype._saveChangesCommand=function(){return this._getTab().autosaveAndReloadWith(this._getTextarea().val())};
SourceGutter.prototype.getGutterTitle=function(){return"Edit Source"};SourceGutter.prototype.componentDidUpdate=function(){AbstractGutter.prototype.componentDidUpdate.call(this);var a=this._getTab();this._getTextarea().val(a?a.childrenToString():"")};SourceGutter.prototype.shouldComponentUpdate=function(){return!0};SourceGutter.prototype.componentDidMount=function(){AbstractGutter.prototype.componentDidMount.call(this);this.componentDidUpdate()};
...
AbstractHelpModal.prototype.getHtml=function(){var a=this.getApp(),b=a.getParsersArray().map(function(a){return a.getDocs()}).join("<br><br>");a.getMountedTab();return"<h4>About "+Say($jscomp$templatelit$21)+'</h4>\n      <p>ohayo is the fastest programming tool in the solar system.</p>\n\n\n      <p>\n      <a data-command="app openOhayoProgram" value="ohayo">Welcome Page</a> |\n      <a data-command="app openOhayoProgram" value="readme">Read Me</a> |\n      <a data-command="app openOhayoProgram" value="faq">FAQ</a> |\n      <a data-command="app openOhayoProgram" value="releasenotes">Release Notes</a> |\n      <a data-command="app openOhayoProgram" value="fib">Fire Example</a>\n      </p>\n\n      <a class="helpToggle">'+
...
NodePickerModal.prototype.getHtml=function(){return'<h4>Click a property to edit</h4>\n    <div class="monospaceModal"><div>'+this.getTab().toHtml()+"</div></div>"};window.NodePickerModal=NodePickerModal;var RowEditorModal=function(a){return AbstractModal.apply(this,arguments)||this};$jscomp.inherits(RowEditorModal,AbstractModal);RowEditorModal._mountedComponents=AbstractModal._mountedComponents;
...
SourceEditorModal.prototype.hasChanges=function(){return this._getTextarea().val()!==this.getApp().getMountedTab().childrenToString()};SourceEditorModal.prototype._getTextarea=function(){return this.getStump().find("textarea")};SourceEditorModal.prototype._saveChangesCommand=function(){var a=this.getApp(),b=this._getTextarea(),c=a.getMountedTab(),b=b.val();c.setChildren(b);a.closeModal();c.autosaveAndRender()};SourceEditorModal.prototype.componentDidMount=function(){this._getTextarea().val(this.getApp().getMountedTab().childrenToString())};
SourceEditorModal.prototype.getHtml=function(){return'<h4>Edit Source</h4>\n  <textarea rows="20" class="bigInput" wrap="off"></textarea>\n  <button title="Save" data-command="ac _saveChangesCommand" class="SVGIcon rightButton">'+MakeSVG("check",30)+"</button>"};window.SourceEditorModal=SourceEditorModal;
var SpeedTestTemplate=function(a,b){return">data\n pin 45 32 17 5\n content "+b.replace(/\n/g,"\n  ")+"\n columns\n  timeToLoad\n   type number\n  timeToRender\n   type number\n >text\n  content "+a+"\n  pin 45 0 23 3\n >table\n  link url\n  title Slow Load Times\n  x timeToLoad\n  y timeToRender\n  orderBy -timeToLoad\n  pin 0 0 43 18\n >table\n  link url\n  title Slow Render Times\n  x timeToLoad\n  y timeToRender\n  orderBy -timeToRender\n  pin 0 20 41 17\n >kpi\n  pin 45 4 11 7\n  column timeToLoad\n  reduction average\n >kpi\n  pin 45 15 11 7\n  column timeToRender\n  reduction average\n >kpi\n  pin 45 24 11 7\n  column timeToRender\n  reduction median\n >kpi\n  pin 57 4 11 7\n  column timeToLoad\n  reduction sum\n >kpi\n  pin 57 15 11 7\n  column timeToRender\n  reduction sum\n >kpi\n  pin 57 24 11 7\n  column timeToRender\n  reduction count"};
window.SpeedTestTemplate=SpeedTestTemplate;var OhayoApp=function(a){return AbstractBrowserApplication.apply(this,arguments)||this};$jscomp.inherits(OhayoApp,AbstractBrowserApplication);OhayoApp._mountedComponents=AbstractBrowserApplication._mountedComponents;OhayoApp.prototype.fetchTab=function(a){a.setEtnAndChildrenAndDiskAndUndoStack(this.getFromStore(a.getUrl()));return Promise.resolve()};
OhayoApp.prototype.componentWillMount=function(){var a=this;AbstractBrowserApplication.prototype.componentWillMount.call(this);var b=["readme","faq","releasenotes","fib"];1===this._getVisitCount()&&Promise.all(b.map(function(b){return a.openOhayoProgram(b)})).then(function(){a.openOhayoProgram("ohayo")})};OhayoApp.prototype.saveTabToDisk=function(a,b){this.storeValue(a.getFullPath(),b.newVersion);return Promise.resolve()};
OhayoApp.prototype.getLinks=function(){return this.getStoreKeys().filter(function(a){return!StorageKeys.isKey(a)}).map(function(a){return{link:a,title:a}})};OhayoApp.prototype.getTabToOpen=function(){};OhayoApp.prototype.doesFileExistSync=function(a){return void 0!==this.getFromStore(a)};OhayoApp.prototype.setRefreshUrl=function(a){return this};OhayoApp.prototype.deleteFileCommand=function(a){this.removeValue(a);return Promise.resolve()};
OhayoApp.prototype.renameFileCommand=function(a,b,c){this.storeValue(b,this.getFromStore(a)||"");this.removeValue(a);return Promise.resolve(b)};OhayoApp.prototype._createFile=function(a,b,c){a=this._getAvailablePermalink(a);this.storeValue(a,b);return Promise.resolve(a)};OhayoApp.prototype.createAndOpen=function(a,b,c){var d=this;return this._createFile(b,a,c).then(function(a){return d.openUrlInNewProgramTabAndFocus(a)})};var bsMain=function(){return(new OhayoApp).renderApp()};window.OhayoApp=OhayoApp;
